 ...
 */
            ...
            /**
            *  QueryBPStatusRut bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryBPStatusRut
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = QueryBPStatusRut
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryBPStatusRut",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryBPStatusRut",
    ...
    public static class Factory{
        ...
        */
        public static QueryBPStatusRut parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryBPStatusRut object =
                new QueryBPStatusRut();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryBPStatusRut".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryBPStatusRut)cl.laaraucana.simulacion.webservices.autogenerado.QueryBPStatus.web_mobile.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
