...
public class QuerySimWebOut implements org.apache.axis2.databinding.ADBBean {
	...
	*/
	...
	protected cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[] localPAYMENT_OPTIONS;
	 ...
	 */
	public cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[] getPAYMENT_OPTIONS() {
	 ...
	 */
	protected void validatePAYMENT_OPTIONS(cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[] param) {
	 ...
	 *            PAYMENT_OPTIONS
	 */
	public void setPAYMENT_OPTIONS(cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[] param) {
	 ...
	 */
	public void addPAYMENT_OPTIONS(cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1 param) {
		if (localPAYMENT_OPTIONS == null) {
			localPAYMENT_OPTIONS = new cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[] {};
		}

		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPAYMENT_OPTIONS);
		list.add(param);
		this.localPAYMENT_OPTIONS = (cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[]) list.toArray(new cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[list.size()]);
		...
		public static QuerySimWebOut parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"QuerySimWebOut".equals(type)) {
							...
							return (QuerySimWebOut) cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "PAYMENT_OPTIONS").equals(reader.getName())) {
					...
					list4.add(cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1.Factory.parse(reader));
					...
					object.setPAYMENT_OPTIONS((cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(cl.laaraucana.simulacion.webservices.autogenerado.QuerySimulationWeb.PAYMENT_OPTIONS_type1.class, list4));
