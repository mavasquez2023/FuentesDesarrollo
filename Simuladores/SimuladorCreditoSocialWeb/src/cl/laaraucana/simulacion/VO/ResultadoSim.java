...
public class ResultadoSim extends AbstractSalidaVO {
	...
	private CreaCotizacionSalidaVO creaCotizacion;
	private QuerySimulationSalidaVO querySimulation;
	...
	public CreaCotizacionSalidaVO getCreaCotizacion() {
		return creaCotizacion;
	}

	public void setCreaCotizacion(CreaCotizacionSalidaVO creaCotizacion) {
		this.creaCotizacion = creaCotizacion;
	}

	public QuerySimulationSalidaVO getQuerySimulation() {
		return querySimulation;
	}

	public void setQuerySimulation(QuerySimulationSalidaVO querySimulation) {
		this.querySimulation = querySimulation;
	}
