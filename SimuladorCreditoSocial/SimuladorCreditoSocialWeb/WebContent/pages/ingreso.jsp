...
})(window,document,'script','dataLayer','GTM-57QJLTF');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-57QJLTF"
	...
	<div class="container-fluid">
		...
		<div class="simulador">
			<div class="simulador__container">
				...
				<div class="simulador__item" id="paso-1" style="margin-top: -20px">
					<html:form action="/resultado" styleClass="form"
						...
						<div class="row">
							<div class="col-xs-12 col-md-6">
								<div class="form__grupo" data-animacion="placeholder">
									...
									<select
										name="tipo_afiliado" id="tipo_afiliado" class="requerido"
										onchange="activarSeguro()" >
										<option value="" hidden></option>
										<option value="1" <c:if test="${tipo==1}">selected</c:if>>Trabajador</option>
										<option value="2" <c:if test="${tipo==2}">selected</c:if>>Pensionado</option>
									</select> <label for="tipo_afiliado">Tipo de afiliado</label>
								</div>
							</div>
							<div class="col-xs-12 col-md-6">
								<div class="form__grupo" data-animacion="placeholder"
									...
									<input type="text" class="text tipo_rut requerido" id="rut"
										name="rut" value="${rut}"> <label for="rut">RUT</label>
								</div>
							</div>
							<div class="col-xs-12 col-md-6">
								<div class="form__grupo" data-animacion="placeholder"
									...
									<input type="text" class="text tipo_numerico formatear-montos"
										id="monto" name="monto" value=""> <label
						...
						-->	
							...
							<div class="col-xs-12"  id="seguro-cesantia-div">
							...
							<div class="col-xs-12 xs-text-right">
								<a href="#"
									...
									onclick="validarDatos();">Simular Crédito</a>
							</div>
						</div>
					</html:form>
