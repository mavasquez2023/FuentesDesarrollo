...
<body>
	<logic:equal value="0" name="codError">
		...
		<div id="datosAfiliado">
			...
			<span><b>Folio Crédito: </b>${folio_contrato}</span>
		...
		<div class="botones">
			<form target="blank" action="detalleCredito.do" method="POST">
				<div id="datosInsolvencia" style="display: none">
					<p align="left"><b>CLIENTE ACOGIDO A LEY DE INSOLVENCIA, ANTES DE ENTREGAR INFORMACIÓN COMUNICARSE CON SU ZONAL DE COBRANZA </b><br></p>
