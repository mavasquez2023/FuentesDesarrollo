...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/araucana.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery.ba-postmessage.min.js"></script>
