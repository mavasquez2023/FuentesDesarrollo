...
</td><td width="700px"><font class="text"> <font class="text"><b>Enviar Casos x Rechazo
							 </b></font></font> 
			<hr>
<html:form action="envio" method="post">
...
<tr><td><font class="blueText">Tabla Rechazo</font></td><td><input type="text" name="tablaorigen" value="LIQREVISA" id="tablaorigen"></td><td>Tablas Tuplas</td><td><input type="text" name="tabladestino" value="TUPLAS"></td></tr>
<tr><td><font class="blueText"></font>Tabla Marca Rechazo</td><td><input type="text" name="tablamarcarechazo" value="MARCARECHAZO"></td><td>Tablas Tramos</td><td><input type="text" name="tablatramo" value="TRAMOS"></td></tr>
...
<tr><td><font class="blueText"></font>Periodo Entre</td><td><input type="text" name="minperiodo" value="2012" size="6" maxlength="6">-<input type="text" name="maxperiodo" value="${periodoActual }" size="6" maxlength="6"></td><td></td><td></td></tr>
<tr><td><font class="blueText"></font>Actualizar Sistemas:</td><td>SIAGF<input type="checkbox" name="accion" value="SF" checked="checked">SIVEGAM<input type="checkbox" name="accion"  id="accionSV" value="SV" onclick="llenaBase(this.value);"></td><td>Opciones</td><td>Tuplas<input type="checkbox" name="actualizar" value="T" checked="checked">
</td></tr>
