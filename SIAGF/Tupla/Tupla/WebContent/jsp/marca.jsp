...
<br>Tramo<input type="checkbox" name="actualizar" value="T" checked="checked"><br>Monto<input type="checkbox" name="actualizar" value="M"><br>Causante<input type="checkbox" name="actualizar" value="C" checked="checked">
