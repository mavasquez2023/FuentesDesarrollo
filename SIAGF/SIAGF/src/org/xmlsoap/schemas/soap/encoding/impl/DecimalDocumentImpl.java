 ...
 */
public class DecimalDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.DecimalDocument {
    private static final javax.xml.namespace.QName DECIMAL$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "decimal");
    ...
    public org.xmlsoap.schemas.soap.encoding.Decimal getDecimal() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Decimal) get_store()
                                                                     .find_element_user(DECIMAL$0,
                    0);
