 ...
 */
public class ENTITYDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.ENTITYDocument {
    private static final javax.xml.namespace.QName ENTITY$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "ENTITY");
    ...
    public org.xmlsoap.schemas.soap.encoding.ENTITY getENTITY() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.ENTITY) get_store()
                                                                    .find_element_user(ENTITY$0,
                    0);
