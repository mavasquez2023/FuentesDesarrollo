 ...
 */
public class ShortDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.ShortDocument {
    private static final javax.xml.namespace.QName SHORT$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "short");
    ...
    public org.xmlsoap.schemas.soap.encoding.Short getShort() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Short) get_store()
                                                                   .find_element_user(SHORT$0,
                    0);
