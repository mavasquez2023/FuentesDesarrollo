 ...
 */
public class LanguageDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.LanguageDocument {
    private static final javax.xml.namespace.QName LANGUAGE$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "language");
    ...
    public org.xmlsoap.schemas.soap.encoding.Language getLanguage() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Language) get_store()
                                                                      .find_element_user(LANGUAGE$0,
                    0);
