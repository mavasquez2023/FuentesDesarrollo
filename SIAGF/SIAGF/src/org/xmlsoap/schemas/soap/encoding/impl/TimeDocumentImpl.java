 ...
 */
public class TimeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.TimeDocument {
    private static final javax.xml.namespace.QName TIME$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "time");
    ...
    public org.xmlsoap.schemas.soap.encoding.Time getTime() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Time) get_store()
                                                                  .find_element_user(TIME$0,
                    0);
