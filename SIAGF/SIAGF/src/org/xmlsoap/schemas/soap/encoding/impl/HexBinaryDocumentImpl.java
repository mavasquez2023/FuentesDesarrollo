 ...
 */
public class HexBinaryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.HexBinaryDocument {
    private static final javax.xml.namespace.QName HEXBINARY$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "hexBinary");
    ...
    public org.xmlsoap.schemas.soap.encoding.HexBinary getHexBinary() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.HexBinary) get_store()
                                                                       .find_element_user(HEXBINARY$0,
                    0);
    ...
    public void setHexBinary(
        org.xmlsoap.schemas.soap.encoding.HexBinary hexBinary) {
        synchronized (monitor()) {
            check_orphaned();
