 ...
 */
public class ArrayDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.ArrayDocument {
    private static final javax.xml.namespace.QName ARRAY$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "Array");
    ...
    public org.xmlsoap.schemas.soap.encoding.Array getArray() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Array) get_store()
                                                                   .find_element_user(ARRAY$0,
                    0);
