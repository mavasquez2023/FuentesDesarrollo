 ...
 */
public class DurationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.DurationDocument {
    private static final javax.xml.namespace.QName DURATION$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "duration");
    ...
    public org.xmlsoap.schemas.soap.encoding.Duration getDuration() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Duration) get_store()
                                                                      .find_element_user(DURATION$0,
                    0);
