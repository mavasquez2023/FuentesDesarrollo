 ...
 */
public class UnsignedShortDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.UnsignedShortDocument {
    private static final javax.xml.namespace.QName UNSIGNEDSHORT$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "unsignedShort");
    ...
    public org.xmlsoap.schemas.soap.encoding.UnsignedShort getUnsignedShort() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.UnsignedShort) get_store()
                                                                           .find_element_user(UNSIGNEDSHORT$0,
                    0);
    ...
    public void setUnsignedShort(
        org.xmlsoap.schemas.soap.encoding.UnsignedShort unsignedShort) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.UnsignedShort) get_store()
                                                                               .add_element_user(UNSIGNEDSHORT$0);
            }
