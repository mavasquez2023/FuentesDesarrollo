 ...
 */
public class NCNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.NCNameDocument {
    private static final javax.xml.namespace.QName NCNAME$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "NCName");
    ...
    public org.xmlsoap.schemas.soap.encoding.NCName getNCName() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.NCName) get_store()
                                                                    .find_element_user(NCNAME$0,
                    0);
