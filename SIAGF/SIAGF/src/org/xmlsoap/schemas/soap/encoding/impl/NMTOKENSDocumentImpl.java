 ...
 */
public class NMTOKENSDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.NMTOKENSDocument {
    private static final javax.xml.namespace.QName NMTOKENS$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "NMTOKENS");
    ...
    public org.xmlsoap.schemas.soap.encoding.NMTOKENS getNMTOKENS() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.NMTOKENS) get_store()
                                                                      .find_element_user(NMTOKENS$0,
                    0);
