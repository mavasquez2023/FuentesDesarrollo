 ...
 */
public class IntDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.IntDocument {
    private static final javax.xml.namespace.QName INT$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "int");
    ...
    public org.xmlsoap.schemas.soap.encoding.Int getInt() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Int) get_store()
                                                                 .find_element_user(INT$0,
                    0);
