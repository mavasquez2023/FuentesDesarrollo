 ...
 */
public class NegativeIntegerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.NegativeIntegerDocument {
    private static final javax.xml.namespace.QName NEGATIVEINTEGER$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "negativeInteger");
    ...
    public org.xmlsoap.schemas.soap.encoding.NegativeInteger getNegativeInteger() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.NegativeInteger) get_store()
                                                                             .find_element_user(NEGATIVEINTEGER$0,
                    0);
    ...
    public void setNegativeInteger(
        ...
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.NegativeInteger) get_store()
                                                                                 .add_element_user(NEGATIVEINTEGER$0);
            }
