 ...
 */
public class IDREFDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.IDREFDocument {
    private static final javax.xml.namespace.QName IDREF$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "IDREF");
    ...
    public org.xmlsoap.schemas.soap.encoding.IDREF getIDREF() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.IDREF) get_store()
                                                                   .find_element_user(IDREF$0,
                    0);
