 ...
 */
public class DoubleDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.DoubleDocument {
    private static final javax.xml.namespace.QName DOUBLE$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "double");
    ...
    public org.xmlsoap.schemas.soap.encoding.Double getDouble() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Double) get_store()
                                                                    .find_element_user(DOUBLE$0,
                    0);
