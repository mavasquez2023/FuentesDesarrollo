 ...
 */
public class RootAttributeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.RootAttribute {
    private static final javax.xml.namespace.QName ROOT$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "root");
    ...
    public org.xmlsoap.schemas.soap.encoding.RootAttribute.Root xgetRoot() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.RootAttribute.Root) get_store()
                                                                                .find_attribute_user(ROOT$0);
     ...
     */
    public void xsetRoot(
        org.xmlsoap.schemas.soap.encoding.RootAttribute.Root root) {
        synchronized (monitor()) {
            check_orphaned();
     ...
     */
    public static class RootImpl extends org.apache.xmlbeans.impl.values.JavaBooleanHolderEx
        implements org.xmlsoap.schemas.soap.encoding.RootAttribute.Root {
