 ...
 */
public class GYearDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.GYearDocument {
    private static final javax.xml.namespace.QName GYEAR$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "gYear");
    ...
    public org.xmlsoap.schemas.soap.encoding.GYear getGYear() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.GYear) get_store()
                                                                   .find_element_user(GYEAR$0,
                    0);
