 ...
 */
public class UnsignedLongDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.UnsignedLongDocument {
    private static final javax.xml.namespace.QName UNSIGNEDLONG$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "unsignedLong");
    ...
    public org.xmlsoap.schemas.soap.encoding.UnsignedLong getUnsignedLong() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.UnsignedLong) get_store()
                                                                          .find_element_user(UNSIGNEDLONG$0,
                    0);
    ...
    public void setUnsignedLong(
        org.xmlsoap.schemas.soap.encoding.UnsignedLong unsignedLong) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.UnsignedLong) get_store()
                                                                              .add_element_user(UNSIGNEDLONG$0);
            }
