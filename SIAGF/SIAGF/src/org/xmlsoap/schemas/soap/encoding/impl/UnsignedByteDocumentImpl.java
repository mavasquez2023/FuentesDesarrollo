 ...
 */
public class UnsignedByteDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.UnsignedByteDocument {
    private static final javax.xml.namespace.QName UNSIGNEDBYTE$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "unsignedByte");
    ...
    public org.xmlsoap.schemas.soap.encoding.UnsignedByte getUnsignedByte() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.UnsignedByte) get_store()
                                                                          .find_element_user(UNSIGNEDBYTE$0,
                    0);
    ...
    public void setUnsignedByte(
        org.xmlsoap.schemas.soap.encoding.UnsignedByte unsignedByte) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.UnsignedByte) get_store()
                                                                              .add_element_user(UNSIGNEDBYTE$0);
            }
