 ...
 */
public class NormalizedStringDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.NormalizedStringDocument {
    private static final javax.xml.namespace.QName NORMALIZEDSTRING$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "normalizedString");
    ...
    public org.xmlsoap.schemas.soap.encoding.NormalizedString getNormalizedString() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.NormalizedString) get_store()
                                                                              .find_element_user(NORMALIZEDSTRING$0,
                    0);
     ...
     */
    public void setNormalizedString(
        org.xmlsoap.schemas.soap.encoding.NormalizedString normalizedString) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.NormalizedString) get_store()
                                                                                  .add_element_user(NORMALIZEDSTRING$0);
            }
