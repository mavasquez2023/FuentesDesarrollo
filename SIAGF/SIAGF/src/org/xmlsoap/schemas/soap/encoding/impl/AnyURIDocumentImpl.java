 ...
 */
public class AnyURIDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.AnyURIDocument {
    private static final javax.xml.namespace.QName ANYURI$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "anyURI");
    ...
    public org.xmlsoap.schemas.soap.encoding.AnyURI getAnyURI() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.AnyURI) get_store()
                                                                    .find_element_user(ANYURI$0,
                    0);
