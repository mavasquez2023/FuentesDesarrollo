 ...
 */
public class PositiveIntegerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.PositiveIntegerDocument {
    private static final javax.xml.namespace.QName POSITIVEINTEGER$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "positiveInteger");
    ...
    public org.xmlsoap.schemas.soap.encoding.PositiveInteger getPositiveInteger() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.PositiveInteger) get_store()
                                                                             .find_element_user(POSITIVEINTEGER$0,
                    0);
    ...
    public void setPositiveInteger(
        org.xmlsoap.schemas.soap.encoding.PositiveInteger positiveInteger) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.PositiveInteger) get_store()
                                                                                 .add_element_user(POSITIVEINTEGER$0);
            }
