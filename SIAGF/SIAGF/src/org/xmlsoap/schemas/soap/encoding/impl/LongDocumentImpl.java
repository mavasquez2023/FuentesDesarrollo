 ...
 */
public class LongDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.LongDocument {
    private static final javax.xml.namespace.QName LONG$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "long");
    ...
    public org.xmlsoap.schemas.soap.encoding.Long getLong() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Long) get_store()
                                                                  .find_element_user(LONG$0,
                    0);
