 ...
 */
public class ENTITIESDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.ENTITIESDocument {
    private static final javax.xml.namespace.QName ENTITIES$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "ENTITIES");
    ...
    public org.xmlsoap.schemas.soap.encoding.ENTITIES getENTITIES() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.ENTITIES) get_store()
                                                                      .find_element_user(ENTITIES$0,
                    0);
