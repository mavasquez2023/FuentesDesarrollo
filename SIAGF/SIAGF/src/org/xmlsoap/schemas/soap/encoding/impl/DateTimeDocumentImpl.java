 ...
 */
public class DateTimeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.DateTimeDocument {
    private static final javax.xml.namespace.QName DATETIME$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "dateTime");
    ...
    public org.xmlsoap.schemas.soap.encoding.DateTime getDateTime() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.DateTime) get_store()
                                                                      .find_element_user(DATETIME$0,
                    0);
