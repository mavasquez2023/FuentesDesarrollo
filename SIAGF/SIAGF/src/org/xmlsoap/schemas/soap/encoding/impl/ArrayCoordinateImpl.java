 ...
 */
public class ArrayCoordinateImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx
    implements org.xmlsoap.schemas.soap.encoding.ArrayCoordinate {
    public ArrayCoordinateImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType, false);
    }

    protected ArrayCoordinateImpl(org.apache.xmlbeans.SchemaType sType,
        boolean b) {
        super(sType, b);
    }
}
