 ...
 */
public class BooleanDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.BooleanDocument {
    private static final javax.xml.namespace.QName BOOLEAN$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "boolean");
    ...
    public org.xmlsoap.schemas.soap.encoding.Boolean getBoolean() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Boolean) get_store()
                                                                     .find_element_user(BOOLEAN$0,
                    0);
