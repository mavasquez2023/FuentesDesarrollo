 ...
 */
public class GMonthDayDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.GMonthDayDocument {
    private static final javax.xml.namespace.QName GMONTHDAY$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "gMonthDay");
    ...
    public org.xmlsoap.schemas.soap.encoding.GMonthDay getGMonthDay() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.GMonthDay) get_store()
                                                                       .find_element_user(GMONTHDAY$0,
                    0);
     ...
     */
    public void setGMonthDay(
        org.xmlsoap.schemas.soap.encoding.GMonthDay gMonthDay) {
        synchronized (monitor()) {
            check_orphaned();
