 ...
 */
public class NOTATIONDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.NOTATIONDocument {
    private static final javax.xml.namespace.QName NOTATION$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "NOTATION");
    ...
    public org.xmlsoap.schemas.soap.encoding.NOTATION getNOTATION() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.NOTATION) get_store()
                                                                      .find_element_user(NOTATION$0,
                    0);
