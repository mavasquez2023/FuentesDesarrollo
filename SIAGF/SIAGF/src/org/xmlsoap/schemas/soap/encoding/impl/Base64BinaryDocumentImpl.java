 ...
 */
public class Base64BinaryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.Base64BinaryDocument {
    private static final javax.xml.namespace.QName BASE64BINARY$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "base64Binary");
    ...
    public org.xmlsoap.schemas.soap.encoding.Base64Binary getBase64Binary() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Base64Binary) get_store()
                                                                          .find_element_user(BASE64BINARY$0,
                    0);
     ...
     */
    public void setBase64Binary(
        org.xmlsoap.schemas.soap.encoding.Base64Binary base64Binary) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.Base64Binary) get_store()
                                                                              .add_element_user(BASE64BINARY$0);
            }
