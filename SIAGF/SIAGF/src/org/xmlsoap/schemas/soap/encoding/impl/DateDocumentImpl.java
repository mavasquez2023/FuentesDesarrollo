 ...
 */
public class DateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.DateDocument {
    private static final javax.xml.namespace.QName DATE$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "date");
    ...
    public org.xmlsoap.schemas.soap.encoding.Date getDate() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Date) get_store()
                                                                  .find_element_user(DATE$0,
                    0);
