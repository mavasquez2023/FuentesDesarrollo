 ...
 */
public class UnsignedIntDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.UnsignedIntDocument {
    private static final javax.xml.namespace.QName UNSIGNEDINT$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "unsignedInt");
    ...
    public org.xmlsoap.schemas.soap.encoding.UnsignedInt getUnsignedInt() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.UnsignedInt) get_store()
                                                                         .find_element_user(UNSIGNEDINT$0,
                    0);
    ...
    public void setUnsignedInt(
        org.xmlsoap.schemas.soap.encoding.UnsignedInt unsignedInt) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.UnsignedInt) get_store()
                                                                             .add_element_user(UNSIGNEDINT$0);
            }
