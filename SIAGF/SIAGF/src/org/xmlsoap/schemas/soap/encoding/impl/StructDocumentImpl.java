 ...
 */
public class StructDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.StructDocument {
    private static final javax.xml.namespace.QName STRUCT$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "Struct");
    ...
    public org.xmlsoap.schemas.soap.encoding.Struct getStruct() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Struct) get_store()
                                                                    .find_element_user(STRUCT$0,
                    0);
