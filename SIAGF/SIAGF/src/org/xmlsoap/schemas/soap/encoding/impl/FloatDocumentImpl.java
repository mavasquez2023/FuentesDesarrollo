 ...
 */
public class FloatDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.FloatDocument {
    private static final javax.xml.namespace.QName FLOAT$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "float");
    ...
    public org.xmlsoap.schemas.soap.encoding.Float getFloat() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.Float) get_store()
                                                                   .find_element_user(FLOAT$0,
                    0);
