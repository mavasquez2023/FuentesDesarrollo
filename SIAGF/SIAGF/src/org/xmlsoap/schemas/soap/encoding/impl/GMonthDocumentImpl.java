 ...
 */
public class GMonthDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.GMonthDocument {
    private static final javax.xml.namespace.QName GMONTH$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "gMonth");
    ...
    public org.xmlsoap.schemas.soap.encoding.GMonth getGMonth() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.GMonth) get_store()
                                                                    .find_element_user(GMONTH$0,
                    0);
