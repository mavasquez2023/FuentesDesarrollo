 ...
 */
public class NMTOKENDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.NMTOKENDocument {
    private static final javax.xml.namespace.QName NMTOKEN$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "NMTOKEN");
    ...
    public org.xmlsoap.schemas.soap.encoding.NMTOKEN getNMTOKEN() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.NMTOKEN) get_store()
                                                                     .find_element_user(NMTOKEN$0,
                    0);
