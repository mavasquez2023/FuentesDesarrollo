 ...
 */
public class StringDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.StringDocument {
    private static final javax.xml.namespace.QName STRING$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "string");
    ...
    public org.xmlsoap.schemas.soap.encoding.String getString() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.String) get_store()
                                                                    .find_element_user(STRING$0,
                    0);
