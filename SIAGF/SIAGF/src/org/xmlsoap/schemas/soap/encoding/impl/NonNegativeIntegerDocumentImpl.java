 ...
 */
public class NonNegativeIntegerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.NonNegativeIntegerDocument {
    private static final javax.xml.namespace.QName NONNEGATIVEINTEGER$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "nonNegativeInteger");
    ...
    public org.xmlsoap.schemas.soap.encoding.NonNegativeInteger getNonNegativeInteger() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.NonNegativeInteger) get_store()
                                                                                .find_element_user(NONNEGATIVEINTEGER$0,
                    0);
     ...
     */
    public void setNonNegativeInteger(
        org.xmlsoap.schemas.soap.encoding.NonNegativeInteger nonNegativeInteger) {
        synchronized (monitor()) {
            check_orphaned();
            ...
            if (target == null) {
                target = (org.xmlsoap.schemas.soap.encoding.NonNegativeInteger) get_store()
                                                                                    .add_element_user(NONNEGATIVEINTEGER$0);
            }
