 ...
 */
public class QNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.QNameDocument {
    private static final javax.xml.namespace.QName QNAME$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "QName");
    ...
    public org.xmlsoap.schemas.soap.encoding.QName getQName() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.QName) get_store()
                                                                   .find_element_user(QNAME$0,
                    0);
