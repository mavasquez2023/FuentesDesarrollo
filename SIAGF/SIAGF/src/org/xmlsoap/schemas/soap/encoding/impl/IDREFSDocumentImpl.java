 ...
 */
public class IDREFSDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.xmlsoap.schemas.soap.encoding.IDREFSDocument {
    private static final javax.xml.namespace.QName IDREFS$0 = new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/",
            "IDREFS");
    ...
    public org.xmlsoap.schemas.soap.encoding.IDREFS getIDREFS() {
        synchronized (monitor()) {
            ...
            target = (org.xmlsoap.schemas.soap.encoding.IDREFS) get_store()
                                                                    .find_element_user(IDREFS$0,
                    0);
