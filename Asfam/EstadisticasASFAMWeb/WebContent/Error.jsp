		...
		<div id="caja_registro">
			...
			<div id="tabla_reload">
				<table width="1020" align="center" cellpadding="0" cellspacing="1" border="0">
					<tr>
						<td height="40" width="50" valign="middle" bgcolor="#7BAEBD" class="texto" style="color: #fff; text-align: center"><strong>Ha ocurrido un error inesperado. Contacte a su administrador de sistemas.</strong></td>
					</tr>
				</table>
