...
public class NewComprobanteAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			PeticionProcesamientoDto petPro= null;
			for (Iterator iter = encargado.getEmpresas().iterator(); iter.hasNext();) {
				...
				if(empresa.getRut() == Integer.valueOf(rutEmpresaParam)){
					...
					petPro= estProDao.selectPeticionProcesamiento(Integer.parseInt(rutEmpresaParam), Integer.parseInt(periodo));
					...
					cantTotalInformados += petPro.getTotalRegInformados();
					break;
				}
			}
	
			
			if(flagEmpresaEncargado ){
				...
				String str = "<html>" +
					...
					"<body>" +
					"<table>" +
					"	<tr><td align=\"center\"><h1><b>Comprobante de Propuesta<br/></b></h1><br/></td></tr>" +
					"	<tr>" +
					"		<td> " +
					"			<table border=\"1\"> " +
					"				<tr >" +
					...
					"					<td align=\"center\">Informados en Propuesta</td>" +
					"				</tr>" +
					"				<tr>" +
					"					<td>" + rutEmpresa +"</td>" +
					"					<td>" + nombreEmpresa + "</td>" +
					"					<td align=\"center\">" + String.valueOf(cantTotalInformados) + "</td>" +
					"				</tr>" +
					"			</table>" +
					"			<br />" +
					"			<table border=\"1\">" +
					"				<tr>" +
					"					<td align=\"center\" with=\"32\"><b>Archivo</b></td>" +
					"					<td align=\"center\" with=\"17\"><b>Fecha Envio</b></td>" +
					"					<td align=\"center\" with=\"17\"><b>Fecha Proceso</b></td>" +
					"					<td align=\"center\" with=\"17\"><b>Cant. Declarados</b></td>" +
					"					<td align=\"center\" with=\"17\"><b>Cant. No Informados</b><br/>(en base a Propuesta)</td>" +
					"				</tr>";
				...
				//for(PeticionProcesamientoDto obj : listPetPro){
					...
					str += "<td>" + petPro.getRutaArchivo() + "</td>";
					str += "<td align=\"center\">" + petPro.getFechaEnvioStr() + "</td>";
					str += "<td align=\"center\">" + petPro.getFechaProcesamientoStr() + "</td>";
					str += "<td align=\"center\">" + petPro.getTotalRegProcesadosStr() + "</td>";
					str += "<td align=\"center\">" + petPro.getTotalRegNoDeclarados() + "</td>";
					str += "</tr>";
				//}
