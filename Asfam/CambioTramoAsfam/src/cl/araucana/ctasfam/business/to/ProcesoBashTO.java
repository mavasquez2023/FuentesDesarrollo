...
public ProcesoBashTO(){
    ...
    private Timestamp fechaProcesamiento;// AFP66FPA
    private int registrosProcesados; //AFP66TRP
    private int registrosNoInformados; //AFP66TRN
	...
	public int getRegistrosNoInformados() {
		return registrosNoInformados;
	}
	public void setRegistrosNoInformados(int registrosNoInformados) {
		this.registrosNoInformados = registrosNoInformados;
	}
