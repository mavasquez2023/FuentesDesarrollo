...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
			...
			<tbody>
				<tr valign="top">
					...
					<th width="42%" bgcolor="#050BD1">
						<b>
							<font class="text"> Razón Social </font>
						</b>
					</th>
					<th width="38%" bgcolor="#050BD1">
						<b>
							<font class="text"> Aceptar Declaración</font>
						</b>
					</th>
				</tr>
	...
	<font size="1" face="Arial">
		Al seleccionar "Aceptar la declaración jurada", usted declara bajo juramento que los datos consignados son expresión fiel de la realidad. 
	</font>
	<br>
	<br>
