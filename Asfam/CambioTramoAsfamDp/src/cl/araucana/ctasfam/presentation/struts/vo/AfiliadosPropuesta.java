...
public class AfiliadosPropuesta implements Serializable {
	...
	public AfiliadosPropuesta() {
		super();
	}

	public AfiliadosPropuesta(int oficina, int rutEmpresa,
	...
	public String getFullOrigen() {
		if("M".equalsIgnoreCase(getOrigen().trim())) {
			return "Manual";
		} else if("E".equalsIgnoreCase(getOrigen().trim())) {
			return "Web";
		} else if("C".equalsIgnoreCase(getOrigen().trim())) {
			return "Mail";
		} else {
			return "";
		}
