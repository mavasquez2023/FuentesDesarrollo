//funciones que validan formularios de jsp tabla plano8_DatosLicResol
...
*/
	...
	function validarDatosLicResol(tipoForm){
		var key=true;
		var keyAux=true;
	...
	//validar campos
		...
		if(valNull($("#"+tipoForm).find("#"+campo).val()) || valNumerico($("#"+tipoForm).find("#"+campo).val())){
	   	...
	   	campo="num_dias_licencia_rechazados";
		if(valNull($("#"+tipoForm).find("#"+campo).val()) || valNumerico($("#"+tipoForm).find("#"+campo).val())){
			key=false;
			keyAux=false;
	   	}else{
	   ...
	   //puede ser vacio, requiere validacion formato date iso
