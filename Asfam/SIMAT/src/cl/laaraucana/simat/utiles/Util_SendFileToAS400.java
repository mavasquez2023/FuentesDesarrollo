...
public class Util_SendFileToAS400 {
	...
	public Util_SendFileToAS400(String server, String usuario, String password) {
	...
	public void crearDirectorio(String rutaDir) {
		try {
			IFSFile dir = new IFSFile(system, rutaDir);
			if (dir.exists()) {
				System.out.println("* * * * * util_IFS: ya existe directorio [" + rutaDir + "] * * * * *");
			} else {
				dir.mkdir();
				System.out.println("* * * * * util_IFS: se creo directorio [" + rutaDir + "] * * * * *");
			}
		} catch (Exception ex) {
