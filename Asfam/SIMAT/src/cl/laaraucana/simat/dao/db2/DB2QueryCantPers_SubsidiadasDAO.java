...
public class DB2QueryCantPers_SubsidiadasDAO implements QueryCantPers_SubsidiadasDAO {
	...
	public CountVO num_pers_subs_Pre_natal(CountVO qid) throws Exception {
		...
		try {
			qid = (CountVO) sqlMap.queryForObject("getNum_pers_subs_Pre_natal", qid);
	...
	public CountVO num_pers_subs_Post_natal_Madre(CountVO qid) throws Exception {
		...
		try {
			qid = (CountVO) sqlMap.queryForObject("getNum_pers_subs_Post_natal_Madre", qid);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public CountVO num_pers_subs_Post_natal_Padre(CountVO qid) throws Exception {
		...
		try {
			qid = (CountVO) sqlMap.queryForObject("getNum_pers_subs_Post_natal_Padre", qid);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public CountVO num_pers_subs_Enf_menor_Madre(CountVO qid) throws Exception {
		...
		try {
			qid = (CountVO) sqlMap.queryForObject("getNum_pers_subs_Enf_menor_Madre", qid);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public CountVO num_pers_subs_Enf_menor_Padre(CountVO qid) throws Exception {
		...
		try {
			qid = (CountVO) sqlMap.queryForObject("getNum_pers_subs_Enf_menor_Padre", qid);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
