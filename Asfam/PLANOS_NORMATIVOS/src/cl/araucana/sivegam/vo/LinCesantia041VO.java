...
public class LinCesantia041VO {
    ...
    private long fecha_cesantia;
    private long fecha_solicitud;
    private long fecha_inicio_cuota;
    private long fecha_termino_cuota;
    ...
    public long getFecha_cesantia() {
        return fecha_cesantia;
    }

    public void setFecha_cesantia(long fecha_cesantia) {
        this.fecha_cesantia = fecha_cesantia;
    }
    ...
    public long getFecha_inicio_cuota() {
        return fecha_inicio_cuota;
    }

    public void setFecha_inicio_cuota(long fecha_inicio_cuota) {
        this.fecha_inicio_cuota = fecha_inicio_cuota;
    }

    public long getFecha_solicitud() {
        return fecha_solicitud;
    }

    public void setFecha_solicitud(long fecha_solicitud) {
        this.fecha_solicitud = fecha_solicitud;
    }

    public long getFecha_termino_cuota() {
        return fecha_termino_cuota;
    }

    public void setFecha_termino_cuota(long fecha_termino_cuota) {
        this.fecha_termino_cuota = fecha_termino_cuota;
    }
