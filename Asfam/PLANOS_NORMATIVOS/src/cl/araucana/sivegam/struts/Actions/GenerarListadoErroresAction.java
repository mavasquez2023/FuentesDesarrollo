...
import cl.araucana.sivegam.struts.Forms.GenerarListadoErroresForm;

public class GenerarListadoErroresAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        GenerarListadoErroresForm listadoErrores = (GenerarListadoErroresForm) form;
        int opcion;
        ...
        if (a != 0) {
            ...
            opcion = Integer.parseInt(listadoErrores.getOpcion());
            ...
            case 1:
                ...
                /*
                 * case 2: return mapping.findForward("agregarSif011");
                 */
            default:
