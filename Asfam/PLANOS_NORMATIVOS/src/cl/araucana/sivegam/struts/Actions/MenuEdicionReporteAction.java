...
import cl.araucana.sivegam.struts.Forms.MenuEdicionReportesForm;

public class MenuEdicionReporteAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        MenuEdicionReportesForm genEditarReporteForm = (MenuEdicionReportesForm) form;

        int opcion = Integer.parseInt((String)session.getAttribute("opcion"));
        ...
        if (a != 0) {
            ...
            opcion = Integer.parseInt(genEditarReporteForm.getOpcion());
            ...
            case 3:
                return mapping.findForward("listadoErrores");
