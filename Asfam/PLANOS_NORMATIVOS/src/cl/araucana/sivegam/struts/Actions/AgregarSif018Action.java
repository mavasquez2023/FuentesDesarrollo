...
import cl.araucana.sivegam.struts.Forms.AgregarSif018Form;

public class AgregarSif018Action extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        AgregarSif018Form AgregarSif018 = (AgregarSif018Form) form;
        ...
        if (a != 0) {
            ...
            opcion = Integer.parseInt(AgregarSif018.getOpcion());
