...
import cl.araucana.sivegam.struts.Forms.GenerarCuadroComparativoForm;

public class GenerarCuadroComparativoAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        GenerarCuadroComparativoForm cuadroComparativo = (GenerarCuadroComparativoForm) form;
        ...
        if (a != 0) {
            ...
            opcion = Integer.parseInt(cuadroComparativo.getOpcion());
