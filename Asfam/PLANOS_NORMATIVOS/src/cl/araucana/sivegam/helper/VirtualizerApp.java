...
public class VirtualizerApp // extends AbstractSampleApp
{
     ...
     */
    /*
     * public static void main(String[] args) { main(new VirtualizerApp(),
     * args); }
     */
    ...
    /*
     * private static void exportXls(JasperPrint jasperPrint,boolean embedded)
     * throws JRException { JasperExportManager. }
     */
