		...
		<tr>
			...
			<table width="100%" border="1" rules="groups">
				...
				<tr>
					...
					<td >
						<input type="text" name="txt_TotalPagoAsigFamiliar" id="txt_TotalPagoAsigFamiliar" size="20" value="0" maxlength="15" onkeyup="Upper(this,'N')" onkeypress="Upper(this,'N')" disabled="true">
					</td>	
