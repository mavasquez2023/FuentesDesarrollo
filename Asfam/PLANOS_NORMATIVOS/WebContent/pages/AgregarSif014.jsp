...
<script type="text/javascript">
	...
	function validacionDePeriodos(){
		...
		var fechaInicio = document.AgregarSif014Form.txt_FechaInicioBeneficio.value;
		var fechaTermino = document.AgregarSif014Form.txt_FechaTerminoBeneficio.value;
	...
	/* FIN VALIDACIONES ANEXAS A CAMPOS PARA EL REPORTE SIF014 */
	/***********************************************************/
	...
	function validaIngresoDeCampos(){
		...
		if( Trim(document.AgregarSif014Form.txt_NumVerifBeneficiario.value) == "" ){
			alert("Falta ingresar el campo Digito Verificador Beneficiario.");
			return false;
		}
		...
		if( Trim(document.AgregarSif014Form.dbx_TipoBeneficiario.value) == 0 ){
			alert("Falta ingresar el campo Tipo Beneficiario.");
			return false;
		}
		...
		if( Trim(document.AgregarSif014Form.txt_NumVerifCausante.value) == "" ){
			alert("Falta ingresar el campo Digito Verificador Causante.");
			return false;
		}
	...
	function agregarRegistroSif014(){
		...
		if(validaIngresoDeCampos() == true){
			...
			document.AgregarSif014Form.btn_Agregar.disabled=true;
			document.AgregarSif014Form.btn_Cancelar.disabled=true;
			AgregarRegistroDivisionPrevisionalDWR.insertSif014(rutEmpresa,dvEmpresa,nombreEmpresa,rutBeneficiario,dvBeneficiario,nombreBeneficiario,
				...
				document.AgregarSif014Form.btn_Agregar.disabled=false;
...
<html:form action="/agregarSif014.do">
	...
	<table width="1100" border="0">
		...
		<tr>
			<td height="25"><strong><p1> AGREGAR REGISTROS REPORTE DIVISION REGIMENES LEGALES SIF014 </p1></strong></td>
		</tr>
		<tr></tr>
		<tr>
			<td><br />
			...
			<table width="100%" border="1" rules="groups">
				...
				<tr>
					...
					<td colspan="4"><html:select property="dbx_FuenteOrigen" styleClass="dbx_modPago" value="0" onblur="validadorFuenteOrigen();">
				...
				<tr>
					...
					<td><html:select property="dbx_TipoBeneficio"
						styleClass="dbx_modPago" value="0" onblur="validacionBenef();">
						<html:option value="0">Seleccione</html:option>
				...
				<tr>
					...
					<td><input type="text" name="txt_NombreCausante"
		...
		<tr>
			<td height="37" align="right" width="80%">
				<input type="button" name="btn_Agregar" id="btn_Agregar" class="btn_limp" value="Agregar" onclick="agregarRegistroSif014();" /> 
				&nbsp;&nbsp;&nbsp; 
