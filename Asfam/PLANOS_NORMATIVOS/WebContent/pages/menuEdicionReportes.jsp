...
<script type="text/javascript">
	...
	function asignaValor(a){
		//gc();
		document.MenuEdiReporteForm.opcion.value = a;
	}
	...
	function enviaFormulario(a){
		...
		asignaValor(a);
		document.MenuEdiReporteForm.submit();
	}
...
<body>
<html:form action="/menuEditReporte.do">
	...
	<table width="1020" border="0" >
		...
		<tr>
			<td width="32">&nbsp;</td>
				<td align="center">
					<strong><p1><font color="#1B2935"> Menú Edición de Reportes por Área. </font></p1></strong>
				</td>
			<td width="17">&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="center">
				...
				value="División Recuperación Cotizaciones" onClick="asignaValor(2)" /></td>
			<td width="17">&nbsp;</td>
		</tr>
		
		<!-- <tr>
			<td width="32">&nbsp;</td>
			<td width="216"><input type="submit" name="btn_ListaErrores"
				class="btn_menu" id="btn_ListaErrores"
				value="Listado Errores" onClick="asignaValor(3)" /></td>
			<td width="17">&nbsp;</td>
		</tr> -->
		...
		<tr>
			<td width="32">&nbsp;</td>
			<td align="center">
				<input type="submit" name="btn_InformeFinanciero"
				class="btn_menu" id="btn_InformeFinanciero"
				value="Informe Financiero" onClick="asignaValor(4)" /></td>
			<td width="17">&nbsp;</td>
		</tr>
	</table>
	</div>
