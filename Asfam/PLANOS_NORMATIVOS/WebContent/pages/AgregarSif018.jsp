...
<link href="../css/estilos_interna.css" rel="stylesheet"
	type="text/css" />
<link href="../css/grid_960.css" rel="stylesheet"
	type="text/css" />
...
<script type="text/javascript">
	...
	function validaIngresoDeCampos(){
		...
		if( Trim(document.AgregarSif018Form.dbx_CodArchivo.value) == 0 ){
			alert("Falta ingresar el campo Codigo Archivo.");
			return false;
		}	
	...
	function agregarRegistroSif018(){
		...
		if((validaIngresoDeCampos() == true) && (validacionDePeriodos() == true)){
			...
			document.AgregarSif018Form.btn_Agregar.disabled=true;
			document.AgregarSif018Form.btn_Cancelar.disabled=true;
			
			AgregarRegistroCotizacionesDWR.insertSif018(codArchivo,rutEmpresa,dvEmpresa,nombreEmpresa,modalidadPago,montoDocumento,numeroSerie,numeroDocumento,fechaEmision,codigoBanco,fechaCobro,function(data){
				
				var resp = null;
				resp = data.codRespuesta;
				
				document.getElementById("pantallaDeCarga").style.visibility = "hidden";
				document.AgregarSif018Form.btn_Agregar.disabled=false;
...
<div id="caja_registro">
	...
	<table width="1100" border="0">
		...
		<tr>
			...
			AGREGAR REGISTROS REPORTE DIVISI&Oacute;N RECUPERACI&Oacute;N COTIZACIONES SIF018 </p1></strong></td>
		</tr>
		<tr></tr>
		<tr>
			<td><br/>
			...
			<table width="100%" border="1" rules="groups">
				...
				<tr>	
					...
					<td >
						<input type="text" name="txt_FechaCobro" id="txt_FechaCobro" size="19" maxlength="11" onkeyup="Upper(this,'N')" onkeypress="Upper(this,'N')" disabled="true">
		...
		<tr>
			<td height="37" align="right" width="80%">
				<input type="button" name="btn_Agregar" id="btn_Agregar" class="btn_limp" value="Agregar" onclick="agregarRegistroSif018();"/>
				&nbsp;&nbsp;&nbsp;
