...
<body>
	<logic:notEqual value="null" name="credito">
		...
		<table>
			...
			<tr>
				<td>
				<a href="<%=request.getContextPath() %>/certificados/creditosvigentes/listadoCreditos/seleccionCredito/detalleCredito.do?folio_contrato=${credito.folio}&fecha_otorgamiento=${credito.fechaOtorgamiento}&accion=cargarDetalle">Detalle</a>
				</td>
