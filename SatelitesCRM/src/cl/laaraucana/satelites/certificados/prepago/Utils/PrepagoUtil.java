...
//	}
	...
	public static SalidaListaConsultaCreditosPorRutEnAs400VO getPorRutVigentesRepactar (SalidaListaConsultaCreditosPorRutEnAs400VO entrada){
		SalidaListaConsultaCreditosPorRutEnAs400VO salida = new SalidaListaConsultaCreditosPorRutEnAs400VO();
		List<SalidaConsultaCreditosPorRutEnAs400VO> listaCreditos = new ArrayList<SalidaConsultaCreditosPorRutEnAs400VO>();
		for (SalidaConsultaCreditosPorRutEnAs400VO creditos : entrada.getListaCreditos()) {
			
//			if(creditos.getEstadoCredito().toUpperCase().trim().equals(ServiciosConst.RES_SERVICIOS.getString("creditos.vigentes.rut.as400.vigente").toUpperCase())||
//					creditos.getEstadoCredito().toUpperCase().trim().equals(ServiciosConst.RES_SERVICIOS.getString("creditos.vigentes.rut.as400.moroso").toUpperCase())){
			
			if((creditos.getEstadoCredito().trim().equalsIgnoreCase(ServiciosConst.RES_SERVICIOS.getString("creditos.vigentes.rut.as400.vigente"))||
				creditos.getEstadoCredito().trim().equalsIgnoreCase(ServiciosConst.RES_SERVICIOS.getString("creditos.vigentes.rut.as400.moroso")))&&
				(!creditos.getTipoCredito().equalsIgnoreCase(CertificadoConst.RES_CERTIFICADOS.getString("certificado.tipoCredito.educacionSuperior")))){
				listaCreditos.add(creditos);
			}
		}
		salida.setListaCreditos(listaCreditos);
		salida.setCodigoError(entrada.getCodigoError());
		salida.setMensaje(entrada.getMensaje());
		return salida;
	}
...
public SalidaListaCreditoPrepagoFoliosVO getCreditosDeudaConFolios(List<SalidaCreditoPrepagoVO> listaPrepagosCompleta, boolean esPrepago){
		...
		//String dvo8 = "Prima Mensual Seg. Cesantía";
		String dvo9 = "Monto cuota descuento";
		String dvo10 = "Desde cuota";
		String dvo11 = "Hasta cuota";
		String dvo12 = "Total cuotas morosas";
		String dvo13 = "N° cuota en tránsito";
		//String dvo14 = "N° de cuota en tránsito";
		String dvo15 = "Gravámenes (interés moratorio)";
		String dvo16 = "Gastos de Cobranza";
		String dvo17 = "Interés devengado a la fecha de admisibilidad";
		String dvo18 = "Saldo Capital";
		String dvo19 = "Saldo Intereses";
		String dvo20 = "Saldo Seguros";
		String dvo21 = "Total Cuotas informadas (tránsito)";
		String dtotales = "Total a pagar (*)";
		String dtotalverif = "Total a verificar (capital + gravámenes + interés devengado)";
		...
		if(largo >= i+1){
			...
			vo12.setValorFolio1(Utils.formateaDobleSinDecimal(credito.getCantidadCuotasMorosas()));
			vo13.setValorFolio1(credito.getNumCuotasEnTransito());
			vo15.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getGravamenes()));
			vo16.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getGastoCobranza()));
			vo17.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresDevengado()));
			vo18.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getSaldoCapital()));
			vo19.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresMoroso()));
			vo20.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getMontoSeguros()));
			vo21.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getTotalCuotasInformadas()));
			totales.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getTotal()));
		...
		if(largo >= i+2){
			...
			vo12.setValorFolio2(Utils.formateaDobleSinDecimal(credito.getCantidadCuotasMorosas()));
			vo13.setValorFolio2(credito.getNumCuotasEnTransito());
			vo15.setValorFolio2("$ "+Utils.formateaDobleSinDecimal(credito.getGravamenes()));
			vo16.setValorFolio2("$ "+Utils.formateaDobleSinDecimal(credito.getGastoCobranza()));
			vo17.setValorFolio2("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresDevengado()));
			vo18.setValorFolio2("$ "+Utils.formateaDobleSinDecimal(credito.getSaldoCapital()));
			vo19.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresMoroso()));
			vo20.setValorFolio1("$ "+Utils.formateaDobleSinDecimal(credito.getMontoSeguros()));
		...
		if(largo >= i+3){
			...
			vo12.setValorFolio3(Utils.formateaDobleSinDecimal(credito.getCantidadCuotasMorosas()));
			vo13.setValorFolio3(credito.getNumCuotasEnTransito());
			vo15.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getGravamenes()));
			vo16.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getGastoCobranza()));
			vo17.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresDevengado()));
			vo18.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getSaldoCapital()));
			vo19.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresMoroso()));
			vo20.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getMontoSeguros()));
			vo21.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getTotalCuotasInformadas()));
			totales.setValorFolio3("$ "+Utils.formateaDobleSinDecimal(credito.getTotal()));
		...
		if(largo >= i+4){
			...
			vo12.setValorFolio4(Utils.formateaDobleSinDecimal(credito.getCantidadCuotasMorosas()));
			vo13.setValorFolio4(credito.getNumCuotasEnTransito());
			vo15.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getGravamenes()));
			vo16.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getGastoCobranza()));
			vo17.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresDevengado()));
			vo18.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getSaldoCapital()));
			vo19.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresMoroso()));
			vo20.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getMontoSeguros()));
			vo21.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getTotalCuotasInformadas()));
			totales.setValorFolio4("$ "+Utils.formateaDobleSinDecimal(credito.getTotal()));
		...
		if(largo >= i+5){
			...
			vo12.setValorFolio5(Utils.formateaDobleSinDecimal(credito.getCantidadCuotasMorosas()));
			vo13.setValorFolio5(credito.getNumCuotasEnTransito());
			vo15.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getGravamenes()));
			vo16.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getGastoCobranza()));
			vo17.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresDevengado()));
			vo18.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getSaldoCapital()));
			vo19.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresMoroso()));
			vo20.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getMontoSeguros()));
			vo21.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getTotalCuotasInformadas()));
			totales.setValorFolio5("$ "+Utils.formateaDobleSinDecimal(credito.getTotal()));
		...
		if(largo >= i+6){
			...
			vo12.setValorFolio6(Utils.formateaDobleSinDecimal(credito.getCantidadCuotasMorosas()));
			vo13.setValorFolio6(credito.getNumCuotasEnTransito());
			vo15.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getGravamenes()));
			vo16.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getGastoCobranza()));
			vo17.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresDevengado()));
			vo18.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getSaldoCapital()));
			vo19.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getMontoInteresMoroso()));
			vo20.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getMontoSeguros()));
			vo21.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getTotalCuotasInformadas()));
			totales.setValorFolio6("$ "+Utils.formateaDobleSinDecimal(credito.getTotal()));
