...
public class SalidaCreditoPrepagoVO extends AbstractSalidaVO {
    ...
    private double montoSeguroDevengado;
    private double montoSeguroMoroso;
	...
	/**
	 * @return the montoSeguroDevengado
	 */
	public double getMontoSeguroDevengado() {
		return montoSeguroDevengado;
	}

	/**
	 * @param montoSeguroDevengado the montoSeguroDevengado to set
	 */
	public void setMontoSeguroDevengado(double montoSeguroDevengado) {
		this.montoSeguroDevengado = montoSeguroDevengado;
	}

	/**
	 * @return the montoSeguroMoroso
	 */
	public double getMontoSeguroMoroso() {
		return montoSeguroMoroso;
	}

	/**
	 * @param montoSeguroMoroso the montoSeguroMoroso to set
	 */
	public void setMontoSeguroMoroso(double montoSeguroMoroso) {
