...
<table width='50%' border='1' cellspacing='0' align = 'center'>
	<tr>
		...
		<td class="certificado">Bitácora Licencia</td>
	</tr>
	...
	<logic:iterate id="register" name="lista.licencias" type='cl.araucana.autoconsulta.vo.LicenciaMedicaVO'>
		<tr>
			...
			if(register.getVisada()!=1) {%>
				...
				<td align="center"><input type="button" class="boton" value="Ver" onclick="popUpBitacora('<bean:write name="register" property="numeroLicencia"/>','<bean:write name="register" property="fechaHasta"/>','<bean:write name="register" property="fechaDePago" formatKey="format.date"/>')"/></td>
