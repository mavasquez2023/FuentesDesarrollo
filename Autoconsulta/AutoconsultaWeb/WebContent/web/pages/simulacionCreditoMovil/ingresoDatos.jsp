...
<%@ include file = "/web/includes/headerSimuladorCredito.jsp"%>  
...
<%																		
	String remuneracionLiquidaMovil = "";
	String montoSolicitadoMovil = "";
	String cuotasMovil = "";
	String fechaNacimientoMovil = "";
	String fechaIngresoEmpresaMovil = "";
	if(session.getAttribute("remuneracionLiquidaMovil") != null)
		remuneracionLiquidaMovil = (String) session.getAttribute("remuneracionLiquidaMovil");
	if(session.getAttribute("montoSolicitadoMovil") != null)
		montoSolicitadoMovil = (String) session.getAttribute("montoSolicitadoMovil");
	if(session.getAttribute("cuotasMovil") != null)
		cuotasMovil = (String) session.getAttribute("cuotasMovil");
	if(session.getAttribute("fechaNacimientoMovil") != null)
		fechaNacimientoMovil = (String) session.getAttribute("fechaNacimientoMovil");
	if(session.getAttribute("fechaIngresoEmpresaMovil") != null)
		fechaIngresoEmpresaMovil = (String) session.getAttribute("fechaIngresoEmpresaMovil");
%>
...
<script type="text/javascript" language="JavaScript">
 ...
 <logic:present name="afiliado">		
 	 var calFechaIngEmpresa=new ctlSpiffyCalendarBox("calFechaIngEmpresa", "PARAMForm", "fechaIngresoEmpresa","btnDate2","<%=fechaIngresoEmpresaMovil%>",2);
	 ...
	 var calFechaNac=new ctlSpiffyCalendarBox("calFechaNac", "PARAMForm", "fechaNacimiento","btnDate1","<%=fechaNacimientoMovil%>",2);
		...
		<td align="center">     
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>  
							...
							<tr>
							<td><%@ include file = "/web/pages/simulacionCreditoMovil/simulaDatos.jsp " %></td>
							</tr> 
					</table>				
