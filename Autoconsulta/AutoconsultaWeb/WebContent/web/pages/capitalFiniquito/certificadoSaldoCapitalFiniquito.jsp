...
<tr>
<td width='160' valign='top' bgcolor="#003360">

<%@ include file = "/web/includes/opciones.jsp"%></td> <!-- menu de opciones -->
...
<input type="submit"  class="boton" name="dummyProperty" value="Volver"        onclick="window.location='Menu.do'" 
       onMouseOver="this.className='botonOver'" 
       onMouseOut="this.className='boton'" />	
