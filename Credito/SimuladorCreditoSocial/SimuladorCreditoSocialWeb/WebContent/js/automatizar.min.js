...
var version = "1.5.9",
  ...
  patrones = [];
patrones.tipo_alfanumerico = /\w/, patrones.tipo_numerico = /\d/, patrones.tipo_rut = /[kK0-9]/, patrones.tipo_email = /[a-zA-Z\@\.\-\_0-9]/, patrones.tipo_telefono = patrones.tipo_numerico, patrones.tipo_texto = /[a-zA-Z \-àèìòùäëïöüâêîôûÀÈÌÒÙÄËÏÖÜÂÊÎÔÛ›]/, patrones.tipo_nombre = patrones.tipo_texto;
var antipatrones = [];
antipatrones.tipo_alfanumerico = /^\w/g, antipatrones.tipo_numerico = /^\d/g, antipatrones.tipo_rut = /[^kK0-9]/g, antipatrones.tipo_email = /[^a-zA-Z\@\.\-\_0-9]/g, antipatrones.tipo_telefono = patrones.tipo_numerico, antipatrones.tipo_texto = /[^a-zA-Z \-àèìòùäëïöüâêîôûÀÈÌÒÙÄËÏÖÜÂÊÎÔÛ›]/g, antipatrones.tipo_nombre = patrones.tipo_texto, $(document).ready(function () {
