          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
              <div class="respuesta-positiva">
                ...
                <h4>Ya tienes una oferta creada el ${fechaCreacion} por un monto de $${montoSolicitado} en ${cuotas} meses (previo a esta simulaci&oacute;n)</h4>
				<p>Pronto te contactaremos para continuar con la oferta en curso</p>
