...
public class SalidaCompContHeader2VO extends AbstractSalidaVO {
	...
	public SalidaCompContHeader2VO(String contractNumber, String terminated,
			...
			String repacta, String reprogramac, String contractCurrency, 
			String bpAnexo, String rutEmpresa, String nroInscripcion) {
		super();
