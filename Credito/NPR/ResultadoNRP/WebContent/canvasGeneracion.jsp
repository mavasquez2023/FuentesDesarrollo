...
<jsp:include page="main/menuServices.jsp" flush="true" />
	...
	<p class="titulo">TOTAL NÓMINAS - GENERACIÓN NRP</p>
	<form action="" name="form1" id="form1">
	<div style="margin-left: 325px">
	<!-- Seleccione tipo gráfico:  -->
	<!-- input type="radio" name="tipoGrafico" id="tipoGrafico" value="registros" <c:if test="${tipoGrafico=='ARCHIVOS' }"> checked="checked"</c:if> onClick="EjecutarProceso('resultConsolidacion', this.value);">Archivos &nbsp;&nbsp; -->
