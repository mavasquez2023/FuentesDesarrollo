...
<body>
	<logic:notEqual value="null" name="credito">
		<p class="titulo">Certificado Créditos Vigentess</p>
		...
		<table>
			...
			<tr>
				<td>
				<a href="<%=request.getContextPath() %>/certificados/creditosvigentes/listadoCreditos/seleccionCredito/detalleCredito.do?folio_contrato=${credito.folio}&fecha_otorgamiento=${credito.fechaOtorgamiento}&accion=cargarDetalle&uc=${uc}">Detalle</a>
				</td>
