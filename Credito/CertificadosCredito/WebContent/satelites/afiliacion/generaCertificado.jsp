		...
		<logic:equal name="error" value="0">
			<blockquote>
				<p class="certificadoLeft">
					...
					RUT N° ${rut} se mantiene como afiliado activo desde el ${fechaAfiliacion} con ${nombreEmpresa}.<br>
			...
			<form action="<%=request.getContextPath() %>/satelites/afiliacion/cargaCertificado.do" target="_blank">
				...
				<input type="hidden" name="nombreAfiliado"  value="${nombreAfiliado }" />
				<input type="hidden" name="fechaAfiliacion"  value="${fechaAfiliacion }" />
