...
public class CargaCertificadoAction extends Action

{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if(nAfiliado==null){
				nAfiliado= request.getParameter("nombreAfiliado");
			}
			String fAfiliacion = (String) sesion.getAttribute("fechaAfiliacion");
			if(fAfiliacion==null){
				fAfiliacion= request.getParameter("fechaAfiliacion");
			}
			String fRol = (String) sesion.getAttribute("fechaRol");
			if(fRol==null){
				fRol= request.getParameter("fechaRol");
			}
			...
			String fechaPDF=fAfiliacion;
			if(!rol.equals("Trabajador")){
				fechaPDF= fRol;
			}
			String codValidacion= generaCodigoValidaon(userInfo, rut, nAfiliado, rol, fechaPDF);
			...
			String ruta="";
			if(rol.equals("Trabajador")){
				ruta = ResourceBundle.getBundle("cl.laaraucana.satelites.certificados.confCertificados").getString("certificado.afiliacion.jasper");
			}else{
				ruta = ResourceBundle.getBundle("cl.laaraucana.satelites.certificados.confCertificados").getString("certificado.afiliacion.pensionado.jasper");
			}
	...
	private String generaCodigoValidaon(User userInfo , String rutAfiliado, String nombreAfiliado, String tipoAfiliado, String fechaAfiliacion){
		...
		try{
	        ...
	        valor.setVariable("Fecha Afiliación");
	        valor.setValor(fechaAfiliacion);
	        listaValores.add(valor);   
