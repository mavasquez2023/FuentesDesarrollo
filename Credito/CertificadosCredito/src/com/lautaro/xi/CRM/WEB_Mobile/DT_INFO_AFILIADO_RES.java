...
public class DT_INFO_AFILIADO_RES  implements java.io.Serializable {
    ...
    private com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_TRAB[] ANEXO_TRAB;

    private com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_PENS[] ANEXO_PENS;

    private com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_DEUD[] ANEXO_DEUD;
    ...
    public DT_INFO_AFILIADO_RES(
           ...
           com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_TRAB[] ANEXO_TRAB,
           com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_PENS[] ANEXO_PENS,
           com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_DEUD[] ANEXO_DEUD) {
           this.NOMBRE = NOMBRE;
     ...
     * @return ANEXO_TRAB
     */
    public com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_TRAB[] getANEXO_TRAB() {
        return ANEXO_TRAB;
    }
     ...
     * @param ANEXO_TRAB
     */
    public void setANEXO_TRAB(com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_TRAB[] ANEXO_TRAB) {
        this.ANEXO_TRAB = ANEXO_TRAB;
    }

    public com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_TRAB getANEXO_TRAB(int i) {
        return this.ANEXO_TRAB[i];
    }

    public void setANEXO_TRAB(int i, com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_TRAB _value) {
     ...
     * @return ANEXO_PENS
     */
    public com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_PENS[] getANEXO_PENS() {
        return ANEXO_PENS;
    }
     ...
     * @param ANEXO_PENS
     */
    public void setANEXO_PENS(com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_PENS[] ANEXO_PENS) {
        this.ANEXO_PENS = ANEXO_PENS;
    }

    public com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_PENS getANEXO_PENS(int i) {
        return this.ANEXO_PENS[i];
    }

    public void setANEXO_PENS(int i, com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_PENS _value) {
     ...
     * @return ANEXO_DEUD
     */
    public com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_DEUD[] getANEXO_DEUD() {
        return ANEXO_DEUD;
    }
     ...
     * @param ANEXO_DEUD
     */
    public void setANEXO_DEUD(com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_DEUD[] ANEXO_DEUD) {
        this.ANEXO_DEUD = ANEXO_DEUD;
    }

    public com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_DEUD getANEXO_DEUD(int i) {
        return this.ANEXO_DEUD[i];
    }

    public void setANEXO_DEUD(int i, com.lautaro.xi.CRM.WEB_Mobile.DT_INFO_AFILIADO_RESANEXO_DEUD _value) {
