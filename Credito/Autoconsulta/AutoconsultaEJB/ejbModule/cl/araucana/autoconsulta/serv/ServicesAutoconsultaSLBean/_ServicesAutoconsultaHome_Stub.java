...
public class _ServicesAutoconsultaHome_Stub extends Stub implements ServicesAutoconsultaHome {
    
    private static final String[] _type_ids = {
        "RMI:cl.araucana.autoconsulta.serv.ServicesAutoconsultaSLBean.ServicesAutoconsultaHome:0000000000000000", 
    ...
    public ServicesAutoconsulta create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (ServicesAutoconsulta) in.read_Object(ServicesAutoconsulta.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",cl.araucana.autoconsulta.serv.ServicesAutoconsultaSLBean.ServicesAutoconsultaHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    ServicesAutoconsulta result = ((cl.araucana.autoconsulta.serv.ServicesAutoconsultaSLBean.ServicesAutoconsultaHome)so.servant).create();
                    return (ServicesAutoconsulta)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
