...
import cl.araucana.autoconsulta.ui.actions.consultaCreditos.GetCreditosVigentesAction;
...
public class RedireccionarSatelitesAction extends Action {
	private static Logger logger =
			Logger.getLogger(RedireccionarSatelitesAction.class);
	...
	public ActionForward execute(ActionMapping mapping,	ActionForm form,
		...
		logger.info("Redirect a server: " + server);
