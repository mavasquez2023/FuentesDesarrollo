	...
	<tr>
		<td nowrap class="certificado">
			<div align='center'>
				<font size='3'>
					<b>
						<bean:message key="label.liquidacion.titulo.linea1"/><BR>
					</b>
				</font>
				<font size="2">
					<bean:message key="label.liquidacion.titulo.linea2"/><BR>
...
<logic:notEmpty name="consulta.detallada" > 
	...
	<table width='100%' border="1" cellspacing='0' align = 'center'>
		<tr>
			<td class="certificado" width='50%'><font size="1"><B><bean:message key="label.liquidacion.saldo.disponible"/><bean:write name="liquidacion" property="fechaLiquidacion"/>:</B></font></td>
			<td class="certificado" width='50%'><bean:write name="liquidacion" property="saldoPrevioLiquidacion" formatKey="format.money"/></td>
		</tr>	
		<tr>
			<td class="certificado" width='50%'><B><font size="1"><bean:message key="label.liquidacion.valor.total.solicitado"/></font></B></td>
			<td class="certificado" width='50%'><bean:write name="liquidacion" property="totalSolicitadoPesos" formatKey="format.money"/></td>
		</tr>	
		<tr>
			<td class="certificado" width='50%'><B><font size="1"><bean:message key="label.liquidacion.valor.pendiente.de.bonificar"/></font></B></td>
			<td class="certificado" width='50%'><bean:write name="liquidacion" property="totalPendientePesos" formatKey="format.money"/></td>
		</tr>	
		<tr>
			<td class="certificado" width='50%'><B><font size="1"><bean:message key="label.liquidacion.valor.rechazado.por.tope"/></font></B></td>
			<td class="certificado" width='50%'><bean:write name="liquidacion" property="totalRechazadoPesos" formatKey="format.money"/></td>
		</tr>	
		
		<tr>
			<td class="certificado" width='50%'><B><font size="1"><bean:message key="label.liquidacion.rebaja.solitada.empresa"/></font></B></td>
			<td class="certificado" width='50%'><bean:write name="liquidacion" property="rebajaSolicitadaEmpresa" formatKey="format.money"/></td>
		</tr>	
		<tr>
			<td class="certificado" width='50%'><B><font size="1"><bean:message key="label.liquidacion.saldo.disponible"/>
							<bean:write name="liquidacion" property="fechaLiquidacion" /></font></B></td>
			<td class="certificado" width='50%'><bean:write name="liquidacion" property="saldoPosterior" formatKey="format.money"/></td>
		</tr>	
		<tr>
			<td class="certificado" width='50%'><font size="1"><B><bean:message key="label.liquidacion.monto.a.rebajar.fondo"/></B></font></td>
			<td class="certificado" width='50%'><bean:write name="liquidacion" property="totalBonificadoPesos" formatKey="format.money"/></td>
		</tr>	
	</table>
		<br>	
		<table  width='100%' border="1" cellspacing='0' align = 'center'>
		<tr bgcolor="#cccccc">
			<td class="certificado" colspan="7" align="center"><font size="2"><B><bean:message key="label.liquidacion.titulo.linea4"/></B></font></td>
		</tr>	
		<tr>  
		...
		<logic:iterate id="movimientos" name="consulta.detallada" property="movimientos" type='cl.araucana.autoconsulta.vo.MovimientosLiquidacionVO'>
			<tr style="border-bottom: 1px;">
				...
				<td class="certificado"><bean:write name="movimientos" property="montoBase" formatKey="format.money"/></td>
				<td class="certificado"><bean:write name="movimientos" property="montoBonificado" formatKey="format.money"/></td>
				<td class="certificado"><bean:write name="movimientos" property="montoPendiente" formatKey="format.money"/></td>
				<td class="certificado"><bean:write name="movimientos" property="montoRechazado" formatKey="format.money"/></td>
			</tr>
		</logic:iterate>
		<tr>
			<bean:define id="totales" name="totales" type='cl.araucana.autoconsulta.vo.TotalesLiquidacionVO'/>
			<td class="certificado" colspan="3"><font size="1"><B> <bean:message key="label.liquidacion.totales"/></B></font></td>		
			<td class="certificado"><bean:write name="totales" property="totalBase" formatKey="format.money"/></td>
			<td class="certificado"><bean:write name="totales" property="totalBonificado" formatKey="format.money"/></td>
			<td class="certificado"><bean:write name="totales" property="totalPendiente" formatKey="format.money"/></td>
			<td class="certificado"><bean:write name="totales" property="totalRechazado" formatKey="format.money"/></td>
		</tr>
		<tr>
			<td class="certificado" colspan="3"><font size="1"><B> <bean:message key="label.liquidacion.documentos"/></B></font></td>		
