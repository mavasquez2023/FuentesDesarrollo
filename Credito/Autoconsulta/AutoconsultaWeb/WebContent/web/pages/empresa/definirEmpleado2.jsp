...
<table border="0" cellpadding="2" cellspacing="2" width="50%">
	...
	<tr>
	 	...
	 	<td>
<input type="text" size="15" class="" readonly="true" value="" id="fecha" name="fecha" class="datepicker"><!--<img class="datepicker_trigger" src="/AutoconsultaWeb/web/images/calendar.gif" alt="fecha" title="fecha" >-->
