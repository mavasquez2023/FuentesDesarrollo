...
<div class="texto">
<br>
<div class="textobold"><bean:message key="label.liquidacion.selec.periodo"/></div>
<br>
...
<html:form action="/getResumenMensual" onsubmit="return valida();">
<html:hidden property="periodo" value="0"/>
<table border="0" cellpadding="2" cellspacing="2" width="50%">
	<tr>
		<td class="textobold"><bean:message key="label.liquidacion.empresa.periodo"/>:</td>
		<td class="texto">
		<select name="periodos" onchange="javascript:getPeriodo();">  
			<option value="0">Seleccione</option>    
			<logic:iterate id="cboperiodo" name="lista.periodos" scope="session" >
				<option value="<bean:write name="cboperiodo" property="rePeriodo"/>" ><bean:write name="cboperiodo" property="descPeriodo"/></option>       
			</logic:iterate>   
