...
-->
	...
	<tr>
		<td nowrap class="certificado">
			<div align='center'><h1><bean:message key="label.consulta.creditos.titulo"/></h1></div>
		</td>
	</tr>
</table>
...
<logic:notEmpty name="empleadores">
	<tr>
		<td valign="top" class="certificado"><bean:message key="label.credito.vigente.empleador.nombre"/>:</td>
		<td class="certificado">
		<logic:iterate id="register" name="empleadores">
			<bean:write name="register" property="nombre"/><br>
		</logic:iterate>
		</td>
	</tr>
	<tr>
		<td valign="top" class="certificado"><bean:message key="label.credito.vigente.empleador.rut"/>:</td>
		<td class="certificado">
		<logic:iterate id="register" name="empleadores">
			<bean:write name="register" property="fullRut"/><br>
		</logic:iterate>
		</td>
	</tr>
</logic:notEmpty>
