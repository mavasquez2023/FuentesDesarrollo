                ...
                <td align="center" valign="top"><table width="90%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <logic:present name="afiliado">
                      <tr>
                        ...
                        <td class="LetraNegraDiezNormalArial"><html:text property="ingresosLiquidos"  size='10' maxlength="9" value="<%=remuneracionLiquidaMovil%>" onkeypress="return acceptNum(event)" onchange="javascript:formatNumber(this);"/></td>
                        <td class="data1" width="20%" nowrap="nowrap"><img src="images/asteric.gif" width="9" height="12">Monto Solicitado $:</td>
                        <td class="LetraNegraDiezNormalArial"><html:text property="montoSolicitado" size='10' maxlength="9" value="<%=montoSolicitadoMovil%>" onkeypress="return acceptNum(event);" onchange="javascript:formatNumber(this);"/></td>
                      </tr>
                    </logic:present>
                    ...
                    <tr>
                      ...
                      <td class="LetraNegraDiezNormalArial"><html:text property="cantidadCuotas" size='10' maxlength="9" value="<%=cuotasMovil%>" onkeypress="return acceptNum(event)"/></td>
                    ...
                    <tr>
                      ...
                      <td  colspan="2" align="right"><html:select property="oficina" styleClass="LetraNegraDiezNormalArial">
                ...
                <td align="center" valign="top"><table width="90%" border="0" cellspacing="2" cellpadding="0" align="center">
                    ...
                    <tr>
                      ...
                      <td class="data1">Si&nbsp;&nbsp;
                        ...
                        No&nbsp;&nbsp;
                        <input type="radio" name="seguroVida" value="0"/></td>
                    </tr> -->
					<%	
