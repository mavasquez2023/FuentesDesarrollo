...
<title>Certificado de créditos vigentes</title>
</head>
<body>
	<div class="bloque-explorer">
		<div id="inicioFiniquito">
			<p class="titulo"></p>
			<form action="<%=request.getContextPath() %>/certificados/creditosvigentes/seleccionEmpresa.do" method="post" class="form" id="formIniFini">
