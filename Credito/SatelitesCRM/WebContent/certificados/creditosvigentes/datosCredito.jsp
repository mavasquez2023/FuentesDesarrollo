	...
	<logic:iterate id="lista" name="listaCreditosVigentes">
		<tr>
			<td>
				...
				<a href="listadoCreditos/seleccionCredito/detalleCredito.do?folio_contrato=${lista.folio}&fecha_otorgamiento=${lista.fechaOtorgamiento}&accion=cargarDetalle">Detalle</a>
			</td>
			...
			<td>
				<c:if test="${not empty lista.gastosCobranza}">
					$<fmt:formatNumber maxFractionDigits="0" value="${lista.gastosCobranza}" />
				</c:if>			
			</td>
			<td>
				${lista.rolAsociado}
