...
//	List<SalidaCreditoPrepagoVO> datos = null;
	...
	try {
		...
		if (folios!=null) {
			...
			listaCreditoPrepagoFoliosVO = prepagoUtil.getCreditosConFolios(listaPrepago, true);
			//clillo 27-09-2017 se deja única tabla
...
//    	hash.put("folio", certificadoPrepago.getFolio());
		...
		if(request.getParameter("origen") != null && request.getParameter("origen").equals("kiosco")){
	    	...
	    	String plantilla = ((SalidaCreditoPrepagoFoliosVO)listaCreditoPrepagoFoliosVO.getSalidaList().get(13)).getValorFolio1().equals("0") ? "certificado.creditosprepago.vigente.jasper" : "certificado.creditosprepago.moroso.jasper";
