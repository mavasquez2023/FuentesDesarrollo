...
import cl.laaraucana.simulacion.webservices.client.ConsultaDatosAfiliacionAs400.ServicioListaConsultaDatosAfiliacion;
	...
	public static UsuarioAfiliadoVO obtenerAfiliado(String rut) {
		...
		try {
			...
			if (salidaSAP.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_ERROR)) {
				...
				return afiliado;
			}else if(salidaAs400.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_ERROR)){
				afiliado.setCodigoError(ConstantesRespuestasWS.COD_RESPUESTA_ERROR);
				afiliado.setMensaje(salidaAs400.getMensaje());
				return afiliado;
			} else if (salidaSAP.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_VACIO) && salidaAs400.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_VACIO)) {
				afiliado.setCodigoError(ConstantesRespuestasWS.COD_RESPUESTA_VACIO);
				afiliado.setMensaje("El usuario no ha sido encontrado");
				return afiliado;
			}else if (salidaSAP.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_SUCCESS) && salidaAs400.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_SUCCESS)) {
			...
			} else if (salidaAs400.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_SUCCESS) && !salidaSAP.getCodigoError().equals(ConstantesRespuestasWS.COD_RESPUESTA_SUCCESS)) {
