package cl.laaraucana.simulacion.webservices.client.InfoAfiliado;
...
public class ClienteInfoAfiliado implements WSInterface {
	...
	public AbstractSalidaVO call(AbstractEntradaVO entrada) throws Exception {
		...
		SalidaAfiliadoVO salidaListaVO = new SalidaAfiliadoVO();
...
//<==== Validacion Nueva	
	...
	private SalidaAfiliadoVO mapear(DT_INFO_AFILIADO_RES response) {
		
		SalidaAfiliadoVO info_afiliado = new SalidaAfiliadoVO();
