 ...
 * @author
 */
public class Liquidacion704N1Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			factory = BusinessServiceDelegateFactory.singlton();
			delegate = factory.newInstance("cl.araucana.extranet.ea.delegate.BusinessServiceDelegateImpl");
			...
			Collection c = delegate.getLiquidacionCuentaCorriente704N1(
								rutEmpresa,
								codigoOficina,
								codigoSucursal,
								new DTOPeriodo(periodo),
			...
			request.setAttribute("resumen", 
						delegate.getResumenLiquidacionCuentaCorriente704N1(c)); 
