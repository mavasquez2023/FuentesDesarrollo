...
import cl.araucana.ea.ctacte.dto.CompensacionDeudaPorCotizacionElectronicaTO;
 ...
 * @author
 */
public class Liquidacion712N2Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			CompensacionDeudaPorCotizacionElectronicaTO dto = 
										delegate.getCompensacionDeudaPorCotizacionElectronica(
																dtoEmpresa.getRut(),
																codigoOficina,
																codigoSucursal,
			...
			request.setAttribute("cotizacion", dto);
