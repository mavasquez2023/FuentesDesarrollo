 ...
 * @author
 */
public class Liquidacion455N1Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			// getting id of user
			// this must be in a session variable
			/*
			Long id = (Long) PropertyUtils.getSimpleProperty(form, "rutEmpresa");
			...
			*/
			...
			Collection c = delegate.getLiquidacionCuentaCorriente455N1(
								rutEmpresa,
								codigoOficina,
								codigoSucursal,
								new DTOPeriodo(periodo),
			...
			request.setAttribute("resumen", 
						delegate.getResumenLiquidacionCuentaCorriente455N1(c)); 
			*/
