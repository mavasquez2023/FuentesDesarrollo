 ...
 * @author
 */
public class MorosidadCreditoN1Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection detalles = delegate.getMorosidadCreditoCuentaCorrientePeriodo(new RutTO(rutEmpresa, ""), codigoOficina,	codigoSucursal,	codigoConcepto);
			ResumenMorosidadCreditoCuentaCorrienteTO resumen = delegate.getResumenMorosadadCreditoPeriodo(detalles);
