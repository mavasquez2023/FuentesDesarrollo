 ...
 * @author
 */
public class Liquidacion706N1Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection lista = delegate.getListaSaldoAFavorEmpresaPorCotizacion(
													dtoEmpresa.getRut(), 
													codigoOficina, 
													codigoSucursal, 
			...
			long total = delegate.getTotalSaldosAFavorEmpresaPorCotizacion(lista);			
