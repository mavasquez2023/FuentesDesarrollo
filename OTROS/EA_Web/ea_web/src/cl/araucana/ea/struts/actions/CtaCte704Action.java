...
import cl.araucana.ea.ctacte.dto.LiquidacionSaldoAFavorTO;
 ...
 * @author
 */
public class CtaCte704Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			// OBSOLETO
			//LiquidacionSaldoAFavorTO dtoSaldoAFavor = delegate.getLiquidacionSaldoAFavor( 
