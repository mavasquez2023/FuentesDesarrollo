 ...
 * @author
 */
public class DeclaracionCotizacionSinPagoN2Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			rutEmpresa = ((Long) 
					PropertyUtils.getSimpleProperty(form, "rutEmpresa")).longValue();
			...
			periodoRemuneracion = ((Long) 
					PropertyUtils.getSimpleProperty(form, "periodoRemuneracion")).longValue();
			codigoBarra = ((Long) 
					PropertyUtils.getSimpleProperty(form, "codigoBarra")).longValue();
			...
			PlanillaCotizacionCuentaCorrienteTO detalle = delegate.getPlanillaCotizacionCuentaCorriente(codigoBarra);			
			...
			request.setAttribute("periodoRemuneracion", new PeriodoTO(periodoRemuneracion));
			request.setAttribute("codigoBarra",	new Long(codigoBarra));
