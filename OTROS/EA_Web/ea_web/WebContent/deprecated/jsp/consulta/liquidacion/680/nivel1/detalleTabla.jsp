					...
					<table style="width : 100%; border : 0px; border-color : #cccccc; padding-left: 2px; padding-right: 2px; border-spacing: 1px">
						<tbody>
							...
							<tr style="background-color : #cccccc;">
								<td class="smalltableheader" style="width : 50%;"><bean:message key="liquidacion.680.nivel1.table.header.periodo" /></td>
								<td class="smalltableheader" style="width : 50;"><bean:message key="liquidacion.680.nivel1.table.header.monto" /></td>
							</tr>
							
							<logic:iterate id="detalle" name="detalles" scope="request">							
							<tr>
								<td class="smallprompt">
									<html:link action="/liquidacion/680N2" name="detalle" property="params" scope="page">
							...
							<tr>
								<td class="smallprompt">
									<bean:message key="liquidacion.680.nivel1.table.label.total" />
								</td>
								<td class="smallcurrency">
