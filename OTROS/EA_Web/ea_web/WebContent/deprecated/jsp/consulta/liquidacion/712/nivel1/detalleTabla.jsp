		...
		<tbody>
			...
			<tr style="height : 18px;">
				<td class=smallfontreverse >
					<b>
						<bean:message key="liquidacion.712.nivel1.table.header" />&nbsp;
					...
					<table style="width : 100%; border : 0px; border-color : #cccccc; padding-left: 2px; padding-right: 2px; border-spacing: 1px">
						<tbody>
							...
							<tr style="background-color : #cccccc;">
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.712.nivel1.table.header.periodo" /></td>
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.712.nivel1.table.header.saldoAnterior" /></td>
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.712.nivel1.table.header.abonoLiquidacion" /></td>
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.712.nivel1.table.header.saldoDespuesLiquidacion" /></td>
							</tr>
							...
							<tr>
								<td class="smallprompt">
									...
									<!--
									<html:link action="/liquidacion/712N2" name="detalle" property="params" scope="page">
										<bean:write name="detalle" property="periodo.formattedPeriodo" scope="page" />
									</html:link>														
									-->
								</td>
							...
							<tr>
								<td class="smallprompt">
									<bean:message key="liquidacion.712.nivel1.table.label.totales" />
								</td>
								<td class="smallcurrency">
