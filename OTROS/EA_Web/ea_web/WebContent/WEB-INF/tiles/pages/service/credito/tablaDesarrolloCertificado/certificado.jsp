			...
			<table border="0" width="100%;">
				<tr>
					<td style="width: 100%;">
						<table style="width: 100%;" border="0">
							<tr>
								<td class="labelNormal" style="width: 10mm;">Tasa:</td>
								<td style="width: 2mm;"></td>
								<td class="textNormal" style="width: 10mm;">
									<bean:write name="resumen" property="tasa" scope="request" />%
								</td>
								<td style="width: 10mm;"></td>
								<td class="labelNormal" style="width: 30mm;">Valor Cuota:</td>
								<td style="width: 2mm;"></td>
					...
					<td>
						...
						<tr>
							...
							<td class="numberNormal">
								<bean:write name="resumen" property="montoSeguroDesgravamen" scope="request" filter="true" formatKey="global.monto" ignore="true" />
							</td>
							<td></td>
						</tr>		
						<tr>
							...
							<td></td>
							<td class="numberNormal">
								<bean:write name="resumen" property="montoSeguroCesantia" scope="request" filter="true" formatKey="global.monto" ignore="true" />
							</td>
							<td></td>
						</tr>		
						<tr>
							...
							<td></td>
							<td class="numberNormal">
								<bean:write name="resumen" property="montoSeguroVida" scope="request" filter="true" formatKey="global.monto" ignore="true" />
							</td>
							<td></td>
						</tr>		
						<tr>
							...
							<td></td>
							<td class="numberNormal">
								<bean:write name="resumen" property="impuesto" scope="request" filter="true" formatKey="global.monto" ignore="true" />
							</td>
							<td></td>
						</tr>		
						<tr>
			...
			<table width="100%">
				<tr>
					<td style="text-align: center;">
						<html:img page="/img/firmaCredito.gif" property="imgFirmaCredito" />
					</td>
					<td style="text-align: center;">
						<html:img page="/img/firmaSIL.gif" property="imgFirmaSIL" />
					</td>
				</tr>
			</table>
		</td>
