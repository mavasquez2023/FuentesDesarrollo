...
<table style="vertical-align: top;" border="0" cellspacing="0" cellpadding="0">					
	<tbody>
		<tr>
			...
			<td style="width: 340px; height : 4px; background-image : url(../../credito/prepagoFiniquito/nivel1/img/box_top.gif)"></td>
			<td style="width : 4px; height : 4px;"><html:img page="/img/box_2.gif" style="text-align : center; border : 0px;" /></td>
		</tr>
		
		<tr>
			<td style="width : 4px; background-image : url(../../credito/prepagoFiniquito/nivel1/img/box_left.gif)"></td>
									...
									<tbody>
										...
										<tr>
											...
											<td style="width : 100px; font-family: Verdana, Arial, sans-serif; font-size: 11px; font-weight: bold; color: #000000">
												<bean:write name="rut" property="formatedRut" scope="page" />-
			...
			<td style="width : 4px; background-image : url(../../credito/prepagoFiniquito/nivel1/img/box_right.gif)"></td>
		</tr>
		
		<tr>
			<td style="width : 4px; height : 4px"><html:img page="/img/box_3.gif" style="text-align : center; border : 0px;" /></td>
			<td style="width: 340px; height : 4px; background-image : url(../../credito/prepagoFiniquito/nivel1/img/box_bottom.gif)"></td>
