					...
					<table style="width : 100%; border : 0px; border-color : #cccccc; padding-left: 2px; padding-right: 2px; border-spacing: 1px">
						<tbody>
							...
							<tr>
								...
								<td class="smallcurrency" style=" text-align: right; vertical-align: top;">
									<span style="margin-right: 5px;">
										<bean:write name="asfam" property="montoDiferenciaPorInconsistencia" filter="true" formatKey="global.monto" ignore="true" />
									</span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="smallcurrency" style=" text-align: right; vertical-align: top;">
									<span style="margin-right: 5px;">
										<bean:write name="asfam" property="montoDiferencia" filter="true" formatKey="global.monto" ignore="true" />
									</span>
								</td>
							</tr>
...
<logic:notEmpty name="movimientos" scope="request">										
	...
	<logic:empty name="asfam" scope="request">	
