					...
					<tbody>								
						<tr><td colspan="5" style="height : 4px;"></td></tr>
							...
							<tr>
								...
								<td style="text-align : left; vertical-align: top; font-family: Verdana, Arial, sans-serif; font-size: 10px; font-weight: bold; color: #000000">
									<bean:write name="compensacionSaldoAFavor" property="folioComprobante" scope="request" filter="true" ignore="true" />
								</td>												
								<td></td>																							
							</tr>
							...
							<tr>
								...
								<td style="text-align : left; vertical-align: top; font-family: Verdana, Arial, sans-serif; font-size: 10px; font-weight: bold; color: #000000">
									<bean:write name="compensacionSaldoAFavor" property="montoCompensado" scope="request" formatKey="global.monto" filter="true" ignore="true" />
								</td>												
								<td></td>																							
							</tr>
