...
public class ConsultaDatosAfiliacionAs400PortProxy {
		...
		public void init() {
			...
			try {
				...
				_service = (cl.laaraucana.simulacion.webservices.autogenerado.consultadatosafiliacion.ConsultaDatosAfiliacionAs400Service) ctx
						.lookup("java:comp/env/service/ConsultaDatosAfiliacionAs400Service");
		...
		public Dispatch<Source> getDispatch() {
			if (_dispatch == null) {
				QName portQName = new QName("http://delegate.toAS.legados.integracion.laaraucana.cl/",
						"ConsultaDatosAfiliacionAs400Port");
