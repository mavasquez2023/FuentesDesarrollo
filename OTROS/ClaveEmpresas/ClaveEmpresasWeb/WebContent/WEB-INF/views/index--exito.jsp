        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg8">
            <div class="respuesta text-align-center-xs">
              ...
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente hemos recibido su solicitud de clave empresa de sucursal virtual <span class="bold">Mi Araucana</span>, pr&oacute;ximamente ser&aacute; contactado por nuestros ejecutivos.</p>
            </div>
