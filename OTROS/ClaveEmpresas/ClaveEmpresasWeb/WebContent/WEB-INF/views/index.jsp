              ...
              <div class="col xs12 lg6">
                <form class="form" action="/ClaveEmpresasWeb/paso2" method="post" id="paso1">
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Sin puntos ni guión. Ej: 12345678k">
                    <input class="text requerido tipo_rut" type="text" id="rut" name="rut" maxlength="9"/>
                    <label for="rut">RUT</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text requerido tipo_texto" type="text" id="nombre" name="nombre" data-minlength="3" maxlength="80"/>
                    <label for="nombre">Nombre</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text requerido tipo_texto" type="text" id="apellido-paterno" name="apePat" data-minlength="3" maxlength="80"/>
                    <label for="apellido-paterno">Apellido Paterno</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text tipo_texto" type="text" id="apellido-materno" name="apeMat" data-minlength="3" maxlength="80"/>
                  ...
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: +56221234567">
                    <input class="text tipo_fono tipo_numerico" type="text" id="telefono" name="telefono" data-prefijo="+56" data-prefijo-tipo="fijo" data-minlength="12" maxlength="12"/>
                    <label for="telefono">Teléfono</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: +56991234567">
                    <input class="text tipo_fono tipo_numerico" type="text" id="celular" name="celular" data-prefijo="+569" data-prefijo-tipo="celular" data-minlength="12" maxlength="12"/>
