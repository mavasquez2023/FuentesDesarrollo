 ...
 * @version 1.0
 */
public class PlanillaDNPINPDAO implements DAO_Interface {
	 ...
	 * 
	 */
	public PlanillaDNPINPDAO(ConectaDB2 db2, String esquema) {
		this.db2= db2;
	...
	public int insert(Object obj) throws SQLException {
		...
		if(periodoGratiDesde.length()>=6 && periodoGratiHasta.length()>=6){
			db2.setStatement(31, periodoGratiDesde.substring(4, 6));
			db2.setStatement(32, periodoGratiDesde.substring(0, 4));
			db2.setStatement(33, periodoGratiHasta.substring(4, 6));
			db2.setStatement(34, periodoGratiHasta.substring(0, 4));
		}else{
		...
		db2.setStatement(60, planilla.getFechaPago());
		db2.setStatement(61, "D");
