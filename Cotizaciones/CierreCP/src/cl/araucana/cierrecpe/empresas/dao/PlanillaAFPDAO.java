 ...
 * @version 1.0
 */
public class PlanillaAFPDAO implements DAO_Interface {
	 ...
	 * 
	 */
	public PlanillaAFPDAO(ConectaDB2 db2, String esquema) {
		this.db2= db2;
	...
	public int insert(Object obj) throws SQLException {
		...
		db2.setStatement(46, planilla.getFilter()); //Declaración y No Pago e Independiente
	...
	private int insertDetalle(Object obj) throws SQLException {
		...
		for (Iterator iterator = pagina.getCotizantes().iterator(); iterator.hasNext();) {
			...
			db2.setStatement(28, cotizante.getCotizacionFonasaIndependiente()); //Fonasa Independiente
			db2.executeUpdate();
		}
