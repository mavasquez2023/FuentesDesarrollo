...
/*
 * @(#) PlanillaApvPaginaDetalle.java    1.0 04-ago-2008
 *
 ...
 * @version 1.0
 */
public class PlanillaApvPaginaDetalle extends PlanillaBasePaginaDetalle{
	
	private List cotizantes;
	private PlanillaApvDocumentModel cabeceraPlanilla;
 

    public void addCotizante(PlanillaApvCotizante cotizante){
    	if (cotizantes==null){
	 ...
	 */
	public void setCabeceraPlanilla(PlanillaApvDocumentModel cabeceraPlanilla) {
