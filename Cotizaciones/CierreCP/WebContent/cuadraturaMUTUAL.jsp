...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
				...
				<TABLE border=0 align="center">
					<tr>
						...
						<td height="22" width=80 align="center" valign="middle"
							bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formcolor">TASA</td>
						<td height="22" width=80 align="center" valign="middle"
							bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formcolor">IMPONIBLE</td>
						<td height="22" width=100 align="center" valign="middle"
							bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formcolor">TOTAL</td>
					</tr>
					<c:set var="entidad_old" value="Ninguna" />
					<c:set var="totalImponible" value="0"></c:set>
					...
					<tr>
						...
						<td align="left" class="textos_formularios">&nbsp;</td>
						<td align="left" class="textos_formularios">&nbsp;</td>
						<td align="right" class="textos_formularios"><fmt:setLocale value="ES" />&nbsp;</td>
					...
					<tr>
						...
						<td align="right" width=80 class="textos_formularios"><fmt:setLocale value="ES" /><fmt:formatNumber>${comprobante.m1/100}</fmt:formatNumber></td>
					...
					<c:set var="totalImponible" value="${totalImponible + comprobante.m2}"/>
					<c:set var="totalTotal" value="${totalTotal + comprobante.m3}"/>
					
					</c:forEach>
					<!-- se cierra sección final -->
					</table></td></tr>
					<tr><td align="right" colspan=5 class="textos_formcolor">Totales:</td>
					<td align="right" width=80 class="textos_formcolor">$<fmt:setLocale value="ES" /><fmt:formatNumber><c:out value="${totalImponible}"/></fmt:formatNumber></td>
