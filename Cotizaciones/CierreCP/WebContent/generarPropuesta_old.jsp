				...
				<TABLE border=0 align="left" cellpadding="0" cellspacing="0">
					...
					<tr><td colspan=2>
						...
						<table align="center">
							...
							<c:set var="tesempresas" value="0"></c:set>
								...
								<c:set var="numFormas" value="${vs.index+1}"></c:set>
									<c:if test='${forma.formaPago=="1" || forma.formaPago=="2"}'>
										<c:if test='${empresas=="false"}'>
											<tr><td height="22" align="center" valign="middle" class="textos_formcolor" colspan=7>Comprobantes EMPRESAS</td></tr>
											<tr>
												...
												<td height="22" width="90" align="center" valign="middle"
												class="textos_formcolor">TOTAL TESO</td>
												<td height="22" align="center" valign="middle"
										...
										<tr>
												...
												<c:set var="tesempresas" value="${forma.totalTesoreria}"></c:set>
										...
										<tr>
												...
												<td height="22" align="right" valign="middle"
												class="textos_formcolor">&#36;<fmt:setLocale value="ES" /><fmt:formatNumber>${tesempresas}</fmt:formatNumber></td>
												<c:choose>
							...
							<c:set var="tesindependientes" value="0"></c:set>
								...
								<c:set var="numFormas" value="${vs.index+1}"></c:set>
									<c:if test='${forma.formaPago=="3" || forma.formaPago=="4"}'>
										...
										<c:if test='${independientes=="false"}'>
											<tr><td height="22" align="center" valign="middle" class="textos_formcolor" colspan=7>Comprobantes INDEPENDIENTES</td></tr>
											<tr>
												<td height="22" align="center" valign="middle"
												class="textos_formcolor">
												</td>
										...
										<tr>
												...
												<td class="textos_formularios">&nbsp;</td>
												<c:set var="tesindependientes" value="${forma.totalTesoreria}"></c:set>
												<td align="right" class="textos_formularios">&nbsp;</td>
										...
										<tr>
												...
												<td height="22" align="right" valign="middle"
												class="textos_formcolor">&#36;<fmt:setLocale value="ES" /><fmt:formatNumber>${tesindependientes}</fmt:formatNumber></td>
												<c:choose>
							...
							<tr>
								<td height="22" align="center" valign="middle"
									class="textos_formcolor" colspan=7>Información Propuesta Cierre</td>
							</tr>
							<tr>
								<td height="22" align="center" valign="middle"
									class="textos_formcolor" colspan=2>DEPÓSITO</td>
								<td height="22" align="center" valign="middle"
									class="textos_formcolor" colspan=2>TOTAL$</td>
								<td height="22" align="center" valign="middle"
									class="textos_formcolor" colspan=1>CANTIDAD COMPR.</td>
								<td height="22" align="center" valign="middle"
									class="textos_formcolor" colspan=1>N° CIERRE EMP</td>
								<td height="22" align="center" valign="middle"
									class="textos_formcolor" colspan=1>N° CIERRE IND</td>
							</tr>
							<tr>
								...
								<td class="textos_formularios" align="center" colspan=2>$<INPUT type="text" name="totalcierre" value="0" disabled=disabled/></td>
					...
					<DIV id="veroption" style="visibility:hidden;width:400" >
