 ...
 */
            ...
            /**
            *  LoanContrPaymentResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LoanContrPaymentResponse
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = LoanContrPaymentResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LoanContrPaymentResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "LoanContrPaymentResponse",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static LoanContrPaymentResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LoanContrPaymentResponse object =
                new LoanContrPaymentResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LoanContrPaymentResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LoanContrPaymentResponse)cl.laaraucana.botonpago.web.webservices.autogenerado.loanContrPaymentRequest.web_mobile.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    list2.add(cl.laaraucana.botonpago.web.webservices.autogenerado.loanContrPaymentRequest.web_mobile.LoanContract.Factory.parse(reader));
                                    ...
                                    // Process the array and step past its final element's end.
                                    list3.add(cl.laaraucana.botonpago.web.webservices.autogenerado.loanContrPaymentRequest.web_mobile.LoanArrearsInfo.Factory.parse(reader));
                                    ...
                                    // Process the array and step past its final element's end.
                                    list5.add(cl.laaraucana.botonpago.web.webservices.autogenerado.loanContrPaymentRequest.web_mobile.Log.Factory.parse(reader));
