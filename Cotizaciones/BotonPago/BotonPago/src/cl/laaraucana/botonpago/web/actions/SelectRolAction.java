...

{
	...
	public ActionForward muestra(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public ActionForward selecciona(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			HttpSession session = request.getSession();
			...
			//			@SuppressWarnings("unchecked")
			//			ArrayList<String> rolesC = new ArrayList<String>((Collection<String>) session.getAttribute("roles"));
