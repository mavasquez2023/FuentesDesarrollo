...
/**
 * 
 * En el caso todav√≠a no exista un perfil para el usuario lo crea seg√∫n sus permisos<p>
 *
 * Registro de Versiones:<ul>
 * <li>Dec 2, 2011 [ccappelletti - schema ltda.]: Versi√≥n Inicial</li>
 * </ul><p>
 * 
...
public final class AuthorizationFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (r!= null && session.getAttribute("autorizacion") == null && r.getUserPrincipal() != null) {
			logger.info("Obteniendo el nivel de autorizaciÛn para el usuario autenticado >" + r.getUserPrincipal().toString() + "<");
			...
			try {
				...
				logger.error("El username con el que est· autenticado no es un long (supuesto): >" + r.getUserPrincipal().toString() + "<"); 
			}
