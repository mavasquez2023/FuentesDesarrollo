			...
			<tr>
				...
				<td class="bienvenida"
					style="border: 0 px; font-size: 20px; border-color: #FFFFFF; text-align: left;">
					 ...
					 <input id="fecha1" name="fechaInicio" type="text" maxlength="10" class="form-control input-sm" />
				...
				<td class="bienvenida"
					style="border: 0 px; font-size: 20px; border-color: #FFFFFF; text-align: left;">
					 ...
					 <input id="fecha2" name="fechaFin" type="text" maxlength="10" class="form-control input-sm" />
