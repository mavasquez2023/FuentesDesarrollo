...
public class UtilLogThread {

	public static void info(String texto){
		UtilLog.info(MiLogUtil.LOG_THREAD , texto);
	}
	public static void debug(String texto){
		UtilLog.debug(MiLogUtil.LOG_THREAD , texto);
	}
	public static void error(String texto){
		UtilLog.error(MiLogUtil.LOG_THREAD , texto);
	}
	public static void fatal(String texto){
		UtilLog.fatal(MiLogUtil.LOG_THREAD , texto);
	}
