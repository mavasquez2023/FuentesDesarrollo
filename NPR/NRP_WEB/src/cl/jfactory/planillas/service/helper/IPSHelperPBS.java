...
public class IPSHelperPBS {
	...
	public static boolean limpiarTabla(){
		...
		try {
			int deleteData = sqlMap.delete("carga_SAP.deleteDataPBS");
	...
	public static void procesandoRegistroIPS(HashMap data) throws SQLException{
		...
		if(cargaNoBatch == null){
			cargaNoBatch = new CargaNoBatch("CARGA_IPS_PBS", "nrpdta/nrp85f1");
		}
		
		MiHashMap o = new MiHashMap().toMiHashMap(data);
		
		String registro = JDBCUtil.getQueryCompleta("query.jdbc.registro.ips.pbs", o);
