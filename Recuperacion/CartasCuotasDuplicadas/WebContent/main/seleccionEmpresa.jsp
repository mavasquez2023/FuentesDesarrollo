...
<script language="JavaScript" type="text/javascript">
	function aceptar(rutEmpresa, oficina, sucursal){
		window.location="<%=request.getContextPath() %>/main/crm.do?rut=" + rutEmpresa + "&oficina=" + oficina + "&sucursal=" + sucursal;
	}
</script>
</head>
<body>
		...
		<logic:equal name="error" value="0">
			<blockquote>
				...
				<p>
					...
					<tr>
						<td><a href="#" onclick="aceptar('${lista.rutEmpresa}-${lista.dvRutEmpresa}', '${lista.oficina}', '${lista.sucursal}');">${lista.rutEmpresa}-${lista.dvRutEmpresa}</a></td>
