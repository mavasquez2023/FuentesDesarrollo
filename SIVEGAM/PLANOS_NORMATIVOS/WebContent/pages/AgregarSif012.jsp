...
<script type="text/javascript">
		...
		if (id_tipo_declaracion == 0){
			...
			if((id_tipo_declaracion == 2)){
				...
				if(anioIni < (anioInformado - 5)){
					alert("Error, el mes informado no puede ser inferior a 5 años atras.");
					document.getElementById("txt_FechaInicioBeneficio").value = " ";
					document.getElementById("txt_FechaTerminoBeneficio").value = " ";
					return false;
				}
	...
	function agregarRegistroSif012(){
		...
		var causalReliquidacion = document.AgregarSif012Form.dbx_CausalReliquidacion.value;
		var origenInfo = document.AgregarSif012Form.txt_OrigenInfo.value;
		...
		if(validaIngreso == true){
			...
			document.AgregarSif012Form.btn_Agregar.disabled=true;
			document.AgregarSif012Form.btn_Cancelar.disabled=true;
			AgregarRegistroDivisionPrevisionalDWR.insertSif012( rutEmpresa,
																dvEmpresa,
																nombreEmpresa,
																rutAfiliado,
																dvAfiliado,
				...
				document.AgregarSif012Form.btn_Agregar.disabled=false;
				...
				if(resp == 0){
					...
					if(correlativoRequest == "" || correlativoRequest == "null"){
						...
						eliminarDatoErroneoSif011(correlativoRequest);
						cerrarVentana();
					}
	...
	/**Funcion que realiza un borrado logico de la tabla sif011, tomando en consideracion el correlativo (id)*/
	...
	function obtenerDataCruzada(correlativo){
		...
		DWREngine.setAsync(false);
		AgregarRegistroDivisionPrevisionalDWR.obtenerDataSif011(correlativo, function(data){
			...
			if(sif011 != null)
			{
				document.AgregarSif012Form.txt_Rut.value = sif011.rut_empresa;
				document.AgregarSif012Form.txt_NumVerif.value = sif011.dv_empresa;
				document.AgregarSif012Form.txt_NombreEmpresa.value = sif011.nombre_empresa;
				document.AgregarSif012Form.txt_RutAfiliado.value = sif011.rut_afiliado;
				document.AgregarSif012Form.txt_NumVerifAfiliado.value = sif011.dv_afiliado;
				document.AgregarSif012Form.txt_NombreAfiliado.value = sif011.nombre_afiliado;
				document.AgregarSif012Form.dbx_TipoBeneficio.value = sif011.cod_tipo_beneficio;
				document.AgregarSif012Form.dbx_TipoBeneficiario.value = sif011.tipo_beneficiario;
				document.AgregarSif012Form.txt_RutCausante.value = sif011.rut_causante;
				document.AgregarSif012Form.txt_NumVerifCausante.value = sif011.dv_causante;
				document.AgregarSif012Form.txt_NombreCausante.value = sif011.nombre_causante;
				document.AgregarSif012Form.dbx_TipoCausante.value = sif011.cod_tipo_causante;
				document.AgregarSif012Form.txt_FechaInicioBeneficio.value = sif011.fechaInicioBeneficioDate;
				document.AgregarSif012Form.txt_FechaTerminoBeneficio.value = sif011.fechaTerminoBeneficioDate;
				document.AgregarSif012Form.txt_DiasAsfam.value = sif011.dias_asfam;
				document.AgregarSif012Form.dbx_CodigoTramo.value = sif011.codigo_tramo;
				document.AgregarSif012Form.txt_MontoBeneficio.value = sif011.monto_beneficio;
				document.AgregarSif012Form.dbx_TipoEmision.value = sif011.tipo_emision;
				document.AgregarSif012Form.dbx_TipoEgreso.value = sif011.cod_tipo_egreso;
				document.AgregarSif012Form.dbx_ModPago.value = sif011.modalidad_pago;
				document.AgregarSif012Form.txt_MontoDocumento.value = sif011.monto_documento;
				
				if(sif011.numero_serie == "null" || sif011.numero_serie == ""){
					document.AgregarSif012Form.txt_NumeroSerie.value = 0;
				}else{	
					document.AgregarSif012Form.txt_NumeroSerie.value = sif011.numero_serie;
				}
				
				if(sif011.numero_documento == "null" || sif011.numero_documento == ""){
					document.AgregarSif012Form.txt_NumeroDocumento.value = 0;
				}else{
					document.AgregarSif012Form.txt_NumeroDocumento.value = sif011.numero_documento;	
				}
				
				document.AgregarSif012Form.txt_FechaEmision.value = sif011.fechaEmisionDocumentoDate;
				document.AgregarSif012Form.dbx_CodBanco.value = sif011.codigo_banco;
				document.AgregarSif012Form.dbx_FuenteOrigen.value = sif011.fuente_origen;
				document.AgregarSif012Form.dbx_TipoDeclaracion.value = sif011.tipo_declaracion;
				
				//este campo como no esta en sif011 se deja en modo "seleccione" para que el usuario escoja lo que se requiere.
				document.AgregarSif012Form.dbx_CausalReliquidacion.value = 0;
				document.AgregarSif012Form.txt_OrigenInfo.value = "";
...
<div id="caja_registro">
	...
	<table width="1100" border="0">
		...
		<tr>
			...
			AGREGAR REGISTROS REPORTE DIVISION REGIMENES LEGALES SIF012 </p1></strong></td>
		</tr>
		<tr></tr>
		<tr>
			<td><br/>
			...
			<table width="100%" border="1" rules="groups">
				...
				<tr>	
					...
					<td >
						...
						<IMG style="cursor:hand" border="0" src="../images/Calendar.jpg" width="16" height="16" onClick="ShowCalendarFor(txt_FechaTerminoBeneficio);validacionUno();"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td >
						<strong>Causal Reliquidaci&oacute;n</strong>
					</td>
					<td>
						<html:select property="dbx_CausalReliquidacion" styleClass="dbx_modPago" value="0">
							<html:option value="0">Seleccione</html:option>
				...
				<tr>	
					...
					<td colspan="4">
						...
						<IMG name="calenFecEmiDoc" id="calenFecEmiDoc" style="cursor:hand" border="0" src="../ages/Calendar.jpg" width="16" height="16" onClick="ShowCalendarFor(txt_FechaEmision)"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td >
						<strong>Origen Informaci&oacute;n</strong>
					</td>
					<td >
						<input type="text" name="txt_OrigenInfo" id="txt_OrigenInfo" size="20" maxlength="15" onkeyup="Upper(this,'A')" onkeypress="Upper(this,'A')" />
					</td>
				</tr>
		...
		<tr>
			<td height="37" align="right" width="80%">
				<input type="button" name="btn_Agregar" id="btn_Agregar" class="btn_limp" value="Agregar" onclick="agregarRegistroSif012();"/>
				&nbsp;&nbsp;&nbsp;
