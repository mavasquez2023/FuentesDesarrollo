...
import cl.araucana.sivegam.struts.Forms.AgregarSif019Form;

public class AgregarSif019Action extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        AgregarSif019Form AgregarSif019 = (AgregarSif019Form) form;
        ...
        if (a != 0) {
            ...
            opcion = Integer.parseInt(AgregarSif019.getOpcion());
