...
import cl.araucana.sivegam.struts.Forms.MenuEdicionDivPrevisionalForm;

public class MenuEdicionDivPrevisionalAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        MenuEdicionDivPrevisionalForm menuEditRepDivPrevisionalForm = (MenuEdicionDivPrevisionalForm) form;
        ...
        if (a != 0) {
            session.setAttribute("Error", "Ha ocurrido un error al conectar con el servidor de Base de Datos. Comuniquese con su administrador " +
            	"del Sistema.");
            return mapping.findForward("login");
        } else {
            opcion = Integer.parseInt(menuEditRepDivPrevisionalForm.getOpcion());
