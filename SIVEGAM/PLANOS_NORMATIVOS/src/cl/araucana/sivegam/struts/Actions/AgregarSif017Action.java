...
import cl.araucana.sivegam.struts.Forms.AgregarSif017Form;

public class AgregarSif017Action extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        AgregarSif017Form AgregarSif017 = (AgregarSif017Form) form;
        ...
        if (a != 0) {
            ...
            opcion = Integer.parseInt(AgregarSif017.getOpcion());
