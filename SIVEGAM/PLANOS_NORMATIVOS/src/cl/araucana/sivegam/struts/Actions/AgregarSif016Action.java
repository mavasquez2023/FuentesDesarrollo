...
import cl.araucana.sivegam.struts.Forms.AgregarSif016Form;

public class AgregarSif016Action extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        AgregarSif016Form AgregarSif016 = (AgregarSif016Form) form;
        ...
        if (a != 0) {
            ...
            opcion = Integer.parseInt(AgregarSif016.getOpcion());
