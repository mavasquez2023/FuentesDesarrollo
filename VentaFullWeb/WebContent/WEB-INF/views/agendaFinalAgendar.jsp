          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
              <div class="respuesta-positiva">
				...
				<h3>Llamado agendado exitosamente</h3>
				<p>Nos comunicaremos contigo al número ${telefono} el ${fechaSeleccionada} entre las ${rangoHorario} hrs.</p>
				<p>Por favor debes estar atento a tu celular</p>				
