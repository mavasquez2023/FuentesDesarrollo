          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
              <div class="respuesta-positiva">
				...
				<h3>Te esperamos de vuelta.</h3>
				<div class="separador"></div>
				<div class="botonera">
					<a href="<c:url value='<%=cl.laaraucana.ventafullweb.util.Configuraciones.getConfig("url.salir.portal")%>' />" target="_top" class="boton boton--borde terciario">Ir al home</a>
				</div>
              </div>
            </div>
          </div>
