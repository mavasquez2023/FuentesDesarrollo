...
public class MotorCreditScoringSOAPImpl implements cl.araucana.www.CreditScoring_PortType {
	...
	public void evaluarCreditoSyncFull(
		...
		try {
			...
			myService.evaluarCondicionesOtorgamientoFull(myRut, tipoAfiliado, myMonto, genero, fechaNac,
					estadoCivil, remuneracion, diasMorosidad, numCreditosAnteriores,
					numDiasLicencia, antiguedadLaboral, empRut, clasifRiesgoEmpresa);
