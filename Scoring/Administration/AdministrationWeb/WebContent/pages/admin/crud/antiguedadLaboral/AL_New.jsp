<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/antiguedadLaboral/AL_New.java" --%><%-- /jsf:pagecode --%>
											...
											<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6"
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.AL_New_title}"></h:outputText>
													<hx:jspPanel id="jspPanel4">
														<hr>
													</hx:jspPanel>

													<h:messages styleClass="messages"
														id="originDataALSingleRow2messages"></h:messages>
													<hx:jspPanel id="jspPanel3">
														<hx:panelFormBox helpPosition="over" labelPosition="left"
															...
															<hx:formItem styleClass="formItem" id="formItem2"
																label="Nombre:" showHelp="info">
																<h:inputText styleClass="inputText" id="nombre1"
																	value="#{pc_AL_New.originDataALSingleRow.Nombre}"
															...
															<hx:formItem styleClass="formItem" id="formItem3"
																label="Desde:" infoText="#{label.AL_New_desde_hint}"
																showHelp="info">
																<h:inputText styleClass="inputText" id="desde1"
																	value="#{pc_AL_New.originDataALSingleRow.Desde}"
																	required="true">
																	<hx:convertNumber integerOnly="true" />
																	<hx:inputHelperSpinner id="spinner3" />
															...
															<hx:formItem styleClass="formItem" id="formItem4"
																label="Hasta:" infoText="#{label.AL_New_desde_hint}"
																showHelp="info">
																<h:inputText styleClass="inputText" id="hasta1"
																	value="#{pc_AL_New.originDataALSingleRow.Hasta}">
																	<hx:convertNumber integerOnly="true" />
													...
													<hx:panelBox styleClass="panelBox" id="box7">
														<hx:commandExButton styleClass="commandExButton"
															...
															action="#{pc_AL_New.doOriginDataALSingleRowUpdateAction}">
														</hx:commandExButton>
														...
														<hx:commandExButton type="submit"
															...
															id="cancelBtn" action="#{pc_AL_New.doButton2Action}"></hx:commandExButton>
													</hx:panelBox>
