<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/antiguedadLaboral/AL_Edit.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
											...
											<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6"
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.AL_Edit_title}"></h:outputText>
													<hx:jspPanel id="jspPanel4">
														<hr>
													</hx:jspPanel>

													<h:messages styleClass="messages"
														id="originDataALSingleRow2messages" layout="table" globalOnly="true"></h:messages>
														...
														<hx:panelFormBox helpPosition="over" labelPosition="left"
															...
															<hx:formItem styleClass="formItem" id="formItem2"
																...
																<h:inputText styleClass="inputText" id="nombre1"
																	value="#{pc_AL_Edit.originDataALSingleRow.Nombre}"
															...
															<hx:formItem styleClass="formItem" id="formItem3"
																label="Desde:" infoText="#{label.AL_Edit_desde_hint}"
																showHelp="info">
																<h:inputText styleClass="inputText" id="desde1"
																	value="#{pc_AL_Edit.originDataALSingleRow.Desde}"
																	required="true">
															...
															<hx:formItem styleClass="formItem" id="formItem4"
																label="Hasta:" infoText="#{label.AL_Edit_desde_hint}"
																showHelp="info">
																<h:inputText styleClass="inputText" id="hasta1"
																	value="#{pc_AL_Edit.originDataALSingleRow.Hasta}"
																	required="true">
																	<hx:convertNumber integerOnly="true" />
												...
												<hx:commandExButton styleClass="commandExButton"
													...
													action="#{pc_AL_Edit.doOriginDataALSingleRowUpdateAction}">
												</hx:commandExButton>
												<hx:commandExButton styleClass="commandExButton"
													type="submit" value="#{label.delete_btn}" id="deleteBtn"
													action="#{pc_AL_Edit.doOriginDataALSingleRowDeleteAction}">
												</hx:commandExButton>
												<hx:commandExButton type="submit" immediate="true"
													value="#{label.cancel_btn}" styleClass="commandExButton"
													id="cancelBtn" action="#{pc_AL_Edit.doButton1Action}"></hx:commandExButton>
											</h:form>
										</hx:scriptCollector>
									<%-- /tpl:put --%>
								</hx:jspPanel>
