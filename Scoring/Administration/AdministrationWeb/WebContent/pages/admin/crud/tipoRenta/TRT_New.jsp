<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/tipoRenta/TRT_New.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												...
												<hx:panelBox styleClass="panelBox" id="box6" layout="pageDirection">
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.TRT_New_title}"></h:outputText>
													<hx:jspPanel id="jspPanel3">
														<hr>
													</hx:jspPanel>
													<h:messages styleClass="messages" id="originDataTRTSingleRow2messages"></h:messages><hx:panelFormBox helpPosition="over" labelPosition="left" styleClass="panelFormBox" id="formBox1">
														<hx:formItem styleClass="formItem" id="formItem2" label="Nombre:" showHelp="info">
															<h:inputText styleClass="inputText" id="nombre1"
																value="#{pc_TRT_New.originDataTRTSingleRow.Nombre}" required="true" maxlength="25">
														...
														<hx:formItem styleClass="formItem" id="formItem1"
															label="Descripción:" showHelp="info">
															<h:inputText styleClass="inputText" id="descripcion1"
																value="#{pc_TRT_New.originDataTRTSingleRow.Descripcion}" required="true" maxlength="40">
												...
												<hx:panelBox styleClass="panelBox" id="box7">
														<hx:commandExButton styleClass="commandExButton"
															...
															action="#{pc_TRT_New.doOriginDataTRTSingleRowUpdateAction}">
														</hx:commandExButton>
														<hx:commandExButton type="reset"
															value="#{label.reset_btn}" styleClass="commandExButton"
															id="resetBtn"></hx:commandExButton>
														<hx:commandExButton type="submit"
															value="#{label.cancel_btn}" styleClass="commandExButton"
															id="cancelBtn" action="#{pc_TRT_New.doCancelBtnAction}"></hx:commandExButton>
