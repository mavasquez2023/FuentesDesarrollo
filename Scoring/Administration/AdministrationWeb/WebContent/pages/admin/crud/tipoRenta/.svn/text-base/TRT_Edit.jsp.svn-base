<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/tipoRenta/TRT_Edit.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6" layout="pageDirection">
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.TRT_Edit_title}"></h:outputText>
													<hx:jspPanel id="jspPanel3">
														
														<hr>
													</hx:jspPanel><h:messages styleClass="messages" id="originDataTRTSingleRow3messages"></h:messages><hx:panelFormBox helpPosition="over" labelPosition="left" styleClass="panelFormBox" id="formBox1">
														<hx:formItem styleClass="formItem" id="formItem2" label="Nombre:" showHelp="info">
															<h:inputText styleClass="inputText" id="nombre1"
																value="#{pc_TRT_Edit.originDataTRTSingleRow.Nombre}" required="true">
																<f:validateLength minimum="25"></f:validateLength>
															</h:inputText>
															<h:message for="nombre1" styleClass="message"></h:message>
														</hx:formItem>
															<hx:formItem styleClass="formItem" id="formItem1" label="Descripción:" showHelp="info">
															<h:inputText styleClass="inputText" id="descripcion1"
																value="#{pc_TRT_Edit.originDataTRTSingleRow.Descripcion}" required="true">
																<f:validateLength minimum="40"></f:validateLength>
															</h:inputText>
														...
														<hx:commandExButton styleClass="commandExButton"
															...
															id="originDataTRTSingleRow1"
															action="#{pc_TRT_Edit.doOriginDataTRTSingleRowUpdateAction}">
														</hx:commandExButton>

														<hx:commandExButton styleClass="commandExButton"
															type="submit" value="#{label.delete_btn}"
															id="originDataTRTSingleRow2"
															action="#{pc_TRT_Edit.doOriginDataTRTSingleRowDeleteAction}">
														</hx:commandExButton>
														<hx:commandExButton type="submit"
															value="#{label.cancel_btn}" styleClass="commandExButton"
															id="cancelBtn" action="#{pc_TRT_Edit.doCancelBtnAction}"></hx:commandExButton>
													</hx:panelBox>
