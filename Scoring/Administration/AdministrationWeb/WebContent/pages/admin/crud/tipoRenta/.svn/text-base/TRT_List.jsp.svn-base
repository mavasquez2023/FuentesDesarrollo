<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/tipoRenta/TRT_List.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6" layout="pageDirection">
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.TRT_List_title}"></h:outputText>
													<hx:jspPanel id="jspPanel3">
														...
														<hx:commandExButton styleClass="commandExButton"
															...
															id="doOriginDataTRTMultiRowFetchAction1"
															action="#{pc_TRT_List.doOriginDataTRTMultiRowFetchAction}">
														</hx:commandExButton>
													</hx:panelBox>
													
												<hx:dataTableEx id="originDataTRTMultiRow1" value="#{pc_TRT_List.originDataTRTMultiRow}" var="varoriginDataTRTMultiRow" styleClass="dataTableEx" headerClass="headerClass" footerClass="footerClass" rowClasses="rowClass1,rowClass2" columnClasses="columnClass1" border="0" cellpadding="2" cellspacing="0">
													<hx:columnEx id="columnEx1">
														<hx:inputRowSelect styleClass="inputRowSelect" id="rowSelect1" value="#{pc_TRT_List.selectedRows}">
															<f:param value="#{varoriginDataTRTMultiRow.IdTipoRentaPermitida}" name="idRow" id="param1"></f:param>
														</hx:inputRowSelect>
													...
													<hx:columnEx id="nombre1column">
														...
														<h:outputText styleClass="outputText" id="nombre1" value="#{varoriginDataTRTMultiRow.Nombre}">
														</h:outputText>
													</hx:columnEx>
													<hx:columnEx id="descripcion1column">
														<f:facet name="header">
															<h:outputText styleClass="outputText" value="Descripcion" id="descripcion1text"></h:outputText>
														</f:facet>
														<h:outputText styleClass="outputText" id="descripcion1" value="#{varoriginDataTRTMultiRow.Descripcion}">
														</h:outputText>
													</hx:columnEx>
														<hx:columnEx id="columnEx2">
															<hx:requestLink styleClass="requestLink" id="link1" action="#{pc_TRT_List.doLink1Action}">
																<h:outputText id="text3" styleClass="outputText"
																	value="Editar"></h:outputText>
																<f:param
																	value="#{varoriginDataTRTMultiRow.IdTipoRentaPermitida}"
																	name="idTRT" id="param2"></f:param>
															</hx:requestLink>
															<f:facet name="header">
															</f:facet>
														</hx:columnEx>
														...
														<hx:commandExButton styleClass="commandExButton"
															type="submit" value="#{label.new_btn}" id="newBtn"
															action="#{pc_TRT_List.doNewBtnAction}">
														</hx:commandExButton>
														<hx:commandExButton type="submit"
															value="#{label.delete_btn}" styleClass="commandExButton"
															id="button1"
															action="#{pc_TRT_List.doDeleteTipoRentaBtnAction}"></hx:commandExButton>
