						...
						<hx:panelLayout styleClass="panelLayout" id="layout1C"
							...
							<f:facet name="body">
								<hx:jspPanel id="jspPanelUnder1CC">
									<%-- tpl:put name="bodyCenter" --%>Default content of bodyCenter<%-- /tpl:put --%>
								</hx:jspPanel>
							</f:facet>
							<f:facet name="left">
...
<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/condicionOtorgamiento/CO_List.java" --%><%-- /jsf:pagecode --%>