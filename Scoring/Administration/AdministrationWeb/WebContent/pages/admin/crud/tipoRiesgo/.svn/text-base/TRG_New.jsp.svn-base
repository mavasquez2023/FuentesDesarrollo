<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/tipoRiesgo/TRG_New.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6"
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.TRG_New_title}"></h:outputText>
													...
													<hx:panelFormBox helpPosition="over" labelPosition="left"
														...
														<hx:formItem styleClass="formItem" id="formItem2" label="Nombre" showHelp="info">
															<h:inputText styleClass="inputText" id="nombre1"
																value="#{pc_TRG_New.originDataTRGSingleRow.Nombre}" required="true">
																<f:validateLength maximum="25"></f:validateLength>
															</h:inputText>
															<h:message for="nombre1" styleClass="message"></h:message>
														</hx:formItem>
														<hx:formItem styleClass="formItem" id="formItem4" label="Desde" showHelp="info" infoText="#{label.TRG_New_desde}">
															<h:inputText styleClass="inputText" id="desde1"
																value="#{pc_TRG_New.originDataTRGSingleRow.Desde}" required="true">
														...
														<hx:formItem styleClass="formItem" id="formItem1" label="Hasta" showHelp="info" infoText="#{label.TRG_New_desde}">

															<h:inputText styleClass="inputText" id="hasta1"
																value="#{pc_TRG_New.originDataTRGSingleRow.Hasta}" required="true">
																<hx:convertNumber integerOnly="true"/>
													...
													<hx:panelBox styleClass="panelBox" id="box7">
														...
														<hx:commandExButton styleClass="commandExButton"
															...
															action="#{pc_TRG_New.doOriginDataTRGSingleRowUpdateAction}">
														</hx:commandExButton>
														...
														<hx:commandExButton type="submit"
															...
															id="cancelBtn" action="#{pc_TRG_New.doCancelBtnAction}"></hx:commandExButton>
													</hx:panelBox>
												</hx:panelBox>
