<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/tipoRiesgo/TRG_List.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6"
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.TRG_List_title}"></h:outputText>
													<hx:jspPanel id="jspPanel3">
														<hr>
													</hx:jspPanel><hx:panelBox styleClass="panelBox" id="box1" align="left">
														<hx:commandExButton styleClass="commandExButton"
															type="submit" value="#{label.refresh_btn}"
															id="doOriginDataTRGMultiRowFetchAction1"
															action="#{pc_TRG_List.doOriginDataTRGMultiRowFetchAction}">
														</hx:commandExButton>
													</hx:panelBox>
													
												<hx:dataTableEx id="originDataTRGMultiRow1" value="#{pc_TRG_List.originDataTRGMultiRow}" var="varoriginDataTRGMultiRow" styleClass="dataTableEx" headerClass="headerClass" footerClass="footerClass" rowClasses="rowClass1, rowClass2" columnClasses="columnClass1" border="0" cellpadding="2" cellspacing="0" width="100%">
													<hx:columnEx id="columnEx1">
														<hx:inputRowSelect styleClass="inputRowSelect" id="rowSelect1" value="#{pc_TRG_List.selectedRows}">
															<f:param value="#{varoriginDataTRGMultiRow.IdTipoRiesgoExterno}" name="idRow" id="param1"></f:param>
														</hx:inputRowSelect>
													...
													<hx:columnEx id="nombre1column">
														...
														<h:outputText styleClass="outputText" id="nombre1" value="#{varoriginDataTRGMultiRow.Nombre}">
														</h:outputText>
													</hx:columnEx>
													<hx:columnEx id="desde1column">
														...
														<h:outputText styleClass="outputText" id="desde1" value="#{varoriginDataTRGMultiRow.Desde}">
															<hx:convertNumber />
														</h:outputText>
													</hx:columnEx>
													<hx:columnEx id="hasta1column">
														...
														<h:outputText styleClass="outputText" id="hasta1" value="#{varoriginDataTRGMultiRow.Hasta}">
															<hx:convertNumber />
														</h:outputText>
													</hx:columnEx>
													<hx:columnEx id="columnEx2">
														...
														<hx:requestLink styleClass="requestLink" id="link1" action="#{pc_TRG_List.doLink1Action}">
															<h:outputText id="text1" styleClass="outputText" value="Editar"></h:outputText>
															<f:param value="#{varoriginDataTRGMultiRow.IdTipoRiesgoExterno}" name="idTRG" id="param2"></f:param>
														</hx:requestLink>
													</hx:columnEx>
												</hx:dataTableEx><hx:panelBox styleClass="panelBox" id="box2" align="left">
														<hx:commandExButton type="submit" value="#{label.new_btn}"
															styleClass="commandExButton" id="newBtn"
															action="#{pc_TRG_List.doNewBtnAction}"></hx:commandExButton>
														<hx:commandExButton type="submit"
															value="#{label.delete_btn}" styleClass="commandExButton"
															id="deleteBtn" action="#{pc_TRG_List.doDeleteBtnAction}"></hx:commandExButton>
