<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/clasificacionEmpresa/CE_List.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6" layout="pageDirection">
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.CE_List_title}"></h:outputText>
													<hx:jspPanel id="jspPanel3">
														...
														<hx:commandExButton styleClass="commandExButton"
															type="submit" value="#{label.delete_btn}" id="refreshBtn"
															action="#{pc_CE_List.doOriginDataCEMultiRowFetchAction}">
														</hx:commandExButton>


													</hx:panelBox><hx:dataTableEx id="originDataCEMultiRow1" value="#{pc_CE_List.originDataCEMultiRow}" var="varoriginDataCEMultiRow" styleClass="dataTableEx" headerClass="headerClass" footerClass="footerClass" rowClasses="rowClass1, rowClass2" columnClasses="columnClass1" border="0" cellpadding="2" cellspacing="0">
					<hx:columnEx id="columnEx1">
						<hx:inputRowSelect styleClass="inputRowSelect" id="rowSelect1" value="#{pc_CE_List.selectedRows}">
							<f:param value="#{varoriginDataCEMultiRow.IdClasificacionEmpresa}" name="idRow" id="param1"></f:param>
						</hx:inputRowSelect>
					...
					<hx:columnEx id="nombre1column">
						...
						<h:outputText styleClass="outputText" id="nombre1" value="#{varoriginDataCEMultiRow.Nombre}">
						</h:outputText>
					</hx:columnEx>
					<hx:columnEx id="descripcion1column">
						...
						<h:outputText styleClass="outputText" id="descripcion1" value="#{varoriginDataCEMultiRow.Descripcion}">
						</h:outputText>
					</hx:columnEx>
														<hx:columnEx id="columnEx2">
															<hx:requestLink styleClass="requestLink" id="link1"
																action="#{pc_CE_List.doLink1Action}">
																<h:outputText id="text3" styleClass="outputText"
																	value="Editar"></h:outputText>
																<f:param
																	value="#{varoriginDataCEMultiRow.IdClasificacionEmpresa}"
																	name="idCE" id="param2"></f:param>
															</hx:requestLink>
															<f:facet name="header">
															</f:facet>
														</hx:columnEx>
														...
														<hx:commandExButton type="submit" value="#{label.new_btn}"
															...
															action="#{pc_CE_List.doNewBtnAction}"></hx:commandExButton>
														<hx:commandExButton type="submit"
															value="#{label.delete_btn}" styleClass="commandExButton"
															id="deleteBtn" action="#{pc_CE_List.doDeleteBtnAction}"></hx:commandExButton>
