<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/clasificacionEmpresa/CE_New.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6" layout="pageDirection">
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.CE_New_title}"></h:outputText>
													<hx:jspPanel id="jspPanel3">
														<hr>
													</hx:jspPanel><h:messages styleClass="messages" id="originDataCESingleRow2messages" layout="table" globalOnly="true"></h:messages><hx:panelFormBox helpPosition="over" labelPosition="left" styleClass="panelFormBox" id="formBox1">
														<hx:formItem styleClass="formItem" id="formItem3" label="Nombre:" showHelp="info">
															<h:inputText styleClass="inputText" id="nombre1"
																value="#{pc_CE_New.originDataCESingleRow.Nombre}" maxlength="25" required="true">
																<f:validateLength maximum="25"></f:validateLength>
															</h:inputText>
															<h:message for="nombre1" styleClass="message"></h:message>
														</hx:formItem>
														<hx:formItem styleClass="formItem" id="formItem2" label="Descripción:" showHelp="info">
															<h:inputText styleClass="inputText" id="descripcion1"
																value="#{pc_CE_New.originDataCESingleRow.Descripcion}" maxlength="40" required="true">
												...
												<hx:panelBox styleClass="panelBox" id="box7">
													<hx:commandExButton styleClass="commandExButton"
														type="submit" value="#{label.create_btn}" id="okBtn"
														action="#{pc_CE_New.doOkBtnAction}">
													</hx:commandExButton>
													...
													<hx:commandExButton type="submit"
														...
														id="cancelBtn" action="#{pc_CE_New.doCancelBtnAction}"></hx:commandExButton>
