<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/perfilRiesgo/PR_Edit.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
						...
						<hx:panelLayout styleClass="panelLayout" id="layout1C"
							...
							<f:facet name="body">
								<hx:jspPanel id="jspPanelUnder1CC">
									<%-- tpl:put name="bodyCenter" --%><hx:scriptCollector id="scriptCollector1">
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6" layout="pageDirection">
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.PR_Edit_title}"></h:outputText>
													<hx:jspPanel id="jspPanel3">
														<hr>
													</hx:jspPanel>
													
													<h:messages styleClass="messages" id="originDataPRSingleRow3messages"></h:messages><hx:panelFormBox helpPosition="over" labelPosition="left"
														styleClass="panelFormBox" id="formBox1">
														<hx:formItem styleClass="formItem" id="formItem3" label="Nombre" showHelp="error">
															<h:inputText styleClass="inputText" id="nombre1"
																value="#{pc_PR_Edit.originDataPRSingleRow.Nombre}" required="true" maxlength="25">
														...
														<hx:formItem styleClass="formItem" id="formItem2"
															label="Desde" showHelp="info">

															<h:inputText styleClass="inputText" id="desde1"
																value="#{pc_PR_Edit.originDataPRSingleRow.Desde}"
														...
														<hx:formItem styleClass="formItem" id="formItem5" label="Hasta" showHelp="info">
															<h:inputText styleClass="inputText" id="hasta1"
																value="#{pc_PR_Edit.originDataPRSingleRow.Hasta}" maxlength="10">
																<hx:convertNumber integerOnly="true"/>
														...
														<hx:commandExButton styleClass="commandExButton"
															...
															id="originDataPRSingleRow1"
															action="#{pc_PR_Edit.doOriginDataPRSingleRowUpdateAction}">
														</hx:commandExButton>
														<hx:commandExButton styleClass="commandExButton"
															type="submit" value="#{label.delete_btn}"
															id="originDataPRSingleRow2"
															action="#{pc_PR_Edit.doOriginDataPRSingleRowDeleteAction}">
														</hx:commandExButton>
														<hx:commandExButton type="submit"
															value="#{label.cancel_btn}" styleClass="commandExButton"
															id="cancelBtn" action="#{pc_PR_Edit.doCancelBtnAction}"></hx:commandExButton>
													</hx:panelBox>
