<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/perfilRiesgo/PR_List.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6"
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.PR_List_title}"></h:outputText>
												...
												<h:messages styleClass="messages" id="messages1"></h:messages><hx:panelBox styleClass="panelBox" id="box1">
														<hx:commandExButton styleClass="commandExButton"
															...
															id="refreshBtn"
															action="#{pc_PR_List.doOriginDataPRMultiRowFetchAction}">
														</hx:commandExButton>
													</hx:panelBox><hx:dataTableEx id="originDataPRMultiRow1" value="#{pc_PR_List.originDataPRMultiRow}" var="varoriginDataPRMultiRow" styleClass="dataTableEx" headerClass="headerClass" footerClass="footerClass" rowClasses="rowClass1, rowClass2" columnClasses="columnClass1" border="0" cellpadding="2" cellspacing="0">
					<hx:columnEx id="columnEx1">
						<hx:inputRowSelect styleClass="inputRowSelect" id="rowSelect1" value="#{pc_PR_List.selectedRows}">
							<f:param value="#{varoriginDataPRMultiRow.IdPerfilRiesgo}" name="idRow" id="param1"></f:param>
						</hx:inputRowSelect>
					...
					<hx:columnEx id="nombre1column">
						...
						<h:outputText styleClass="outputText" id="nombre1" value="#{varoriginDataPRMultiRow.Nombre}">
						</h:outputText>
					</hx:columnEx>
					<hx:columnEx id="desde1column">
						...
						<h:outputText styleClass="outputText" id="desde1" value="#{varoriginDataPRMultiRow.Desde}">
							<hx:convertNumber />
						</h:outputText>
					</hx:columnEx>
					<hx:columnEx id="hasta1column">
						...
						<h:outputText styleClass="outputText" id="hasta1" value="#{varoriginDataPRMultiRow.Hasta}">
							<hx:convertNumber />
						</h:outputText>
					</hx:columnEx>
													<hx:columnEx id="columnEx2">
														<hx:requestLink styleClass="requestLink" id="link1" action="#{pc_PR_List.doLink1Action}">
															<h:outputText id="text3" styleClass="outputText" value="Editar"></h:outputText>
															<f:param value="#{varoriginDataPRMultiRow.IdPerfilRiesgo}" name="idPR" id="param2"></f:param>
														</hx:requestLink>
														<f:facet name="header">
														</f:facet>
													</hx:columnEx>
														...
														<hx:commandExButton type="submit" value="#{label.new_btn}"
															...
															action="#{pc_PR_List.doNewBtnAction}"></hx:commandExButton>
														<hx:commandExButton type="submit"
															value="#{label.delete_btn}" styleClass="commandExButton"
															id="deleteBtn"
															action="#{pc_PR_List.doDeletePerfilRiesgoBtnAction}"></hx:commandExButton>
