<%-- jsf:pagecode language="java" location="/src/pagecode/pages/admin/crud/perfilRiesgo/PR_New.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/theme/myTemplate.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><%@page
			...
			<h:form styleClass="form" id="form1">
												<hx:panelBox styleClass="panelBox" id="box6"
													...
													<h:outputText styleClass="myTitle" id="text2"
														value="#{label.PR_New_title}"></h:outputText>
												...
												<h:messages styleClass="messages" id="originDataPRSingleRow2messages"></h:messages><hx:panelFormBox helpPosition="over" labelPosition="left" styleClass="panelFormBox" id="formBox1">
														<hx:formItem styleClass="formItem" id="formItem3" label="Nombre:" showHelp="info">
														<h:inputText styleClass="inputText" id="nombre1"
															value="#{pc_PR_New.originDataPRSingleRow.Nombre}" required="true" maxlength="25">
															<f:validateLength maximum="25"></f:validateLength>
														</h:inputText>
														<h:message for="nombre1" styleClass="message"></h:message>
													</hx:formItem>
														<hx:formItem styleClass="formItem" id="formItem2" label="Desde:" showHelp="info">
														<h:inputText styleClass="inputText" id="desde1"
															value="#{pc_PR_New.originDataPRSingleRow.Desde}" required="true">
															<hx:convertNumber integerOnly="true"/>
															<hx:inputHelperSpinner id="spinner1" />
														</h:inputText>
														<h:message for="desde1" styleClass="message"></h:message>
													</hx:formItem>
													<hx:formItem styleClass="formItem" id="formItem4" label="Hasta:" showHelp="info">
														<h:inputText styleClass="inputText" id="hasta1"
															value="#{pc_PR_New.originDataPRSingleRow.Hasta}" required="true">
															<hx:convertNumber integerOnly="true"/>
													...
													<hx:commandExButton type="submit"
														value="#{label.create_btn}" styleClass="commandExButton"
														id="okBtn"
														action="#{pc_PR_New.doOriginDataPRSingleRowUpdateAction}"></hx:commandExButton>
													<hx:commandExButton type="reset" value="#{label.reset_btn}"
														styleClass="commandExButton" id="resetBtn"></hx:commandExButton>
													<hx:commandExButton type="submit"
														value="#{label.cancel_btn}" styleClass="commandExButton"
														id="cancelBtn" action="#{pc_PR_New.doCancelBtnAction}"></hx:commandExButton>
												</hx:panelBox>
