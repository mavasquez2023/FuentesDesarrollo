  ...
  <g id="svg_21">
   ...
   <text stroke="#003f7f" transform="matrix(3.4442861563765934,0,0,2.0447679395653884,-394.7044206094649,-269.09630682566683) " xml:space="preserve" text-anchor="middle" font-family="Open Sans" font-size="24" id="svg_20" y="227" x="140" stroke-linecap="null" stroke-linejoin="null" stroke-dasharray="null" stroke-width="0" fill="#003f7f">SIL</text>
          ...
          <div class="col xs12 lg10">
            ...
            <div class="separador"></div>
            <form class="form" id="paso3" action="guardarLicencia.do">
            <p><strong>Información del Afiliado</strong></p>
             ...
             <div class="separador"></div>
             <p><strong>REMUNERACIONES NO CONSIDERADAS EN LA BASE DE CÁLCULO</strong></p>
             <p>Origen renta utilizada:<strong> ${origen_rentas}</strong></p>
             <c:if test="${origen_rentas=='Liquidaciones'}">
             <c:forEach var="renta"  varStatus="vs" items="${rentas}">
              <div class="row">
              	<div class="col xs12 lg2">
                  <div class="form__grupo" data-animacion="placeholder" 
                  <c:if test='${vs.index==0}'>
                  	data-comentario="Ej: 201906"
                  </c:if>
                  >
                  <input class="text tipo_numerico" type="text" id="mes" name="mes" value="${renta.periodo}" maxlength="6"/>
                    <label for="mes">Mes</label>
                  </div>
                </div>
               <div class="col xs12 lg2">
                  <div class="form__grupo" data-animacion="placeholder">
                  <input class="text tipo_monto" type="text" id="monto" name="monto" value="${renta.monto}" maxlength="9"/>
                    <label for="monto">Monto</label>
                  </div>
                </div>
              <div class="col xs12 lg4">
                  <div class="form__grupo" data-animacion="placeholder">
                  <input class="text" type="text" id="motivo" name="motivo" value="${renta.motivo}" />
                    <label for="motivo">Detalle/Motivo</label>
                  </div>
                </div>
              </div>
              </c:forEach>
              <c:if test="${licencia.tipoLicencia==1 }">
              <p>Rentas Maternal</p>
              <c:forEach var="renta"  varStatus="vs" items="${rentas_maternales}">
              <div class="row">
              	<div class="col xs12 lg2">
                  <div class="form__grupo" data-animacion="placeholder">
                  <input class="text tipo_numerico" type="text" id="mes_maternal" name="mes_maternal" value="${renta.periodo}" maxlength="6"/>
                    <label for="mes_maternal">Mes</label>
                  </div>
                </div>
               <div class="col xs12 lg2">
                  <div class="form__grupo" data-animacion="placeholder">
                  <input class="text tipo_monto" type="text" id="monto_maternal" name="monto_maternal" value="${renta.monto}" maxlength="9"/>
                    <label for="monto_maternal">Monto</label>
                  </div>
                </div>
                <div class="col xs12 lg4">
                  <div class="form__grupo" data-animacion="placeholder">
                  <input class="text" type="text" id="motivo_maternal" name="motivo_maternal" value="${renta.motivo}" maxlength="100"/>
                    <label for="motivo_maternal">Detalle/Motivo</label>
                  </div>
                </div>
              </div>
              </c:forEach>
              ...
              <div class="alerta alerta--error" id="errores_paso3" style="display:none"></div>
                  <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="#" onClick="validarPaso3(); return false;">Aceptar</a>
          	</div>
          </form>
        </div>
      </div>
