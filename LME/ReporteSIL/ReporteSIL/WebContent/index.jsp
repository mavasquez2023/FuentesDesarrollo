  ...
  <g id="svg_21">
   ...
   <text stroke="#003f7f" transform="matrix(3.4442861563765934,0,0,2.0447679395653884,-394.7044206094649,-269.09630682566683) " xml:space="preserve" text-anchor="middle" font-family="Open Sans" font-size="24" id="svg_20" y="227" x="140" stroke-linecap="null" stroke-linejoin="null" stroke-dasharray="null" stroke-width="0" fill="#003f7f">SIL</text>
          ...
          <div class="col xs12 lg10">
            ...
            <div class="separador"></div>
            <p>Ingresa un RUT y rango de fecha licencias</p>
            <div class="separador"></div>
            <div class="row">
              <div class="col xs12 lg6">
                <form class="form" id="paso1" action="validaAfiliado.do">
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Sin puntos ni guión. Ej: 12345678K">
                    <input class="text requerido tipo_rut" type="text" id="rut" name="rut" value="${rut}" maxlength="12" onblur="this.value"/>
                    <label for="rut">RUT</label>
                  </div>
                  <c:if test='${errorMsg=="rut_error" }'>
                  <div class="alerta alerta--error">El RUT ingresado no se encuentra afiliado a La Araucana. Por favor, comuníquese con nuestro Call Center <strong>600 4228 100</strong></div>
                  </c:if>
                  <c:if test='${errorMsg=="cedula_error" }'>
                  <div class="alerta alerta--error">La cédula ingresada no se encuentra vigente en Sinacofi. Por favor, comuníquese con nuestro Call Center <strong>600 4228 100</strong></div>
                  </c:if>
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Formato dd/mm/aaaa Ej: 01/12/2018" style="position:relative">
                    <input class="text requerido tipo_fecha" type="text" id="fecha_desde" name="fecha_desde" maxlength="10" onkeyup="formateaFecha(this);"/>
                    <label for="fecha_desde">Fecha Desde</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Formato dd/mm/aaaa Ej: 30/12/2018" style="position:relative">
                    <input class="text tipo_fecha" type="text" id="fecha_hasta" name="fecha_hasta" maxlength="10" onkeyup="formateaFecha(this);"/>
