...
/*!
 * Funciones exclusivas de la librerí de FLN
...
/**
 * Objeto que contiene todas las funcionalidades de la librerí
 * @type {object}
 * @memberof variables_globales
 * @instance
 */
...
fln.scrolling = function() {
  ...
  if (typeof fun === 'function') {
    ...
    console.warn('fln.scrolling(Â¿function?) : Se debe pasar una función como argumento');
  }
};
/**
 ...
 * @param {number} delay Retraso para que se ejecutÃ© la función
 */
...
/**
 * Objeto con varios mÃ©todos y propiedades de utilidades para los botones
 * @function
 * @memberof botones
 ...
 * @property {method} init Da inicio a los mÃ©todos de "fln.botones" y además incluye la función de animacion Ripple 
 */
