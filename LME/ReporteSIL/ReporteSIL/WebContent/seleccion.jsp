...
<html lang="es">
  <head>
    ...
    <script>
      ...
      function seleccionLicencia(licencia){
  ...
  <g id="svg_21">
   ...
   <text stroke="#003f7f" transform="matrix(3.4442861563765934,0,0,2.0447679395653884,-394.7044206094649,-269.09630682566683) " xml:space="preserve" text-anchor="middle" font-family="Open Sans" font-size="24" id="svg_20" y="227" x="140" stroke-linecap="null" stroke-linejoin="null" stroke-dasharray="null" stroke-width="0" fill="#003f7f">SIL</text>
          ...
          <div class="col xs12 lg10">
            ...
            <div class="separador"></div>
            <form class="form" id="paso2" action="seleccionLicencia.do">
            ...
            <div class="separador"></div>
              ...
              <div class="separador"></div>
              <p><strong>Listado de Licencias Médicas</strong></p>
               <div class="separador"></div>
              <div class="row">
              	<div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="numlic"><strong>Nro. Licencia</strong></label>
                  </div>
                </div>
                <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="fecini"><strong>Fecha Inicio</strong></label>
                  </div>
                </div>
                <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="fecter"><strong>Fecha Término</strong></label>
                  </div>
                </div>
               <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="numdia"><strong>Nro. Días</strong></label>
                  </div>
                </div>
                <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
              ...
              <div class="row">
                  ...
                  <div class="form__seleccion">
                    <label for="numlic"><a class="link-externo" href="#" onclick="seleccionLicencia('${licencia.numinterno}${licencia.fechaHastaStr }')">${licencia.licencia}</a></label>
                  </div>
                </div>
                <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="fecini">${licencia.fechaDesdeStr }</label>
                  </div>
                </div>
                <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="fecter">${licencia.fechaHastaStr}</label>
                  </div>
                </div>
               <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="numdia">${licencia.dias}</label>
                  </div>
                </div>
                <div class="col xs12 lg2">
                  <div class="form__seleccion" data-animacion="placeholder">
                    <label for="estado">${licencia.estado}</label>
                  </div>
                </div>
              </div>
              </c:forEach>
              <div class="separador"></div>
              <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario btn--borde" href="#" onClick="volver(); return false;">Volver</a>
