		...
		<c:choose>
		   <c:when test="${KeyErrores==false}">
					...
					<script>
						$(document).ready(function(){
        					...
        					buttons["Aceptar"] = function() {
        						...
        						$("#dialog_form_log_"+plano).dialog( "close" );
        					};
        					
        					$("#dialog_form_log_"+plano).dialog({buttons:buttons});
        				});
					</script>
		    ...
		    <form action="" name="form_mantenedor_SIL" id="form_mantenedor_SIL">
		        ...
		        <div class="visorForm">
		        	<div class="campoForm">
						<label class="lbl_numero" >( )</label>
						<label class="lbl_nombre" >Folio de pago</label>
						<input class="txt_campo" id="pagfol" name="pagfol" value="${registro_SIL.pagfol}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="lichasfec" name="lichasfec" value="${registro_SIL.lichasfec}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="codope" name="codope" value="${registro_SIL.codope}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="tpofor" name="tpofor" value="${registro_SIL.tpofor}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="nrofol" name="nrofol" value="${registro_SIL.nrofol}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="ruttrabaj" name="ruttrabaj" value="${registro_SIL.ruttrabaj}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="fecemi" name="fecemi" value="${registro_SIL.fecemi}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="diasub" name="diasub" value="${registro_SIL.diasub}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="mtoliq" name="mtoliq" value="${registro_SIL.mtoliq}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="mtocot" name="mtocot" value="${registro_SIL.mtocot}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="codint" name="codint" value="${registro_SIL.codint}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="finipa" name="finipa" value="${registro_SIL.finipa}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="mocope" name="mocope" value="${registro_SIL.mocope}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="baseca" name="baseca" value="${registro_SIL.baseca}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="idlice" name="idlice" value="${registro_SIL.idlice}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="inimes" name="inimes" value="${registro_SIL.inimes}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="tpolic" name="tpolic" value="${registro_SIL.tpolic}">
				...
				<div class="visorForm">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="ndicot" name="ndicot" value="${registro_SIL.ndicot}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="ndiinc" name="ndiinc" value="${registro_SIL.ndiinc}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="ndipag" name="ndipag" value="${registro_SIL.ndipag}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="mtsbpa" name="mtsbpa" value="${registro_SIL.mtsbpa}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="mtsbdi" name="mtsbdi" value="${registro_SIL.mtsbdi}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="mcsegc" name="mcsegc" value="${registro_SIL.mcsegc}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="motcot" name="motcot" value="${registro_SIL.motcot}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="ofipgo" name="ofipgo" value="${registro_SIL.ofipgo}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="ccopgo" name="ccopgo" value="${registro_SIL.ccopgo}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="inssal" name="inssal" value="${registro_SIL.inssal}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="submat" name="submat" value="${registro_SIL.submat}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="tpoliq" name="tpoliq" value="${registro_SIL.tpoliq}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="fecpgo" name="fecpgo" value="${registro_SIL.fecpgo}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="mliqpa" name="mliqpa" value="${registro_SIL.mliqpa}">
					...
					<div class="campoForm">
						...
						<input class="txt_campo" id="rimpms" name="rimpms" value="${registro_SIL.rimpms}">
