...
public class EndPointUtil {
	...
	private static Map<String, String> endPointsDbMap = new HashMap<String, String>();
	private static Map<String, String> endPointsPropertiesMap = new HashMap<String, String>();
	public static Map<String, String> endPointsCompletoMap = new HashMap<String, String>();
	private static Map<String, Boolean> erroresPorOperadorMap = new HashMap<String, Boolean>();
	...
	private void cargarParametrosDb() throws Exception {
		...
		endPointsDbMap= DAOFactory.getDaoFactory().getServIngresoDao().getEndPoints();
	}
	...
	private void cargarParametrosProperties() {
		...
		endPointsPropertiesMap.put(operadorMediPass + ",ZONA_C," + prioridadProperties, Config.getConfig("medipass.ZONA_C"));
		endPointsPropertiesMap.put(operadorImed + ",ZONA_C," + prioridadProperties, Config.getConfig("imed.ZONA_C"));
	}
	...
	private void cargarParametrosGenerales() {
		operadorMediPass = Config.getConfig("codigo.medipass");
		operadorImed = Config.getConfig("codigo.imed");
		prioridadDb = Config.getConfig("prioridad.db");
		prioridadProperties = Config.getConfig("prioridad.properties");
	}
