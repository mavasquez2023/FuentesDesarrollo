...
public class ConstantesWS {
  ...
  public static final String LINEA_CRED_ESP = resource.getString("queryContractHeader.comercialLine.credito");
  ...
  //Códigos de respuesta ConsultaDatosCliente
  ...
  //nombre de usuario y contraseña para validar el servicio de Autenticacion LDAP
  ...
  /**
   * Obtiene límites superiores de intervalos de cuotas para obtener tasas de interés
   * 
   * @param codigo
   * @return
   */
