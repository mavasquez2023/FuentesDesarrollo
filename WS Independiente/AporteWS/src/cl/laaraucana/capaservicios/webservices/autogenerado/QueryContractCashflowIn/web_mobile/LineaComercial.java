 ...
 */
            ...
            /**
            *  LineaComercial bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LineaComercial
                           ...
                           */
                           public  java.lang.String getLineaComercial(){
                            ...
                            public java.lang.String toString(){
                                        ...
                                        return localLineaComercial.toString();
                               ...
                               if (serializeType){
                                   ...
                                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           namespacePrefix+":LineaComercial",
                                           xmlWriter);
                                   } else {
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           "LineaComercial",
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                 return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLineaComercial)
                            },
                            null);
    ...
    public static class Factory{
                ...
                public static LineaComercial fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    LineaComercial returnValue = new  LineaComercial();
                    
                            returnValue.setLineaComercial(
                ...
                public static LineaComercial fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return LineaComercial.Factory.fromString(content,namespaceUri);
                    } else {
                       return LineaComercial.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static LineaComercial parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LineaComercial object =
                new LineaComercial();
