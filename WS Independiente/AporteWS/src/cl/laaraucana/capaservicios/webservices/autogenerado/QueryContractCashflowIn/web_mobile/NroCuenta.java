 ...
 */
                           ...
                           */
                           public  java.lang.String getNroCuenta(){
                            ...
                            public java.lang.String toString(){
                                        ...
                                        return localNroCuenta.toString();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                 return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNroCuenta)
                            },
                            null);
    ...
    public static class Factory{
                ...
                public static NroCuenta fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    NroCuenta returnValue = new  NroCuenta();
                    
                            returnValue.setNroCuenta(
                ...
                public static NroCuenta fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return NroCuenta.Factory.fromString(content,namespaceUri);
                    } else {
                       return NroCuenta.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static NroCuenta parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NroCuenta object =
                new NroCuenta();
