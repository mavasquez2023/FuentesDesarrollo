...
public class App3 {
	...
	public static void main(String[] args) {
	    ...
	    product.setUser_transaction_code("5012342");
	    product.setProduct_code("A682452");
	    product.setProduct_description("Gift Card $10.000");
	    product.setReceptor_name("Nombre Receptor");
	    product.setReceptor_rut("1234567890");
	    product.setReceptor_email("heralexis2000@gmail.com");
	    product.setStock("23");
