...
public class ActualizarDatosAction extends DispatchAction {
	...
	/**
	 * carga el formulario disponible para actualizar los datos con la informacion
	 * actual del usuario
	 * 
	 * @param mapping
	 * @param form
	...
	public ActionForward cargaInfo(ActionMapping mapping, ActionForm form, HttpServletRequest request,
