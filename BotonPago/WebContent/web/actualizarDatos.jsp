				...
				<form id="formulario" action="actualizaDatos.do?op=updateInfo"
					...
					<table class="formH">
						<tr>
							...
							<td><label style="display: none" for="recibirECVM">Recibir&nbsp;estado&nbsp;de&nbsp;cuenta&nbsp;vía&nbsp;email</label><br>
								<c:if test="${empty datosDeudor.envecta}">
									<input style="display: none"  type="checkbox" value="S" name="recibirECVM">
								</c:if> <c:if test="${not empty datosDeudor.envecta}">
									<input style="display: none" type="checkbox" value="S"  
										name="recibirECVM">
								</c:if></td>
						</tr>
						<tr>
