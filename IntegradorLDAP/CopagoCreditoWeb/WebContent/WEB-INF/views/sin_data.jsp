        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">No existe información asociada a tu cuenta!</h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Cualquier duda puedes llamar al Call Center <br> La ARAUCANA 600 4228 100.</p>
            </div>
