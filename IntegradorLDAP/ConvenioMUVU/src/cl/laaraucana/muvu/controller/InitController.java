...
public class InitController {
	...
	public String ejecutaSincronizacion(ModelMap model, @RequestParam(required = false) String periodo, HttpServletRequest request, HttpServletResponse response) {
		try {
			// Como String para poder correrlo manual pasando parámetro.
			if(periodo == null) {
				periodo = UtilsFecha.getFechaPeriodo();
			}
	...
	public String inscripcionConvenio(ModelMap model, @RequestParam("correo") String correo, HttpServletRequest request,
	...
	public String login(ModelMap model, @RequestParam("rut") String rut, HttpServletRequest request,
			HttpServletResponse response) {
	...
	public String bienvenida(ModelMap model, @ModelAttribute LoginVO form, HttpServletRequest request,
			HttpServletResponse response) {
		...
		try {
			...
			if (resultado.equals("OK")) {
				...
				mailService
						.sendEmailClie(data_afiliado.getEmail(), Configuraciones.getConfig("mail.asunto.cliente"),
								Utils.emailCliente(data_afiliado.getNombre(),
										Configuraciones.getConfig("url.cliente.condiciones")),
								data_afiliado.getRut(), null);
			} else {
