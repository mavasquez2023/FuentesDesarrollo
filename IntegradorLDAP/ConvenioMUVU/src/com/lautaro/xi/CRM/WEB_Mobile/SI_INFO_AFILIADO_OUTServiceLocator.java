...
public class SI_INFO_AFILIADO_OUTServiceLocator extends org.apache.axis.client.Service implements com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTService {
    ...
    public com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUT getHTTPS_Port() throws javax.xml.rpc.ServiceException {
    ...
    public com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUT getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub _stub = new com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub(portAddress, this);
    ...
    public com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUT getHTTP_Port() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUT getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub _stub = new com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUT.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub _stub = new com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUT.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub _stub = new com.lautaro.xi.CRM.WEB_Mobile.SI_INFO_AFILIADO_OUTBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
