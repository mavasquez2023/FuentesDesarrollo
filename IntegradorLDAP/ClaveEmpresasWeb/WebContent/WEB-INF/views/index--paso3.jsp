...
<html lang="es">
  ...
  <body>
    <main>
          ...
          <div class="col xs12 lg10">
            ...
            <div class="row">
              <div class="col xs12 lg6">
                <form class="form" action="/ClaveEmpresasWeb/paso4" method="post" enctype="multipart/form-data" id="paso3">
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Sin puntos ni guión. Ej: 12345678k">
                    <input class="text requerido tipo_rut" type="text" id="rut" name="rutRepr" maxlength="12"/>
                    <label for="rut">RUT Rep. Legal</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text requerido tipo_texto" type="text" id="nombre" name="nomRepr" data-minlength="3" maxlength="80"/>
                    <label for="nombre">Nombre Rep. Legal</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text requerido tipo_texto" type="text" id="apellido-paterno" name="apePatRepr" data-minlength="3" maxlength="80"/>
                    <label for="apellido-paterno">Apellido Paterno Rep. Legal</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text tipo_texto" type="text" id="apellido-materno" name="apeMatRepr" data-minlength="3" maxlength="80"/>
                    <label for="apellido-materno" data-comentario="(Opcional)">Apellido Materno Rep. Legal</label>
                  </div>
                  <div class="documento">
                    <div class="documento__item"><span class="documento__tipo"></span><span class="documento__nombre"><span class="documento__nombre__text">Adjuntar archivo (.pdf)</span><span class="documento__icono fln-subir-light"></span><a class="documento__eliminar" href="#" onclick="limpiar(this); return false;"><span>+</span></a></span>
                      <input class="requerido documento__input" type="file" id="documento-pdf" name="fichero" accept=".pdf" data-maxsize="5000" data-formatos="pdf"/>
                    </div>
                    <p class="adicional adicional--dos">Peso m&aacute;ximo del archivo 5 MB</p>
                    <p class="adicional adicional--dos">Debe adjuntar Solicitud de Clave completada y firmada</p>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <textarea id="textarea-simple" name="mensaje" cols="30" rows="10"></textarea>
                    <label for="textarea" data-comentario="(Opcional)">Mensaje</label>
                  </div>
                  <div class="separador"></div>
                  <div class="captcha" id="captcha"></div>
                  <div class="separador"></div>
                  <div class="alerta alerta--error" id="errores_paso3" style="display:none"></div>
                  <div class="btn__grupo text-align-right-md text-align-center-xs"><a class="btn btn--primario validar3" href="#" onClick="volverPaso2(); return false;">Volver</a>&nbsp;&nbsp;<a class="btn btn--primario validar3" href="#" onClick="validarPaso3(); return false;">Enviar</a>
                  </div>
                </form>
              </div>
              <div class="col xs12 lg6">
                      ...
                      <div class="bloque__item">
                        ...
                        <div class="row">
                         <div class="col xs12 lg12 xl6">
                            <p class="bloque__texto bloque__texto__descarga">Si requieres una sola clave.</p>
                            <a class="bloque__descarga" href="<%=request.getContextPath() %>/resources/pdf/Sol_Clave_Empresa.pdf" target="_blank">Descargar aqu&iacute;­ <span class="icon fln-descargar"></span></a>
                          </div>
                          <div class="col xs12 lg12 xl6">
                            <p class="bloque__texto bloque__texto__descarga">Si se requiere más de una clave como Encargado o perteneces a un holding y necesitas acceder a la información de todas las empresas asignadas.</p>
                            <a class="bloque__descarga" href="<%=request.getContextPath() %>/resources/pdf/Sol_Clave_Holding.pdf" target="_blank">Descargar aqu&iacute;­ <span class="icon fln-descargar"></span></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col xs12 md12">
                      <div class="bloque__item">
                        <div class="bloque__cabecera">
                          ...
                          <p class="bloque__texto">Imprime la <b>solicitud</b> y completa los datos requeridos, incluyendo la autorización del representante legal u otra persona con <b>firma certificada ante la caja</b>.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col xs12 md12">
                      <div class="bloque__item">
                        <div class="bloque__cabecera">
                          ...
                          <p class="bloque__texto">Escanee la <b>solicitud</b> y guarda el archivo en formato <b>PDF</b>.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col xs12 md12">
                      <div class="bloque__item">
                        <div class="bloque__cabecera">
                          ...
                          <p class="bloque__texto">Sube la <b>solicitud en pdf</b> y presiona Enviar.</p>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="alerta__contenedor alerta__contenedor--fixed-bottom">
        <div class="alerta alerta--global" id="alerta-general" style="display:none"></div>
      </div>
    </main>
    <script>
      ...
      var onloadCallback = function() {
        if (_captcha) {
          grecaptcha.render(_captcha, {
            'sitekey': '<%=cl.araucana.spring.utils.Configuraciones.getConfig("servicios.recaptcha.key")%>',
    ...
    <script src="<%=request.getContextPath() %>/resources/assets/js/jquery.Rut.min.js"></script>
