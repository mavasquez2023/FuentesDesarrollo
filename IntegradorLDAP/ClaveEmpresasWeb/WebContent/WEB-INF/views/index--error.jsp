        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg8">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Ha ocurrido un error</h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente la solicitud no ha sido recibida.</p>
            </div>
            <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="https://www.laaraucana.cl/">Ir al home</a><a class="btn btn--primario" href="<c:url value="/" />">Reintentar</a>
            </div>
          </div>
        </div>
      </div>
