    ...
    <main>
      <div class="container">
        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg8">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Solicitud Enviada Exitosamente</h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente hemos recibido su solicitud de clave empresa de sucursal virtual <span class="bold">Mi Araucana</span>, pr&oacute;ximamente ser&aacute; remitida la clave al correo electr&oacute;nico ingresado.</p>
            </div>
            <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="https://www.laaraucana.cl/">Ir al home</a>
            </div>
          </div>
        </div>
      </div>
