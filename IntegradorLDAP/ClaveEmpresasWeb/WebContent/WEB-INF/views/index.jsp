          ...
          <div class="col xs12 lg10">
            ...
            <div class="row">
              <div class="col xs12 lg6">
                <form class="form" action="/ClaveEmpresasWeb/paso2" method="post" id="paso1">
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Sin puntos ni guión. Ej: 12345678k">
                    <input class="text requerido tipo_rut" type="text" id="rut" name="rut" value="${paso2.rut}" maxlength="12" />
                    <label for="rut">RUT</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text requerido tipo_texto" type="text" id="nombre" name="nombre" value="${paso2.nombre}" data-minlength="3" maxlength="80"/>
                    <label for="nombre">Nombre</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text requerido tipo_texto" type="text" id="apellido-paterno" name="apePat" value="${paso2.apePat}" data-minlength="3" maxlength="80"/>
                    <label for="apellido-paterno">Apellido Paterno</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text tipo_texto" type="text" id="apellido-materno" name="apeMat" value="${paso2.apeMat}" data-minlength="3" maxlength="80"/>
                    <label for="apellido-materno" data-comentario="(Opcional)">Apellido Materno</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: +56221234567">
                    <input class="text tipo_fono tipo_numerico" type="text" id="telefono" name="telefono" value="${paso2.telefono}" data-prefijo="+56" data-prefijo-tipo="fijo" data-minlength="12" maxlength="12"/>
                    <label for="telefono">Teléfono</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: +56991234567">
                    <input class="text tipo_fono tipo_numerico" type="text" id="celular" name="celular" value="${paso2.celular}" data-prefijo="+569" data-prefijo-tipo="celular" data-minlength="12" maxlength="12"/>
                    <label for="celular">Celular</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: nombre@correo.cl">
                    <input class="text requerido tipo_email" type="text" id="email" name="email" value="${paso2.email}"/>
                    <label for="email">Email Institucional</label>
                  </div>
                  <div class="separador"></div>
                  <div class="alerta alerta--error" id="errores_paso1" style="display:none"></div>
                  <div class="btn__grupo text-align-right-md text-align-center-xs"><a class="btn btn--primario" href="#" onClick="validarPaso1(); return false;" >Siguiente</a>
              ...
              <div class="col xs12 lg6">
                <div class="bloque">
                  <h4 class="bloque__titulo color--secundario">Para solicitar tu <span class="bold">clave de empresa</span> sigue los siguientes pasos:</h4>
                    ...
                    <div class="col xs12 md12">
                      <div class="bloque__item">
                        <div class="bloque__cabecera">
                          ...
                          <p class="bloque__texto bloque__texto__titulo">Descarga tu <b>solicitud</b>:</p>
                        </div>
                        <div class="row">
