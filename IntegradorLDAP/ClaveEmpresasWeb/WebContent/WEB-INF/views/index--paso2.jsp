              ...
              <div class="col xs12 lg6">
                <form class="form" action="/ClaveEmpresasWeb/paso3" method="post" id="paso2">
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Sin puntos ni guión. Ej: 12345678k">
                    <input class="text requerido tipo_rut" type="text" id="rut" name="rutemp" value="${paso3.rutemp}" maxlength="12"/>
                    <label for="rut">RUT Empresa</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder">
                    <input class="text requerido tipo_texto" type="text" id="nombre" name="nomEmp" value="${paso3.nomEmp}" data-minlength="3" maxlength="80"/>
                    <label for="nombre">Nombre Empresa</label>
                  </div>
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: +56221234567">
                    <input class="text tipo_fono tipo_numerico" type="text" id="telefono" name="telEmp" value="${paso3.telEmp}" data-prefijo="+56" data-prefijo-tipo="fijo" data-minlength="12" maxlength="12"/>
                  ...
                  <div class="btn__grupo text-align-right-md text-align-center-xs"><a class="btn btn--primario" href="#" onClick="volverPaso1(); return false;">Volver</a>&nbsp;&nbsp;<a class="btn btn--primario" href="#" onClick="validarPaso2(); return false;">Siguiente</a>
                  </div>
                </form>
              </div>
              <div class="col xs12 lg6">
