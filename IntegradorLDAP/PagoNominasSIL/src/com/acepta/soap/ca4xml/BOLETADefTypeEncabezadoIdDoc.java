...
public class BOLETADefTypeEncabezadoIdDoc  implements java.io.Serializable {
     ...
     * 
     * @return folio   * Folio del Documento Electronico
     */
     ...
     * 
     * @param folio   * Folio del Documento Electronico
     */
     ...
     * 
     * @return fchEmis   * Fecha Emision Contable del DTE (AAAA-MM-DD)
     */
     ...
     * 
     * @param fchEmis   * Fecha Emision Contable del DTE (AAAA-MM-DD)
     */
     ...
     * 
     * @return indServicio   * Indica el Tipo de Transaccion
     */
     ...
     * 
     * @param indServicio   * Indica el Tipo de Transaccion
     */
     ...
     * 
     * @return indMntNeto   * Indica el Uso de Montos Netos en Detalle
     */
     ...
     * 
     * @param indMntNeto   * Indica el Uso de Montos Netos en Detalle
     */
     ...
     * 
     * @return periodoDesde   * Periodo de Facturacion - Desde (AAAA-MM-DD)
     */
     ...
     * 
     * @param periodoDesde   * Periodo de Facturacion - Desde (AAAA-MM-DD)
     */
     ...
     * 
     * @return periodoHasta   * Periodo Facturacion - Hasta (AAAA-MM-DD)
     */
     ...
     * 
     * @param periodoHasta   * Periodo Facturacion - Hasta (AAAA-MM-DD)
     */
     ...
     * 
     * @return fchVenc   * Fecha de Vencimiento del Pago (AAAA-MM-DD)
     */
     ...
     * 
     * @param fchVenc   * Fecha de Vencimiento del Pago (AAAA-MM-DD)
     */
