...
if(formulario=="consulta"){
	...
	if($("#razonSocialEmpresa").val()!="" || $("#observaciones").html()!=""){
		...
		$("#clave").val("");
		$("#credential").val("");
}else if(formulario=="consulta_anexo"){
	if($("#razonSocialAnexo").val()!="" || $("#observaciones").html()!=""){
		$('#frme input[type="text"]').each(function(){
      		$(this).val("");  
  		});
  		$('#frme input[type="radio"]').each(function(){
  		...
  		$("#consultar_anexo").css("visibility", "visible");
  		$("#consultar_encargados_anexo").css("visibility", "hidden");
		$("#guardar_anexo").css("visibility", "hidden");
		$("#agregar_encargado_anexo").css("visibility", "hidden");
		$("#nuevoanx").val("");
		$("#rutanexo").removeAttr("disabled");
		$("#razonSocialAnexo").removeAttr("disabled");
		$("#rutanexo").focus();
	}
}
	return;
