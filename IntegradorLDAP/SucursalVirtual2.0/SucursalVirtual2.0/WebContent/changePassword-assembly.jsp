...
type="button" value="Cancelar" name="cancelar" /></td>
    ...
    <div class="grid_4 omega">
      <div class="pad_caja">Ingrese su clave actual y nueva clave de 4 digitos.</div></div>
    <div style="clear:left;"></div>
    </div>
    <div class="grid_3 borde3 omega" style="height:143px;">
      <div class="pad_caja"> <img src="images/sobre.gif" width="19" height="15" class="aleft" /><a href="#">Consultas<br />
        sugerencias o reclamos</a></div>
          <div class="hr"></div>
