...
<div id="content" class="container_12">
  <div class="grid_12">
    ...
    <div class="mensaje bg_gris">   <% if (initialChange) { %>
		Estimado usuario, Usted ha ingresado al sistema por primera vez. Por razones de seguridad es obligatorio que usted cambie su clave actual por una nueva clave de 4 dígitos.
	<% } else { %>
		Señor usuario: si desea cambiar su clave, proceda según lo siguiente
	<% } %></div>
...
type="button" value="Cancelar" name="cancelar" /></td>
    ...
    <div class="grid_3 borde3 omega">
        <div class="pad_caja"><img src="images/sobre.gif" width="19" height="15" class="aleft" /><a href="http://146.83.1.194:50000/irj/go/km/docs/documents/corpsite/personas/inicio/LinksCabecera/Contactenos">Consultas<br />
