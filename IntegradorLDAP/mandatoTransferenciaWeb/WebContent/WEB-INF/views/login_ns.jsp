...
<title>Login Mandato Transferencia - La Araucana</title>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col xs12 lg10">
						...
						<div class="col xs12 sm12 md4 oculto-xs block-md">
							<div
								...
								<div class="pasos__data">
									<span>Login</span>MANDATO TRANSFERENCIA
								</div>
							</div>
						</div>
				...
				<p style="margin-top: 10px">Ingresa tu RUT y Número Serie para acceder al sistema</p>
				 
				<form class="form" id="paso1" action="init.do" method="POST">
					<div class="row">
						 			
						<div class="col xs12 lg10">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="Sin puntos ni guión. Ej: 12345678K">
								<input class="text requerido tipo_rut" type="text" id="rut" name="rutAfiliado"
									value="" maxlength="12" autocomplete="off" /> <label for="rut">RUT</label>
							</div>
						</div>
					</div>
					
					<c:if test='${errorMsg=="serie_error" }'>
								<div class="alerta alerta--error" id="aviso" style="margin-top: 10px; margin-bottom: 10px">
					...
					<c:if test='${errorMsg=="servicio_error" }'>
								<div class="alerta alerta--error" id="aviso" style="margin-top: 10px; margin-bottom: 10px">
									Error de comunicación del servicio, intenta nuevamente.
								</div>
								<script>
                  				setTimeout('$("#aviso").fadeOut()', 5000);
                  				</script>
						...
						<div class="col xs12 lg10">
									<div class="form__grupo" data-animacion="placeholder"
										...
										<input class="text requerido" type="text" id="serie"
											name="serie" value="" maxlength="10" onkeypress="validarEnter();"/> <label for="serie">Número
					...
					<div class="alerta alerta--error" id="errores_paso1" style="display: none;margin-top: 5px; margin-bottom: -0px"></div>
					 <div class="col xs12 lg8">
					<div class="captcha" id="captcha" style="margin-top: 10px"></div>
					</div>
                   <div class="col xs12 lg12">
					<div class="btn__grupo text-align-center-xs" style="margin-top: 15px">
						
						<a id="login" style="margin-left: 20px" class="btn btn--primario" href="#" onclick="validarPaso1();"
						>Ingresar</a>
						<br>
						<p class="adicional" style="margin-top: 10px;margin-left:-15px;font-size: medium;text-align: center">
							Si prefieres puedes ingresar con tu RUT y Contraseña &nbsp;
							<a style="color:#2072BC" href="<c:url value='login.jsp' />">aquí</a>
						</p>
					</div>
				</div>
				...
				<div class="col xs12 lg12 xl6">
                <div class="bloque">
                  <h5 class="bloque__titulo-principal" style="font-size: medium;">Al registrar tu mandato, podrás recibir  vía transferencia electrónica el pago de:</h5>
                  <div class="separador--small"></div>
                  <div class="row">
                    <div class="col xs12 md12 lg12">
                      <div class="bloque__item">
                        <div class="bloque__cabecera"><img src="img/check.png" style="width:18px;height:18px;" /></div>
                        <div class="bloque__titulo">
                          <p>Licencias Médicas </p>
                        </div>
                      </div>
                    </div>
                    <div class="col xs12 md12 lg12">
                  ...
                  <p class="bloque__titulo-principal" style="font-size: medium;">Si tu licencia médica está pendiente de pago y los datos de tu cuenta están correctos, la transferencia se hará efectiva dentro de los 6 días hábiles siguientes, contados desde la fecha de nuestra recepción</p>
