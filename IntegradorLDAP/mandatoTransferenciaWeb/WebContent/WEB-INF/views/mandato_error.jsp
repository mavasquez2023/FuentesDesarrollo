        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Ha ocurrido un error al registrar Mandato</h4>
              <div class="separador"></div>
              <p class="respuesta__texto"> Estimado cliente, hemos presentado problemas al registrar el Mandato, favor intente nuevamente o llámenos al <span class="color--secundario">600 4228 100</span></p>
