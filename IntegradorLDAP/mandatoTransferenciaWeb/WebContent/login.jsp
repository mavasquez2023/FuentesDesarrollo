	...
	<div class="container">
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<p style="margin-top: 10px">Ingresa tu RUT y Contraseña para acceder al sistema</p>

				<form class="form" id="paso1" action="initMandato.do" method="POST">
					<div class="row">
					...
					<div class="row">	
						<div class="col xs12 lg10">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_numerico" type="password" id="password" name="password"
									value="" maxlength="10" onkeypress="validarEnter();" autocomplete="new-password" /> <label for="password">Contraseña</label>
							</div>
                   ...
                   <div class="col xs12 lg10">
					<div class="btn__grupo text-align-center-xs">
						...
						<p class="adicional" style="margin-top: 10px;margin-left:-15px;font-size: medium;text-align: center">
							Solicita clave &nbsp;
							<a style="color:#2072BC" href="<c:url value='<%=cl.laaraucana.transferencias.util.Configuraciones.getConfig("url.clave.persona")%>' />" target="_blank">aquí</a>
							&nbsp;|&nbsp;Recupera clave &nbsp;
							<a style="color:#2072BC" href="<c:url value='<%=cl.laaraucana.transferencias.util.Configuraciones.getConfig("url.recuperar.clave.persona")%>' />" target="_blank">aquí</a>
						</p>
					</div>
				</div>
