...
public class Utils {
	...
	private static DateFormat formatoInforme = new SimpleDateFormat("dd/MM/yy");
	...
	private static DateFormat formatoYear = new SimpleDateFormat("yyyy");
	private static DecimalFormat formateador = new DecimalFormat("###,###");
	private static DecimalFormat formateador2 = new DecimalFormat("###,###.#####");
	
	public static List<Integer> getAnios(Integer ultimoAnio) {
		List<Integer> anios = new ArrayList<Integer>();
		Integer currentYear = Integer.parseInt( formatoYear.format(new Date()));
		ultimoAnio= currentYear-ultimoAnio;
		for (Integer i = currentYear; i >= ultimoAnio; i--) {
			anios.add(i);
		}
	...
	public static String fechaWebSlash(){
		return formatoWeb2.format(new Date());
	}
	
	public static String pasaFechaInforme(String date) throws ParseException {
		java.util.Date parsedUtilDate;
		String formatStr = "";
		parsedUtilDate = formatoInforme.parse(date);
		formatStr = formatoWeb2.format(parsedUtilDate);
		return formatStr;
	}
	...
	public static String dateToperiodo(Date fecha) {
		return formatoAs400Periodo.format(fecha);
	}
	...
	public static Date periodoToDate(String periodo) throws ParseException {
