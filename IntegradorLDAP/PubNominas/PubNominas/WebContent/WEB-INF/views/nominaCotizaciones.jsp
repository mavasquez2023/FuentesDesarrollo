    ...
    <body>
        <main>
            ...
            <c:if test="${rol=='ejecutivo' || rol=='operador'}">
            	<div class="guia__container marco"> <a class="guia__link" href="<c:url  value='/init.do' />">Inicio</a><a class="guia__link--active guia__link" href="#">Declaración y Pago Cotizaciones</a></div>
            </c:if>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-xs-12">
                            <div class="contenido-dinamico">
                                <h1>Declaración y Pago Cotizaciones</h1>
                               	<div class="bloque" style="margin-top: -30px;">
                                    <form class="form" action="cotizaciones.do" id="form-nomina" method="post">
                                ...
                                <div class="tabla tabla--full tabla--borde tabla--responsive" style="margin-top: -50px;">
                                    ...
                                    <table class="nomina">
                                        ...
                                        <tbody id="nombreColumna">
											...
											<tr class="nomina">
												<td class="nomina" >${cab.periodo}</td>
												<td class="nomina" >${cab.rutEmpresa}-${cab.digEmpresa}</td>
												<td class="nomina" >${cab.razonsocial}</td>
												<td class="nomina" >${cab.codofi}</td>
												<td class="nomina" >${cab.sucursal}</td>
												<td class="nomina" >
												
												<a id="reg${numreg.count }" class="tabla__icon fln-pdf-light" href="<c:url value='/reporteCOT.do?rutemp=${cab.rutEmpresa}&periodo=${cab.periodo}&codofi=${cab.codofi}&sucursal=${cab.sucursal}'/>" onclick="lock(this, '${numreg.count}');"></a>
