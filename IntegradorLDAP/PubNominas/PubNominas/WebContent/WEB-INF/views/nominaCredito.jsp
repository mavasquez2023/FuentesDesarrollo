           ...
           <jsp:include page="banner.jsp" flush="true" />
            ...
            <div class="guia" style="margin-top: -15px;margin-bottom: -15px">
            	<c:if test="${rol=='ejecutivo' || rol=='operador'}">
            		<div class="guia__container marco"> <a class="guia__link" href="<c:url  value='/init.do' />">Inicio</a><a class="guia__link--active guia__link" href="#">Nóminas de Crédito</a></div>
            	</c:if>
            	<c:if test="${rol=='encargado'}">
            		<div class="guia__container marco"><a class="guia__link" href="<c:url  value='/sv_inicio.do' />">Servicios en Línea</a><a class="guia__link" href="<c:url  value='/sv_planillas.do' />">Emisión de Planillas</a><a class="guia__link" href="<c:url  value='/init.do' />">Inicio</a><a class="guia__link--active guia__link" href="#">Nóminas de Crédito</a> </div>
            	</c:if>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-xs-12">
                            <div class="contenido-dinamico">
                                <h1>Nóminas de Crédito</h1>
                               


                                    <form class="form" action="ArsdocQueryServlet" id="form-nomina" target="iaccion">
                                        <input type="hidden" name="_display_fields" size="100" value="Periodo,RutEmpresa:Rut Empresa,RazonSocial:Razon Social,CodigoOficina:Codigo Oficina,CodigoNomina:Codigo Nomina">
										<input type="hidden" name="_alignDisplayFields" size="100" value="Periodo:center,CodigoOficina:center,CodigoNomina:center">
										<input type="hidden" name="_folder" value="Nomina Creditos PDF: ">	
										<input type="hidden" name="_max_hits" value="200">
										<input type="hidden" name="_sort_field_order" value="Periodo:D,RutEmpresa:A,CodigoOficina:A,CodigoNomina:A">
										<input type="hidden" name="_html" value="araucana.htm">
										<input type="hidden" name="_dataTypes" size="100" value="Periodo:date,RutEmpresa:int,RazonSocial:string,CodigoOficina:int,CodigoNomina:int,Folio:int">	
										<input type="hidden" name="_dateFormats" value="Periodo:yyyyMM">
										<input type="hidden" name="_sqlOperators" size="100" value="Periodo:=,RutEmpresa:in,RazonSocial:like,CodigoOficina:=,CodigoNomina:=,Folio:=">	
										<input type="hidden" name="_nameAdditionalField" value="">
										<input type="hidden" name="_dateAdditionalField" value="">
										<input type="hidden" name="_applicationGroup" size="100" value="Nomina Creditos PDF">
										...
										<input type="hidden" name="CodigoNomina" value="${sucursal }">
