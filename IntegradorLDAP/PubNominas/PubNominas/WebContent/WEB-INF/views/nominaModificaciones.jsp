                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-xs-12">
                            <div class="contenido-dinamico" >
                                <h1>Modificaciones Cargas del Mes</h1>
                                            ...
                                            <div class="col-xs-12 col-md-6 col-lg-4">
                                                <div class="form__grupo js-periodo " data-animacion="placeholder"><span class="icono fln-abajo"></span>
                                                    <select class="requerido" name="tipomov" id="tipomov" onchange="callNominas();">
                                                        <option value="AUT">Autorizaciones Asfam</option>
                                                        <option value="MOD" selected="selected">Nómina Modificaciones Asfam</option>
                                                    </select>
                                                    <label for="tipomov"> Tipo Autorización</label>
                                                </div>
                                            </div>
                                        </div>
									...
									<tbody id="nombreColumna">
										<c:forEach items="${cabeceras}" var="cab" varStatus="numreg">
											<tr class="nomina">
												...
												<td class="nomina" >
												<a id="reg${numreg.count }" class="tabla__icon fln-pdf-light" href="<c:url value='/reporteMOD.do?rutemp=${cab.rutEmpresa}&periodo=${cab.periodo}&oficina=${cab.oficina}&sucursal=${cab.sucursal}'/>" onclick="lock(this, '${numreg.count}');"></a>
