                   ...
                   <div class="col xs12 lg6">
					<div class="btn__grupo text-align-center-xs">
						...
						<p class="adicional" style="margin-top: 10px;margin-left:-15px;font-size: medium;text-align: center">
							Solicita clave &nbsp;
							<a style="color:#2072BC" href="<c:url value='<%=cl.laaraucana.envioFormularioASFAM.util.Configuraciones.getConfig("url.clave.persona")%>' />" target="_blank">aquí</a>
							&nbsp;|&nbsp;Recupera clave &nbsp;
							<a style="color:#2072BC" href="<c:url value='<%=cl.laaraucana.envioFormularioASFAM.util.Configuraciones.getConfig("url.recuperar.clave.persona")%>' />" target="_blank">aquí</a>
						</p>
					</div>
				</div>
