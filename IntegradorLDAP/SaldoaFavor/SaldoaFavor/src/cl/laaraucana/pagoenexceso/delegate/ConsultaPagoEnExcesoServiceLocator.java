...
public class ConsultaPagoEnExcesoServiceLocator extends org.apache.axis.client.Service implements cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoService {
    ...
    public cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoDelegate getConsultaPagoEnExcesoPort() throws javax.xml.rpc.ServiceException {
    ...
    public cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoDelegate getConsultaPagoEnExcesoPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoPortBindingStub _stub = new cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoDelegate.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoPortBindingStub _stub = new cl.laaraucana.pagoenexceso.delegate.ConsultaPagoEnExcesoPortBindingStub(new java.net.URL(ConsultaPagoEnExcesoPort_address), this);
                _stub.setPortName(getConsultaPagoEnExcesoPortWSDDServiceName());
                return _stub;
            }
        }
