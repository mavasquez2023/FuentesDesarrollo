            ...
            <div class="row">
              <div class="col xs12 lg12 xl6">
                <div class="respuesta text-align-center-xs">
                  <p class="respuesta__texto">Error al consultar el RUT ingresado para verificar <span class="doble-linea">devoluciones de saldos a favor.</span></p>
                </div>
                <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="/">Volver</a>
                  <div class="separador"></div>
                </div>
              </div>
