            ...
            <div class="row">
              <div class="col xs12 lg12 xl6">
                <div class="respuesta text-align-center-xs">
                  <p class="respuesta__texto">El RUT ingresado al día <span class="destacado">${fechahoy }</span> registra un <span class="doble-linea">saldo a favor de:</span></p>
                  <p class="respuesta__valor">$<fmt:formatNumber currencyCode="$" maxFractionDigits="0"> ${consultaSF.monto }</fmt:formatNumber></p>
                  <p class="respuesta__texto">correspondiente a pagos en exceso de cuotas de crédito.</p>
                </div>
                <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="https://www.laaraucana.cl/"  target="_top">Volver</a>
                  <div class="separador"></div>
                </div>
              </div>
