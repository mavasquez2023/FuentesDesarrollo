...
var validarPaso1 = function validarPaso1(opcion) {
	...
	if ($('#check_v1').is(':checked')) {
		_check1 = true;
	}
	if ($('#check_v2').is(':checked')) {
		_check2 = true;
	}
	if ($('#check_v3').is(':checked')) {
		_check3 = true;
	}
	if(_check1 && _check2 &&_check3 || opcion=="DP"){
		_check=true;
	}
	...
	validarFormulario('paso1', {
		...
		texto : 'Debes ',
		otrosCampos : {
			'verificar condiciones' : [ _check, $('#check_v1').parent() ]
		},
...
var telefonoValido= true;
	...
	var _folio=true;
	if(folioparam!=""){
		_folio= (/^[0-9]{5,9}[-]{0,1}[0-9kK]{0,1}$/.test(folioparam ))?true:false;
	}
	validarFormulario('paso2', {
		...
		otrosCampos : {
			'Celular V�lido':  [telefonoValido,
		      			      	$('#paso2').find('.telefono')],
			'Comuna' : [ comunaSelect, $('#paso2').find('.comuna') ],
			'Region' : [ regionSelect, $('#paso2').find('.region') ],
...
var validarPaso3DocP_2 = function validarPaso3DocP_2() {
...
var validarPaso3 = function validarPaso3() {
	...
	if (imgVal == '') {
		$('#file_error1')
				.html(
						"<p style='color:red; font-size:0.8em'>Debe adjuntar su licencia</p>");
		return false;
	}
	...
	if (imgVal == '') {
		$('#file_errorC')
				.html(
						"<p style='color:red; font-size:0.8em'>Debe adjuntar licencia ZonaC</p>");
		return false;
	}
