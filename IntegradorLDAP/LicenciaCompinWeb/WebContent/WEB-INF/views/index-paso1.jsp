...
<body>
 ...
 <g>
  ...
  <path d="m16.562496,41.337509c2.6,0 4.700001,-2.099998 4.700001,-4.700001c0,-0.199997 0,-0.299999 0,-0.5l0,0c0,-0.199997 -0.1,-0.5 -0.1,-0.699997c-0.1,-0.200001 -0.1,-0.400002 -0.199999,-0.700001c-0.700001,-1.700001 -2.400002,-2.900002 -4.300001,-2.900002c-1.9,0 -3.599999,1.100002 -4.299999,2.900002c-0.1,0.200001 -0.200001,0.399998 -0.200001,0.700001c-0.099999,0.199997 -0.099999,0.5 -0.099999,0.699997c0,0.200001 0,0.300003 0,0.5c-0.2,2.600002 1.9,4.700001 4.499999,4.700001zm-1.9,-7c0.1,-0.099998 0.3,-0.200001 0.5,-0.299999c0.1,0 0.200001,-0.099998 0.3,-0.099998c0.2,-0.100002 0.400001,-0.100002 0.5,-0.200001c0.2,0 0.400001,-0.100002 0.599999,-0.100002c1.6,0 2.900002,1.300003 2.900002,2.900002c0,0.200001 0,0.400002 -0.1,0.599998c0,0.200001 -0.1,0.400002 -0.200001,0.5c0,0.100002 -0.1,0.200001 -0.1,0.300003l0,0c-0.099998,0.199997 -0.199999,0.299999 -0.299999,0.5c-0.6,0.699997 -1.4,1.099998 -2.299999,1.099998c-0.200001,0 -0.400002,0 -0.6,-0.099998c-0.200001,0 -0.400001,-0.100002 -0.5,-0.200001c-0.1,0 -0.200001,-0.100002 -0.3,-0.100002c-0.2,-0.099998 -0.3,-0.199997 -0.5,-0.299999c-0.1,-0.099998 -0.3,-0.299999 -0.400001,-0.399998c-0.099999,-0.100002 -0.2,-0.300003 -0.299999,-0.5c0,-0.100002 -0.1,-0.200001 -0.1,-0.300003c-0.1,-0.199997 -0.1,-0.399998 -0.2,-0.5c0,-0.199997 -0.1,-0.399998 -0.1,-0.599998c0.2,-0.799999 0.5,-1.599998 1.2,-2.200001z" id="svg_8"/>
				...
				<p style="margin-top: 10px; margin-bottom: 10px">Este servicio te permitirá subir  tu Licencia en forma electrónica</p>
				<form class="form" id="paso1" action="paso2.do" method="POST" >
					<div class="row">
					<c:if test="${mandato==false }">
						<div class="col xs12 lg12" id="aviso_mandato">
							<div class="alerta alerta--info" id="aviso" style="margin-top:-5px; margin-bottom: 5px; padding-top: 5px; padding-bottom: 5px">
								<b><h4>Solicita transferencia electrónica:</h4></b>
								<b><ul><li><img src="img/check.png" style="width:18px;height:18px;" />&nbsp;Recibe el pago de tu licencia en tu cuenta rut o cuenta corriente</li>
								<li><img src="img/check.png" style="width:18px;height:18px;" />&nbsp;Si tu licencia médica está pendiente de pago y los datos de tu cuenta están correctos, 
								la transferencia se hará efectiva dentro de los 6 días hábiles siguientes, contados desde la fecha de nuestra recepción</li>
								</ul></b>
								<p align="center" style="margin-top: 10px; margin-bottom: 5px">
								<a id="botonMD" style="margin-left: 20px;height:18px;" class="btn btn--terciario" href="<c:url value="/mandato.do" />" onClick="javascript:fln.preloader(1);">Solicitar</a>
								&nbsp;&nbsp;<a id="botonCLS" style="margin-left: 20px;height:18px;" class="btn btn--terciario" href="#">Cerrar</a>
								</p>
							</div>
						</div>
					</c:if>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<p class="adicional"
									...
									<font color="red">NUEVO* </font><b>: Si deseas consultar o modificar
									tus datos de transferencia bancaria para el pago de tu licencia médica &nbsp;&nbsp;
									<a href="<c:url value='/mandato.do' />" onClick="javascript:fln.preloader(1);" style="color: #2072BC">
									(Ingresa aquí)</a></b>
								</p>
							</div>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="alerta alerta--aviso" id="aviso" style="margin-top: -10px" >
								<b><h4>Antes de continuar verifica condiciones:</h4></b><br> Sube los siguientes documentos asegurando que estén legibles o no podremos tramitar tu licencia:<br><br>
								<b><ul><li><input type="checkbox" id="check_v1" name="check_v1" />&nbsp;Licencia médica con firmas del médico y trabajador</li>
								<li><input type="checkbox" id="check_v2" name="check_v2" />&nbsp;El diagnóstico debe ser visible</li>
								<li><input type="checkbox" id="check_v3" name="check_v3" />&nbsp;Sección C de la licencia completada por empleador</li></ul></b>
								</div>
						</div>
						
						<div class="col xs12 lg6">
							<div class="btn__grupo text-align-right-xs" style="margin-top: -10px" >
								<a id="botonDP" class="btn btn--primario btn--2palabras"
									href="#" onClick="validarPaso1('DP'); return false;">Documentación<br>Pendiente</a>
								<a id="botonIL" style="margin-left: 20px"
									class="btn btn--primario btn--alto" href="#"
									onClick="validarPaso1('IL'); return false;">Ingresar
									Licencia</a>
							</div>
						</div>
