...
import cl.laaraucana.licenciascompin.CRM.WebMovile.DT_INFO_AFILIADO_REQ;
import cl.laaraucana.licenciascompin.CRM.WebMovile.DT_INFO_AFILIADO_RES;
import cl.laaraucana.licenciascompin.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_DEUD;
import cl.laaraucana.licenciascompin.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_PENS;
import cl.laaraucana.licenciascompin.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_TRAB;
import cl.laaraucana.licenciascompin.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub;
import cl.laaraucana.licenciascompin.vo.AnexoAfiliadoVO;
...
public class ClienteInfoAfiliado implements WSInterface {
	...
	public SalidainfoAfiliadoVO getDataAfiliado(String rut) throws AxisFault { 
		...
		try {
			...
			logger.error("Error en servicio SI_INFO_AFILIADO_OUT: compruebe el servicio, mensaje= " + e.getMessage());
...
//<==== Validacion Nueva	
		if(respuesta!=null){
			...
			logger.warn("Error en servicio InfoAfiliado:" + salidaListaVO.getMensaje());
		}
//<==== Validacion Nueva	
		return salidaListaVO;
