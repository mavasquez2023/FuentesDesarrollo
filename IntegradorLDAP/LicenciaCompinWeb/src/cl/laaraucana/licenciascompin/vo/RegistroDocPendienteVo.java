...
public class RegistroDocPendienteVo {
	...
	/** Campos para Bitacora nueva **/
	private String folioLicenciaReal;
	...
	/**
	 * @return the folioLicenciaReal
	 */
	public String getFolioLicenciaReal() {
		return folioLicenciaReal;
	}

	/**
	 * @param folioLicenciaReal the folioLicenciaReal to set
	 */
	public void setFolioLicenciaReal(String folioLicenciaReal) {
		this.folioLicenciaReal = folioLicenciaReal;
	}
