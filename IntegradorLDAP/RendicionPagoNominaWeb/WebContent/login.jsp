...
<title>TEF - La Araucana</title>
<link href="<c:url value='/resources/css/layo.css'/>" rel="stylesheet" type="text/css" />
...
<div id="content" class="container_12">
  ...
  <img src="<c:url value='/resources/img/cabecera_claves.jpg'/>" /> <br/><br/>
    <h1>Transferencia Electrónica de Fondos - Convenio Bancos</h1>
    <div class="mensaje bg_gris">Por favor ingresa tu <strong>RUT</strong> y <strong>Clave</strong> de acceso</div>
