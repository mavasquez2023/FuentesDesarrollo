...
<body>
	...
	<table align="center" class="tabla-creditos"
		...
		<tr>
			<td class="bienvenida"
				...
				Seguimiento transferencias consultas</td>
	...
	<form action="detalleAfiliado.do" method="post" name="formbuscar" id="formbuscar" style="margin-top: 0px;">
	...
	<tr><td class="bienvenida"
		...
		<td class="bienvenida"
					style="border: 0 px; font-size: 14px; border-color: #FFFFFF; text-align: left;">
					<br><input type="button" value="buscar" id="buscar"
