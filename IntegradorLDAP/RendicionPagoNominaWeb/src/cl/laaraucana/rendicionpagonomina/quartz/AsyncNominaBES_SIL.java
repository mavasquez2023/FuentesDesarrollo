...
public class AsyncNominaBES_SIL {
	private static final Logger logger = Logger.getLogger(AsyncNominaBES_SIL.class);
	...
	@Scheduled(cron = "${config.cron.bes.rendicion.sil}")
	public void asyncProcessNomina() {
		
		String estado = Configuraciones.getConfig("cronta.bes.estado");
		logger.info("Cron working, estado cronta BES SIL: " + estado);
