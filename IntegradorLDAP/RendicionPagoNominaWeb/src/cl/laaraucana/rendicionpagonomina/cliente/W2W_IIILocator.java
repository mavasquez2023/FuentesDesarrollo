...
package cl.laaraucana.rendicionpagonomina.cliente;

public class W2W_IIILocator extends org.apache.axis.client.Service implements cl.laaraucana.rendicionpagonomina.cliente.W2W_III {
    ...
    public cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap getw2w_IIISoap() throws javax.xml.rpc.ServiceException {
    ...
    public cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap getw2w_IIISoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoapStub _stub = new cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoapStub(portAddress, this);
    ...
    public cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap getw2w_IIISoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap getw2w_IIISoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap12Stub _stub = new cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoapStub _stub = new cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoapStub(new java.net.URL(w2w_IIISoap_address), this);
                _stub.setPortName(getw2w_IIISoapWSDDServiceName());
                return _stub;
            }
            if (cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap12Stub _stub = new cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap12Stub(new java.net.URL(w2w_IIISoap12_address), this);
                _stub.setPortName(getw2w_IIISoap12WSDDServiceName());
                return _stub;
            }
        }
