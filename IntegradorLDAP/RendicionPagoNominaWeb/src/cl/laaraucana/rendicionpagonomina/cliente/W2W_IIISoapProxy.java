...
public class W2W_IIISoapProxy implements cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap {
  private String _endpoint = null;
  private cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap w2W_IIISoap = null;
  ...
  private void _initW2W_IIISoapProxy() {
    try {
      w2W_IIISoap = (new cl.laaraucana.rendicionpagonomina.cliente.W2W_IIILocator()).getw2w_IIISoap();
      if (w2W_IIISoap != null) {
        if (_endpoint != null)
  ...
  public cl.laaraucana.rendicionpagonomina.cliente.W2W_IIISoap getW2W_IIISoap() {
    if (w2W_IIISoap == null)
      _initW2W_IIISoapProxy();
    return w2W_IIISoap;
  }
