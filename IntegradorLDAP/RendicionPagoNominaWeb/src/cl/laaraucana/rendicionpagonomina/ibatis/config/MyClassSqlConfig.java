...
* 
*/
package cl.laaraucana.rendicionpagonomina.ibatis.config;
...
public class MyClassSqlConfig {
	...
	static {
		try {
			String resource = "cl/laaraucana/rendicionpagonomina/ibatis/config/IbatisConfig.xml";
	...
	static {
		try {
			String resource = "cl/laaraucana/rendicionpagonomina/ibatis/config/IbatisConfigSql.xml";
			Reader reader = Resources.getResourceAsReader(resource);
