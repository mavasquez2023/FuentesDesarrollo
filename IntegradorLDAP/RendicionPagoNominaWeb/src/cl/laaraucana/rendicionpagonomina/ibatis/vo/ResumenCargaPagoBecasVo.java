 ...
 *
 */
public class ResumenCargaPagoBecasVo {
	...
	private List<BecasEntity> listaNomina;
	 ...
	 */
	public List<BecasEntity> getListaNomina() {
		return listaNomina;
	}
	/**
	 * @param listaNomina the listaNomina to set
	 */
	public void setListaNomina(List<BecasEntity> listaNomina) {
