 ...
 *
 */
public class ResumenCargaPagoManualVo {
	...
	private List<DetalleCargaPagoManualVo> listaNomina;
	 ...
	 */
	public List<DetalleCargaPagoManualVo> getListaNomina() {
		return listaNomina;
	}
	/**
	 * @param listaNomina the listaNomina to set
	 */
	public void setListaNomina(List<DetalleCargaPagoManualVo> listaNomina) {
