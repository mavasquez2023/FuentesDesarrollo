...
public class CONSULTAR  implements java.io.Serializable {
    ...
    /**
     * Gets the RUT value for this CONSULTAR.
     * 
     * @return RUT
     */
    public int getRUT() {
    ...
    /**
     * Sets the RUT value for this CONSULTAR.
     * 
     * @param RUT
     */
    ...
    /**
     * Gets the DV value for this CONSULTAR.
     * 
     * @return DV
     */
    ...
    /**
     * Sets the DV value for this CONSULTAR.
     * 
     * @param DV
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servicio.laaraucana.cl/mandato", "CONSULTAR"));
