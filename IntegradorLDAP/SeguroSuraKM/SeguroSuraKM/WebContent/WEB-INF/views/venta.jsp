	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<p>Conectando Convenio Seguro x Km SURA</p>
				<div class="separador"></div>
				<div id="loading" style="position:fixed; top:25%; left:47%; z-index: auto;display:block;" >
				<img src="<%=request.getContextPath() %>/img/3d-loader.gif">
				</div>
				<form class="form" id="paso2" action="<%=cl.laaraucana.surakm.util.Configuraciones.getConfig("url.ventakm.sura")%>" method="POST">
					...
					<input class="text" type="hidden" id="telefono" name="telefono" value="${venta.celular }" /> 
					<input class="text" type="hidden" id="id" name="id" value="${venta.id}" /> 
				</form>
			</div>
		</div>
	</div>
