...
<body>
	...
	<div align="right">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
					...
					<div class="row justify-center-xs justify-start-sm">
						...
						<div class="col xs12 sm12 md4">
							<div
								...
								<div class="pasos__data">
									<span>Paso 3</span>CONTRATA TU SEGURO
								</div>
							</div>
						</div>
					</div>
				...
				<p>Ingresa todos los datos solicitados</p>
				<div class="separador"></div>
				<form class="form" id="paso2" action="paso2.do" method="POST">
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_fono tipo_numerico"
									...
									data-prefijo-tipo="telefono" value="${data.celular}" /> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text tipo_fono tipo_numerico"
							...
							<div class="grupo-emails">
								<div class="row">
									<div class="col xs12 lg6">
										<div class="form__grupo" data-animacion="placeholder"
											...
											<input class="text requerido tipo_email" type="text"
												id="email" name="email" value="${data.email}" /> <label
									...
									<div class="col xs12 lg6">
										<div class="form__grupo" data-animacion="placeholder"
											data-comentario="Ej: nombre@correo.cl">
											<input class="text tipo_email" type="text"
												id="confirmar-email" name="confirmarEmail"  autocomplete="off" disabled="disabled"/> <label
												for="confirmar-email" value="">Confirmar
												email</label>
										</div>
									</div>
								</div>
					...
					<div class="btn__grupo text-align-right-xs">
						<a class="btn btn--primario" href="#"
							onClick="validarDatosContacto(); return false;">Continuar</a>
					</div>
					<input class="text" type="hidden" id="email_old" name="" value="${data.email}" />
	...
	$("#email").change(function(){
		if($("#email").val()!= $("#email_old").val()){
  			$("#confirmar-email").prop('disabled', false);
  		}else{
  			$("#confirmar-email").prop('disabled', true);
  		}
	});
	if($("#email").val()==""){
		$("#confirmar-email").prop('disabled', false);
