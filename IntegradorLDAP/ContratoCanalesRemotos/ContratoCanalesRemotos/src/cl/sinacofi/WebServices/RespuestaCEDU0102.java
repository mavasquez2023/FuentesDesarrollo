...
public class RespuestaCEDU0102  implements java.io.Serializable {
    ...
    private cl.sinacofi.WebServices.Detalle[] detalles;
    ...
    public RespuestaCEDU0102(
           ...
           cl.sinacofi.WebServices.Detalle[] detalles) {
     ...
     * @return detalles
     */
    public cl.sinacofi.WebServices.Detalle[] getDetalles() {
        return detalles;
    }
     ...
     * @param detalles
     */
    public void setDetalles(cl.sinacofi.WebServices.Detalle[] detalles) {
        this.detalles = detalles;
    }
