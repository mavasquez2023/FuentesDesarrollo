...
public class MailServiceImpl implements MailService {
	...
	public boolean sendEmailMandato(String to, String subject, String bodyContent, String rut, String ruta) throws Exception {
		...
		try {
			...
			DataSource fds = new FileDataSource(Configuraciones.getConfig("carpeta.report") + "img/logo.jpg");
			...
			adjunto.setFileName("Contrato_uso_canales_remotos_" + rut + ".pdf");
	...
	public boolean sendEmail(String to, String subject, String bodyContent) throws Exception {
		...
		try {
			...
			DataSource fds = new FileDataSource(Configuraciones.getConfig("mandato.report") + "logo.jpg");
