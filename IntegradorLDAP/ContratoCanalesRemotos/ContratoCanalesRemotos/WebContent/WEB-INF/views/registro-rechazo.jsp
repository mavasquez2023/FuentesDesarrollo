			...
			<div class="col xs12 lg10">
				...
				<div class="col xs12 md8 lg10">
            		<div class="respuesta text-align-center-xs">
              			<h4 class="respuesta__titulo color--secundario">
              			 <c:if test="${tipo_rechazo=='03'}">
              				Ha sido rechazado el crédito</h4>
              				<div class="separador"></div>
              				<p class="respuesta__texto"><span>Le solicitamos contactar al ejecutivo que le atendió.</span></p>
              			</c:if>
              			<c:if test="${tipo_rechazo=='05'}">
              				Sus respuestas no han sido correctas. No puede continuar</h4>
              			</c:if>
             		 	<div class="separador"></div>
            		</div>
