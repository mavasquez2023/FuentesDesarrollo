			...
			<div class="col xs12 lg10">
				...
				<div class="col xs12 md8 lg10">
					<div class="respuesta text-align-center-xs">
						<form id="aprobar" action="aprobar.do" method="post">
						<div class="col xs12 lg10">
							<p>
								¡Felicitaciones, sus respuestas son correctas!
							<br>
								<b> Ahora puede autorizar el Contrato de Uso de Canales Remotos ingresando su mail</b>
							</p>
						</div>
						
						<div class="col xs12 lg10 text-align-left-xs" style="margin-top: 20px">
						...
						<div class="separador"></div>
						<div class="col xs12 md8 lg10" style="margin-top: -15px">
						<div class="alerta alerta--error" id="errores_aprobar"
						style="display: none"></div>
						</div>
						<div class="col xs12 lg10" style="margin-top: 0px">
							<a class="btn btn--primario" id="btn-aprobar" href="#"
								style="background: #1A9332; border-color: #1A9332" onclick="validarPaso3();">Aprobar</a>
						</div>
