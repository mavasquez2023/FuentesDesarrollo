...
<script type="text/javascript">
	function ValidaDescarga(url){
		...
		$('#validaPDF').val("SI");
		$("#descargando" ).show();
		setTimeout( '$("#descargando" ).hide()', 4000);
	}
</script>
</head>
<body>
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<div class="col xs12 lg9">
					<p>Estimado(a) ${nombre}, RUT ${rutLdap }, usted ya autorizó el Contrato de Uso de Canales Remotos el <fmt:formatDate value="${contrato.fechaAprobacion }" pattern="dd-MM-yyyy" /> .</p>
				</div>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
				...
				<c:if test="${vacio == 'NO'}">
					<div class="col xs12 lg9">
							...
							<p style="text-align: justify;">Estimado(a) ${nombre}, RUT
								${rutUser}, le
								solicitamos descargar el Contrato de Uso de Canales Remotos para autorizarlo.</p>

						<div class="separador"></div>

						<form class="form" id="paso2" action="question.do" method="POST">
							
							<table align="center" class="tabla-creditos">
								<thead>
									<tr>
										<th class="certificadoLeft">Link a documentación</th>
								...
								<tbody>
										...
										<tr>
											<td class="certificadoCenter">
													<a href="#" onclick="ValidaDescarga('${id_ccr}');return false;">
														<font style="font-size: medium;">Contrato uso canales remotos ${rutLdap }</font>&nbsp;<img src="<c:url value='/resources/img/descarga.png'/>"
							...
							<div class="col xs12 md8 lg9" id="descargando"  style="display: none;">
								<div class="alerta alerta--aviso">
									<p class="respuesta__texto">
										Descargando PDF, espere un momento por favor...<span
											class="color--secundario">${email }</span>
									</p>
								</div>
							</div>
							<div class="separador"></div>
							<div class="col xs12 md8 lg9"  style="margin-bottom: 20px">
							<p style="text-align: justify;">
								<b>Por favor confirmar que recibió y leyó el contrato.</b><br />
								Marque y seleccione "Confirmo recepción y lectura".<br />
							</p>
							</div>
							<div class="separador"></div>
							<table style="border: hidden">
									<tr style="border: hidden">
										...
										<td style="border: hidden" class="certificadoLeft">Contrato uso de canales remotos</td>
									</tr>
								...
								<div class="col xs12 lg9">
									...
									<div class="btn__grupo text-align-center-xs" id="div-boton"
										...
										<a class="btn btn--primario" href="#"
											onClick="validarPaso2(); return false;">Confirmo
											recepción y lectura</a>
									</div>
								</div>
								<input type="hidden" name="validaPDF" id="validaPDF" value="" />
								<input type="hidden" name="ipremota" id="ipremota"
