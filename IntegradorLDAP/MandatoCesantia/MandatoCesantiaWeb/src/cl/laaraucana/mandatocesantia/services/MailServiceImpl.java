...
public class MailServiceImpl implements MailService {
	...
	public boolean sendEmail(String to, String subject, String bodyContent, String rut, String ruta) throws Exception {
		...
		try {
			...
			DataSource fds = new FileDataSource(Configuraciones.getConfig("mandato.cesantia.report") + "cabecera.jpg");
			...
			DataSource fds2 = new FileDataSource(Configuraciones.getConfig("mandato.cesantia.report") + "piedepagina.gif");
			...
			adjunto.setFileName("Mandato_Cesantia_" + rut + ".pdf");
