      ...
      <div align="right">
        ...
        <div class="row justify-center-xs">
          <div class="col xs12 lg2 text-align-center-xs">
          		<img alt="Mandato Cesantía" src="img/ayuda.png" width="155px" height="170px">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Ha ocurrido un error al procesar la petición</h4>
              <div class="separador"></div>
              <p class="respuesta__texto"> Estimado cliente, hemos presentado problemas al procesar la petición, favor intente nuevamente o llámenos al <span class="color--secundario">600 4228 100</span></p>
