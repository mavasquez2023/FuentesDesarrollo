...
<title>Login Mandato Cesantía - La Araucana</title>
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
						...
						<div class="col xs12 sm12 md4 oculto-xs block-md">
							<div
								...
								<div class="pasos__data">
									<span>Login</span>MANDATO CESANTÍA
								</div>
							</div>
						</div>
				...
				<form class="form" id="paso1" action="init.do" method="POST">
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_rut" type="text" id="rut" name="rutCliente"
									value="${rut }" maxlength="12" autocomplete="off" /> <label for="rut">RUT</label>
							</div>
						</div>
					</div>
					<c:if test='${errorMsg=="serie_error" }'>
								<div class="alerta alerta--error" id="aviso" style="margin-top: 0px; margin-bottom: 10px">
					...
					<div class="alerta alerta--error" id="errores_paso1" style="display: none;margin-top: -10px; margin-bottom: -0px"></div>
                   ...
                   <div class="col xs12 lg6">
					<div class="btn__grupo text-align-center-xs" style="margin-top: 15px">
						...
						<p class="adicional" style="margin-top: 10px;margin-left:-15px;font-size: medium;text-align: center">
							...
							<a style="color:#2072BC" href="<c:url value='login.jsp' />" target="_blank">aquí</a>
						</p>
					</div>
				</div>
		...
		var onloadCallback = function() {
			if (_captcha) {
				grecaptcha.render(_captcha, {
					'sitekey' : '<%=cl.laaraucana.mandatocesantia.util.Configuraciones.getConfig("servicios.recaptcha.key")%>',
