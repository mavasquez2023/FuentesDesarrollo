...
function drawBasic() {
      ...
      var options = {
      title: 'Cantidad de Licencias por Periodo',
        hAxis: {
          title: 'Periodos'
        },
        vAxis: {
 ...
 <g>
  ...
  <ellipse ry="9.24249" rx="8.96572" cy="20.6879" cx="48.9012" stroke-width="8" stroke="#f2f7f7" fill="none" id="svg_22"/>
			...
			<div class="col xs12 lg10">
				...
				<p>Estadísticas por Período de las Licencias Médicas Recibidas</p>
				<div class="separador"></div>
				<form class="form" id="paso1" action="paso2.do" method="GET">
					<div class="row">
					
						<div class="col xs12 lg10">
							<div class="form__grupo" data-animacion="placeholder" data-comentario="">
								<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
 								 <div id="chart_div" style="width: 900px; height: 400px; margin-top: -30px"></div>
							</div>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="btn__grupo text-align-right-xs">
								<a id="botonIL" style="margin-left: 20px"
									class="btn btn--primario" href="<c:url value='/paso2.do' />"
									>Siguiente</a>
							</div>
						</div>
