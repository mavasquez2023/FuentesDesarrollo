...
public class ReporteServiceImpl implements ReporteService {
	...
	private static final String TEMPLATE1 = Configuraciones.getConfig("diferimiento.especial.report") + "\\report1.jrxml";

	private static String PDF;

	public String generarReport(HttpServletRequest request, HttpServletResponse response, CreditoVo vo, Connection con)
			throws Exception {

		List<JasperPrint> jasperPrintList = new ArrayList<JasperPrint>();

		PDF = Configuraciones.getConfig("diferimiento.especial.report") + "\\diferimientoEspecial_"
		...
		response.setHeader("Content-Disposition", "attachment;filename=Diferimiento_Especial.pdf");
