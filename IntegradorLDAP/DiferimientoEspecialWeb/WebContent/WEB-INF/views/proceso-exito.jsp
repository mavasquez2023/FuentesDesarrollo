  ...
  <rect height="402" width="582" y="-1" x="-1" fill="none" id="canvas_background"/>
              ...
              <div class="row justify-center-xs justify-start-sm">
                ...
                <div class="col xs12 sm6">
                  <div class="pasos__item flex-xs align-middle-xs justify-center-xs justify-start-sm activo">
                    ...
                    <div class="pasos__data"><span>Paso 2</span>AUTORIZACIÓN</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Autorización registrada exitosamente!</h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Descargando PDF, espere un momento por favor.</p>
            </div>
