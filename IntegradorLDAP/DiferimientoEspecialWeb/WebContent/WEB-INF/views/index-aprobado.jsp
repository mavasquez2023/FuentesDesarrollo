  ...
  <body onload="reportAprobado()">
    <main>
      <div class="container">
       ...
       <form id="form-aprobado" action="descargar.do" method="post">
  ...
  <rect height="402" width="582" y="-1" x="-1" fill="none" id="canvas_background"/>
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Descargando PDF, espere un momento por favor.</h4>
              <div class="separador"></div>
              <p class="respuesta__texto"></p>
            </div>
            <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="https://www.laaraucana.cl/">Finalizar</a>
            </div>
          </div>
        </div>
      </div>
