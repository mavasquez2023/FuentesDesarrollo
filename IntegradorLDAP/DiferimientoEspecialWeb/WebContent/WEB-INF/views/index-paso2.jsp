...
<title>Autorización de Diferimiento Especial - La Araucana</title>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col xs12 lg2 text-align-center-xs">
				<svg width="170.00008905263041" height="150.00007857585035" xmlns="http://www.w3.org/2000/svg">
 ...
 <g>
  ...
  <line y2="147.837" x2="123.466" y1="5.20916" x1="122.941" stroke-width="8" stroke="#4c4c4c" fill="none" id="svg_3"/>
  <line y2="144" x2="4.57331" y1="144" x1="127.212" stroke-width="8" stroke="#4c4c4c" fill="none" id="svg_4"/>
  <line y2="33.0987" x2="101.521" y1="4.67668" x1="101.259" stroke-width="8" stroke="#4c4c4c" fill="none" id="svg_5"/>
  <line y2="31.2588" x2="127.042" y1="31.2588" x1="97.5715" stroke-width="8" stroke="#4c4c4c" fill="none" id="svg_6"/>
  <line y2="29.9413" x2="124.152" y1="6.78664" x1="102.834" stroke-width="8" stroke="#4c4c4c" fill="none" id="svg_7"/>
  ...
  <line y2="64.1532" x2="89" y1="64.1532" x1="34.5728" stroke-width="8" stroke="#4c4c4c" fill="none" id="svg_21"/>
  <ellipse ry="36.9806" rx="38.4241" cy="96.3241" cx="63.0463" stroke-width="8" stroke="#3c75ad" fill="#ffffff" id="svg_8"/>
  <text xml:space="preserve" y="113.9829" x="94.5321" transform="matrix(2.83478 0 0 2.40614 -215.54 -166.74)" text-anchor="start" stroke="#007f00" fill="#000000" font-size="16" font-family="Helvetica, Arial, sans-serif" id="svg_14">$</text>
  <line y2="87.1971" x2="114.574" y1="102.202" x1="99.568" stroke-width="8" stroke="#3c75ad" fill="none" id="svg_12"/>
  <line y2="101.866" x2="103.556" y1="86.7745" x1="86.4622" stroke-width="8" stroke="#3c75ad" fill="none" id="svg_11"/>
  ...
  <text xml:space="preserve" y="24.1814" x="92.4669" transform="matrix(6.06602 0 0 1 -536.086 0)" text-anchor="start" stroke-width="0" stroke="#3c75ad" fill="#000000" font-size="24" font-family="Helvetica, Arial, sans-serif" id="svg_15"/>
 </g>
 <g>
  <title>background</title>
			...
			<div class="col xs12 lg10">
				...
				<div class="container">
					...
					<form id="paso2" action="aprobacion.do" method="post">
						<div class="row">
							 <div class="col xs12 lg10">
							<p style="padding-right: 30%; text-align: justify;">
								<strong>AUTORIZACIÓN CAMBIO DE VENCIMIENTO</strong><br /> <br />
								El afiliado ${nombre},
								cédula de identidad N° ${rut}, autoriza a C.C.A.F. La Araucana a
								diferir el vencimiento del crédito identificado en la tabla adjunta, a continuación
								del vencimiento de la última cuota pactada, debido al no descuento realizado por el empleador producto
								de un error operativo.<c:if test="${emptyTable != 'emptyTable'}"> <br /> <br />La
								(s) cuota (s) a diferir, son las que se detallan a continuación:</c:if>
							</p>
							</div>
						</div>
						<br />
						<c:if test="${emptyTable == 'emptyTable'}">
						<br/><br/>
						<p style="padding-right: 40%; text-align: justify;">No existe información asociada, favor puede llamar al Call Center de <br>La ARAUCANA 600 4228 100</p>
						<br/><br/></c:if>
						<c:if test="${emptyTable != 'emptyTable'}">
						<table align="center" class="tabla-creditos">
							<thead>
								<tr>
									...
									<th class="certificadoLeft">N°&nbsp;de&nbsp;cuota&nbsp;</th>
									<th class="certificadoLeft">Valor&nbsp;cuota&nbsp;</th>
									<th class="certificadoLeft">Fecha de vencimiento&nbsp;actual&nbsp;</th>
									<th class="certificadoLeft">Nueva&nbsp;fecha de&nbsp;vencimiento&nbsp;</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${credito}" var="cre">
									<tr>
										<td class="certificadoLeft">${cre.idCredito}</td>
										<td class="certificadoLeft">${cre.cuotaDiferir}</td>
										<td class="certificadoRigth">$${cre.montoCuota}</td>
										<td class="certificadoLeft">${cre.fechaVencActual}</td>
										<td class="certificadoLeft">${cre.fechaVencNuevo}</td>
									</tr>
						...
						<p
							style="font-size: 0.9em; padding-right: 40%; text-align: justify;">
							La Araucana C.C.A.F. informa que este documento quedará a
							disposición del afiliado que suscribe en nuestra página web
							institucional <a href="www.laaraucana.cl">www.laaraucana.cl</a><br />
							<br />Esta reprogramación no tiene costo alguno asociado para el
							afiliado, las cuotas diferidas no presentaran reajuste alguno, no
							generaran intereses y no incorpora ninguna clase de seguro
							adicional al contratado en la operacional original.
						</p>
						<div class="separador"></div>
						<div class="separador"></div>
						<div class="btn__grupo text-align-right-xs"
							style="padding-right: 40%">
							<c:if test="${emptyTable == 'emptyTable'}"><a class="btn btn--primario" href="#"
									onClick="validarPaso2_3(); return false;">Finalizar</a></c:if>
							<c:if test="${emptyTable != 'emptyTable'}">
							<c:if test="${existe == 'NO'}">
								<a class="btn btn--primario" href="#"
									onClick="validarPaso2_3(); return false;">Rechazo</a>&nbsp;&nbsp;
							<a class="btn btn--primario" href="#"
									onClick="validarPaso2(); return false;">Apruebo
									diferimiento</a>
							</c:if>
							<c:if test="${existe == 'SI'}">
								<a class="btn btn--primario" href="#"
