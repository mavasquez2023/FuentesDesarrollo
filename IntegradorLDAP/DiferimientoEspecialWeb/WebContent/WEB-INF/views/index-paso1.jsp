					...
					<div class="row justify-center-xs justify-start-sm">
						...
						<form class="form" id="paso1" action="paso2.do" method="POST">
							<div class="row">
								<div class="separador"></div>
								 <div class="col xs12 lg10">
								<p>&nbsp;<br/>Este servicio te permitirá diferir las cuotas de tu crédito.</p>
								</div>
								<div class="separador"></div>
								<div class="col xs12 lg8">
									<div class="form__grupo" data-animacion="placeholder"
										...
										<input class="text requerido tipo_rut" type="text" id="rut"
											name="rutCliente" value="" maxlength="12" /> <label
											for="rut">RUT</label>
									</div>
									<c:if test='${errorMsg=="rut_error" }'>
										<div class="alerta alerta--error">El RUT ingresado no se
											encuentra afiliado a La Araucana.</div>
									</c:if>
									<c:if test='${errorMsg=="serie_error" }'>
										<div class="alerta alerta--error">Número de serie
											ingresado no es válido, intente nuevamente.</div>
									</c:if>
								</div>
								...
								<div class="col xs12 lg8">
									<div class="form__grupo" data-animacion="placeholder"
										...
										<input class="text requerido" type="text" id="serie"
											name="serie" value="" /> <label for="serie">Numero
											serie</label>
		...
		var onloadCallback = function() {
			if (_captcha) {
				grecaptcha.render(_captcha, {
					'sitekey' : '<%=cl.laaraucana.diferimientoEspecial.util.Configuraciones.getConfig("servicios.recaptcha.key")%>',
