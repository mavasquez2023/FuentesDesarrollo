...
public class DT_INFO_AFILIADO_RES  implements java.io.Serializable {
    ...
    private cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_TRAB[] ANEXO_TRAB;

    private cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_PENS[] ANEXO_PENS;

    private cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_DEUD[] ANEXO_DEUD;
    ...
    public DT_INFO_AFILIADO_RES(
           ...
           cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_TRAB[] ANEXO_TRAB,
           cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_PENS[] ANEXO_PENS,
           cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_DEUD[] ANEXO_DEUD) {
           this.NOMBRE = NOMBRE;
     ...
     * @return ANEXO_TRAB
     */
    public cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_TRAB[] getANEXO_TRAB() {
        return ANEXO_TRAB;
    }
     ...
     * @param ANEXO_TRAB
     */
    public void setANEXO_TRAB(cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_TRAB[] ANEXO_TRAB) {
        this.ANEXO_TRAB = ANEXO_TRAB;
    }

    public cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_TRAB getANEXO_TRAB(int i) {
        return this.ANEXO_TRAB[i];
    }

    public void setANEXO_TRAB(int i, cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_TRAB _value) {
     ...
     * @return ANEXO_PENS
     */
    public cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_PENS[] getANEXO_PENS() {
        return ANEXO_PENS;
    }
     ...
     * @param ANEXO_PENS
     */
    public void setANEXO_PENS(cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_PENS[] ANEXO_PENS) {
        this.ANEXO_PENS = ANEXO_PENS;
    }

    public cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_PENS getANEXO_PENS(int i) {
        return this.ANEXO_PENS[i];
    }

    public void setANEXO_PENS(int i, cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_PENS _value) {
     ...
     * @return ANEXO_DEUD
     */
    public cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_DEUD[] getANEXO_DEUD() {
        return ANEXO_DEUD;
    }
     ...
     * @param ANEXO_DEUD
     */
    public void setANEXO_DEUD(cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_DEUD[] ANEXO_DEUD) {
        this.ANEXO_DEUD = ANEXO_DEUD;
    }

    public cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_DEUD getANEXO_DEUD(int i) {
        return this.ANEXO_DEUD[i];
    }

    public void setANEXO_DEUD(int i, cl.laaraucana.mandatopublico.CRM.WebMovile.DT_INFO_AFILIADO_RESANEXO_DEUD _value) {
