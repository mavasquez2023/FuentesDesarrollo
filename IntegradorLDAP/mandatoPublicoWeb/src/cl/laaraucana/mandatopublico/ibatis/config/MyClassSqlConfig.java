...
* 
*/
package cl.laaraucana.mandatopublico.ibatis.config;
...
public class MyClassSqlConfig {
	...
	static {
		try {
			String resource = "cl/laaraucana/mandatopublico/ibatis/config/IbatisConfig.xml";
	...
	static {
		try {
			String resource = "cl/laaraucana/mandatopublico/ibatis/config/IbatisConfigSql.xml";
			Reader reader = Resources.getResourceAsReader(resource);
