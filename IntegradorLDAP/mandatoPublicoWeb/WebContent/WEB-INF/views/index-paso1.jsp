 ...
 <g>
  ...
  <rect height="14.7398" width="11.0549" y="129.706" x="125.988"
			...
			<div class="col xs12 lg8">
				<div class="pasos">
					<div class="row justify-center-xs justify-start-sm">
						<div class="col xs12 sm12 md5 oculto-xs block-md">
							<div
				...
				<form class="form" id="paso1" action="lista.do" method="POST">
					<div class="row">
						<div class="separador"></div>
				...
				<div class="col xs12 lg8">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_rut" type="text" id="rut"
									name="rutAfiliado" value="" maxlength="12" /> <label for="rut">RUT AFILIADO</label>
							</div>
					...
					<div class="btn__grupo text-align-center-xs">
						<a class="btn btn--primario" href="#"
							onClick="validarPaso1(); return false;">Consultar</a>
					</div>
				</form>
			</div>
	...
	<script>
		...
		avisar('El RUT ingresado no se encuentra afiliado a La Araucana', 6000);
		</c:if>
