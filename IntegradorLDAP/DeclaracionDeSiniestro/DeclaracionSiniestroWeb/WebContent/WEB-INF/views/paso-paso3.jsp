...
<title>Declaración Siniestro para AFC - La Araucana</title>
...
<body>
 ...
 <g>
  ...
  <path d="m16.299999,40.21999c2.6,0 4.700001,-2.099998 4.700001,-4.700001c0,-0.199997 0,-0.299999 0,-0.5l0,0c0,-0.199997 -0.1,-0.5 -0.1,-0.699997c-0.1,-0.200001 -0.1,-0.400002 -0.199999,-0.700001c-0.700001,-1.699999 -2.400002,-2.899998 -4.300001,-2.899998c-1.9,0 -3.599999,1.1 -4.299999,2.899998c-0.1,0.200001 -0.200001,0.399998 -0.200001,0.700001c-0.099999,0.199997 -0.099999,0.5 -0.099999,0.699997c0,0.200001 0,0.300003 0,0.5c-0.2,2.600002 1.9,4.700001 4.499999,4.700001zm-1.9,-7c0.1,-0.099998 0.3,-0.200001 0.5,-0.299999c0.1,0 0.200001,-0.099998 0.3,-0.099998c0.2,-0.100002 0.400001,-0.100002 0.5,-0.200001c0.2,0 0.400001,-0.100002 0.599999,-0.100002c1.6,0 2.900002,1.300003 2.900002,2.900002c0,0.200001 0,0.400002 -0.1,0.599998c0,0.200001 -0.1,0.400002 -0.200001,0.5c0,0.100002 -0.1,0.200001 -0.1,0.300003l0,0c-0.099998,0.199997 -0.199999,0.299999 -0.299999,0.5c-0.6,0.699997 -1.4,1.099998 -2.299999,1.099998c-0.200001,0 -0.400001,0 -0.6,-0.099998c-0.200001,0 -0.400001,-0.100002 -0.5,-0.200001c-0.1,0 -0.200001,-0.100002 -0.3,-0.100002c-0.2,-0.099998 -0.3,-0.199997 -0.5,-0.299999c-0.1,-0.099998 -0.3,-0.299999 -0.400001,-0.399998c-0.099999,-0.100002 -0.2,-0.300003 -0.299999,-0.5c0,-0.100002 -0.1,-0.200001 -0.1,-0.300003c-0.1,-0.199997 -0.1,-0.399998 -0.2,-0.5c0,-0.199997 -0.1,-0.399998 -0.1,-0.599998c0.2,-0.799999 0.5,-1.599998 1.2,-2.200001z" id="svg_8"/>
				...
				<p style="margin-top: 10px">Puedes subir imágenes, pdf o word</p>
				...
				<form class="form" id="paso3" action="files.do" method="POST"
					...
					<div class="row">
						...
						<div class="col xs12 lg4">
								<div class="documento__item">
									<span class="documento__tipo"></span><span
										...
										class="documento__nombre__text" style="font-size: 1.2em">Adjuntar<br>Cédula&nbsp;Identidad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span
										...
										class="documento__input" type="file" id="cedula" name="cedula"
										data-maxsize="5000"
										accept="image/jpg,image/png,image/jpeg,application/pdf,.doc,.docx,application/msword" />
								</div>
								<!--div class="ayuda ayuda--form">
									<span style="color: red">?</span>
									<div class="ayuda__container" style="max-width:500px;left:300px;top:-100px">
										<p>Recuerda que la imagen debe ser clara, legible y completa.</p>
										<div class="separador--small"></div>
										<a href="img/numero-serie.png" target="_blank"><img
											src="img/numero-serie.png" alt="Cèdula Identidad" /> </a>
									</div>
								</div-->
								<p id="file_error1"></p>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<p class="adicional adicional--dos">Debes subir Copia de Cédula de Identidad legible<br> (peso máximo del archivo 5M)</p>
						...
						<div class="col xs12 lg4">
								<div class="documento__item">
									<span class="documento__tipo"></span><span
										class="documento__nombre"><span
										class="documento__nombre__text" style="font-size: 1.2em">Adjuntar<br>Contrato&nbsp;de&nbsp;Trabajo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span
										class="documento__icono fln-subir-light"></span><a
										class="documento__eliminar" href="#"
										onclick="limpiar(this); return false;"><span>+</span></a></span> <input
										class="documento__input" type="file" id="contrato" name="contrato"
										data-maxsize="5000"
										accept="image/jpg,image/png,image/jpeg,application/pdf,.doc,.docx,application/msword" />
								</div>
								<!--div class="ayuda ayuda--form">
									...
									<div class="ayuda__container" style="max-width:500px;left:300px;top:-100px">
										...
										<div class="separador--small"></div>
										<a href="img/numero-serie.png" target="_blank"><img
											src="img/numero-serie.png" alt="Certificado AFP" /> </a>
									</div>
								</div-->
								<p id="file_error2"></p>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<p class="adicional adicional--dos">Debes subir contrato de trabajao y anexos<br> (peso máximo del archivo 5M)</p>
								<label for="celular"></label>
							</div>
						</div>
						...
						<div class="col xs12 lg4">
							<div class="documento__item">
								<span class="documento__tipo"></span><span
									class="documento__nombre"><span
									class="documento__nombre__text" style="font-size: 1.2em">Adjuntar<br>Certificado&nbsp;Cesantía&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</span><span class="documento__icono fln-subir-light"></span><a
									class="documento__eliminar" href="#"
									onclick="limpiar(this); return false;"><span>+</span>
								</a>
								</span> <input class="documento__input" type="file" id="certemp"
									name="certemp" data-maxsize="5000"
									accept="image/jpg,image/png,image/jpeg,application/pdf,.doc,.docx,application/msword" />
							</div>
							<!--div class="ayuda ayuda--form">
									<span style="color: red">?</span>
									<div class="ayuda__container" style="max-width:500px;left:300px;top:-100px">
										...
										<div class="separador--small"></div>
										<a href="img/numero-serie.png" target="_blank"><img
											src="img/numero-serie.png" alt="Certificado Empleador" /> </a>
									</div>
								</div-->
								<p id="file_error3"></p>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<p class="adicional adicional--dos">
									Debe subir Certificado de Cesantía el cual debe ser emitido por
									la empresa<br> (peso máximo del archivo 5M)
								</p>
						...
						<div class="col xs12 lg4">
								<div class="documento__item">
									<span class="documento__tipo"></span><span
										class="documento__nombre"><span
										class="documento__nombre__text" style="font-size: 1.2em">Adjuntar<br>Liquidación&nbsp;AFC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span
										class="documento__icono fln-subir-light"></span><a
										class="documento__eliminar" href="#"
										onclick="limpiar(this); return false;"><span>+</span></a></span> <input
										class="documento__input" type="file" id="liqafc" name="liqafc"
										data-maxsize="5000"
										accept="image/jpg,image/png,image/jpeg,application/pdf,.doc,.docx,application/msword" />
								</div>
								<!--div class="ayuda ayuda--form">
									...
									<div class="ayuda__container" style="max-width:500px;left:300px;top:-100px">
										...
										<div class="separador--small"></div>
										<a href="img/numero-serie.png" target="_blank"><img
											src="img/numero-serie.png" alt="Liquidaciòn AFC" /> </a>
									</div>
								</div-->
								<p id="file_error4"></p>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<p class="adicional adicional--dos">Debes subir Liquidación de pago del beneficio por parte de la AFC<br> (peso máximo del archivo 5M)</p>
						...
						<div class="col xs12 lg4">
								<div class="documento__item">
									<span class="documento__tipo"></span><span
										class="documento__nombre"><span
										class="documento__nombre__text" style="font-size: 1.2em">Adjuntar<br>Certificado&nbsp;Cotizaciones&nbsp;AFP&nbsp;</span><span
										class="documento__icono fln-subir-light"></span><a
										class="documento__eliminar" href="#"
										onclick="limpiar(this); return false;"><span>+</span></a></span> <input
										class="documento__input" type="file" id="certafp" name="certafp"
										data-maxsize="5000"
										accept="image/jpg,image/png,image/jpeg,application/pdf,.doc,.docx,application/msword" />
								</div>
								<!--div class="ayuda ayuda--form">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<p class="adicional adicional--dos">Debes subir Certificado de 12 últimas cotizaciones de AFP<br> (peso máximo del archivo 5M)</p>
								<label for="celular"></label>
							</div>
						</div>
						
						<div class="col xs12 lg10"></div>
						<div class="separador"></div>
						<div class="col xs12 lg10">
							<div class="form__seleccion">
								<div class="form__checkbox">
									<input type="checkbox" name="terminos" id="terminos" /> <label
										for="terminos"><span class="adicional">
											Autorizo a C.C.A.F. La Araucana a realizar la tramitación 
											del seguro de cesantía asociado a mi(s) crédito(s)</span></label>
								</div>
							</div>
						</div>
					</div>
				 ...
				 <input type="hidden" name="opcion" id="opcion"  value="IL" />
					...
					<div class="btn__grupo text-align-right-xs">
						...
						&nbsp;&nbsp;&nbsp;<a class="btn btn--primario" href="#"
							onClick="validarPaso3(); return false;">Enviar</a>
