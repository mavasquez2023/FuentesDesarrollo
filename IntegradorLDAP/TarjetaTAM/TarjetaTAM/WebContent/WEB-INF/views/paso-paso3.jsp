				...
				<form class="form" id="paso1" action="paso2.do" method="POST">
					...
					<div class="col xs12 lg6">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<input class="text requerido tipo_fecha"
									type="text" id="fechaNacimiento" name="fechaNacimiento" value="${data.fechaNacimiento}" disabled="disabled"/> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_numerico"
									type="text" id="edad" name="edad"  value=""  disabled="disabled"/> <label
									for="edad">Edad</label>
							</div>
						</div>
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_fono tipo_numerico"
									...
									data-prefijo-tipo="telefono" value="${data.telefono}" disabled="disabled"/> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_email" type="text" id="email"
									name="email" value="${data.email}" disabled="disabled"/> <label for="email">Email</label>
							</div>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<select class="requerido" id="region" name="region" disabled="disabled">
									<c:forEach items="${regiones}" var="re">
										<c:choose>
											<c:when test="${re.id == data.region}">
								...
								</select> <label for="region">Región</label>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo"
								data-comentario="">
								<select class="text requerido" id="comuna" name="comuna" disabled="disabled">
									<option value="0">Seleccione una comuna</option>
									<c:forEach items="${comunas}" var="item">
										<c:choose>
											<c:when test="${item.id == data.comuna}">
								...
								</select> <label for="comuna">Comuna</label>
							</div>
						</div>
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_text"
									type="text" id="direccion" name="direccion"  value="${data.direccion}" disabled="disabled" /> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<input class="text requerido tipo_numerico"
									type="text" id="numero" name="numero"  value="${data.numero}" disabled="disabled" /> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<input class="text tipo_text"
									type="text" id="depto" name="depto"  value="${data.depto}" disabled="disabled"/> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<input class="text tipo_text"
									type="text" id="referencia" name="referencia"  value="${data.referencia}" disabled="disabled"/> <label
									for="referencia">Referencia</label>
							</div>
						</div>
						<c:if test="${data.oficinaDespacho!=null }">
					<div class="col xs12 lg6">
						<div class="form__grupo" data-animacion="placeholder"
							data-comentario="">
							...
							<select class="requerido" id="oficinaDespacho" name="oficinaDespacho">
								...
								<c:forEach items="${oficinas}" var="ofi">
									<c:choose>
										<c:when test="${ofi.codigoOficina == data.oficinaDespacho}">
							...
							</select> <label for="oficinaDespacho">Oficina Despacho</label>

						</div>
					</div>
					</c:if>
					<c:if test="${data.oficinaDespacho==null }">
						<c:if test="${comuna_habilitada=='1' && repetirDireccion!=null}">
							<div class="col xs12 md12">
								<div class="form__seleccion">
									<div class="form__checkbox">
										<input type="checkbox" name="repetirDireccion"
											id="repetirDireccion" style="margin-top: 5px"
										 	checked="checked"  />
										<label for="terminos">Utilizar dirección particular</label>
									</div>
								</div>
							</div>
						</c:if>
					...
					<a id="botonIL" style="margin-top: 15px"
							...
							<a id="botonIL" style="margin-top: 15px"
								...
								onClick="validarPaso3(); return false;">Confirmar</a>
						</div>
					</div>
				</form>				
			</div>
