			...
			<div class="col xs12 lg9">
				...
				<form class="form" id="paso1" action="paso2.do" method="POST">
					...
					<div class="col xs12 lg6">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_fecha"
									type="text" id="fechaNacimiento" name="fechaNacimiento" value="${data.fechaNacimiento}" maxlength="10"/> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="Ej: 60">
								<input class="text requerido tipo_numerico"
									type="text" id="edad" name="edad"  value="${data.edad}"  maxlength="3"/> <label
									for="edad">Edad</label>
							</div>
						</div>
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_fono tipo_numerico"
									...
									data-prefijo-tipo="telefono" value="${data.telefono}" /> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_email" type="text" id="email"
									name="email" value="${data.email}" maxlength="50"/> <label for="email">Email</label>
							</div>
						</div>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_text"
									type="text" id="direccion" name="direccion"  value="${data.direccion}" maxlength="50" /> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_numerico"
									type="text" id="numero" name="numero"  value="${data.numero}" maxlength="6" /> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text tipo_text"
									type="text" id="depto" name="depto"  value="${data.depto}" maxlength="30"/> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="Ej: 4279">
								<input class="text tipo_text"
									type="text" id="referencia" name="referencia"  value="${data.referencia}" maxlength="50"/> <label
					...
					<a id="botonIL" style="margin-top: 15px"
							...
							<a id="botonIL" style="margin-top: 15px"
								...
								onClick="validarPaso1_2(); return false;">Continuar</a>
						</div>
				</form>
			</div>
