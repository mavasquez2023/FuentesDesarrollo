...
import cl.laaraucana.tarjetatam.vo.AnexoAfiliadoVO;
...
public class ClienteInfoAfiliado implements WSInterface {
	...
	public SalidainfoAfiliadoVO getDataAfiliado(String rut) throws AxisFault { 
		...
		try {
			...
			salidaListaVO.setMensaje("Error en servicio BancoEstado: compruebe el servicio");
		...
		if(respuesta!=null){
			...
			salidaListaVO.setMensaje("Carga de datos Cliente BancoEstado OK. Código error: 0");
		}else{
			salidaListaVO.setCodigoError(ConstantesRespuestasWS.COD_RESPUESTA_ERROR);				
