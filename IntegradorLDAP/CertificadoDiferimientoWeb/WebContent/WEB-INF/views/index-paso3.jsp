...
<title>autorización de diferimiento - La Araucana</title>
...
<body>
	...
	<div class="container">
		<div align="right">
			<form id="logout" method=GET action="exit.do">
				<a href="#" onclick="$('#logout').submit();"
					style="text-decoration: none"><img alt="Salir"
					src="img/salir.png" title="Cerrar Sesión" /><span
  ...
  <rect height="8.90004" width="8.42236" y="59.7231" x="19" stroke-width="3" stroke="#4c4c4c" fill="none" id="svg_25"/>
			...
			<div class="col xs12 lg10">
				<div class="pasos">
					<div class="row justify-center-xs justify-start-sm">
						...
						<div class="row">
							...
							<p style="padding-right: 40%; text-align: justify;">
								<strong>Autorización de cambio de vencimiento por
									contingencia COVID-19</strong><br /> <br />El afiliado ${nombre},
								cédula de identidad N° ${rut}, expresa que fue informado
								previamente por La Araucana C.C.A.F. sobre los términos y
								efectos que produce la reprogramación de su crédito social, así
								como los efectos que se generan en caso de no reprogramar su
								operación crediticia. <br/>En consecuencia, declara que conoce
								inequívocamente y acepta los términos y efectos que produce la
								reprogramación que por este acto acepta y autoriza a La Araucana
								C.C.A.F. a diferir el vencimiento de la(s) cuota (s) de su(s)
								crédito(s), a continuación del vencimiento de la última cuota
								pactada, en atención a que la contingencia ocasionada por el
								virus COVID-19 ha producido una disminución de su remuneración
								que impactará en el pago de la(s) Cuota(s).<c:if test="${emptyTable != 'emptyTable'}"> <br /> <br />La
				...
				<div class="container">
					...
					<form id="paso3" action="aprobacion.do" method="post">
						...
						<table align="center" class="tabla-creditos">
							<thead>
								<tr>
									...
									<th class="certificadoLeft">N° de cuotas</th>
						...
						<div class="row">
							<div class="col xs12 lg6">
								<p>Si quiere recibir el certificado por correo(opcional)</p>
						...
						<div class="btn__grupo text-align-right-xs"
							...
							<c:if test="${emptyTable == 'emptyTable'}"><a class="btn btn--primario" href="#"
									onClick="validarPaso3_3(); return false;">Finalizar</a></c:if>
							<c:if test="${emptyTable != 'emptyTable'}">
							<c:if test="${existe == 'NO'}">
								<a class="btn btn--primario" href="#"
									onClick="validarPaso3_3(); return false;">Rechazo</a>&nbsp;&nbsp;
							<a class="btn btn--primario" href="#"
									onClick="validarPaso3(); return false;">Apruebo
									diferimiento</a>
							</c:if>
							<c:if test="${existe == 'SI'}">
								<a class="btn btn--primario" href="#"
									onClick="validarPaso3_2(); return false;">Descargar
									aprobación</a>
							</c:if>
							</c:if>
						</div>
					</form>
					<form id="paso3_2" action="procesado.do" method="post">
						<input type="hidden" name="emailDescarga" id="emailDescarga" />
					</form>
					<form id="paso3_3" action="rechazo.do" method="post">
