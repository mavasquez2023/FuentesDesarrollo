							...
							<div class="row">
								...
								<div class="col xs12 lg8">
									...
									<c:if test='${errorMsg=="rut_error" }'>
										<div class="alerta alerta--error" id="aviso" style="margin-top: 0px; margin-bottom: 10px">El RUT ingresado no se
									...
									<c:if test='${errorMsg=="serie_error" }'>
										<div class="alerta alerta--error" id="aviso" style="margin-top: 0px; margin-bottom: 10px">Número de serie
		...
		var onloadCallback = function() {
			if (_captcha) {
				grecaptcha.render(_captcha, {
					'sitekey' : '<%=cl.laaraucana.certificadodiferimiento.util.Configuraciones.getConfig("servicios.recaptcha.key")%>',
