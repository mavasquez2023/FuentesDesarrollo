...
public class SI_INFO_AFILIADO_OUTServiceLocator extends org.apache.axis.client.Service implements cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTService {
    ...
    public cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUT getHTTPS_Port() throws javax.xml.rpc.ServiceException {
    ...
    public cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUT getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub _stub = new cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub(portAddress, this);
    ...
    public cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUT getHTTP_Port() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUT getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub _stub = new cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUT.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub _stub = new cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUT.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub _stub = new cl.laaraucana.certificadodiferimiento.CRM.WebMovile.SI_INFO_AFILIADO_OUTBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
