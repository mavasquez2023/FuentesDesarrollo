...
public class ReporteServiceImpl implements ReporteService {
	...
	private static final String TEMPLATE1 = Configuraciones.getConfig("diferimiento.report") + "\\report1.jrxml";

	private static String PDF;

	public String generarReport(HttpServletRequest request, HttpServletResponse response, AfiliadoVo vo, Connection con)
			throws Exception {

		List<JasperPrint> jasperPrintList = new ArrayList<JasperPrint>();

		PDF = Configuraciones.getConfig("diferimiento.report") + "\\diferimiento_"
				+ vo.getRut().replace(".", "").replace("-", "") + ".pdf";
