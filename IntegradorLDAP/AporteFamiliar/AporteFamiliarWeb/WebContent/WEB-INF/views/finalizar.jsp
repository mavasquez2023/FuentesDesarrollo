      ...
      <div class="container">
		<div class="row">
          ...
          <div class="col xs12 md8 lg10">
            ...
            <c:if test="${opcion=='email' }">
              <p class="respuesta__titulo color--secundario">Certificado en PDF ha sido enviado exitosamente!</p>
            </c:if>
            <c:if test="${opcion!='email'}">
              <p class="respuesta__titulo color--secundario">Certificado en PDF ha sido descargado exitosamente!</p>
            </c:if>
              <br>
