		...
		<div class="row">
          ...
          <div class="col xs12 md8 lg10">
            <div class="respuesta text-align-center-xs">
              <p class="respuesta__titulo color--secundario">No se puede emitir el certificado.</p>
              <br>
               <p class="respuesta__subtitulo color--secundario"><font  style="font-size: medium;">Favor, consultar en www.aportefamiliar.cl, ingresando run y fecha de nacimiento.</font> </p>
