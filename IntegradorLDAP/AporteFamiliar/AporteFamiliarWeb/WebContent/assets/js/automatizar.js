/*
LibrerÃƒÂ­a de automatizaciÃƒÂ³n para jQuery
Autor: J-FactorySolutions
...
patrones['tipo_texto'] = /[a-zA-Z \-'ÃƒÂ¡ÃƒÂ©ÃƒÂ­ÃƒÂ³ÃƒÂºÃƒï¿½Ãƒâ€°Ãƒï¿½Ãƒâ€œÃƒÅ¡ÃƒÂ±Ãƒâ€˜ÃƒÂ¤ÃƒÂ«ÃƒÂ¯ÃƒÂ¶ÃƒÂ¼Ãƒâ€žÃƒâ€¹Ãƒï¿½Ãƒâ€“ÃƒÅ“ÃƒÂ¢ÃƒÂªÃƒÂ®ÃƒÂ´ÃƒÂ»Ãƒâ€šÃƒÅ ÃƒÅ½Ãƒâ€�Ãƒâ€º]/;
...
antipatrones['tipo_texto'] = /[^a-zA-Z \-'ÃƒÂ¡ÃƒÂ©ÃƒÂ­ÃƒÂ³ÃƒÂºÃƒï¿½Ãƒâ€°Ãƒï¿½Ãƒâ€œÃƒÅ¡ÃƒÂ±Ãƒâ€˜ÃƒÂ¤ÃƒÂ«ÃƒÂ¯ÃƒÂ¶ÃƒÂ¼Ãƒâ€žÃƒâ€¹Ãƒï¿½Ãƒâ€“ÃƒÅ“ÃƒÂ¢ÃƒÂªÃƒÂ®ÃƒÂ´ÃƒÂ»Ãƒâ€šÃƒÅ ÃƒÅ½Ãƒâ€�Ãƒâ€º]/g;
...
function automatizar_init () {
  // readonly para los calendarios si estÃƒÂ¡ disponible el type="date"
  if (dateHabilitado) {
  ...
  $(':text, :password, textarea, select').each(function (i, el) {
    ...
    // forzar a que se validen los campos que no sean requeridos en caso de tener algÃƒÂºn caracter
  ...
  // automatizaciÃƒÂ³n para inputs type="password"
  $(':password').each(function (i, el) {
    $(el).data('tipo', 'tipo_password');
    aplicarEventos(el);
  });

  // automatizaciÃƒÂ³n para inputs de texto y textarea
  $(':text, textarea').each(function (i, el) {
    ...
    // bloqueo de teclas segÃƒÂºn patrones
    for (key in patrones) {
      if ($(el).hasClass(key)) {
        // patrones
        $(el).data('tipo', key);
