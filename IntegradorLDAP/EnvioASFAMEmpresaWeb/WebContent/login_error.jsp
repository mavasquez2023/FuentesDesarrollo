...
<script type="text/javascript" src="resources/js/ldap.js"></script>
...
<div id="content" class="container_12">
  <div class="grid_12">
  <img src="resources/img/cabecera.jpg" /> <br/><br/>
    <h1>Asignación y Extinción de ASFAM</h1>
    <div class="mensaje bg_gris"><strong>RUT</strong> o <strong>Clave</strong> no válido, intente nuevamente.</div>
    ...
    <div class="grid_8 omega"> <img src="resources/img/imagen_login.jpg" width="646" height="295" /></div>
</div>
</div>
