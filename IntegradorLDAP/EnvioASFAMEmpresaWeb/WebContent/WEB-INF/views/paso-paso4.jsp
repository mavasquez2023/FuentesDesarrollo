...
<title>Envío de Formularios ASFAM - La Araucana</title>
	...
	<div align="right">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
					...
					<div class="row justify-center-xs justify-start-sm">
						...
						<div class="col xs12 sm12 md4">
							<div
								...
								<div class="pasos__data">
									<span>Paso 3</span>ENVÍA LA ASIGNACIÓN FAMILIAR
								</div>
							</div>
						</div>
					</div>
				...
				<div class="separador"></div>
				<p>Adjunta una imagen completa y legible de los certificados y
					declaracón jurada de ingresos, requeridos para actualizar
					cargas:</p>
				<div class="separador"></div>
				<form class="form" id="paso4" action="paso4.do" method="POST"
					...
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="documento__item">
								<span class="documento__tipo"></span><span
									...
									class="documento__input" type="file" id="certificado"
									name="certificado" data-maxsize="5000"
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<p class="adicional adicional--dos">Subir los certificados o
									documentación que respaldan, según el trámite que está
									realizando (peso máximo 5M)</p>
							...
							<div class="col xs12 lg12">
								<div class="btn__grupo text-align-left-xs">
									<a class="btn btn--primario" href="#"
										onClick="validarPaso4(); return false;">Confirmar
										certificado</a>
								</div>
							</div>
					...
					<div class="btn__grupo text-align-right-xs"
						...
						&nbsp;&nbsp;&nbsp;<a class="btn btn--primario" href="#"
							onClick="validarPaso5(); return false;">Enviar</a>

					</div>
					</c:if>
				</form>
				<form action="volver.do" id="back-form" method="post"></form>
