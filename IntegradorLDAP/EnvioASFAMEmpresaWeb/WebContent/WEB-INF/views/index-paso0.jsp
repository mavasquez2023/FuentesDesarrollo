...
<title>Envió de Formularios ASFAM - La Araucana</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<p>Este servicio permitirá subir el formulario y certificado de asignación familiar</p>
				<div class="separador"></div>
				<form class="form" id="paso0" action="paso1.do" method="POST">
					<div class="row">
						<table align="center" class="tabla-creditos">
							<thead>
								<tr>
									...
									<th class="certificadoLeft" style="height: 30px; vertical-align: middle;"></th>
