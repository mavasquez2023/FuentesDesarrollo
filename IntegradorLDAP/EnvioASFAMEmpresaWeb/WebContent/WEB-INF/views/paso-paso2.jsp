	...
	<div align="right">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<div class="separador"></div>
				<form class="form" id="paso2" action="registrar.do" method="POST">
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_fono tipo_numerico"
									...
									data-prefijo-tipo="telefono" value="${telefono}" maxlength="9"/> <label
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" style="margin-bottom: 0px;"
								data-animacion="placeholder" data-comentario="">
								<select class="requerido" id="sucursal" name="sucursal">
									<option value="">Selecciona una Oficina</option>
									<c:forEach items="${sucursales}" var="suc">
										<c:choose>
											<c:when test="${suc.codigo == sucursal}">
												<option value="${suc.codigo}" selected="selected">${suc.descripcion}</option>
											</c:when>
											<c:otherwise>
							...
							<p style="font-size: 1.35em">
								<strong>Selecciona Oficina La Araucana</strong>
							</p>
						</div>
					...
					<div class="btn__grupo text-align-right-xs">
						<a class="btn btn--secundario"  href="<c:url value='/paso1.do' />">Volver</a>
