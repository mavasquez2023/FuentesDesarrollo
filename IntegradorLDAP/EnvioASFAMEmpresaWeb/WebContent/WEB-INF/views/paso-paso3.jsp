	...
	<div align="right">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<div class="separador"></div>
				<p>Adjunta una imagen completa y legible de la solicitud los
					documentos requeridos para actualizar las cargas:</p>
				<div class="separador"></div>
				<form class="form" id="paso3" action="paso3.do" method="POST"
					...
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="documento__item">
								<span class="documento__tipo"></span><span
									...
									class="documento__input" type="file" id="solicitud"
									name="solicitud" data-maxsize="5000"
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<p class="adicional adicional--dos">Sube solicitud de asignación familiar: requerida para todos los trámites <br>(peso máximo 5M, formato archivo png, jpeg, gif, pdf, doc )</p>
					...
					<div class="btn__grupo text-align-right-xs">
						...
						&nbsp;&nbsp;&nbsp;<a class="btn btn--primario" href="#"
							onClick="validarPaso3(); return false;">Continuar</a>
