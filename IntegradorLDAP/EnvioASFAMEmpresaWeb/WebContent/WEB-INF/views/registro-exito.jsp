		...
		<div class="row">
          ...
          <div class="col xs12 md8 lg12">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Proceso exitoso!</h4>
              <div class="separador"></div>
              <p class="respuesta__texto"><span>Sus archivos se han subido exitosamente!</span></p>
            </div>
            
           <div class="btn__grupo text-align-center-xs">
            <a class="btn btn--primario" href="<c:url value="/paso1.do" />"
							>Enviar otra Asignación Familiar</a>&nbsp;&nbsp;&nbsp;
			<a class="btn btn--primario" href="<c:url value="/initemp.do" />"
							>Cambiar empresa</a>&nbsp;&nbsp;&nbsp;
            <a class="btn btn--primario" href="<c:url value="/exit.do" />">Ir al home</a>
            </div>
          </div>
        </div>
      </div>
