	...
	<div align="right">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<div class="separador"></div>
				<form class="form" id="paso1" action="paso2.do" method="POST" style="margin-top: -20px">
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_rut" type="text" id="rut" name="rut"
									value="" maxlength="12"/> <label for="rut">RUT</label>
							</div>
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								style="position: relative">
								 	...
								 	<p class="adicional adicional--dos" style="color:#2072BC;padding-left: 10%">
									<br>Para información e instrucciones de uso puede descargar
									instructivo (<a style="color:#134470" href="resources/pdf/acreditacióndeASFAM-WEB.pdf" target="_blank">descarga aqui</a>)
								</p>
                  ...
                  <div class="captcha" id="captcha"></div>
					...
					<div class="col xs12 lg6" style="margin-top: -10px">
						...
						<ul>
							...
							<li><p class="adicional adicional--dos"
									style="padding-left: 3%;">
									-&nbsp;&nbsp;&nbsp;Declaración Jurada de Ingresos Para Actualización Asignación Familiar (<a style="color: #2072BC"
				...
				<form class="form" id="documentacion" action="documentacion.do"
					method="POST">
					<input type="hidden" id="rutTrabajador" name="rutTrabajador"
									value="" />
					</form>
			</div>
