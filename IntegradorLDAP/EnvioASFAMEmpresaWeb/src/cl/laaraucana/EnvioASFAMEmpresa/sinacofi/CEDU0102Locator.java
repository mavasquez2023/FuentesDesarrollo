...
public class CEDU0102Locator extends org.apache.axis.client.Service implements cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102 {
    ...
    public cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102Soap getCEDU0102Soap() throws javax.xml.rpc.ServiceException {
    ...
    public cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102Soap getCEDU0102Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102SoapStub _stub = new cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102SoapStub _stub = new cl.laaraucana.EnvioASFAMEmpresa.sinacofi.CEDU0102SoapStub(new java.net.URL(CEDU0102Soap_address), this);
                _stub.setPortName(getCEDU0102SoapWSDDServiceName());
                return (Remote) _stub;
            }
        }
