...
public class RespuestaCEDU0102  implements java.io.Serializable {
    ...
    private cl.laaraucana.EnvioASFAMEmpresa.sinacofi.Detalle[] detalles;
    ...
    public RespuestaCEDU0102(
           ...
           cl.laaraucana.EnvioASFAMEmpresa.sinacofi.Detalle[] detalles) {
     ...
     * @return detalles
     */
    public cl.laaraucana.EnvioASFAMEmpresa.sinacofi.Detalle[] getDetalles() {
        return detalles;
    }
     ...
     * @param detalles
     */
    public void setDetalles(cl.laaraucana.EnvioASFAMEmpresa.sinacofi.Detalle[] detalles) {
        this.detalles = detalles;
    }
