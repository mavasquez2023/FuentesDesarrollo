        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Registro Realizado Exitosamente </h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente hemos enviado tu clave de sucursal virtual <span class="bold">Mi Araucana</span> al correo electrónico registrado <span class="color--secundario">${email }</span></p>
            </div>
