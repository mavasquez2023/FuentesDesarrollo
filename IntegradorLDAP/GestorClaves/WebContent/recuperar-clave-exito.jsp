        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Recuperación de Clave Realizada Exitosamente </h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente hemos enviado tu clave de sucursal virtual <span class="bold">Mi Araucana</span> al correo electrónico registrado <span class="color--secundario">${emailX}</span></p>
            </div>
            <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="<c:url value='<%=cl.laaraucana.claves.utils.Configuraciones.getConfig("url.salir.portal")%>' />" target="_top">Ir al home</a>
            </div>
          </div>
        </div>
      </div>
