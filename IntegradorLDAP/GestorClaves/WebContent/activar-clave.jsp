    ...
    <main>
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col xs12 lg10" style="margin-top: 5px">
            <div class="pasos">
            ...
            <div class="separador"></div>
            <form class="form" id="paso2" action="registraAfiliado.do"  method="post">
              <div class="row">
                ...
                <div class="col xs12 lg6">
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: +56912345678">
                    <input class="text requerido tipo_fono tipo_numerico" type="text" id="celular" name="celular" data-prefijo="+569" data-prefijo-tipo="celular"/>
                    <label for="celular">Celular</label>
                  </div>
                </div>
                <div class="col xs12 lg6">
                  <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: +56912345678">
                    <input class="text tipo_fono tipo_numerico" type="text" id="telefono" name="telefono" data-prefijo="+56" data-prefijo-tipo="fijo"/>
                    ...
                    <div class="row">
                      <div class="col xs12 lg6">
                        <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: nombre@correo.cl">
                          <input class="text requerido tipo_email" type="text" id="email" name="email"/>
                          <label for="email">Email</label>
                        </div>
                      </div>
                      <div class="col xs12 lg6">
                        <div class="form__grupo" data-animacion="placeholder" data-comentario="Ej: nombre@correo.cl">
                          <input class="text requerido tipo_email" type="text" id="confirmar-email" name="confirmar-email" autocomplete="off"/>
                ...
                <div class="col xs12 md6" style="margin-top: 10px">
                  <div class="form__seleccion">
                    <div class="form__checkbox">
                      <input type="checkbox" name="terminos" id="terminos"/>
                      <label for="terminos">Acepto los <a class="link-externo" href="pdf/Termino_Condiciones.pdf" target="_blank">Términos y condiciones</a></label>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="btn__grupo text-align-right-xs"><a class="btn btn--primario" href="#" onClick="validarPaso2(); return false;">Registrarme</a>
              </div>
            </form>
          </div>
        </div>
