        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              ...
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente hemos enviado tu clave de sucursal virtual <span class="bold">Mi Araucana</span> al celular registrado <span class="color--secundario"></span></p>
            </div>
            <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="<c:url value='<%=cl.laaraucana.claves.utils.Configuraciones.getConfig("url.salir.portal")%>' />">Ir al home</a>
            </div>
          </div>
        </div>
      </div>
