        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">RUT No Registrado</h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente, favor registre sus datos para enviar clave de sucursal virtual <span class="bold">Mi Araucana</span> </p>
            </div>
            <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="<%=request.getContextPath()%>">Registrarme</a>
            </div>
          </div>
        </div>
      </div>
