        ...
        <div class="row justify-center-xs">
          ...
          <div class="col xs12 md8 lg6">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Error en la Recuperación de Clave, Intente Nuevamente </h4>
              <div class="separador"></div>
              <p class="respuesta__texto">Estimado cliente hemos presentado problemas en la recuperación de tu clave de sucursal virtual <span class="bold">Mi Araucana</span> intenta nuevamente o llámanos al <span class="color--secundario">600 4228 100</span></p>
            </div>
            <div class="btn__grupo text-align-center-xs"><a class="btn btn--primario" href="<%=request.getContextPath()%>/recuperar-clave.jsp">Volver</a>
            </div>
          </div>
        </div>
      </div>
