...
* 
*/
package cl.laaraucana.convenfsura.ibatis.config;
...
public class MyClassSqlConfig {
	...
	static {
		try {
			String resource = "cl/laaraucana/convenfsura/ibatis/config/IbatisConfig.xml";
	...
	static {
		try {
			String resource = "cl/laaraucana/convenfsura/ibatis/config/IbatisConfigSql.xml";
			Reader reader = Resources.getResourceAsReader(resource);
