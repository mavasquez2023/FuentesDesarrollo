	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<p>Conectando Convenio Enfermedades SURA</p>
				<div class="separador"></div>
				<form class="form" id="paso3" action="<%=cl.laaraucana.convenfsura.util.Configuraciones.getConfig("url.venta.sura")%>" method="POST">
					<!--div class="btn__grupo text-align-center-xs">
						<a class="btn btn--primario" href="#"
							onClick="submitPaso3(); return false;">Submit</a>
					</div-->
					<input class="text" type="hidden" id="Rut" name="Rut" value="${venta.rut }" /> 
					<input class="text" type="hidden" id="DV" name="DV" value="${venta.dv}" />
					<input class="text" type="hidden" id="Email" name="Email" value="${venta.email}" />
					<input class="text" type="hidden" id="Celular" name="Celular" value="${venta.celular }" /> 
					<input class="text" type="hidden" id="CanalId" name="CanalId" value="${venta.canal }" /> 
					<input class="text" type="hidden" id="Token" name="Token" value="${venta.token}" />
				</form>
			</div>
		</div>
	</div>
