 ...
 <g>
  ...
  <ellipse ry="9.24249" rx="8.96572" cy="20.6879" cx="48.9012" stroke-width="8" stroke="#f2f7f7" fill="none" id="svg_22"/>
			...
			<div class="col xs12 lg10">
					...
					<div class="row justify-center-xs justify-start-sm">
						...
						<div class="col xs12 sm12 md4">
							<div
								...
								<div class="pasos__data">
									<span>Paso 3</span>ENVÍA LA DOCUMENTACIÓN
								</div>
							</div>
						</div>
					</div>
				...
				<p>Selecciona el Folio de la Licencia</p>
				<div class="separador"></div>
				<form class="form" id="paso2" action="paso3DocP.do" method="POST">
					<div class="row">
						...
						<table class="col xs12 md12">
							<thead>
								<tr>
									...
									<th class="certificadoLeft" style="height: 30px; vertical-align: middle;">Observación</th>
									<th class="certificadoLeft" style="height: 30px; vertical-align: middle;">Envío doc pendiente</th>

								</tr>
								
							</thead>
							<tbody>
								    <c:forEach var="entry" varStatus="vs" items="${licenciasPendientesList}">
									<tr>
										<td class="certificadoLeft" style="height: 30px; vertical-align: middle;">${entry.folioLicencia}</td>
										<td class="certificadoLeft" style="height: 30px; vertical-align: middle;">${entry.fechaInicio}</td>
										<td class="certificadoLeft" style="height: 30px; vertical-align: middle;">${entry.fechaTermino}</td>
										<td class="certificadoLeft" style="height: 30px; vertical-align: middle;">${entry.diasLicencia}</td>
										<td class="certificadoLeft" style="height: 30px; vertical-align: middle;">${entry.tipoLicencia}</td>
										<td class="certificadoLeft" style="height: 30px; vertical-align: middle;">${entry.observacion}</td>
										
										<td class="certificadoLeft" style="height: 30px; vertical-align: middle;">
																				
											<a href="#" 
							onClick="validarPaso2DocP_2('${entry.folioLicencia}');"  style="text-decoration:none">
												<img alt="Editar Licencia" src="img/icono-de-archivo.png"  title="Editar Licencia" width="30" height="30"  />
					...
					<div class="btn__grupo text-align-right-xs">
						<a id="botonIL" class="btn btn--secundario btn--alto" href="<c:url value='/paso1.do' />">Volver</a>
