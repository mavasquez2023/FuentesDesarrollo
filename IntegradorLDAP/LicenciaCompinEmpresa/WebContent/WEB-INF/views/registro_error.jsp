...
<html lang="es">
  ...
  <body>
    <main>
      <div class="container">
        <div align="right">
		<form id="logout" method=GET action="salir">
 ...
 <g>
  ...
  <ellipse ry="9.24249" rx="8.96572" cy="20.6879" cx="48.9012" stroke-width="8" stroke="#f2f7f7" fill="none" id="svg_22"/>
          ...
          <div class="col xs12 md8 lg12">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Ha ocurrido un error al enviar licencias</h4>
              <div class="separador"></div>
              <p class="respuesta__texto"> Estimado cliente, hemos presentado problemas en el proceso, favor intente nuevamente o llámenos al <span class="color--secundario">600 4228 100</span></p>
