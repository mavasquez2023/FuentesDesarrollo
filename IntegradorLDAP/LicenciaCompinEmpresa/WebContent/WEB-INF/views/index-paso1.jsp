...
<body>
	...
	<div align="right">
		...
		<a href="#" onclick="$('#logout').submit();" style="text-decoration:none"><img alt="Salir" src="img/salir.png"  title="Cerrar Sesión" /><span class="pasos__data" style="font-size:1.6rem;color:gray;">&nbsp;Salir</span></a>
		</form>
	</div>
		<div class="row">
 ...
 <g>
  ...
  <ellipse ry="9.24249" rx="8.96572" cy="20.6879" cx="48.9012" stroke-width="8" stroke="#f2f7f7" fill="none" id="svg_22"/>
			...
			<div class="col xs12 lg10">
				...
				<p>Este servicio permitirá subir las licencia de tus trabajadores en forma electrónica</p>
				<div class="separador"></div>
				<form class="form" id="paso1" action="paso2.do" method="POST">
					<div class="row">
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<input class="text requerido" type="text" id="rutemp" name="rutemp"
									value="${rutemp}" disabled="disabled"
									style="background-color: #DCDCDC" /> <label for="rut">RUT Empresa</label>
							</div>

						</div>
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder">
								<input class="text requerido" type="text" id="razonSocial"
									name="razonSocial" value="${razonSocial}" disabled="disabled"
									style="background-color: #DCDCDC" /> <label for="nombre">Razon Social</label>
							</div>
						</div>
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_rut" type="text" id="rut" name="rut"
									value="" maxlength="12"/> <label for="rut">RUT Trabajador</label>
							</div>
							<c:if test='${errorMsg=="rut_error" }'>
								<div class="alerta alerta--error">
									El RUT ingresado no pertenece a la empresa seleccionada.
								</div>
							</c:if>
							<c:if test='${errorMsg=="rut_inactivo" }'>
								<div class="alerta alerta--error">
									El RUT ingresado no está activo en la empresa seleccionada.
								</div>
							</c:if>
						</div>
					</div>
				  ...
				  <div class="separador"></div>
					...
					<div class="btn__grupo text-align-right-xs">
						<a id="botonIL" class="btn btn--secundario btn--alto" href="<c:url value='/initemp.do' />">Volver</a>
						&nbsp;&nbsp;<a id="botonDP" class="btn btn--primario btn--2palabras" href="#" 
							onClick="validarPaso1('DP'); return false;">Documentación <br>Pendiente</a>
							<a id="botonIL" style="margin-left: 20px" class="btn btn--primario btn--alto" href="#"
							onClick="validarPaso1('IL'); return false;"	>Ingresar Licencia</a>	
					</div>
				</form>
			</div>
