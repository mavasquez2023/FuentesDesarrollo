 ...
 <g>
  ...
  <ellipse ry="9.24249" rx="8.96572" cy="20.6879" cx="48.9012" stroke-width="8" stroke="#f2f7f7" fill="none" id="svg_22"/>
			...
			<div class="col xs12 lg10">
				...
				<form class="form" id="paso2" action="registrar.do" method="POST" style="margin-top: 10px">
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_fono tipo_numerico"
									...
									for="telefono">Teléfono Empresa</label>
							</div>
						</div>
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_email" type="text" id="email"
									name="email" value="${email}" /> <label for="email">Email Empresa</label>
							</div>
						</div>
								...
								<div class="row" style="margin-top: -15px">
									...
									<div class="col xs12 lg6">
										<div class="form__grupo bold" data-animacion="placeholder"
											data-comentario="Seleccione región laboral">
											<select class="requerido" id="region" name="region">
									...
									<div class="col xs12 lg6">
										<div class="form__grupo bold"
											data-comentario="Selecione comuna laboral">
											<select class="text requerido" id="comuna" name="comuna">
									...
									<div class="col xs12 lg6">
										<div class="form__grupo" data-animacion="placeholder"
											data-comentario="Ingrese el folio de licencia" style="margin-top: -15px">
											<input class="text requerido" type="text" id="folioLicencia"
												name="folioLicencia" value="${folio}" maxlength="9" onkeypress="keyRut();"/> <label for="folioLicencia"
												value="${datos.folioLicencia}">Folio</label>
												<div class="ayuda ayuda--form">
												<span style="color: red">?</span>
												<div class="ayuda__container">
													<p>Acá puedes encontrar el folio de tu licencia médica.</p>
													<div class="separador--small"></div>
													<a href="img/ejemploFolio.png" target="_blank"><img
														src="img/ejemploFolio.png" alt="Número serie" />
													</a>
												</div>
											</div>
										</div>
					...
					<div class="btn__grupo text-align-right-xs">
						<a id="botonIL" class="btn btn--secundario" href="<c:url value='/paso1.do' />">Volver</a>
