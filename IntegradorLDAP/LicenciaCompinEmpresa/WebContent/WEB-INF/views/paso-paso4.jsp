...
<body>
	...
	<div align="right">
		...
		<div class="row">
			<div class="col xs12 lg2 text-align-center-xs">
				<svg width="155.30017318187797" height="139.99975464130628"
					xmlns="http://www.w3.org/2000/svg" class="svg svg--secundario">
 ...
 <g>
  <title>Subir Licencia - La Araucana</title>
  <path
						d="m77.699997,85.400002c23.599998,0 42.700005,-19.099998 42.700005,-42.700001s-19.200005,-42.700001 -42.700005,-42.700001s-42.799995,19.1 -42.799995,42.700001s19.199997,42.700001 42.799995,42.700001zm0,-77.600001c19.299995,0 34.900002,15.600001 34.900002,34.900001s-15.599998,34.999996 -34.900002,34.999996s-34.999996,-15.699997 -34.999996,-34.999996c0,-19.300001 15.700001,-34.900001 34.999996,-34.900001z"
						id="svg_1" />
  <path
						d="m135.600006,96.800003l0,0c-37.200005,-15 -78.800003,-15 -116,0l0,0c-11.900006,4.899994 -19.600006,15.199997 -19.600006,26.599998l0,16.599998l155.300003,0l0,-16.599998c0,-11.400002 -7.699997,-21.700005 -19.699997,-26.599998zm11.899994,35.399994l-139.7,0l0,-8.900002c0,-8.099998 5.8,-15.699997 14.8,-19.299995c35.300001,-14.200005 74.800001,-14.200005 110.200003,0c9,3.599998 14.799988,11.199997 14.799988,19.299995l0,8.900002l-0.099991,0z"
						id="svg_2" />
  <line y2="127.31" x2="106.795" y1="105.73" x1="106.795"
						stroke-width="8" stroke="#bf0000" fill="none" id="svg_5" />
  <line y2="116.255" x2="117.825" y1="116.255" x1="95.7204"
						stroke-width="8" stroke="#bf0000" fill="none" id="svg_6" />
  <polyline points="74.6904,26.7804 74.6904,26.7804" stroke-width="7"
						stroke-linecap="round" fill="none" id="svg_10" />
  <polyline points="49.4304,21.5154 49.4304,21.5154" stroke-width="7"
						stroke-linecap="round" stroke="#000a0a" fill="none" id="svg_20" />
  <ellipse ry="20.5249" rx="20.5275" cy="20.9649" cx="48.9029"
						stroke-width="9" fill="#0f0f00" id="svg_34" />
  <ellipse ry="9.24249" rx="8.96572" cy="20.6879" cx="48.9012"
						stroke-width="8" stroke="#f2f7f7" fill="none" id="svg_22" />
 </g>
</svg>
			...
			<div class="col xs12 lg10">
					...
					<div class="row justify-center-xs justify-start-sm">
						<div class="col xs12 sm12 md4 oculto-xs block-md">
							<div
								...
								<div class="pasos__data">
									<span>Paso 1</span>INGRESA RUT TRABAJADOR
								</div>
							</div>
						</div>
						<div class="col xs12 sm12 md4 oculto-xs block-md">
							<div
								...
								<div class="pasos__data">
									<span>Paso 2</span>INGRESA DATOS TRABAJADOR
								</div>
							</div>
						</div>
						<div class="col xs12 sm12 md4">
							<div
								...
								<div class="pasos__data">
									<span>Paso 3</span>ENVÍA LA LICENCIA
								</div>
							</div>
						</div>
					</div>
				...
				<p>Puedes subir imágenes o documentos adicionales, selecciona el
					archivo y haz clic en Subir.<br>Al finalizar selecciona Enviar.</p>
				<div class="separador"></div>
				<form class="form" id="paso4" action="files-add.do" method="POST"
					...
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="documento__item">
								<span class="documento__tipo"></span><span
									...
									class="documento__nombre__text">Adjuntar Documento</span><span
									...
									class="documento__input" type="file" id="adicional"
									name="adicional" data-maxsize="5000"
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								data-comentario="">
								<p class="adicional adicional--dos">Sube tus documentos
									adicionales (peso máximo del archivo 5M)</p>
					...
					<div class="separador"></div>
						<div class="col xs12 lg6">
							<div class="btn__grupo text-align-center-xs" style="padding-right: 12%">
								<a class="btn btn--primario" href="#"
								onClick="validarPaso4(); return false;">Subir otro documento</a>
							</div>
						</div>
					<c:if test="${files!=null}">
					<div class="col xs12 lg12">
						<div class="alerta alerta--exito" id="aviso">
						<ul>
							<c:forEach items="${files}" var="item">
								<li><p class="adicional adicional--dos">Archivo:&nbsp;${item}&nbsp;subido.</p></li>
							</c:forEach>
						</ul>
						</div>
					</div>
		...
		<div class="btn__grupo text-align-right-xs" style="margin-top:-40px">

			<a class="btn btn--primario" href="#"
				onClick="validarPaso5(); return false;">Enviar Licencia</a>
		...
		<form class="form" id="paso3" action="volver_paso3.do" method="POST">
			<input type="hidden" name="opcion" id="opcion" value="IL" />
		</form>
		<form class="form" id="paso5" action="success.do" method="POST">
