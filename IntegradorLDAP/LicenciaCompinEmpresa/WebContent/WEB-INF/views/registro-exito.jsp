  ...
  <ellipse ry="9.24249" rx="8.96572" cy="20.6879" cx="48.9012" stroke-width="8" stroke="#f2f7f7" fill="none" id="svg_22"/>
          ...
          <div class="col xs12 md8 lg10">
            <div class="respuesta text-align-center-xs">
              ...
              <div class="separador"></div>
              <p class="respuesta__texto"><span>Tus archivos se han subido exitosamente!</span></p>
            </div>
					
            <div class="btn__grupo text-align-center-xs">
            <a class="btn btn--primario" href="<c:url value='/paso1.do' />" onClick="javascript:fln.preloader(1);"
							>Enviar otra licencia</a>&nbsp;&nbsp;&nbsp;
			<a class="btn btn--primario" href="<c:url value='/initemp.do' />" onClick="javascript:fln.preloader(1);"
							>Cambiar empresa</a>&nbsp;&nbsp;&nbsp;
