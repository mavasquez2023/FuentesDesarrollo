  ...
  <tr style="border: 0 px;border-color: #FFFFFF;">
	...
	<ul>
			...
			<li class="active">
				...
				<ul>
				   <li><a href="<c:url value='/init.do'/>" title="Boletas Pendientes">Boletas Pendientes</a></li>
				   
				    <li><a href="<c:url value='/emitidas.do'/>" title="Boletas Emitidas">Boletas Emitidas</a></li>
				   
				 	<li><a href="<c:url value='/parametros.do'/>" title="Mantenedor parámetros">Mantenedor Par&aacute;metros</a>
					</li>
