...
var validarPaso0 = function validarPaso0() {
...
var validarPaso1 = function validarPaso1() {
	...
	validarFormulario('paso1', {
		texto : 'Debe ingresar ',
		otrosCampos : {
			'N�mero de Serie v�lido' : [ serieValido,
					$('#paso1').find('.serie') ],
...
var validarRespuestas = function validarRespuestas() {

	validarFormulario('paso_setpreguntas', {
		texto : 'Debe ingresar ',
		otrosCampos : {
		...
		exito : function exito() {
			 ...
			 */
			fln.preloader(1);
			$('#paso_setpreguntas').submit();
		}
	});
};

var validarPasoPreguntas = function validarPasoPreguntas() {
...
var validarPaso2 = function validarPaso2() {
	...
	if( $("#paso2 input[name='credito']:radio").is(':checked')) {  
		 _check = true;
	...
	validarFormulario('paso2', {
		...
		otrosCampos : {
			...
			'Seleccione para aprobar' : [ _check ],
			'Link a documentaci�n para descargar PDF' : [ _pdf]
		},
		exito : function exito() {
			/*
			 * Ingresar metodo para procesar el formulario aquí Puede ser:
