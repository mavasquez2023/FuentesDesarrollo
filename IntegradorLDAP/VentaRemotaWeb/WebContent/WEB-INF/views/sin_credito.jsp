		...
		<div class="row">
          ...
          <div class="col xs12 md8 lg10">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">Estimado(a) ${nombre}, no tienes créditos para aprobar el día de hoy</h4>
              <div class="separador"></div>
              <p class="respuesta__texto"><span>En caso de dudas, le solicitamos contactar al ejecutivo que le atendió.</span></p>
            </div>
