	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<div class="separador"></div>
				<form class="form" id="paso1" action="login.do" method="POST">
					<div class="row">
						...
						<div class="col xs12 lg6">
							<div class="form__grupo" data-animacion="placeholder"
								...
								<input class="text requerido tipo_rut" type="text" id="rut" name="rutAfiliado"
									value="${rutLdap }" maxlength="12" autocomplete="off" /> <label for="rut">RUT</label>
							</div>
						</div>
					</div>
					<c:if test='${errorMsg=="rut_error" }'>
								<div class="alerta alerta--error">
									Rut o Contraseña no válida, intente nuevamente.
								</div>
					</c:if>
