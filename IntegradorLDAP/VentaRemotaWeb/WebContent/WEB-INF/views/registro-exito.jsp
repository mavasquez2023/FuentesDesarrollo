          ...
          <div class="col xs12 md8 lg10">
            <div class="respuesta text-align-center-xs">
             ...
             <c:if test="${tipoCredito=='Renegociación' || tipoCredito=='Normal'}">
              <p class="respuesta__texto"><span>Su crédito social será transferido a su cuenta bancaria a más tardar el próximo día hábil.</span></p>
             </c:if>
              <div class="separador"></div>
              <p class="respuesta__texto"><span>Le enviaremos prontamente la documentación a su correo electrónico.</span></p>
            </div>
