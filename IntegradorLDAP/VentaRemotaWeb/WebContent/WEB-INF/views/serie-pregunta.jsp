	...
	<div align="right">
		...
		<div class="row">
			...
			<div class="col xs12 lg10">
				...
				<p>Ya casi hemos terminado.<br/>Por seguridad, requerimos hacer una última validación.</p>
				<div class="separador"></div>
				<form class="form" id="serie-pregunta" action="question.do" method="POST">
					<div class="row">
                 ...
                 <!--  <div class="captcha" id="captcha"></div>-->
					...
					<div class="btn__grupo text-align-center-xs">
						<a class="btn btn--primario" href="#"
							onClick="validarPaso5(); return false;">Continuar</a>
					</div>
