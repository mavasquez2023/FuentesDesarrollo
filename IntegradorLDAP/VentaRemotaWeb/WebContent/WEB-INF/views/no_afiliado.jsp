		...
		<div class="row">
					...
					<div class="row justify-center-xs justify-start-sm">
						...
						<div class="col xs12 sm12 md4">
							<div
								...
								<div class="pasos__data">
									<span>Paso 3</span>APROBACIÓN CRÉDITO
								</div>
							</div>
						</div>
					</div>
          ...
          <div class="col xs12 md8 lg12">
            <div class="respuesta text-align-center-xs">
              <h4 class="respuesta__titulo color--secundario">¡Lo sentimos, ha ocurrido un error!</h4>
              <div class="separador"></div>
              <p class="respuesta__texto"> Estimado cliente, no se encuentra registrado como afiliado, favor intente nuevamente o llámenos al <span class="color--secundario">600 4228 100</span></p>
