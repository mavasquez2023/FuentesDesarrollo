			...
			<div class="col xs12 lg10">
				...
				<div class="col xs12 md8 lg10">
					<div class="respuesta text-align-center-xs">
						...
						<c:if
							test="${tipoCredito!='Reprogramación' && tipoCredito!='Acuerdo de pago'}">
							<p>
								<b>¡Felicitaciones, sus respuestas son correctas! Ahora
									puede aprobar su crédito.</b>
							</p>
						</c:if>
						<c:if
							test="${tipoCredito=='Reprogramación' || tipoCredito=='Acuerdo de pago'}">
							<p>
								<b>¡Felicitaciones, sus respuestas son correctas! Ahora
									puede aprobar su reprogramación.</b>
							</p>
						</c:if>
						...
						<div class="btn__grupo text-align-center-xs">
							<a class="btn btn--primario" id="btn-aprobar" href="#"
								style="background: #1A9332; border-color: #1A9332">Aprobar</a>
						</div>

						<form id="aprobar-action" action="aprobar.do" method="post"></form>
