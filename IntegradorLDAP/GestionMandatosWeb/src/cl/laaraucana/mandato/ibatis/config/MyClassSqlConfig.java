...
* 
*/
package cl.laaraucana.mandato.ibatis.config;
...
public class MyClassSqlConfig {
	...
	static {
		try {
			String resource = "cl/laaraucana/mandato/ibatis/config/IbatisConfig.xml";
	...
	static {
		try {
			String resource = "cl/laaraucana/mandato/ibatis/config/IbatisConfigSql.xml";
			Reader reader = Resources.getResourceAsReader(resource);
