...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="${contextRoot}/styles/internet/araucana.css" rel="stylesheet" type="text/css"/>
		<link href="${contextRoot}/styles/internet/jquery.tools.css" rel="stylesheet" type="text/css"/>
	...
	<body onbeforeunload="javascript:showLoadingInternet();">	

		<div id="loading" style="position:fixed; top:30%; left:50%; display:none; z-index: auto" >
			<html:img page='/images${internetPath}/3d-loader.gif' height="30" width="30" />
		</div>
	...
	<html:form action="/commons/GoBack" styleId="initialBack">
		<html:hidden property="_cmd" value="${_backtile}"/>
	</html:form>
	
	<html:form action="/commons/GoBack" styleId="popUpForm" target="popUp">
	</html:form>	
