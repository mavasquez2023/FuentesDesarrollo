...
<script language="javascript">
	...
	function envialink(id){
		document.location("/adminBecasIncentivos/EliminaBeca.do?idBeneficiario="+id+"+&texto=ddddd")
	}
					...
					<c:if test="${beneficiario.tieneBeca}">
							...
							<div id="masBeca${i}" style="display:none">
								<logic:iterate id="becas" name="beneficiario" property="listaBecas">
									...
									<!-- <html:link page="/	/detalleBeneficiario.do?_cmd=inicio&idBeneficiario=${becas.idBeneficiario}" styleClass="links" target="_blank"><bean:write name="becas" property="nombreBeca" /></html:link>-->
									<html:link page="/adminBecasIncentivos/eliminaDetalleBeneficiario.do?idBeneficiario=${becas.idBeneficiario}" styleClass="links" onclick="javascript:setTimeout('hideLoading();',4000);"><img src="${contextRoot}/images/icono_basurero.gif"/></html:link>
									<br/>
