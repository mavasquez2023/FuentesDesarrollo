...
<html>
	<head>
		<title>Planillas AFPs DNP</title>
...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaAFPDNP_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">


		<FORM id="form1">
		<input type="hidden" value="Planillas AFPs DNP Holding:Planillas AFPs DNP" name="_folder">
			<font class="titulo">Solicitud Planillas AFPs DNP</font>
