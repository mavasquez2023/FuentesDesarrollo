...
<html>
	...
	function BajarPDF(){
		var strCondicion = "";
		var holding= "${holding}";
	        strCondicion = strCondicion + " AND Holding IN (" + holding.replace(".", ",") + ")";
		...
		window.parent.frames("frmDownload").document.all.inTipo.value = "11";
...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaAFPTP_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">
		<FORM id="form1">
			<input type="hidden" value="Planillas AFPs TP Holding:Planillas AFPs TP" name="_folder">
					<font class="titulo">Solicitud Planillas AFPs Pesados</font>
					<br/>
					<br/>
