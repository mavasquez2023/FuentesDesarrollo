...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaAFP_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">
		<FORM id="form1">
			<input type="hidden" value="Planillas AFPs Holding:Planillas AFPs" name="_folder">
				<font class="titulo">Solicitud Planillas AFPs</font>
				<br/>
				<br/>
