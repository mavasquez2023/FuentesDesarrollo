...
<html>
	<head>
		<title>Planillas INP Pagadas</title>
	...
	function Aceptar(){
		...
		window.parent.frames['frmResultado'].document.all.NumeroSerie.value = form1.NumeroSerie.value;
	...
	function BajarPDF(){
		...
		if (form1.NumeroSerie.value != "") {
			strCondicion = strCondicion + " AND NumeroSerie = ''" + form1.NumeroSerie.value + "''";
	    }
		...
		window.parent.frames["frmDownload"].document.all.inTipo.value = "4";
...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaINPPago_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">
		<FORM id="form1">
		<input type="hidden" value="Planillas INP DNP Pagadas Holding:Planillas INP DNP Pagadas" name="_folder">
			<font class="titulo">Solicitud Planillas INP Pago Atrasado</font>
				<br/>
				<br/>
				...
				<table width="650" border="0" cellspacing="5" cellpadding="0" id="tabla_cont">
					<tr>
			        	...
			        	<td align="left" valign="middle" nowrap="nowrap">Desde<strong>
								<input type="text" id="FechaProceso" class="campos" value="${periodoant}" style="font-family:Arial;font-size:8pt;" size="10" maxlength="6" onkeypress="JValidaCaracter('Numerico','');" onblur="ValidaFecha(this); ValidaRango(this, FechaProceso2); ValidaFeinicotiza(this, FechaProceso2, ${inicotiza})">&nbsp;
										</strong>Hasta<strong>
								<input type="text" id="FechaProceso2" class="campos" value="${periodo}" style="font-family:Arial;font-size:8pt;" size="10" maxlength="6" onkeypress="JValidaCaracter('Numerico','');" onblur="ValidaFecha(this); ValidaRango(FechaProceso, this); ValidaFeinicotiza(FechaProceso, this, ${inicotiza})">&nbsp;
										<span class="fecha_cuadro">(aaaamm)</span> </strong>
						</td>
					</tr>
					<tr>
						<td align="left" valign="middle" nowrap="nowrap">Nº Serie :</td>
						<td>
								<input name="NumeroSerie" id="NumeroSerie" type="text" size="12" maxlength="10" style="font-family:Arial;font-size:8pt;" onkeypress="JValidaCaracter('Numerico','')">
						</td>
						<td align="left" valign="middle" nowrap="nowrap">Folio :</td>
						<td>
								<input name="FolioPlanilla" type="text" id="FolioPlanilla" style="font-family:Arial;font-size:8pt;" onblur="validaFolio();" onkeypress="JValidaCaracter('Numerico','');" size="12" maxlength="10">
						</td>
					</tr>
					<tr>
