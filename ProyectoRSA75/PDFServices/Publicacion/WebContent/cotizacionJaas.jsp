...
<html>
	...
	<frameset rows="0,*,0" frameborder="no">
	<frame src="fblank.htm" scrolling="no" noresize	name="frmPresenta" id="frmPresenta">
<!--	<frameset cols="0,*,0,0" frameborder="no" id="menuFrame" onload="showMenu()"> -->
	<frameset cols="190,*,0,0" frameborder="no">
		<frame src="PaginaPresentacionJaas" name="HITLIST" scrolling="auto" noresize>
