...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaINPDNP_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">

		<FORM id="form1">
		<input type="hidden" value="Planillas INP DNP Holding:Planillas INP DNP" name="_folder">
			<font class="titulo">Solicitud Planillas INP DNP</font>
				<br/>
				<br/>
				...
				<table width="650" border="0" cellspacing="5" cellpadding="0" id="tabla_cont">
					<tr>
				        ...
				        <td align="left" valign="middle" nowrap="nowrap">Desde<strong>
								...
								<input type="text" id="FechaProceso2" class="campos" value="${periodo}" style="font-family:Arial;font-size:8pt;" size="10" maxlength="10" onkeypress="JValidaCaracter('Numerico','');" onblur="ValidaFecha(this); ValidaRango(FechaProceso, this); ValidaFeinicotiza(FechaProceso, this, ${inicotiza})">&nbsp;
