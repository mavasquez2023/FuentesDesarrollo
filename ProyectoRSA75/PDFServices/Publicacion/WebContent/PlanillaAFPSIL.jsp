...
<html>
	<head>
		<title>Planillas AFPs SIL</title>
	...
	function BajarPDF(){
		...
		if (form1.Sucursal.value != "") {
			strCondicion = strCondicion + " AND Sucursal = ''" + form1.Sucursal.value + "''";
	        }
		...
		window.parent.frames("frmDownload").document.all.inTipo.value = "16";  // ver Download.pdf función retornaTipo
...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaAFPSIL_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">

		<FORM id="form1">
		<input type="hidden" value="Planillas AFPs SIL Holding" name="_folder">

				<font class="titulo">Solicitud Planillas AFPs SIL</font>
				<br/>
				<br/>
			...
			<table width="650" border="0" cellspacing="5" cellpadding="0" id="tabla_cont">
				...
				<tr>
					...
					<td width="27%" align="left" valign="middle"><strong>
							...
							<option value="S">Subsidio de Incapacidad Laboral</option>
					  </select>
					</strong></td>
