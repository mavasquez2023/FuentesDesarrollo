...
<script>
	...
	function Aceptar(){
		...
		window.parent.frames['frmResultado'].document.all.NombreMutual.value = form1.NombreMutual.value;
	...
	function BajarPDF(){
		...
		if (form1.NombreMutual.selectedIndex != 0) {
			strCondicion = strCondicion + " AND NombreMutual LIKE ''" + form1.NombreMutual.value + "%''";
	    }
		...
		window.parent.frames("frmDownload").document.all.inTipo.value = "6";
...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaMutual_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">

		<FORM id="form1">
<input type="hidden" value="Planillas Mutuales Holding:Planillas Mutuales" name="_folder">		
	<font class="titulo">Solicitud Planillas Mutuales</font>
				<br/>
				<br/>
				...
				<table width="650" border="0" cellspacing="5" cellpadding="0" id="tabla_cont">
					<tr>
				        ...
				        <td align="left" valign="middle" nowrap="nowrap">Desde<strong>
					        		<input type="text" id="FechaProceso" value="${periodoant}" style="font-family:Arial;font-size:8pt;" size="10" maxlength="6" onkeypress="JValidaCaracter('Numerico','');" onblur="ValidaFecha(this); ValidaRango(this, FechaProceso2); ValidaFeinicotiza(this, FechaProceso2, ${inicotiza})">&nbsp;
								</strong>Hasta<strong>						
									<input type="text" id="FechaProceso2" value="${periodo}" style="font-family:Arial;font-size:8pt;" size="10" maxlength="6" onkeypress="JValidaCaracter('Numerico','');" onblur="ValidaFecha(this); ValidaRango(FechaProceso, this); ValidaFeinicotiza(FechaProceso, this, ${inicotiza})">&nbsp;
								<span class="fecha_cuadro">(aaaamm)</span> </strong>
						</td>
					</tr>
					<tr>					
						<td align="left" valign="middle" nowrap="nowrap">Mutual :</td>
						<td align="left" valign="middle">
					    	<select name='NombreMutual' id='NombreMutual' size='1' style='font-family:Arial;font-size:7pt;' onChange='rut_razon()'>
								<%
								...
								%>
								<c:forEach var="nommutual" items="${MUTUAL}">
									<option value='${nommutual}'>${nommutual}</option>
								</c:forEach>
							</select>
						</td>
