...
<html>
	...
	function BajarPDF(){
		...
		if (form1.NombreAFP.selectedIndex != 0) {
			strCondicion = strCondicion + " AND NombreAFP LIKE ''" + form1.NombreAFP.value + "%''";
	    }
...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaCotAPC_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">
		<FORM id="form1">
			<input type="hidden" value="Planillas APVs Colectivo Holding:Planillas APVs Colectivo" name="_folder">
				<font class="titulo">Solicitud Cotizaciones APC</font>
				<br/>
				<br/>
