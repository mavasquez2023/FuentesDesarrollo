...
<head>
	...
	<title>Archivo para Dirección del Trabajo (F30-1)</title>
	...
	<script type="text/javascript">
		...
		function generaZIP(index)
		{
			window.location="/Publicacion/ArchivoCotizacionPrevisionalZIP?indice="+index.toString();
			//window.open("/Publicacion/zipDownload.jsp?indice=" + index,'width=800,height=630,left=0,top=100,screenX=0,screenY=100');
		}
	</script>
</head>
			...
			<table align="center" border="1" style="font-size:12px;background:#ffffff;border-collapse: collapse;" bordercolor="darkblue">
				...
				<c:forEach begin="1" end="${(fn:length(comprobantes))}">
					<tr>
						...
						<td>
							<button type="button" name="bpdf"
							 onclick="generaZIP('${comprobantes[pos].index}');"
							 >Descargar</button>
						</td>
					</tr>
