...
<html>
	...
	function Aceptar(){
		...
		window.parent.frames['frmResultado'].document.all.NombreAFP.value = form1.NombreAPV.value;
	...
	function BajarPDF(){
		...
		if (form1.NombreAPV.selectedIndex != 0) {
			strCondicion = strCondicion + " AND NombreAFP LIKE ''" + form1.NombreAPV.value + "%''";
	    }
		...
		window.parent.frames["frmDownload"].document.all.inTipo.value = "2";
...
<body leftmargin="3" topmargin="3" marginwidth="3" marginheight="3" onload="window.open('PlanillaAPV_Obj.htm','frmResultado');window.open('Download.htm','frmDownload');sizeRows();">

		<FORM id="form1">
		<input type="hidden" value="Planillas APVs Holding:Planillas APVs" name="_folder">
			<font class="titulo">Solicitud Planillas APVs</font>
			<br/>
			<br/>
			...
			<table width="650" border="0" cellspacing="5" cellpadding="0" id="tabla_cont">
				...
				<tr>
					...
					<td width="27%" align="left" valign="middle"><strong>
							<br><select name="TipoProceso" size="1" id="TipoProceso" class="campos">
				...
				<tr>
					<td align="left" valign="middle" nowrap="nowrap">APV :</td>
					<td align="left" valign="middle">
						<select name='NombreAPV' id='NombreAPV' size='1' style='font-family:Arial;font-size:7pt;' onChange='rut_razon()'>
							<%if (!usuario.equals("entidad")){ %>
							<option value=''>--Todas--</option>
							<%} %>
							<c:forEach var="nomapv" items="${APV}">
							<option value='${nomapv.value}'>${nomapv.nombre}</option>
							</c:forEach>
							<%if (!usuario.equals("entidad")){ %>
								<option value='BANCOESTADO ADMINISTRADORA GENERAL DE FO'>BANCOESTADO ADMINISTRADORA GENERAL DE FONDOS</option>
								<option value='BICE INVERSIONES ADMINISTRADORA GENERAL '>BICE INVERSIONES ADMINISTRADORA GENERAL DE FONDOS</option>
								<option value='BICE INVERSIONES CORREDORES DE BOLSA'>BICE INVERSIONES CORREDORES DE BOLSA</option>
								<option value='CHILENA CONSOLIDADA SEG. VIDA S.A.'>CHILENA CONSOLIDADA SEG. VIDA S.A.</option>
								<option value='CIA SEG VIDA EUROAMERICA SA'>CIA SEG VIDA EUROAMERICA S.A.</option>
								<option value='CORPBANCA ADMINISTRADORA GENERAL DE FOND'>CORPBANCA ADMINISTRADORA GENERAL DE FONDOS S.A.</option>
								<option value='CRUZ DEL SUR CORREDORA DE BOLSA S.A.'>CRUZ DEL SUR CORREDORA DE BOLSA S.A.</option>
								<option value='EUROAMERICA ADMINISTRADORA GENERAL DE FO'>EUROAMERICA ADMINISTRADORA GENERAL DE FONDOS S.A.</option>
								<option value='IM TRUST ADMINISTRADORA GENERAL DE FONDO'>IM TRUST ADMINISTRADORA GENERAL DE FONDO</option>
								<option value='LARRAIN VIAL S.A.'>LARRAIN VIAL S.A.</option>
								<option value='LEGG MASON (CHILE) ADMINISTRADORA GRAL. '>LEGG MASON (CHILE) ADMINISTRADORA GRAL. DE FONDOS</option>
								<option value='LOS ANDES'>LOS ANDES</option>
								<option value='PENTA ADMINISTRADORA GENERAL DE FONDOS S'>PENTA ADMINISTRADORA GENERAL DE FONDOS S.A.</option>
								<option value='PRINCIPAL ADM. GRAL. DE FONDOS'>PRINCIPAL ADM. GRAL. DE FONDOS</option>
								<option value='PRINCIPAL VIDA CHILE S.A.'>PRINCIPAL VIDA CHILE S.A.</option>
								<option value='SANTANDER S.A. ADMINISTRADORA DE FONDOS '>SANTANDER S.A. ADMINISTRADORA DE FONDOS MUTUOS</option>
								<option value='SANTANDER SEGUROS DE VIDA S.A'>SANTANDER SEGUROS DE VIDA S.A</option>
								<option value='SCOTIA SUDAMERICANO ADM DE FONDOS MUTUOS'>SCOTIA SUDAMERICANO ADM DE FONDOS MUTUOS S.A.</option>
								<option value='ZURICH ADM GRAL DE FONDOS S.A.'>ZURICH ADM GRAL DE FONDOS S.A.</option>
