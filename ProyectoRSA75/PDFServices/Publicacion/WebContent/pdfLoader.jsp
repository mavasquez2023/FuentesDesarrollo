...
<script type="text/javascript">
		$(function(){
			...
			var rut = igualdades[0].split("=")[1];
			var year = igualdades[1].split("=")[1];
			var holding = igualdades[2].split("=")[1];
			//window.location="/Publicacion/CertificadoAnualPDF?rut="+rut.toString()+"&year="+year.toString()+"&holding="+holding;
			$.download('/Publicacion/CertificadoAnualPDF',"rut="+rut.toString()+"&year="+year.toString()+"&holding="+holding,'get');
		});
</script>
