...
public class ListaEmpresasAfbr extends HttpServlet {

	
	private static final long serialVersionUID = 740518947366536149L;

	public ListaEmpresasAfbr() {
	...
	protected void doPost(HttpServletRequest request,
		...
		empresa = dao.getDatosReporteGrilla(omeses);
		
		if (empresa.size() != 0) {

			Integer tamaño = new Integer(empresa.size());
			sesion.setAttribute("maxreg", tamaño);
			sesion.setAttribute("empresa", empresa);
			response.sendRedirect("PlanillasListaAfbr.jsp");
