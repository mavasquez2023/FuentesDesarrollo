 ...
 * Ventana - Preferencias - Java - Estilo de código - Plantillas de código
 */
public class PubDAOFactory {
	private Context ctx;
	private DataSource ds;
	private ConectaDB2 db2;
	private static Logger logger = LogManager.getLogger();
	
	public PubDAOFactory(){
		...
		try {
			...
			logger.finer("Conectando a Datasource: java:comp/env/jdbc/publica");
			//this.ds = (DataSource)ctx.lookup("java:comp/env/jdbc/publica");
			//this.ds = (DataSource)ctx.lookup("jdbc/cppub"); 
			this.ds = (DataSource)ctx.lookup("java:comp/env/jdbc/cppub");//**cambiar aquí**
