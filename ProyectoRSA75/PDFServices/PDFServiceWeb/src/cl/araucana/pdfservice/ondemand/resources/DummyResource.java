...
/*
 * @(#) DummyResource.java    1.0 30-06-2009
 *
...
public class DummyResource extends Resource {
	...
	private static final long serialVersionUID = -1791143038753204008L;

	private static Logger logger = LogManager.getLogger();
	
	public DummyResource(String name, String address, String params,
			String extras) {
	...
	public void end(String lastDocID) {
		logger.info(
				logID + "action: id=" + action.getID() + " docID=" + lastDocID);
