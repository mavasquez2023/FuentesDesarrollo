...
/*
 * @(#) IncludeCacheInstruction.java    1.0 10-04-2008
 *
 ...
 * @version 1.0
 */
public class IncludeCacheInstruction extends Instruction {

	private String name;

	public IncludeCacheInstruction(String label, String name) {
		super(FPGCode.INCLUDE_CACHE, label, true);
	...
	public void execute(CompiledPDFObject compiledObject,
		...
		compiledObject.includeCache(name);
	}
}
