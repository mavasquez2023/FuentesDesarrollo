...
/*
 * @(#) ImageInstruction.java    1.0 10-04-2008
 *
...
public class ImageInstruction extends Instruction {
	...
	public ImageInstruction(String label, int type,	int propIndex) {
		super(FPGCode.IMAGE, label, true);
	...
	public void execute(CompiledPDFObject compiledObject,
		...
		// TODO.
		throw new FPGException("Unimplemented image instruction still.");
	}
}
