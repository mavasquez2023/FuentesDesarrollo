...
/*
 * @(#) BeginCacheInstruction.java    1.0 10-04-2008
 *
 ...
 * @version 1.0
 */
public class BeginCacheInstruction extends JumpableInstruction {

	private String name;

	public BeginCacheInstruction(String label, String name, String jumpLabel) {
		super(FPGCode.BEGIN_CACHE, label, jumpLabel);

		this.name = name;
	}

	public byte[] toByteArray() {
		return (name + " " + jumpLabel + "\n").getBytes();
	}

	public void execute(CompiledPDFObject compiledObject,
			FlowControl flowControl) throws FPGException {

		if (!compiledObject.beginCache(name)) {
