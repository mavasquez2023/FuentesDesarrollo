...
/*
 * @(#) XYBaseInstruction.java    1.0 08-04-2008
 *
 ...
 * @version 1.0
 */
public class XYBaseInstruction extends Instruction {

	private String xyBase;

	public XYBaseInstruction(String label, String xyBase) {
		super(FPGCode.XYBASE, label, true);
	...
	public void execute(CompiledPDFObject compiledObject,
		...
		compiledObject.setXYBase(xyBase);
	}
}
