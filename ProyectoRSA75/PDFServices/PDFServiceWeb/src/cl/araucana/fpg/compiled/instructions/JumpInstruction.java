...
/*
 * @(#) JumpInstruction.java    1.0 09-04-2008
 *
 ...
 * @version 1.0
 */
public class JumpInstruction extends JumpableInstruction {

	public JumpInstruction(String label, String jumpLabel) {
		super(FPGCode.JUMP, label, jumpLabel);
	}
