...
public class TesoreriaDAO implements DAO_Interface{
	...
	public TesoreriaDAO(ConectaDB2 db2, String ipTesoreria, String usuario, String password)throws SQLException{
		this.db2teso= db2;
	...
	public Object select(Object pk) throws SQLException {
		...
		query.append("select tea7a as codigobarra, te42a as rut, te43a as dvrut, te44a as identificacion, te45a as rut2, te46a as dvrut2, te47a as identificacion2, te7na as monto, a.sajkm92 as user, cmca as oficina, sajkky1 as area, te49a as observacion ");
		...
		if (db2teso.next()){
			...
			if(identificacion.length()>29){
				identificacion= identificacion.substring(0, 29);
			}
