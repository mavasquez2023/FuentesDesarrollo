...
function verOficinas(fecha, estado){
	window.location= path + "/Estadistica?fecha="+ fecha+ "&estado="+ estado + "&action=OFI";
}
		...
		<tr>
			<td width="72%" valign="top">
				<TABLE border=0 width="85%">
					...
					<tr><td width="150" class="textos-formularios1">Estadísticas x FECHA</td><td colspan="2" class="textos-formularios1">${ruta}</td></tr>
					<tr><td>&nbsp;</td></tr>
				</table>
				<TABLE border=0 align="center">
					<tr>
						<td height="22" align="center" valign="middle"
							bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formcolor">FECHA</td>
						<td height="22" align="center" valign="middle"
					...
					<tr><td align="center" class="textos_formularios">${estadistica.fecha}</td>
						...
						<c:if test="${hidecol!='1'}">
							<td class="textos_formularios" align="right"><a href="#" title="Ver Detalle por Oficina para el Día" onclick="verOficinas('${estadistica.fecha}', '${estadistica.estado}');">Ver</a></td>
						</c:if>
					</tr>
					</c:forEach>
					<tr><td>&nbsp;</td></tr>
