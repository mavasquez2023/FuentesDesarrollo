...
function verUsuarios(mes, fecha, oficina, estado){
	if(mes=='0'){
		window.location= path + "/Estadistica?fecha="+ fecha+ "&oficina=" + oficina + "&estado="+ estado + "&action=USU";
	}else if(fecha==''){
		window.location= path + "/Estadistica?mes="+ mes+ "&oficina=" + oficina + "&estado="+ estado + "&action=USU";
	}
}
		...
		<tr>
			<td width="72%" valign="top">
				<TABLE border=0 width="85%">
					...
					<tr><td width="150" class="textos-formularios1">Estadísticas x OFICINA</td><td colspan="2" class="textos-formularios1">${ruta}</td></tr>
					<tr><td>&nbsp;</td></tr>
				</table>
				<TABLE border=0 align="center">
					...
					<tr><td align="center" class="textos_formularios"><a href="#" title="Ver Detalle por Usuario" onclick="verUsuarios('${estadistica.mes}', '${estadistica.fecha}', '${estadistica.oficina}', '${estadistica.estado}');">${estadistica.oficina}</a></td>
						...
						<c:if test="${hidecol!='1'}">
							<td class="textos_formularios" align="center"><a href="#" title="Ver Detalle por Día para la Oficina" onclick="verFechas('${estadistica.mes}', '${estadistica.oficina}', '${estadistica.estado}');">Ver</a></td>
						</c:if>
					</tr>
					</c:forEach>
					<tr><td>&nbsp;</td></tr>
