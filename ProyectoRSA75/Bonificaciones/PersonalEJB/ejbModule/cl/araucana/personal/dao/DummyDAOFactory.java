...
public class DummyDAOFactory extends DAOFactory {
  ...
  public DescuentoDAO getDescuentoDAO() throws Exception {
	if (true) throw new UnsupportedOperationException("Personal no tiene implementación vía Dummy");
	return null;
  }
  
  /** Obtiene DAO de Axis */
  public AxisDAO getAxisDAO() throws Exception {
	if (true) throw new UnsupportedOperationException("Axis no tiene implementación vía Dummy");
	return null;
  }  
