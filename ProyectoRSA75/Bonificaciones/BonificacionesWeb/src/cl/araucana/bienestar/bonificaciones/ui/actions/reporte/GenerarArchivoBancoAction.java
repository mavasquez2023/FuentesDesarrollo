 ...
 * @author
 */
public class GenerarArchivoBancoAction extends Action {
	...
	public ActionForward execute(
		...
		delegate.generarArchivoBanco(cod);
		request.getSession(false).setAttribute("procesoCarga", "true");
		//Cargar Lista Reembolsos nuevamente
