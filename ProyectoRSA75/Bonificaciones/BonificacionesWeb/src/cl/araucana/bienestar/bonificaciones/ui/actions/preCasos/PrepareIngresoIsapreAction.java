 ...
 */
public class PrepareIngresoIsapreAction extends Action {
	...
	public ActionForward execute(
		...
		Logger logger = Logger.getLogger(PrepareIngresoIsapreAction.class);
		...
		double total=casoVO.getMontoIngresoIsapreTesoreria();
			
		datosMovimientoTesoreriaVO.setMonto(total);
	
		Socio socio = servicesSociosDelegate.getSocio(casoVO.getRutSocio());
		datosMovimientoTesoreriaVO.setTipoMovimiento(Constants.MOVI_INGRESO_ISAPRE);
