 ...
 * @author
 */
public class CierraCasoAction extends Action {
	...
	public ActionForward execute(
		...
		int montoAbono=Integer.parseInt((String)dynaValidatorActionForm.get("montoAbono"));
		int montoPrestamo=Integer.parseInt((String)dynaValidatorActionForm.get("montoPrestamo"));
		int numeroPrestamo=Integer.parseInt((String)dynaValidatorActionForm.get("numeroPrestamo"));
		...
		caso.setAbono(montoAbono);
		caso.setPrestamo(montoPrestamo);
		caso.setNumeroPrestamo(numeroPrestamo);
		
		Evento evento = new Evento();
		evento.setComentario(observacion);
		evento.setUsuario(userinformation.getNombreCompleto());
		
		delegate.cierraCaso(caso,evento);
