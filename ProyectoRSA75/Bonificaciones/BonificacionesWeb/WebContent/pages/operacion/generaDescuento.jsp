    ...
    <td><table width="97%" border="0" cellspacing="2" cellpadding="2">
      ...
      <table width="97%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <html:form action="/generaDescuento">
          ...
          <br>
            <table width="530" border="0" cellpadding="2" cellspacing="2">
              <tr>
                ...
                <td width="108" class="celdaColor1">
                	<p class="vinculosUp">Caso ID</p>
                </td>
                <td width="137" class="celdaColor1">
                	<p class="vinculosUp">Cuota</p>
                </td>                                                
                <td width="137" class="celdaColor1">
                	<p class="vinculosUp">Fecha Ocurrencia</p>
                </td>                                
                <td width="238" class="celdaColor1">
                	<p class="vinculosUp">RUT</p>
                </td>
                <td width="137" class="celdaColor1">
                	<p class="vinculosUp">Descuento Socio</p>
                </td>
                <td width="137" class="celdaColor1">
                	<p class="vinculosUp">Descuento Convenio</p>
                </td>
              </tr>
              
 		<logic:iterate id="register" name="lista.descuentos" indexId="i" type="cl.araucana.bienestar.bonificaciones.vo.DescuentosVO">
              ...
              <tr> 
                ...
                <td bgcolor="#F0F0F0" class="lookup01"><bean:write name="register" property="fullCuota"/></td>
                ...
                <td bgcolor="#F0F0F0" class="lookup01">$ <bean:write name="register" property="montoDescuento" formatKey="format.int"/></td>
                <td bgcolor="#F0F0F0" class="lookup01">$ <bean:write name="register" property="aporteConvenio" formatKey="format.int"/></td>
              </tr>
         </logic:iterate>
