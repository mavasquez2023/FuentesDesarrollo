      ...
      <table width="97%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <td width="77%" valign="top">
            ...
            <html:errors/>
            <html:form action="/getListaCoberturasCaso?source=caso">
              <tr>
                ...
                <td width="63" class="celdaColor1"><a href="#" class="vinculosUp">Tipo
                    de Tope</a></td>
                <td class="celdaColor1" width="74"><p><a href="#" class="vinculosUp">Valor
                      Tope</a></p></td>
                <td class="celdaColor1" width="53"><p><a href="#" class="vinculosUp">%
                  Desc.</a></p></td>
              ...
              <tr class="lookup01">
                <td bgcolor="#F0F0F0"><html:link page="/getDetallesCaso.do" paramId="cobertura" paramName="register" paramProperty="codigo" target="_top"><bean:write name="register" property="codigo"/></html:link></td>
                ...
                <td bgcolor="#F0F0F0" width="74"><p>$ <bean:write name="register" property="tope" formatKey="format.int"/></p>
                </td>
                <td bgcolor="#F0F0F0" width="53"><p><bean:write name="lista" property="descuento" formatKey="format.int"/></p>
                </td>
                <td bgcolor="#F0F0F0"><p>$ <bean:write name="register" property="valorReferencial"/></p>
                </td>
              </tr>
              ...
              <tr class="lookup01">
                ...
                <td bgcolor="#F0F0F0" width="74"><p>&nbsp;</p>
                </td>
                <td bgcolor="#F0F0F0" width="53"><p>&nbsp;</p>
                </td>
