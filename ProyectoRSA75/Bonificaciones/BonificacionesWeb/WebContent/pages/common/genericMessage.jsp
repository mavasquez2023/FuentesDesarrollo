      ...
      <table width="97%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <td width="77%" valign="top"><h1>&nbsp;</h1>
            <h1 class="centrado"><%=msg%></h1>
            <br>
            <%
            if(session.getAttribute("subMsg") != null && !session.getAttribute("subMsg").equals("")){
	            String subMsg = (String) session.getAttribute("subMsg");
            %>
            <p class="centrado"><b><%=subMsg%></b></p>
            <br>
            <%}%>
