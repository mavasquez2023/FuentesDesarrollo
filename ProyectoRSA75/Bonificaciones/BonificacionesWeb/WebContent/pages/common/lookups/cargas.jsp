    ...
    <td><table width="97%" border="0" cellspacing="2" cellpadding="2">
      ...
      <table width="97%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <td width="77%" valign="top"><html:form action="/getListaCargas">
			...
			<logic:iterate id="register" name="lista.cargas" indexId="i" type="cl.araucana.bienestar.bonificaciones.model.Carga">
              <tr>
                <td bgcolor="#F0F0F0" class="lookup01"><html:link page="/setFichaSocio.do?source=socio" paramId="rut" paramName="register" paramProperty="rutSocio"><bean:write name="register" property="fullRutSocio"/></html:link></td>
                <td bgcolor="#F0F0F0" class="lookup01"><bean:write name="register" property="nombreSocio"/></td>
                <td bgcolor="#F0F0F0" class="lookup01"><html:link page='<%="/setFichaCarga.do?carga="+register.getRutCarga()%>' paramName="register" paramId="socio" paramProperty="rutSocio"><bean:write name="register" property="rutCarga"/>-<bean:write name="register" property="dvCarga"/></html:link></td>
