...
<table width="756" border="0" align="center" cellpadding="8" cellspacing="8" bgcolor="#FFFFFF">
  <tr>
    <td><table width="97%" border="0" cellspacing="2" cellpadding="2">
      <tr>
        <td class="caminito"><%@ include file="/includes/camino.jsp"%> Lista de Convenios &gt;</td>
      </tr>
    </table>
      <table width="97%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          ...
          <td width="77%" valign="top">
			<html:errors/>
			<html:form action="/getListaConveniosCaso?source=caso">
            <table width="529" border="0" cellspacing="2" cellpadding="2">
              <tr>
                ...
                <td width="128" class="celdaColor1"><p> <a href="#" class="vinculosUp">Nombre</a></p>
                </td>
                ...
                <td width="82" class="celdaColor1"><a href="#" class="vinculosUp">Fecha Inicio</a></td>
                <td width="82" class="celdaColor1"><a href="#" class="vinculosUp">Fecha T&eacute;rmino</a></td>
              </tr>

       		<logic:iterate id="register" name="lista.convenios" indexId="i" type="cl.araucana.bienestar.bonificaciones.model.Convenio">

              <tr class="lookup01">
                <td bgcolor="#F0F0F0"><html:link page="/setFichaCaso.do" paramId="convenio" paramName="register" paramProperty="codigo" target="_top"><bean:write name="register" property="codigo"/></html:link></td>
                ...
                <td bgcolor="#F0F0F0"><html:link page="/setFichaSocio.do?source=socio" paramId="rut" paramName="register" paramProperty="rut"><bean:write name="register" property="rut"/>-<bean:write name="register" property="dvRut"/></html:link></td>
                <td bgcolor="#F0F0F0"><bean:write name="register" property="fecInicio" formatKey="format.date"/></td>
                <td bgcolor="#F0F0F0"><bean:write name="register" property="fecFin" formatKey="format.date"/></td>
           </tr>
			</logic:iterate> 
              <tr class="lookup01">
                ...
                <td bgcolor="#F0F0F0">
                <html:select property="codigoConcepto" styleClass="menuDespl">
