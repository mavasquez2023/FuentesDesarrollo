...
<table width="756" border="0" align="center" cellpadding="8" cellspacing="8" bgcolor="#FFFFFF">
 ...
 INFORME DE PAGO DE CONVENIOS CÓDIGO <bean:write name="reporte" property="codigoPago"/></strong></p>
          
            <table width="530" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td class="celdaColor1"><p class="vinculosUp">
                <strong>RESUMEN DE PAGOS CÓDIGO <bean:write name="reporte" property="codigoPago"/> DEL <bean:write name="reporte" property="fechaPago" formatKey="format.date"/></strong></p></td>
              </tr>
            </table>
            <table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr>
                <td width="210"><p class="textoHeader1"><strong>Número de Pagos:</strong></p>
                </td>
            ...
            <table width="530" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td width="90" class="celdaColor2"><p class="vinculosUp">Código Convenio</p>
                </td>
                ...
                <td width="115" class="celdaColor2"><p class="vinculosUp">Folio Tesorería</p>
                </td>
