package cl.araucana.migra.jcrontab;
...
public class InitJcrontab extends loadCrontabServlet
{
	...
	public void process()
	{
		log.info(">>Iniciando Cronta Migracion SQLServer.");
		System.out.println(">>Iniciando Cronta Migración SQLServer.");
		...
		{
			log.error("Problemas en carga parametros proceso migra:", ioe);
		}
