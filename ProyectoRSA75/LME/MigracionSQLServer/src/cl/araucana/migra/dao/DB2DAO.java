...
public class DB2DAO {
	...
	public DB2DAO(){
		...
		try {
			...
			logger.finer("Conectando a Datasource--> java:comp/env/jdbc/sw_services");
			this.ds = (DataSource)ctx.lookup("jdbc/sw_services");
			this.connection= ConectaDB2(ds);
	...
	private Connection ConectaDB2(DataSource ds) throws SQLException{
