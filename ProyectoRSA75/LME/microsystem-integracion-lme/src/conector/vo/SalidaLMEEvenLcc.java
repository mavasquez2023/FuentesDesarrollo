...
public class SalidaLMEEvenLcc {
	...
	public LicenciaType[] getListaLicencias() {
		return listaLicencias;
	}

	public void setListaLicencias(LicenciaType[] listaLicencias) {
