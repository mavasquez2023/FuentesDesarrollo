...
public class LmeTrabType  implements java.io.Serializable {
    ...
    private conector.lme.ws.cliente.operador.Liquidacion[] listaLiquid;
    ...
    public LmeTrabType(
           ...
           conector.lme.ws.cliente.operador.Liquidacion[] listaLiquid) {
     ...
     * @return listaLiquid
     */
    public conector.lme.ws.cliente.operador.Liquidacion[] getListaLiquid() {
        return listaLiquid;
    }
     ...
     * @param listaLiquid
     */
    public void setListaLiquid(conector.lme.ws.cliente.operador.Liquidacion[] listaLiquid) {
        this.listaLiquid = listaLiquid;
    }
