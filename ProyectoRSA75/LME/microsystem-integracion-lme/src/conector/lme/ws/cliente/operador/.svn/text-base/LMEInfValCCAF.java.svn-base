...
public class LMEInfValCCAF  implements java.io.Serializable {
    ...
    private conector.lme.ws.cliente.operador.LicenciaSimpleType[] listaLicencias;
    ...
    public LMEInfValCCAF(
           ...
           conector.lme.ws.cliente.operador.LicenciaSimpleType[] listaLicencias) {
     ...
     */
    public conector.lme.ws.cliente.operador.LicenciaSimpleType[] getListaLicencias() {
        return listaLicencias;
    }
     ...
     */
    public void setListaLicencias(conector.lme.ws.cliente.operador.LicenciaSimpleType[] listaLicencias) {
        this.listaLicencias = listaLicencias;
    }
