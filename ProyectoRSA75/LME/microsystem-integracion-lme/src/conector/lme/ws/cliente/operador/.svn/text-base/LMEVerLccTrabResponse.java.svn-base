...
public class LMEVerLccTrabResponse  implements java.io.Serializable {
    ...
    private conector.lme.ws.cliente.operador.LmeTrabType[] listaLmeTrab;
    ...
    public LMEVerLccTrabResponse(
           ...
           conector.lme.ws.cliente.operador.LmeTrabType[] listaLmeTrab) {
     ...
     * @return listaLmeTrab
     */
    public conector.lme.ws.cliente.operador.LmeTrabType[] getListaLmeTrab() {
        return listaLmeTrab;
    }
     ...
     * @param listaLmeTrab
     */
    public void setListaLmeTrab(conector.lme.ws.cliente.operador.LmeTrabType[] listaLmeTrab) {
        this.listaLmeTrab = listaLmeTrab;
    }
