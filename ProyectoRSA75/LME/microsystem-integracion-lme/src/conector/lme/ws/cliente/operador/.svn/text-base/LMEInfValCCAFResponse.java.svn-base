...
public class LMEInfValCCAFResponse  implements java.io.Serializable {
    ...
    private conector.lme.ws.cliente.operador.ResultadoType[] listaResultado;
    ...
    public LMEInfValCCAFResponse(
           ...
           conector.lme.ws.cliente.operador.ResultadoType[] listaResultado) {
           this.estado = estado;
     ...
     */
    public conector.lme.ws.cliente.operador.ResultadoType[] getListaResultado() {
        return listaResultado;
    }
     ...
     */
    public void setListaResultado(conector.lme.ws.cliente.operador.ResultadoType[] listaResultado) {
        this.listaResultado = listaResultado;
    }
