 ...
 * 
 */
package com.microsystem.lme.forms;
...
public class FileUploadForm extends ActionForm{
	...
	public ActionErrors validate(ActionMapping mapping,
	   HttpServletRequest request) {
	    ...
	    if(!"text/plain".equals(getFile().getContentType())&& !"application/vnd.ms-excel".equals(getFile().getContentType())){
	    ...
	    if(getFile().getFileSize() > 10240){ //10kb
	       errors.add("common.file.err.size",
		    new ActionMessage("error.common.file.size.limit"));
	       return errors;
	    }
