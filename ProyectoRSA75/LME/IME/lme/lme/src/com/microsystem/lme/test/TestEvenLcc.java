...
public class TestEvenLcc {
	...
	private static Logger log = Logger.getLogger(TestEvenLcc.class);

	public static void main(String[] args) throws Exception {

		//		/*Set set = EndPointUtil.getInstance().endPointsCompletoMap.entrySet();
		//		  // Get an iterator
		...
		//		//for (int i = 0; i < 5; i++) {
		//		Date now = new Date();
		//		//String urlope = "http://test.medipass.cl/webApp/ws/ws_fonasa.php?wsdlMPEvenLcc";
		//		//String urlope = "http://localhost:9081/ImedServiciosLME/services/WsLMEInetSOAP?wsdlMPEvenLcc";
		//		//		String url1 = EndPointUtil.getInstance().getEndPoint("4", "LIQUIDACION", "1");
		//		String url2 = EndPointUtil.getInstance().getEndPoint("4", "LIQUIDACION", "1");
		...
		//		//
		//		//		ServiciosMultiOperador servicio = new ServiciosMultiOperador("4", "C", "10105", "fonasa", url1, url2);
		//		//		//try {
