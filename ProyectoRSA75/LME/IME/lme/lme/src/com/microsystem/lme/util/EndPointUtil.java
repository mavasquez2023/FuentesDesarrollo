...
public class EndPointUtil {
	...
	private void cargarParametrosProperties() {
		...
		endPointsPropertiesMap.put(operadorMediPass + ",LIQUIDACION," + prioridadProperties, Configuraciones.getConfig("medipass.LIQUIDACION"));
		endPointsPropertiesMap.put(operadorMediPass + ",VALIDACION," + prioridadProperties, Configuraciones.getConfig("medipass.VALIDACION"));
		endPointsPropertiesMap.put(operadorMediPass + ",ZONA_C," + prioridadProperties, Configuraciones.getConfig("medipass.ZONA_C"));
		...
		endPointsPropertiesMap.put(operadorImed + ",LIQUIDACION," + prioridadProperties, Configuraciones.getConfig("imed.LIQUIDACION"));
		endPointsPropertiesMap.put(operadorImed + ",VALIDACION," + prioridadProperties, Configuraciones.getConfig("imed.VALIDACION"));
		endPointsPropertiesMap.put(operadorImed + ",ZONA_C," + prioridadProperties, Configuraciones.getConfig("imed.ZONA_C"));
	}
