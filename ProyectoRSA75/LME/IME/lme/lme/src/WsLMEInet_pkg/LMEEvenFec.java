...
public class LMEEvenFec  implements java.io.Serializable {
    ...
    private java.util.Calendar fecDesde;

    private java.util.Calendar fecHasta;
    ...
    public LMEEvenFec(
           ...
           java.util.Calendar fecDesde,
           java.util.Calendar fecHasta) {
    ...
    /**
     * Gets the codigoOperador value for this LMEEvenFec.
     * 
    ...
    /**
     * Sets the codigoOperador value for this LMEEvenFec.
     * 
    ...
    /**
     * Gets the tipoInstitucion value for this LMEEvenFec.
     * 
    ...
    /**
     * Sets the tipoInstitucion value for this LMEEvenFec.
     * 
    ...
    /**
     * Gets the codUsuario value for this LMEEvenFec.
     * 
     * @return codUsuario
     */
    ...
    /**
     * Sets the codUsuario value for this LMEEvenFec.
     * 
     * @param codUsuario
     */
    ...
    /**
     * Gets the clave value for this LMEEvenFec.
     * 
     * @return clave
     */
    ...
    /**
     * Sets the clave value for this LMEEvenFec.
     * 
     * @param clave
     */
    ...
    /**
     * Gets the fecDesde value for this LMEEvenFec.
     * 
     * @return fecDesde
     */
    public java.util.Calendar getFecDesde() {
        return fecDesde;
    }


    /**
     * Sets the fecDesde value for this LMEEvenFec.
     * 
     * @param fecDesde
     */
    public void setFecDesde(java.util.Calendar fecDesde) {
        this.fecDesde = fecDesde;
    }


    /**
     * Gets the fecHasta value for this LMEEvenFec.
     * 
     * @return fecHasta
     */
    public java.util.Calendar getFecHasta() {
        return fecHasta;
    }


    /**
     * Sets the fecHasta value for this LMEEvenFec.
     * 
     * @param fecHasta
     */
    public void setFecHasta(java.util.Calendar fecHasta) {
        this.fecHasta = fecHasta;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LMEEvenFec)) return false;
        LMEEvenFec other = (LMEEvenFec) obj;
        ...
        _equals = true && 
            ...
            ((this.fecDesde==null && other.getFecDesde()==null) || 
             (this.fecDesde!=null &&
              this.fecDesde.equals(other.getFecDesde()))) &&
            ((this.fecHasta==null && other.getFecHasta()==null) || 
             (this.fecHasta!=null &&
              this.fecHasta.equals(other.getFecHasta())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFecDesde() != null) {
            _hashCode += getFecDesde().hashCode();
        }
        if (getFecHasta() != null) {
            _hashCode += getFecHasta().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LMEEvenFec.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:WsLMEInet", "LMEEvenFec"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fecDesde");
        elemField.setXmlName(new javax.xml.namespace.QName("", "FecDesde"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fecHasta");
        elemField.setXmlName(new javax.xml.namespace.QName("", "FecHasta"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
