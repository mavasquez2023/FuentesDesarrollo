...
public class LMEEvenFecResponse  implements java.io.Serializable {
    ...
    private WsLMEInet_pkg.LicenciaType[] listaLicencias;
    ...
    public LMEEvenFecResponse(
           ...
           WsLMEInet_pkg.LicenciaType[] listaLicencias) {
           this.estado = estado;
     ...
     */
    public WsLMEInet_pkg.LicenciaType[] getListaLicencias() {
        return listaLicencias;
    }
     ...
     */
    public void setListaLicencias(WsLMEInet_pkg.LicenciaType[] listaLicencias) {
        this.listaLicencias = listaLicencias;
    }
