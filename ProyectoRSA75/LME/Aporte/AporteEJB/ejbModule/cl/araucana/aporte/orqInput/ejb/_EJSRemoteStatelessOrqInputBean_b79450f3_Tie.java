...
public class _EJSRemoteStatelessOrqInputBean_b79450f3_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessOrqInputBean_b79450f3 target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:cl.araucana.aporte.orqInput.ejb.OrqInputRemote:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessOrqInputBean_b79450f3) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 15: 
                    ...
                    } else if (method.equals("obtenerInfoPago")) {
                        return obtenerInfoPago(in, reply);
                    }
            }
    ...
    private OutputStream obtenerInfoPago(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        OrqInputResultBO result = target.obtenerInfoPago(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,OrqInputResultBO.class);
        return out;
    }
}
