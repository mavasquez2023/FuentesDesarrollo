...
public class _OrqInputRemote_Stub extends Stub implements OrqInputRemote {
    ...
    public OrqInputResultBO obtenerInfoPago(int arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("obtenerInfoPago", true);
                        out.write_long(arg0);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (OrqInputResultBO) in.read_value(OrqInputResultBO.class);
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                        String id = in.read_string();
                        throw new UnexpectedException(id);
                ...
                ServantObject so = _servant_preinvoke("obtenerInfoPago",cl.araucana.aporte.orqInput.ejb.OrqInputRemote.class);
                if (so == null) {
                    continue;
                }
                try {
                    OrqInputResultBO result = ((cl.araucana.aporte.orqInput.ejb.OrqInputRemote)so.servant).obtenerInfoPago(arg0);
                    return (OrqInputResultBO)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
