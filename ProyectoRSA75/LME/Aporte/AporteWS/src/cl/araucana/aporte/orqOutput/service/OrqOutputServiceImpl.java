...
public class OrqOutputServiceImpl {
    public OrqOutputResultVO recuperacionPago (int rut, int montoCredito, int montoLeasing, int montoAporte, int periodoAporte, String fechaRecaudacion, String horaRecaudacion, String usuario, int documentoPago){
        ...
        try{
            orqOutputVO = orqOutputDlg.recuperacionPago(rut, montoCredito, montoLeasing, montoAporte, periodoAporte, fechaRecaudacion, horaRecaudacion, usuario, documentoPago);
        }catch (Exception e) {
            e.printStackTrace();
    ...
    public OrqOutputResultVO recuperacionPagoRemote (int rut, int montoCredito, int montoLeasing, int montoAporte, int periodoAporte, String fechaRecaudacion, String horaRecaudacion, String usuario, int documentoPago)throws RemoteException{
        OrqOutputResultVO orqOutputVO = new OrqOutputResultVO();
        OrqOutputDelegate orqOutputDlg = new OrqOutputDelegate();
        ErrorResultVO errorVO = new ErrorResultVO();
        try {
