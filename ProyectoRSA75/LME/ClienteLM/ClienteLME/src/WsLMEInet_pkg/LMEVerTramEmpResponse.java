...
public class LMEVerTramEmpResponse  implements java.io.Serializable {
    ...
    private WsLMEInet_pkg.LicenciaCompletaType[] listaLicencias;
    ...
    public LMEVerTramEmpResponse(
           ...
           WsLMEInet_pkg.LicenciaCompletaType[] listaLicencias) {
           this.estado = estado;
     ...
     */
    public WsLMEInet_pkg.LicenciaCompletaType[] getListaLicencias() {
        return listaLicencias;
    }
     ...
     */
    public void setListaLicencias(WsLMEInet_pkg.LicenciaCompletaType[] listaLicencias) {
        this.listaLicencias = listaLicencias;
    }
