...
public class ResponseWSFonasaTO_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public ResponseWSFonasaTO_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        ResponseWSFonasaTO bean = (ResponseWSFonasaTO) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_0;
          propValue = bean.getEstado();
          serializeChild(propQName, null, 
              propValue, 
              QName_1_4,
              true,null,context);
          propQName = QName_0_6;
          propValue = bean.getExtApellidoMat();
          ...
          propQName = QName_0_7;
          propValue = bean.getExtApellidoPat();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
          ...
          propQName = QName_0_8;
          propValue = bean.getExtCodEstBen();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
          ...
          propQName = QName_0_9;
          propValue = bean.getExtDescEstado();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
          ...
          propValue = bean.getExtFechaNacimi();
          serializeChild(propQName, null, 
              propValue, 
              QName_1_14,
              true,null,context);
          propQName = QName_0_11;
          propValue = bean.getExtNombres();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
