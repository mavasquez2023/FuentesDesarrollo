...
<table border='0' cellspacing='0' width='100%'>
	...
	<tr>
		<td nowrap class="certificado">
			<div align='center'><font size='3'><b><bean:message key="label.consulta.cheques.titulo"/></b></font></div>
		</td>
	</tr>
</table>
...
<br>
	...
	<logic:iterate id="register" name="cheques" type='cl.araucana.autoconsulta.vo.ChequeVO'>
		<tr>
			...
			<td class="certificado">
				<%if(register.getFechaPago()!=null) { %>
					<bean:write name="register" property="fechaPago" formatKey="format.date"/>
				<%} else { %>
			 		&nbsp;
				<% } %>				
			</td>
