...
<table border='0' cellspacing='0' width='100%'>
	...
	<tr> 
		<td nowrap class="certificado">
			<div align='center'><font size='5'><b><bean:message key="label.afiliacion.certificado.titulo"/></b></font></div>
		</td>
	</tr>
</table>
...
<br><br>										 
<bean:write name="nombre"/>, <bean:message key="label.afiliacion.certificado.rut"/> 
<bean:write name="rut"/> 
<bean:message key="label.afiliacion.certificado.afiliado"/> 
<bean:write name="tipo"/> 
<bean:message key="label.afiliacion.certificado.afiliado.activo"/> 
