...
<table border='0' cellspacing='0' width='100%'>
	...
	<tr>
		<td nowrap class="certificado">
			<div align='center'><font size='3'><b><bean:message key="label.deuda.vigente.certificado.titulo"/></b></font></div>
		</td>
	</tr>
</table>
...
<logic:notPresent name="tieneDeuda">
	...
	<logic:present name="comercial">
		<script language="JavaScript">
			...
			ventana=window.open('<%= "/"+fullappname+"/pages/deudaVigente/comercialCredito.html"%>',"Crédito",prop);
		</script>
	</logic:present>
</logic:notPresent>
