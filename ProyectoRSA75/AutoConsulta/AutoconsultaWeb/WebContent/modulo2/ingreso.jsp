...
this.location.href = "http://localhost/araucana/start.aspx";
</script>
<body onload="document.location.href='http://localhost/araucana/start.html';">
<form name="many" action="http://localhost/araucana/start.html"></form>
