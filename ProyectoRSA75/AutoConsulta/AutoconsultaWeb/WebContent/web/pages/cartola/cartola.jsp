...
<table border="0" cellpadding="0" cellspacing="0" height='100%' class="sello_agua">
<tr>
...
function imprimir(){
	...
	ventana=window.open('<%= "/"+fullappname+"/showCartola.do"%>',"print",prop);
	ventana.print();
}
</script>
...
<%@ include file = "/web/pages/cartola/cuerpoCartola.jsp  "%>
