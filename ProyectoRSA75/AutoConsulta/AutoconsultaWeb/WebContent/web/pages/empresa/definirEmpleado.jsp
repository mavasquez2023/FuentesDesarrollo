...
<input size="15"  id="fecha" 
name="fecha" type="text"><img title="fecha" src="/AutoconsultaWeb/web/images/calendar.gif" onclick="cargarCalendario();">
	...
	<tr>
		...
		<td class="texto">
			<input type="text" name="rut" id="rut" class="field" size='8' maxlength='8' onkeypress="return acceptNum(event);" value='<%= rutEmpleado%>' /> - 
                       ...
                       <input type="text" name="dv" id="dv" class="field" size='1' maxlength='1'  value='<%= rutDVEmpleado%>' onchange="javascript:validaRut(document.forms[1].rut,this);"/>
