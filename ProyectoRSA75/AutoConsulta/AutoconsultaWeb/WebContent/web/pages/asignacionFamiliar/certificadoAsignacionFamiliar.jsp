...
function imprimir(){
	...
	ventana=window.open('<%= "/"+fullappname+"/showCertificadoASFAM.do"%>',"print",prop);
	ventana.print();
}
</script>
...
<%@ include file = "/web/pages/asignacionFamiliar/cuerpoCertificadoAsignacionFamiliar.jsp"%>

<!-- End de la pagina particular -->
<div align="center" >
                  <input type="button"  class="boton" name="dummyProperty" value="Imprimir este resultado" onclick="imprimir();" onMouseOver="this.className='botonOver'" onMouseOut="this.className='boton'" />	
                  <span style="font-size:10px">&nbsp; &nbsp; &nbsp;</span>
                  <input type="submit"  class="boton" name="dummyProperty" value="Cerrar" onclick="window.location='Menu.do'" onMouseOver="this.className='botonOver'" onMouseOut="this.className='boton'" />	
