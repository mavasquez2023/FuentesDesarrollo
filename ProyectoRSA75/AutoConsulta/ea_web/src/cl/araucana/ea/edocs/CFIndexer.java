 ...
 * @version 1.0
 */
public class CFIndexer extends DocumentIndexer {

	public CFIndexer(String sourceDir, String indexBaseDir) {
		super("CF", sourceDir, indexBaseDir);
	}

	public CFIndexer(String sourceDir, String indexBaseDir,
			IndexControl control) {
				
		super("CF", sourceDir, indexBaseDir, control);
	}
	...
	public Document getDocument(File file) throws IOException {
		...
		return new CargasFamiliares(rutEmpresa, dvRutEmpresa);		
	}	
}
