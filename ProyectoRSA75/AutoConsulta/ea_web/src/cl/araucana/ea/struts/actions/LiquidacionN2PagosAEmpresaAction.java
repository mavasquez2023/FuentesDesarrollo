 ...
 * @author
 */
public class LiquidacionN2PagosAEmpresaAction extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection lista = delegate.getMontosLuiquidadosPorPago(
														dtoEmpresa.getRut(), 
														codigoOficina, 
														codigoSucursal, 
			...
			long total = 0L;
			total = delegate.getTotalMovimeintosLiquidacion(lista);			
