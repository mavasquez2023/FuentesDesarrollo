 ...
 * @author
 */
public class Liquidacion704N2Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			//SaldoAFavorEmpresaPorCotizacionTO dto = delegate.getSaldoAFavorEmpresaPorCotizacion(
			//																dtoEmpresa.getRut(), 
			//																codigoOficina, 
			//																codigoSucursal, 
			//																dtoPeriodoRemuneracion);
			
			// obtener resumen planilla que contiene menor pago de la empresa en cotizacion informada (concepto 704).
			ResumenPlanillaCotizacionTO dto = delegate.getMenorPagoEmpresaCotizacionInformada(
																dtoEmpresa.getRut(), 
																codigoOficina, 
																codigoSucursal, 
																dtoPeriodoRemuneracion);
