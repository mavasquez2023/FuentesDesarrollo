 ...
 * @author
 */
public class Liquidacion712N1Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection c = delegate.getLiquidacionCuentaCorriente712N1(
								rutEmpresa,
								codigoOficina,
								codigoSucursal,
								new DTOPeriodo(periodo),
			...
			request.setAttribute("resumen", 
						delegate.getResumenLiquidacionCuentaCorriente712N1(c)); 
