 ...
 * @author
 */
public class LiquidacionN2PagosASaldoAFavorEmpresaAction extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection lista = delegate.getPagosSaldoAFavorEmpresa(
														dtoEmpresa.getRut(), 
														codigoOficina, 
														codigoSucursal, 
			...
			long total = delegate.getTotalPagosSaldoAFavorEmpresa(lista);			
			...
			paramsHome.put("idChanged", "FECHA");
			...
			paramsHome.put("periodoLiquidacion", new Long(periodoLiquidacion));
			paramsHome.put("fechaLiquidacion", new Long(fechaLiquidacion));
