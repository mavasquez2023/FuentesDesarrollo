...
import cl.araucana.ea.ctacte.dto.SumaDesarrolloAbonoTO;
 ...
 * @author
 */
public class LiquidacionN2AbonosASaldoAdeudadoAction extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection detalles = delegate.getListaDesarrolloAbono(
														dtoEmpresa.getRut(), 
														codigoOficina, 
														codigoSucursal, 
			...
			SumaDesarrolloAbonoTO resumen = delegate.getSumaDesarrollosAbono(detalles);			
