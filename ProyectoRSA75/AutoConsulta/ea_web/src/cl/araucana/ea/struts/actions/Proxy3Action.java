 ...
 * 
 */
public class Proxy3Action extends Action {
	...
	public ActionForward execute(
		...
		if("r".equalsIgnoreCase(status)) {
			/*
			 * solicita cambio de empresa
			 * elimina empresaElegida desde la session
			 */
			...
			/*
			 * 	caso predeterminado
			 * 	crear de nuevo perfil de usuario
			 * 	debe ser modificado: 
			 * 		due to the SSO, the user remains authenticated inspite of session becomes invalid by server
			 * 		throw new InvalidSessionStatusException in order to force the user reauthhenticate.  
			 */
