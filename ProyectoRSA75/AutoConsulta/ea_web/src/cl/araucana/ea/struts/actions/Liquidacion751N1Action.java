 ...
 * @author
 */
public class Liquidacion751N1Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			delegate = factory.newInstance("cl.araucana.ea.catcte.delegate.BusinessDelegateImpl");
			...
			Collection c = delegate.getLiquidacionCuentaCorriente751N1(
								rutEmpresa,
								codigoOficina,
								codigoSucursal,
								new DTOPeriodo(periodo),
			...
			request.setAttribute("resumen", 
						delegate.getResumenLiquidacionCuentaCorriente751N1(c)); 
			*/
