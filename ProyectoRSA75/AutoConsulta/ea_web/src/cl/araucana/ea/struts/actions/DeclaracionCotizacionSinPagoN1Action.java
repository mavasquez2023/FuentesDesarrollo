 ...
 * @author
 */
public class DeclaracionCotizacionSinPagoN1Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection detalles = delegate.getPlanillaCotizacionPeriodoCuentaCorriente(new RutTO(rutEmpresa, ""), codigoOficina, codigoSucursal, codigoConcepto);
			ResumenPlanillaCotizacionCuentaCorrienteTO resumen = delegate.getResumenPlanillaCotizacionCuentaCorriente(new RutTO(rutEmpresa, ""), codigoOficina, codigoSucursal);
