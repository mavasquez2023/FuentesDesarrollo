 ...
 * @author
 */
public class LiquidacionGravamenesAction extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection lista = delegate.getListaGravamenesConcepto(
												dtoEmpresa.getRut(),
												codigoOficina,
												codigoSucursal,
			...
			long total = delegate.getTotalGravamenesConcepto(lista);
