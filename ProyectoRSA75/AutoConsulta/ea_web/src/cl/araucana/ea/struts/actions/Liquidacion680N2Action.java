 ...
 * @author
 */
public class Liquidacion680N2Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			periodoReemplazo = 
					((Long) PropertyUtils.getSimpleProperty(form, "periodoReemplazo")).longValue();
			...
			Collection c = delegate.getLiquidacionCuentaCorriente680N2(
								rutEmpresa,
								codigoOficina,
								codigoSucursal,
								new DTOPeriodo(periodo),
								codigoConcepto,
								new DTOPeriodo(periodoReemplazo));
								 						
			request.setAttribute("detalles", c);
			request.setAttribute("resumen", 
						delegate.getResumenLiquidacionCuentaCorriente680N2(c)); 
