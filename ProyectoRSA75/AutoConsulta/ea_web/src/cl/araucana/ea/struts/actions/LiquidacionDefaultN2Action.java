 ...
 * @author
 */
public class LiquidacionDefaultN2Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			Collection c = null;
			if("I".equals(concepto.getTipo())) {
				c = delegate.getLiquidacionCuentaCorriente402N1(
								rutEmpresa,
								codigoOficina,
								codigoSucursal,
								new DTOPeriodo(periodo),
				...
				request.setAttribute("resumen", 
							delegate.getResumenLiquidacionCuentaCorriente402N1(c));
			} else{
				c = delegate.getLiquidacionCuentaCorriente707N1(
									rutEmpresa,
									codigoOficina,
									codigoSucursal,
									new DTOPeriodo(periodo),
									new DTOFecha(fecha),
									codigoConcepto);
				request.setAttribute("flag", "E"); 						
				request.setAttribute("detalles", c);
				request.setAttribute("resumen", 
							delegate.getResumenLiquidacionCuentaCorriente707N1(c));
			}
