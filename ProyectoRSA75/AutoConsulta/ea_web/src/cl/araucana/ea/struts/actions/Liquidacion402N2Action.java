...
import cl.araucana.ea.ctacte.dto.DesarrolloAbonoTO;
import cl.araucana.ea.ctacte.dto.EmpresaTO;
import cl.araucana.ea.ctacte.dto.FechaTO;
import cl.araucana.ea.ctacte.dto.NominaAsignacionFamiliarTO;
 ...
 * @author
 */
public class Liquidacion402N2Action extends Action {
	...
	public ActionForward execute(
		...
		try {
			...
			// nomina asignacion familiar resumido en el periodo de remuneracion
			NominaAsignacionFamiliarTO dtoNominaASFAM = delegate.getNominaAsignacionFamiliar(
			...
			DesarrolloAbonoTO dtoDesarrolloAbono = delegate.getDesarrolloAbono(
														dtoEmpresa.getRut(), 
														codigoOficina, 
														codigoSucursal, 
														dtoFechaLiquidacion, 
			...
			// movimientos liquidacion en cuenta corriente
			Collection movimientos = delegate.getListaMovimientoLiquidacion(
																new RutTO(rutEmpresa, ""),
																codigoOficina,
																codigoSucursal,
			...
			request.setAttribute("asfam", dtoNominaASFAM);
			 						
			request.setAttribute("desarrolloAbono", dtoDesarrolloAbono);
			...
			params.put("periodoLiquidacion", new Long(periodoLiquidacion));			
			params.put("fechaLiquidacion", new Long(fechaLiquidacion));
