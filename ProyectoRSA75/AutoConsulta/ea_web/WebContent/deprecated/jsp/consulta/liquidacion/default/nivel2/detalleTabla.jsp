		...
		<tbody>
			...
			<tr style="height : 18px;">
				<td class=smallfontreverse >
					<b>
						<bean:message key="liquidacion.default.nivel2.table.header" />&nbsp;
						<bean:message key="global.text.unidadMonetaria" />
					</b>
				</td>
			</tr>
			
			<logic:equal name="flag" value="I" scope="request">
			<tr>
				<td>
					<table style="width : 100%; border : 0px; border-color : #cccccc; padding-left: 2px; padding-right: 2px; border-spacing: 1px">
						<tbody>
							...
							<tr style="background-color : #cccccc;">
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.default.nivel2.table.header.periodo" /></td>
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.default.nivel2.table.header.saldoAnterior" /></td>
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.default.nivel2.table.header.abonoLiquidacion" /></td>
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacion.default.nivel2.table.header.saldoDespuesLiquidacion" /></td>
							</tr>
							...
							<tr>
								<td class="smallprompt">
									...
									<bean:define id="dtoPeriodo" name="detalle" property="periodo" />
										<html:link action="/liquidacion/defaultN3" name="parametros">
							...
							<tr>
								<td class="smallprompt">
									<bean:message key="liquidacion.default.nivel2.table.label.total" />
								</td>
								<td class="smallcurrency">
			...
			<logic:equal name="flag" value="E" scope="request">
			<tr>
				<td>
					<table style="width : 100%; border : 0px; border-color : #cccccc; padding-left: 2px; padding-right: 2px; border-spacing: 1px">
						<tbody>
							...
							<tr style="background-color : #cccccc;">
								<td class="smalltableheader" style="width : 50%;"><bean:message key="liquidacion.default.nivel2.table.header.periodo" /></td>
								<td class="smalltableheader" style="width : 50;"><bean:message key="liquidacion.default.nivel2.table.header.monto" /></td>
							</tr>
