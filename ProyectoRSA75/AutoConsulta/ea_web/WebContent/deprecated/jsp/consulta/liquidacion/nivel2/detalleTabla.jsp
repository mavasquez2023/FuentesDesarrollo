		...
		<tbody>
			...
			<tr style="height : 18px;">
				<td class=smallfontreverse >
					<b>
						<bean:message key="liquidacionN2.table.header" />&nbsp;
					...
					<table style="width : 100%; border : 0px; border-color : #cccccc; padding-left: 2px; padding-right: 2px; border-spacing: 1px">
						<tbody>
							...
							<tr style="background-color : #cccccc;">
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacionN2.table.header.fechaMovimiento" /></td>
								<td class="smalltableheader" style="width : 50%;"><bean:message key="liquidacionN2.table.header.descripcion" /></td>
								<td class="smalltableheader" style="width : 25%;"><bean:message key="liquidacionN2.table.header.monto" /></td>
							</tr>
							...
							<tr>
								<td class="smallprompt">
									<bean:define id="parametros" name="detalle" property="params"></bean:define>
										<html:link page="/deprecated/uc.html" name="parametros">
											<bean:write name="detalle" property="fecha" />
										</html:link>														
								</td>
								<td class="smallprompt">
									<bean:write name="detalle" property="glosa" filter="true" ignore="true" />
								</td>
