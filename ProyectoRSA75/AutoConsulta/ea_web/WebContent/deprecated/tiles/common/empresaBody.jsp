...
<table style="vertical-align: top;" border="0" cellspacing="0" cellpadding="0">					
	<tbody>
		<tr>
			...
			<td style="width: 340px; height : 4px;"><html:img page="/img/box_top.gif" style="width: 340px; height : 4px; text-align : center; border : 0px;" /></td>
						...
						<tr>
							...
							<td>
								<table>
									<tbody>
										<tr>
											<td style="height : 4px;" rowspan="2" style="font-family: Verdana, Arial, sans-serif; font-size: 11px; font-weight: bold; color: #006666; vertical-align : top;">
