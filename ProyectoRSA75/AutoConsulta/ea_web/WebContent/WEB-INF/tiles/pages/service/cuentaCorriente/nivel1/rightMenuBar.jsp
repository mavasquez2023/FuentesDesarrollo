						...
						<tr>										
							<td id="note">
								...
								<logic:iterate id="detalle" name="detalles" scope="request">						
									<div id='i<bean:write name="detalle" property="concepto.codigo" />'; style="position: absolute; visibility: hidden;" >
											...
											<tbody>
												<tr>
													<td style="font-family: verdana, ariel, serif; font-size: 10px; background-color: #ffffcc; text-align: justify;">
														...
														<bean:write name="detalle" property="concepto.descripcion" scope="page" />
													</td>
												</tr>
											</tbody>
										</table>
