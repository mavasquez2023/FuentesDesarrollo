					...
					<tbody>
						<tr>
							...
							<td style="text-decoration: none; color: #0000ff; font-family: Verdana, Arial, sans-serif; font-size: 10px; font-weight: bold;">
								<logic:notEmpty name="paramsHomeCredito" scope="request">
									<html:link action="/deudaCreditoN1" name="paramsHomeCredito" style="text-decoration: none; color: #0000ff; font-family: Verdana, Arial, sans-serif; font-size: 10px; font-weight: bold;">
										<bean:message key="global.text.paginaInicioCredito" />
									</html:link>
								</logic:notEmpty>
								<logic:notEmpty name="paramsHomeCtaCte" scope="request">
