		...
		<tbody>
			...
			<tr style="height : 18px;">
				<td class=smallfontreverse >
					<b>
						<bean:message key="prepagoFiniquitoN1.table.header" />&nbsp;
					...
					<table style="width : 100%; border : 0px; border-color : #cccccc; padding-left: 2px; padding-right: 2px; border-spacing: 1px">
						<tbody>
							...
							<tr style="background-color : #cccccc;">
								<td class="smalltableheader" style="width : 40%;" rowspan="2">
									<bean:message key="prepagoFiniquitoN1.table.header.folio" />
								</td>
								<td class="smalltableheader" style="width : 60%;" colspan="2">
									<bean:message key="prepagoFiniquitoN1.table.header.saldo" />
								</td>
							</tr>
							<tr style="background-color : #cccccc;">
								<td class="smalltableheader" style="width : 30%;">
									<bean:message key="prepagoFiniquitoN1.table.header.vigente" />
								</td>
								<td class="smalltableheader" style="width : 30%;">
									<bean:message key="prepagoFiniquitoN1.table.header.moroso" />
								</td>
							</tr>
