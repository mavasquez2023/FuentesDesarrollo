					...
					<tbody>
						<tr>
							...
							<td style="text-decoration: none; color: #0000ff; font-family: Verdana, Arial, sans-serif; font-size: 10px; font-weight: bold;">
								<html:link action="/liquidacionN1.do" name="paramsHome" style="text-decoration: none; color: #0000ff; font-family: Verdana, Arial, sans-serif; font-size: 10px; font-weight: bold;">
