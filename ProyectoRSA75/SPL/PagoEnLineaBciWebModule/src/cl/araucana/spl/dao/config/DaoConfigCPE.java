...
public class DaoConfigCPE {
	
	private static final Logger logger = Logger.getLogger(DaoConfigCPE.class);
	
	private static final String resource = "cl/araucana/spl/dao/config/daoCPE.xml";
