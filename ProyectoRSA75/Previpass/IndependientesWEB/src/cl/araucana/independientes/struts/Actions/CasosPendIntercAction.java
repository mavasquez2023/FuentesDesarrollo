...
import cl.araucana.independientes.struts.Forms.CasosPendientesIntForm;

public class CasosPendIntercAction extends Action{
            ...
            , HttpServletResponse response)
    {
        ...
        CasosPendientesIntForm casosPendientes = (CasosPendientesIntForm) form;
        opcion = Integer.parseInt(casosPendientes.getOpcion());
