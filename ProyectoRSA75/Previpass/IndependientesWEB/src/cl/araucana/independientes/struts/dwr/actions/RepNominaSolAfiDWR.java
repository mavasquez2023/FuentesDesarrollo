...
import cl.araucana.independientes.impl.RepNominaSolAfiImpl;
...
public class RepNominaSolAfiDWR{

    public RepNominaSolAfiVO consultaRepNominaSolAfi (String fechaIni, String fechaFin, String oficina, String estado, String user, String fechaActual){

        RepNominaSolAfiImpl impl = new RepNominaSolAfiImpl();

        RepNominaSolAfiVO ret = new RepNominaSolAfiVO();

        try{

            ret = impl.consultaRepNominaSolAfi(fechaIni, fechaFin, oficina, estado, user, fechaActual);
    ...
    public String enviarMail(String archivoEntrada, String user, String fechaIni, String fechaFin, String oficina){
        ...
        if(!archivoEntrada.equals("")){//Esta validacion es para señalar que no hubo solicitudes
            ...
            cuerpo = "Estimados: \n\nAdjunta sigue la nómina de solicitudes de afiliación ";
