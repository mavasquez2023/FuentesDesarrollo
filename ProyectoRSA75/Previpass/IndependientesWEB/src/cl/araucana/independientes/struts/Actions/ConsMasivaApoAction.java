...
import cl.araucana.independientes.struts.Forms.ConsMasivaApoForm;

public class ConsMasivaApoAction extends Action{
            ...
            , HttpServletResponse response)
    {
        ...
        ConsMasivaApoForm consMasivaApoForm = (ConsMasivaApoForm) form;

        opcion = Integer.parseInt(consMasivaApoForm.getOpcion());
        ...
        case 2:
            ...
            try{
                String archivoEntrada = consMasivaApoForm.getArchivo();
