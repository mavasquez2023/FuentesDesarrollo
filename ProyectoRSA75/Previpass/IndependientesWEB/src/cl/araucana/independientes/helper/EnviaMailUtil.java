...
public class EnviaMailUtil {
    ...
    public static boolean EnviarMail(String mailToNomina, String mailSubject, String mailContent, String filePath, String fileName, int flag)
    {
        ...
        try {
            ...
            //Session mailSession = (Session) env.lookup("mailSession/araucana");
    ...
    private static boolean sendMessage(Session mailSession,String to,String cc, String from,String subject, 
            String bodyContent, String filePath, String fileName, int flag) throws Exception {
