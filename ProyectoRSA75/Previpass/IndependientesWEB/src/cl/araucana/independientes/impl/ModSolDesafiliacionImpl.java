...
import cl.araucana.independientes.dao.ModSolDesafiliacionDAO;
...
public class ModSolDesafiliacionImpl {
    ...
    public static SolicitudNegocioVO obtenerSolicitud(String folio, String rut )
    {
        ...
        vo=ModSolDesafiliacionDAO.obtenerSolicitud(folio, rut);
...
//      TODO SToro #parche2		
    ...
    public static int updateEstadoSol(String folio, String estado, String rut, String fecVigencia)
    {
        ...
        result=ModSolDesafiliacionDAO.updateEstadoSol(folio, estado, rut);

        if(result==0 && "7".equals(estado))
        {
            try {
                String fechaResolucion = Helper.primerDiaMesSiguiente(fecVigencia);
                resultUpdate=ModSolDesafiliacionDAO.updateEstadoFechaResolucion(folio, fechaResolucion);
            } catch (Exception e) {
    ...
    /*public static int updateFechaResolucion(String folio, String estado, String fechaResolucion, String fechaVigencia){		
		return ModSolDesafiliacionDAO.updateEstadoFechaResolucion(folio, fechaResolucion);
	}*/	
     ...
     * 	al DAO (ModSolDesafiliacionDAO) que es donde se redistribuyen los campos a los onjetos correspondientes.*/
    public static int updateSolicitud(String cadenaForm){

        return ModSolDesafiliacionDAO.updateSolicitud(cadenaForm);
    }
    ...
    public static Parametro[] getEstadosDestinoPosibles(String estadoActual){
        ...
        return ModSolDesafiliacionDAO.getEstadosDestinoPosibles(estadoActual);
    }
    ...
    {
        SolicitudNegocioVO vo=new SolicitudNegocioVO();
        vo=ModSolDesafiliacionDAO.obtenerSolicitudPorFolio(folio);
...
//      TODO SToro #parche2	
    ...
    public static SolicitudNegocioVO obtenerDatosPorRut(String rut){
        ...
        return ModSolDesafiliacionDAO.obtenerDatosPorRut(rut);
    }
    ...
    public static SolicitudVO[] obtenerFoliosPorRut(String rut){
        ...
        Parametro[] param = listaParam.getListEstadoSolicitudDesafiliacion();

        SolicitudVO[] temp = ModSolDesafiliacionDAO.obtenerFoliosPorRut(rut);
    ...
    public static Parametro[] getEstadosDestinoPosiblesDoc(String estadoActual){
        ...
        return ModSolDesafiliacionDAO.getEstadosDestinoPosiblesDoc(estadoActual);
    }
    ...
    public static String recuperarFecVigencia(String folio){
        ...
        fecha = ModSolDesafiliacionDAO.recuperarFecVigencia(folio);
    ...
    public static String recuperarFecFirma(String folio){
        ...
        fecha = ModSolDesafiliacionDAO.recuperarFecFirma(folio);
