...
{/*	idEntPensionReal
	...
	if(document.getElementById('idEntPensionReal').value == idAFPNinguna)
	{
		...
		if(document.getElementById('idEntExCaja').value == '-1')
		{
		    /*alert("No corresponde AFC para trabajador sin pensión");
		    document.getElementById('idEntAFCReal').value		= -100;
	...
	else
	{
		...
		else
		{
			...
			} else //INP
			{
				...
				if (((document.getElementById('idEntPensionReal').value == '-1' || document.getElementById('idEntPensionReal').value == '-100' ) && (document.getElementById('idEntAFCReal').value == '-1' ||  document.getElementById('idEntAFCReal').value == '-100')) &&
...
//APV
	...
	//csanchez. Validación para APV Colectivo sobre montos no ingresados.
	if (document.getElementById("idAPVC").value != "-1")
	{
		...
		if (creaNumero(document.getElementById("aporteEmpAPVC").value) == 0)
			msg += " - Debe ingresar el aporte de la empresa para el APV Colectivo. \n";
	}
...
//csanchez: Validación propia de Depósito Convenido
