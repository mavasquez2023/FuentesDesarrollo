    		...
    		<td>
				<table border="1" width="90%" align="center" cellpadding="3" cellspacing="0">
					...
					<tr>
						...
						<td width="35%" class="row-left-blue">
							&nbsp;<%= Padder.lpad(receiptReport.getReceiptNo(), 8, '0') %>
						</td>
					...
					<tr>
						...
						<td width="35%" colspan="3" class="row-left">
							...
							%>
							        <font color="blue">
								    &nbsp;<b>OK. Revise el resultado de validaci&oacute;n de su n&oacute;mina</b>
							        </font>
							<%  } else if (status == 1) {
							%>
							        <font color="orange">
								    &nbsp;<b>ADVERTENCIA (${receiptReport.statusMessage})</b>
							        </font>
							<%  } else {
							%>
							        <font color="red">
								    &nbsp;<b>ERROR (${receiptReport.statusMessage})</b>
							        </font>
							<%  }
							%>
						</td>
				...
				<tr>
					<td>
						<table border="1" width="90%" align="center" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td colspan="2" class="main-header-left-green">
									&nbsp;<b>N&oacute;minas Aceptadas</b>
								</td>
							</tr>

							<tr>
								<td width="20%" class="header-left-green">
									&nbsp;<b>N&oacute;mina</b>
								</td>

								<td class="header-left-green">
									&nbsp;<b>Comentario</b>
								</td>
							</tr>
							...
							%>
									<tr>
										<td width="20%" class="row-left">
											&nbsp;<%= acceptedNomina.getID() %>
										</td>
				...
				<tr>
					<td>
						...
						<table border="1" width="90%" align="center" cellpadding="3" cellspacing="0">
							...
							<tr>
								<td colspan="2" class="main-header-left-red">
									&nbsp;<b>N&oacute;minas Rechazadas</b>
								</td>
							</tr>

							<tr>
								<td width="20%" class="header-left-red">
									&nbsp;<b>N&oacute;mina</b>
								</td>

								<td class="header-left-red">
									&nbsp;<b>Causa del Rechazo</b>
								</td>
							</tr>
