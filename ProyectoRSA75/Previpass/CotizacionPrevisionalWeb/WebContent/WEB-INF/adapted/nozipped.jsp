...
<script language="JavaScript1.2">
	 ...
	 */
	var period = "${periodo}";
	var MAX_NOMINAS_SELECCIONABLES = 11;
					...
					<table border="0" width="100%" align="center" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="2" align="left" class="textos_formularios">
								...
								Para cada n&oacute;mina a enviar, seleccione su empresa y adjunte la n&oacute;mina de cotizaciones correspondiente, si desea enviar varias nóminas simultáneamente escoja la opción de archivo comprimido Zip*.
								<br>
								<br>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<table border="0" align="center">
									...
									<tr>
										<th align="left" class="barra_titulos">
										    <code>&nbsp;</code>Envío Nóminas Comprimidas
										</th>
																			
										<th align="left" class="barra_titulos">
										    <code>&nbsp;&nbsp;&nbsp;&nbsp;</code>Archivo Zip
										<th>
									</tr>
									<tr>
										<td align="left">
											<input type="hidden" name="idNomina11" value="" tabindex="22">
											<div class="textos_formularios"></div>											
										</td>
			
										<td align="left">
											<code>&nbsp;&nbsp;1:</code> <input type="file" name="nomina11" tabindex="24" size="15" onclick="limpiarForm('zip')">
										</td>
									</tr>
								</table>
							</td>
							...
							<td colspan="2" align="left">
								...
								<table border="0" width="85%" align="center" cellspacing="0" cellpadding="0">
									<tr align="center">
										...
										<td class="textos_formularios">
											Los archivos zipeados deben tener el formato <b>&lt;rutempresa&gt;&lt;dv&gt; .&lt;tipo&gt;&lt;convenio&gt;</b>
											<br><br>
											El nombre del archivo zip puede ser cualquiera.
											<br><br>
											Ejemplo: 
											<br>archivo empresa1 (1.111.111-4) convenio 1: <b>11111114.r01</b>
											<br>archivo empresa2 (2.222.222-8) convenio 1: <b>22222228.r01</b>
											<br>archivo empresa2 (2.222.222-8) convenio 2: <b>22222228.r02</b>
											<br>archivo zip: <b>remu_laaraucana.zip</b>
