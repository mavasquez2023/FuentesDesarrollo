...
<!-- 	    	 <a href="${linkHome}" class="menuSuperior"><img src="<c:url value="/img/ico_home.gif" />" width="11" height="10" border="0" /></a>&nbsp;<a href="${linkHome}" class="menuSuperior">Home</a>&nbsp;&nbsp;  -->
...
<!--     		<a href="PrepareChangePassword.do" class="menuSuperior">
    		...
    		&nbsp;&nbsp;
			<a href="${linkContactenos}" class="menuSuperior"><img src="<c:url value="/img/ico_contact.gif" />" width="11" height="10" border="0" /></a>&nbsp;<a href="${linkContactenos}" class="menuSuperior">Cont&aacute;ctenos</a>&nbsp;&nbsp;
