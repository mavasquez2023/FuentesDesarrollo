  	...
  	<tr>
     	<td valign="top">
	       	<table class="textos-formularios3">
	         	...
	         	<tr>
	           		<td colspan="2" align="right"><html:submit property="operacion" styleClass="btn-destacado" value="${buscar}"/></td>
	         	</tr>
	         	<tr>
	           		<td colspan="4">&nbsp;</td>
	         	</tr>
		         	...
		         	<tr align="center"> 
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
			            	<tr align="center"> 
			                    ...
			                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="tabla-datos">
		                       		<tr class="subtitulos_tablas">
					                 	...
					                 	<td width="15%" align="center" valign="middle" nowrap="nowrap" bordercolor="#CCCCCC" class="barra_tablas" colspan="2">RUT Empresa</td>
...
<!-- 
	...
	function validaFormulario(f) 
	{
		...
		var rutTrim =  (document.getElementById("rut").value).replace(/^(\s|\&nbsp;)*|(\s|\&nbsp;)*$/g,"");
		var nombreTrim =  (document.getElementById("nombre").value).replace(/^(\s|\&nbsp;)*|(\s|\&nbsp;)*$/g,"");
		var apellidosTrim =  document.getElementById("apellidos").value;
		var rutEmpresa = (document.getElementById("rutEmpresa").value).replace(/^(\s|\&nbsp;)*|(\s|\&nbsp;)*$/g,"");
		var razonSocial = (document.getElementById("razonSocial").value).replace(/^(\s|\&nbsp;)*|(\s|\&nbsp;)*$/g,"");
		
		if(rutTrim.length == 0 && nombreTrim.length == 0 && apellidosTrim.length == 0 && rutEmpresa.length == 0 && razonSocial.length == 0)
				sMsje += "* Debe ingresar algun valor en los campos\n";
