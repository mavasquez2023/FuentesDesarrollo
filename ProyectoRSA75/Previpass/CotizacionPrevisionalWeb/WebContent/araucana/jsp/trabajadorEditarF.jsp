	    	...
	    	<logic:equal name="CotizacionActionForm" property="mostrar" value="ap">	    	
		        ...
		        <tr>
		        	<td colspan="4">&nbsp;</td>
			      	...
			      	<tr>
			      		<td colspan="3">&nbsp;</td>
			      		<td align="center"><input type="submit" value="${aplicar}" class="btn-destacado" onclick="javascript:enviar('${aplicar}')"/></td>
			      	</tr>
			      	<tr> 
		        		<td colspan="4">&nbsp;</td>
			     	</tr>
...
<!-- movto pers --> <div id="otros" STYLE="position:relative; width:590; display:none; z-index:1; top:0px; left:0px; ">	
	...
	<tr align="center"> 
    	<td height="33" valign="top"><br />
	    	...
	    	<input type="button" class="btn_grande" value="${guardar}" id="btnGuardar"/>
    		<input type="button" class="btn_grande" value="${cancelar}" onclick="javascript:enviar('${cancelar}')"/>
        </td>
    </tr>
    </logic:present>
</table>
