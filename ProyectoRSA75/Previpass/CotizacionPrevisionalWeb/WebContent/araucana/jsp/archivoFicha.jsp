    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <table class="textos-formularios3">
        	...
        	<tr valign="bottom"> 
            	<td height="30" bgcolor="#FFFFFF" class="titulo" width="30%"><strong>Mapeo de campos de archivo</strong></td>
                <td align="right" bgcolor="#FFFFFF" width="40%">
					...
					<input type="button" class="btn_grande" value="${imprimir}" onclick="javascript:abrirDocImpresion('${url}');" />&nbsp;&nbsp;&nbsp;
								...
								<c:choose>
									...
									<c:when test="${(consulta.idConcepto < 134 || consulta.idConcepto > 136) && prodCaja== false}">
				               			<tr>
				                    		...
				                    		<td align="right" valign="middle" nowrap="nowrap" class="${estilo}">
				                    			<nested:write property="nombre"/>xx
				                    		</td>
				                    		<td align="right" valign="middle" nowrap="nowrap" class="${estilo}">
				                    			<div align="right">
					                    			<nested:write property="posicion"/>
