    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="100%" border="0" cellpadding="1" id="tipoProcesoTable" cellspacing="1" class="textos-formularios3">
              <tr> 
          		<td colspan="2">&nbsp;</td>
          	</tr>
              <tr> 
					   		    	...
					   		    	<c:when test="${numConvenios == 1}">
					   		    		<logic:iterate id="convenio" name="empresa" property="convenios">
					   		    			<logic:iterate id="cmpIdCodBarras" name="convenio" property="comprobantes">
							   		    		<td align="right" valign="middle" class="${estilo}">${convenio.idConvenio}</td>
