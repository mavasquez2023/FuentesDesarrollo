	    ...
	    <logic:notEqual name="CotizacionActionForm" property="mostrar" value="new">
	    	...
	    	<logic:equal name="CotizacionActionForm" property="mostrar" value="ap">	    	
		        <table width="100%" border="0" cellpadding="1" cellspacing="5" class="tabla-datos">
			      	...
			      	<tr>
			      		<td colspan="3">&nbsp;</td>
			      		<td align="center"><input type="submit" value="${aplicar}" class="btn-destacado" onclick="javascript:enviarGrati('${aplicar}')"/></td>
			      	</tr>
			    </table>
	    	</logic:equal>
...
<input type="hidden" value="<bean:write name='exigirValidacion'/>" id="exigirValidacion">
		     			<table width="100%" border="0" cellpadding="0" cellspacing="1">
							...
							<%-- La lógica para "exigirValidacion" en S y O eran idénticas, de hecho para N también lo es, solo que en dicho caso los tag TR están ocultos y además se agrega un campo hidden "cotizacion.previsionTotal" (Esto último solo es válido para GRATIFICACIÓN)--%>
...
<!-- INP -->		<table width="100%" border="0" cellpadding="0" cellspacing="1">
				        	...
				        	<tr> 
				           	...
				           	<tr> 
			                   	...
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		$ <html:text property="cotizacion.remImpPension" maxlength="8" size="12" styleId="remImpPension" styleClass="campos" onfocus="javascript:conFocoCampoNumerico(this);" onblur="javascript:soloMonto(this, '');sinFocoCampoNumerico(this);" onkeyup="javascript:soloMonto(this, '');" onchange="javascript:recalculaINP();" readonly="true"/>
		                    	</td>
				           	...
				           	<tr> 
			                   	...
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		$ <html:text property="cotizacion.prevObligatorioINP" maxlength="8" size="12" styleId="prevObligatorioINP" styleClass="campos" onfocus="javascript:conFocoCampoNumerico(this);" onblur="javascript:soloMonto(this, '');sinFocoCampoNumerico(this);recalculaINP();" onkeyup="javascript:soloMonto(this, '');" readonly="true"/>
		                    	</td>
				           	...
				           	<tr> 
			                   	...
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		$ <html:text property="cotizacion.saludObligFONASA" maxlength="8" size="12" styleId="saludObligFONASA" styleClass="campos" onfocus="javascript:conFocoCampoNumerico(this);" onblur="javascript:soloMonto(this, '');sinFocoCampoNumerico(this);recalculaINP();" onkeyup="javascript:soloMonto(this, '');" readonly="true"/>
		                    	</td>
				           	...
				           	<tr id="accTrabINPTR"> 
			                   	...
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		$ <html:text property="cotizacion.accTrabajoINP" maxlength="8" size="12" styleId="accTrabajoINP" styleClass="campos" onfocus="javascript:conFocoCampoNumerico(this);" onblur="javascript:soloMonto(this, '');sinFocoCampoNumerico(this);recalculaINP();" onkeyup="javascript:soloMonto(this, '');" readonly="true"/>
		                    	</td>
				        ...
				        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="rebajasINPTable">
				           ...
				           <tr> 
				         	...
				         	<tr> 
			                   	...
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		<html:text property="cotizante.numCargaSimpleINP"    styleId="cargasSimplesINP"    maxlength="2" size="5" styleClass="campos" onblur="javascript:soloNumero(this, '');sinFocoCampoNumerico(this);" onkeyup="javascript:soloNumero(this, '');" readonly="true"/> Simples <br />
		                     		<html:text property="cotizante.numCargaMaternaINP"   styleId="cargasMaternalesINP" maxlength="2" size="5" styleClass="campos" onblur="javascript:soloNumero(this, '');sinFocoCampoNumerico(this);" onkeyup="javascript:soloNumero(this, '');" readonly="true"/> Maternales <br />
		                    		<html:text property="cotizante.numCargaInvalidezINP" styleId="cargasInvalidezINP"  maxlength="2" size="5" styleClass="campos" onblur="javascript:soloNumero(this, '');sinFocoCampoNumerico(this);" onkeyup="javascript:soloNumero(this, '');" readonly="true"/> Invalidez<br />
		                    	</td>
   	...
   	$("#fonasaCheck").click(function(){
		if ($("#fonasaCheck").attr("checked")) {
			...
			if($("#remImpPension").val() == "0" || $("#remImpPension").val() == "")
				$("#remImpPension").val($("#montoGrati").val());			
			recalculaSalud();
			recalculaTotalINP();
		} else {
...
//exigirValidacion: <bean:write name='exigirValidacion'/>
</script>