	...
	<tr>
  	...
  	<tr> 
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
        	<tr valign="bottom"> 
            	<td width="30%" height="30" bgcolor="#FFFFFF" class="titulo"><strong>Lista de Encargados</strong></td>
                <td width="40%" align="right" bgcolor="#FFFFFF">
					...
					<html:button property="operacion" styleClass="btn_grande" value="${crearEncargado}" onclick="javascript:creaUsuario(this);" />
		        </td>
            </tr>
            <tr>
            	<td colspan="2">&nbsp;</td>
