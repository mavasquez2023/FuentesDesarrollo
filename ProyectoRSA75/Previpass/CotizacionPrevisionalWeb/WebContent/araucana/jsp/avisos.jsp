...
<logic:notEmpty name="informe" property="listadoResumen">
	<div class="div-datos">
		...
		<b><bean:write name="informe" property="empresa.idEmpresaFmt"/> <bean:write name="informe" property="empresa.razonSocial"/> Convenio Nº<bean:write name="informe" property="nomina.idConvenio"/></b> <br><br>
		...
		<logic:iterate id="listado" name="informe" property="listadoResumen">
			<b>- <bean:write name="listado" property="cotizante.nombre"/> <bean:write name="listado" property="cotizante.apellidoPat"/> <bean:write name="listado" property="cotizante.apellidoMat"/>, <bean:write name="listado" property="cotizante.formatRut"/><logic:equal name="informe" property="tipoProceso" value="A">, Per&iacute;odo:<bean:write name="listado" property="cotizante.periodo"/></logic:equal></b>
