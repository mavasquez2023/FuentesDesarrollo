								...
								<tr valign="bottom">
									...
									<td align="right" bgcolor="#FFFFFF">
										...
										<nested:equal property="puedeCrear" value="true">
											&nbsp;&nbsp;&nbsp;<html:button property="operacion" styleClass="btn_grande" value="${crearSucursal}" onclick="javascript:creaSucursal(this);"/>
										</nested:equal>
									</td>
								</tr>
							</table>
								...
								<tr>
									<td align="center" bgcolor="#FFFFFF">
										<table border="0" cellpadding="0" cellspacing="0" class="tabla-datos">
											<tr>
												<td width="15%" align="center" valign="middle" nowrap="nowrap" bordercolor="#CCCCCC" class="barra_tablas"><img src="<c:url value="/img/flecha2.gif" />" width="12" height="12" border="0" />&nbsp;C&oacute;digo</td>
