	               		...
	               		<nested:iterate id="fila" property="lista" indexId="nFila">
	               			...
	               			<tr>
	                    		...
	                    		<td width="150" align="right" valign="middle" nowrap="nowrap" class="textos_formularios">
	                    			...
	                    			<nested:text property="idCodigoNew" styleId="txt${nFila}" styleClass="campos" maxlength="13" onblur="javascript:soloAlfanumerico(this, '');" onkeyup="javascript:soloAlfanumerico(this, '');"/>
	                    		</td>
