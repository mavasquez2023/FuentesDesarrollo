	...
	function validaFormulario()  {
		...
		if (sMsje == "") {
			if (validaReq(document.getElementById("rutEmpresa")) &&	!validaDV(document.getElementById("rutEmpresa").value))
				sMsje += "* Dígito verificador inválido para el RUT de la Empresa a buscar\n";
		}
...
<html:form action="/ResultadoInformeDNP" styleId="formulario">
...
<table class="textos-formularios3">
  ...
  <tr>
    ...
    <td>
	 ...
	 <td>Periodo:</td>
    <td><html:text property="periodo" maxlength="6" size="7" styleClass="campos" styleId="periodo" onblur="javascript:soloRut(this);" onkeyup="javascript:soloRut(this);"/>&nbsp;&nbsp;aaaamm</td>
  </tr>
  <tr>
  	<td colspan="4">&nbsp;</td>
