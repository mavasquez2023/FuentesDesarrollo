...
<table width="590" border="0" cellspacing="0" cellpadding="0">
	<tr>
	    ...
	    <logic:notEqual name="CotizacionActionForm" property="mostrar" value="new">
		    ...
		    <logic:present name="CotizacionActionForm" property="cotizacion">
		        <table width="100%" border="0" cellpadding="0" cellspacing="1">
		        	<tr valign="bottom"> 
		            	<td width="72%" height="30" bgcolor="#FFFFFF" class="titulo"><strong>Ficha Trabajador Dependiente</strong></td>
		...
		<c:if test="${tipoTrabajador == 'V'}">
   		...
   		<logic:present name="CotizacionActionForm" property="cotizacion">
        <table border="0" cellpadding="0" cellspacing="1" class="tabla-datos" width="100%">
...
<!-- ANTECEDENTES --><div id="antecedentes" STYLE="position:relative; width:590; display:none; z-index:1; top:0px; left:0px; ">
				        <table width="100%" border="0" cellpadding="0" cellspacing="1">
				            ...
				            <tr> 
				             	<td width="30%" height="22" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">RUT</td>
				                <td height="22" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios"><html:text property="cotizante.rut" maxlength="12" size="15" styleClass="campos" styleId="newRutTrabajador" onblur="javascript:soloRut(this);" onkeyup="javascript:soloRut(this);"/></td>
				           ...
				           <tr> 
				           		<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Nombres</td>
				           ...
				           <tr> 
				           		<td width="30%" height="22" align="left" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="barra_tablas">Apellido Paterno</td>
				           ...
				           <tr> 
				           		<td width="30%" height="22" align="left" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="barra_tablas">Apellido Materno</td>
				           ...
				           <tr> 
				           		<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">G&eacute;nero</td>
				           ...
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Renta Imponible</td>
				           ...
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Dias Trabajados</td>
				           ...
				           <tr> 
				           		<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Sucursal</td>
				               	<td align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios"> 
...
<!-- SALUD -->		<div id="salud" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
		     			<table width="100%" border="0" cellpadding="0" cellspacing="1">
				        	<tr> 
		                 	...
		                 	<tr> 
			                    <td width="30%" align="left" valign="middle" class="barra_tablas">Isapre</td>
			                    <td align="left" valign="middle" class="textos_formularios">
									...
									<logic:iterate id="porcentajeSalud" name="CotizacionActionForm" property="entidadesSalud">
				                   		<html:hidden property="tasaSalud_${porcentajeSalud.id}" value="${porcentajeSalud.tasaSalud}" styleId="tasaSalud_${porcentajeSalud.id}" />
		                   			</logic:iterate>
		                     	</td>
		                 	...
		                 	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Obligatoria</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                 	...
		                 	<tr id="saludAdicionalTr"> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Adicional</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                 	...
		                 	<tr id="saludPactadaTr"> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Pactada</td>
		                   		<td align="left" valign="middle" class="textos_formularios">		                   			
		                 ...
		                 <table width="100%" border="0" cellpadding="0" cellspacing="1">
		                 	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas"><b>Total Cotizaci&oacute;n</b></td>
		                   		<td align="left" valign="middle" class="textos_formularios">
...
<!-- AFP -->	    <div id="prevision" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
						<input type="hidden" value="<bean:write name='exigirValidacion'/>" id="exigirValidacion">
		     			<table width="100%" border="0" cellpadding="0" cellspacing="1">
		                	...
		                	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Sistema Previsional</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                     		<span style="padding-bottom: 3px;"> 
			                     		<html:select property="cotizante.idEntPensionReal" styleClass="campos" styleId="idEntPensionReal" onchange="javascript:avisoINPaAFP();" onfocus="javascript:guardaValorAFP(this.value);">
							...
							<tr id="afpAhorroTr">
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Ahorro</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
							...
							<tr style="display: ${visibilidadSIS};">
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Renta Imponible SIS</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
							...
							<tr style="display: ${visibilidadSIS};">
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Prevision SIS</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                 ...
		                 <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tableSegCes">
				        	<tr> 
				           	...
				           	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Entidad AFC</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                     		<span style="padding-bottom: 3px;"> 
				               	...
				               	<td align="left" class="textos_formularios">&nbsp;<%=((java.util.HashMap)mensajesErrores).get("entidadaAfc") == null ? "" : ((java.util.HashMap)mensajesErrores).get("entidadaAfc")%></td>
		                 	</tr>
		                 	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Remuneraci&oacute;n Imponible para Seguro de Cesant&iacute;a</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                 	...
		                 	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Aporte Trabajador</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                 	...
		                 	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Aporte Empresa</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                 	...
		                 	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas"><b>Total Seguro Cesant&iacute;a</b></td>
		                   		<td align="left" valign="middle" class="textos_formularios">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1" id="trabajoPesadoTable">
				        	<tr> 				        	
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Tasa Trabajo Pesado</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Nombre Trabajo Pesado</td>
			                   	<td align="left" valign="middle" class="textos_formularios">
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Trabajo Pesado</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr>
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas"><b>TOTAL A PAGAR AFP</b></td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				    	...
				    	<input type="hidden" id="exigirValidacion" value="${exigirValidacion}"/>
				    </div>
...
<!-- INP -->		<table width="100%" border="0" cellpadding="0" cellspacing="1">
				        	<tr> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Entidad Ex-Caja</td>
			                   	<td align="left" valign="middle" class="textos_formularios">
		                     		<span style="padding-bottom: 3px;"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">C&oacute;digo R&eacute;gimen Impositivo</td>
			                   	<td align="left" valign="middle" class="textos_formularios">
		                     		<span style="padding-bottom: 3px;"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Tasa de Cotizaci&oacute;n</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				        	...
				        	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Fonasa</td>
			                   	<td align="left" valign="middle" class="textos_formularios">
				        	...
				        	<tr> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Remuneraci&oacute;n Imponible para INP</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Pensi&oacute;n</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n de Salud FONASA</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr id="accTrabINPTR"> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Accidentes del Trabajo</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Desahucio</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas"><b>Total Cotizaciones</b></td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				        	...
				        	<tr id="asigFamINPTR">
				        		...
				        		<table width="100%" border="0">
						           ...
						           <tr> 
					                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Tramo de Asignaci&oacute;n Familiar</td>
					                   	<td align="left" valign="middle" class="textos_formularios">
					                   		<span style="padding-bottom: 3px;"> 
						         	...
						         	<tr> 
					                   	<td width="30%" align="left" valign="middle" class="barra_tablas">N&uacute;mero de Cargas</td>
					                   	<td align="left" valign="middle" class="textos_formularios"> 
				                     		<html:text property="cotizante.numCargaSimpleINP"    styleId="cargasSimplesINP"    maxlength="2" size="5" styleClass="campos" onblur="javascript:soloNumero(this, '');sinFocoCampoNumerico(this);recalculaAsigFamINP();" onkeyup="javascript:soloNumero(this, '');" readonly="true"/> Simples <br />
				                     		<html:text property="cotizante.numCargaMaternaINP"   styleId="cargasMaternalesINP" maxlength="2" size="5" styleClass="campos" onblur="javascript:soloNumero(this, '');sinFocoCampoNumerico(this);recalculaAsigFamINP();" onkeyup="javascript:soloNumero(this, '');" readonly="true"/> Maternales <br />
				                    		<html:text property="cotizante.numCargaInvalidezINP" styleId="cargasInvalidezINP"  maxlength="2" size="5" styleClass="campos" onblur="javascript:soloNumero(this, '');sinFocoCampoNumerico(this);recalculaAsigFamINP();" onkeyup="javascript:soloNumero(this, '');" readonly="true"/> Invalidez<br />
				                    	</td>
						           ...
						           <tr id="asigFamTr"> 
					                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Monto Asignaci&oacute;n Familiar (+)</td>
					                   	<td align="left" valign="middle" class="textos_formularios"> 
						           ...
						           <tr id="asigFamRetroTr"> 
					                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Monto Asignaci&oacute;n Familiar Retroactiva (+)</td>
					                   	<td align="left" valign="middle" class="textos_formularios"> 
						           ...
						           <tr id="reintegroAsigFamTr"> 
					                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Monto Reintegro Asignaci&oacute;n Familiar (-)</td>
					                   	<td align="left" valign="middle" class="textos_formularios"> 
						           ...
						           <tr id="reintegroAsigFamTr"> 
					                   	<td width="30%" align="left" valign="middle" class="barra_tablas"><b>Total Asignaci&oacute;n Familiar</b></td>
					                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Bonificaci&oacute;n Art. 19 Ley 15.386</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           	...
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas"><b>Total Rebajas</b></td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				        ...
				        <table width="100%" border="0" cellpadding="0" cellspacing="1">
				           	<tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas"><b>Saldo Final</b></td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
...
<!-- APV -->   	    <div id="apv" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" id="apvTable${countAPV}">
			     			<tr> 
				           	...
				           	<nested:iterate id="apv" name="CotizacionActionForm" property="apvs" indexId="countAPV" type="cl.araucana.cp.distribuidor.hibernate.beans.ApvVO">
			                	<tr> 
			                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Entidad APV ${countAPV + 1}</td>
			                   		<td align="left" valign="middle" class="textos_formularios">
			                	...
			                	<tr> 
			                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Monto APV ${countAPV + 1}</td>
			                   		<td align="left" valign="middle" class="textos_formularios"> 
			                 	...
			                 	<tr> 
			                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Régimen APV ${countAPV + 1}</td>
			                   		<td align="left" valign="middle" class="textos_formularios"> 
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1">		     				
				        	<tr> 
				           	...
				           	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Entidad APV</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                     		<span style="padding-bottom: 3px;">
		                	...
		                	<tr>
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">N&uacute;mero Contrato</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                	...
		                	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Total APV Colectivo</td>
		                   		<td align="left" valign="middle" class="textos_formularios"> 
...
<!-- CAJA -->       <div id="caja" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
		     			...
		     			<table width="100%" border="0" cellpadding="0" cellspacing="1">
				           ...
				           <tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Aporte CCAF ${CotizacionActionForm.aporteCCAFFON}%</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		     			...
		     			<table width="100%" border="0" cellpadding="0" cellspacing="1">
				           ...
				           <tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Cr&eacute;dito</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           ...
				           <tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Leasing C.C.A.F.</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           ...
				           <tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Convenio Dental</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		$ <html:text property="cotizacion.ccafDental" maxlength="8" size="15" styleId="convenioDental" styleClass="campos" onfocus="javascript:conFocoCampoNumerico(this);" onblur="javascript:soloMonto(this, '');sinFocoCampoNumerico(this);" onkeyup="javascript:soloMonto(this, '');"/>
		                    	</td>
				           ...
				           <tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Seguro de Vida</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		$ <html:text property="cotizacion.ccafSeguro" maxlength="8" size="15" styleId="seguro" styleClass="campos" onfocus="javascript:conFocoCampoNumerico(this);" onblur="javascript:soloMonto(this, '');sinFocoCampoNumerico(this);" onkeyup="javascript:soloMonto(this, '');"/>
		                    	</td>
...
<!-- MUTUAL -->    	<div id="mutual" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
		     			<table width="100%" border="0" cellpadding="0" cellspacing="1">
		                	...
		                	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">(%) Tasa Cotizaci&oacute;n</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
				           ...
				           <tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Renta Imponible Mutual</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
				           ...
				           <tr> 
			                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Cotizaci&oacute;n Mutual</td>
			                   	<td align="left" valign="middle" class="textos_formularios"> 
		                     		$ <html:text property="cotizacion.accTrabajoMutual" maxlength="8" size="15" styleId="cotizacionMutual" styleClass="campos" onfocus="javascript:conFocoCampoNumerico(this);" onblur="javascript:soloMonto(this, '');sinFocoCampoNumerico(this);" onkeyup="javascript:soloMonto(this, '');"/>
		                    	</td>
			        	...
			        	<nested:iterate id="m" name="CotizacionActionForm" property="movtosPersonal" indexId="countMP" type="cl.araucana.cp.distribuidor.presentation.beans.MovtoPersonal">
					        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="mpTable${countMP}">
				            	<tr> 				        	
					           	...
					           	<tr> 
				                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Tipo de Movimiento</td>
					           	...
					           	<tr> 
				                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Fecha de Inicio</td>
				                   	<td align="left" valign="middle" class="textos_formularios">
					           	...
					           	<tr> 
				                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Fecha de Fin</td>
				                   	<td align="left" valign="middle" class="textos_formularios">
					           	...
					           	<tr> 
				                   	<td width="30%" align="left" valign="middle" class="barra_tablas">Entidad Pagadora de Subsidio</td>
				                   	<td align="left" valign="middle" class="textos_formularios">
				                   		<span style="padding-bottom: 3px;">
...
<!--DEP CONV     --><div id="deposito" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
						<table width="100%" border="0" cellpadding="0" cellspacing="1">
		                	...
		                	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Entidad</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
		                     		<span style="padding-bottom: 3px;">
		                 	...
		                 	<tr> 
		                   		<td width="30%" align="left" valign="middle" class="barra_tablas">Monto Dep&oacute;sito Convenido</td>
		                   		<td align="left" valign="middle" class="textos_formularios">
...
<!-- INDEMN -->		<div id="indemnizacion" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
						<table width="100%" border="0" cellpadding="0" cellspacing="1">
				           ...
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Tipo R&eacute;gimen Previsional</td>
				           ...
				           <tr> 
				            ...
				            --%>
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Tasa Pactada Indemnizaci&oacute;n</td>
				                <td height="14" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios">
				           ...
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Monto Aporte Indemnizaci&oacute;n</td>
				                <td height="14" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios">
				           ...
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Per&iacute;odos Indemnizaci&oacute;n</td>
				                <td height="14" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios">
				           ...
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Fecha Inicio Indemnizaci&oacute;n</td>
				                <td height="14" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios">
				           ...
				           <tr> 
								<td width="30%" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="barra_tablas">Fecha T&eacute;rmino Indemnizaci&oacute;n</td>
				                <td height="14" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios">
...
<!--OTROS PAGOS     --><div id="otrospagos" STYLE="position:relative; top:0px; left:0px; width:100%; display:none;">
	...
	<tr align="center"> 
    	<td height="33" valign="top"><br />
    		<input type="button" value="${guardar}"  onclick="javascript:enviarRemu('${guardar}')"  class="btn_grande" id="btnGuardar"/>
    		<input type="button" value="${cancelar}" onclick="javascript:enviarRemu('${cancelar}')" class="btn_grande" />
        </td>
    </tr>
    </logic:present>
...
*/	
	...
	//csanchez Se exige que tenga FONASA o INP.
...
function enviarRemu(op)
{
	...
	if(document.getElementById("saludObligFONASA").value > 0){
	...
	if (op == '${guardar}')
	{
		...
		if (exigirValidacionSis == 'O' && document.getElementById('datosSis').value == 'true')
		{
			...
			{
				if (!confirm("El trabajador no cuenta con cotización en Previsión SIS, el sistema validara si está correcto. ¿Está seguro que desea continuar?"))
				{
					return false;
				}
			}
...
function copiaRemuneracion() {
	...
	//clillo 1/12/14 solo se asigna Remuneración Imponible si Remu Cesantía==0 
	if(remImp==0){
		if (document.getElementById("idEntExCaja").value != -1) {
			remImp = document.getElementById("remImpPension").value;
		} else{
			remImp = document.getElementById("rentaImp").value;
		}
...
//csanchez: El siguente código corresponde a validaciones propias de Depósito Convenido
...
if (document.getElementById('datosSis').value == 'false') {
	...
	function limpiaFechaMP(id, mp){
		var	mpValue = mp.value;
		if(mpValue==9){
			document.getElementById('muestraCalendarioFin'+id).style.display = 'none';
			document.getElementById('muestraCalendarioInicio'+id).style.display = 'none';
		}else{
			document.getElementById('muestraCalendarioFin'+id).style.display = '';
			document.getElementById('muestraCalendarioInicio'+id).style.display = '';
		}
	}
</script>