...
/*
* @(#) DetalleReporteDao.java 1.6 10/05/2009
*
...
public class DetalleReporteDAO
{
    ...
    {
    	try	{
    		List result = this.session.createCriteria(DetalleReporteVO.class)
    			.add(Restrictions.eq("idReporte", new Integer(tipoReporte)))
    			.addOrder(Order.asc("idReporte"))
    			.list();
