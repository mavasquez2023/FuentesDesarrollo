...
public class PersonaMgr
{
	...
	public void guardaAccesoEncargadoLector(EncargadoVO encargado, List lista,int idAdmin) throws DaoException
	{
		...
		this.lectorDao.borraPermiso(idUsuario, idAdmin, LectorEmpresaSucursalVO.class);
		this.lectorDao.borraPermiso(idUsuario, idAdmin, LectorEmpresaConvenioVO.class);
		this.lectorDao.borraPermiso(idUsuario, idAdmin, LectorEmpresaEmpresaVO.class);
		this.lectorDao.borraPermisoGRPCONV(idUsuario, idAdmin, LectorEmpresaGrupoConvenioVO.class);
	...
	{
		return this.personaDao.getListaEmpresasCausa(col, filtros);
	}
	/**
	 * lista empresas in
	 * 
	...
	public boolean isAdministradorCaja(int idAdminCaja) throws DaoException {
		return this.personaDao.isAdministradorCaja(idAdminCaja);
	}
}
