...
public class SabanaMgr
{
	 ...
	 * @throws Exception
	 */
	public String generarPdf(String codigoBarra, String rutEmpresa) throws Exception
	{
...
//TODO Quitar comentario jlandero
		...
		boolean result = sabana.createPDFtoPago(nameFile, comprobante, empresa, nomina, gc.getNombre().trim(), cn, "");
		if (!result)
