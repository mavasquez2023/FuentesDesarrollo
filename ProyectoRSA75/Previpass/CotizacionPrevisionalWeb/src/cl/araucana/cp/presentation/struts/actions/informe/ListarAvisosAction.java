...
//					clillo 3-12-14 por Reliquidación
					...
					causas = cotizanteMgr.getCausasAvisos(tipoNomina.charAt(0), Integer.parseInt(idEmpresa), Integer.parseInt(idConvenio), cot.getIdCotizante(), cot.getPeriodo());
				} else {
//					clillo 3-12-14 por Reliquidación
					...
					causas = cotizanteMgr.getCausasAvisosPendientes(tipoNomina.charAt(0), Integer.parseInt(idEmpresa), Integer.parseInt(idConvenio), cot.getIdCotizante(), cot.getPeriodo());
				}
