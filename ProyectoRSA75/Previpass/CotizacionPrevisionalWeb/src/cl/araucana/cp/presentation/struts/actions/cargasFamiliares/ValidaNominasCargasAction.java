...
public class ValidaNominasCargasAction extends AppAction
{
	static Logger logger = Logger.getLogger(ValidaNominasCargasAction.class);
	...
	public ValidaNominasCargasAction() {
		super();
