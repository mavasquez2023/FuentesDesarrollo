...
abstract public class AppAction extends BaseAction
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		if ((request.getRemoteUser() != null && (request.getSession() == null || request.getSession().getAttribute(USER_BEAN) == null)) ||
			(request.getRemoteUser() != null && !request.getRemoteUser().getClass().getName().equals(request.getSession().getAttribute(USER_BEAN).getClass().getName())))
		{
			limpiaCacheWeb();
		...
		if (result != null && !this.subAccion.equals("login"))
		{
			...
			request.setAttribute("bloqueoPagoCaja", "" + parametro.plazoCerrado(Constants.PARAM_FIN_PAGO_CAJA));
			request.setAttribute("bloqueoPagoLinea", "" + parametro.plazoCerrado(Constants.PARAM_FIN_PAGO_LINEA));
