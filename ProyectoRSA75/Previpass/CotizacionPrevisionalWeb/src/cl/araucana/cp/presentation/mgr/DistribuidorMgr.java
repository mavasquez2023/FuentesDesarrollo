...
//	clillo 3-12-14 por Reliquidación
	...
	public List valida(int idCotizPend, String oldRut, CotizanteVO cotizante, int periodo_old)
	{
		try
		{
...
//			clillo 3-12-14 por Reliquidación
			...
			return this.nodoEjb.valida(idCotizPend, this.idPersona, oldRut, cotizante, periodo_old);
...
//	clillo 3-12-14 por Reliquidación
	...
	public int eliminaTrabajador(boolean pendiente, int rutEmpresa, int idConvenio, char tipoProceso, int idTrabajador, int periodo)
	{
		try
		{
			DistribuidorVO distribuidor = this.distribuidorDao.getNodoDistribuidor();
			...
			this.nodoEjb = home.create();
//			clillo 3-12-14 por Reliquidación
			//return this.nodoEjb.eliminaTrabajador(pendiente, rutEmpresa, idConvenio, tipoProceso, idTrabajador, this.idPersona);
			return this.nodoEjb.eliminaTrabajador(pendiente, rutEmpresa, idConvenio, tipoProceso, idTrabajador, this.idPersona, periodo);
		} catch (RemoteException e)
		{
