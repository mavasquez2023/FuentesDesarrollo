...
public class EmpresaMgr
{
	...
	/**
	 * trae sucursal matriz Empresa
	 * 
	 * @param idEmpresa
	 * @return
	 * @throws DaoException
	 */
	public String getSucursalMatriz(int idEmpresa) throws DaoException
	{
		return this.empresaDao.getSucursalMatrizEmpresa(idEmpresa);
	}
	...
	{
		return this.empresaDao.getListaConceptos(idGrupoConvenio);
	}
}
