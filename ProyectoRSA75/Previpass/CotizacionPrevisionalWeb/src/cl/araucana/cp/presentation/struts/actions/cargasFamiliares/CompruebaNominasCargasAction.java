...
public class CompruebaNominasCargasAction extends AppAction
{
	static Logger logger = Logger.getLogger(CompruebaNominasCargasAction.class);
	...
	public CompruebaNominasCargasAction() {
		super();
