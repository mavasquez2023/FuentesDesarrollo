              	...
              	<tr align="center"> 
                	...
                	<br />
                  	...
                  	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
				         <tr>
				           <td colspan="2" width="120" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas"><img src="<c:url value="/img/flecha2.gif" />" width="12" height="12" border="0" />&nbsp;Grupo Convenio</td>
				           <td colspan="2" width="80" align="center" valign="middle" nowrap="nowrap" bordercolor="#CCCCCC" class="barra_tablas">RUT</td>
				           <td width="165" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Nombre</td>
				           <td width="60" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Convenio</td>
				           <td width="105" colspan="2" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Accesos</td>
				         ...
				         <tr>
				           ...
				           <td width="20"  align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Gr</td>
				           <td colspan="4" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Ind</td>
				           <td width="20"  align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Cn</td>
				           <td width="20"  align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Sc</td>
				         </tr>
											...
											<td colspan="11" class="${estilo}">
												<table width="590" cellpadding="0" cellspacing="0" border="0" align="right">
													<nested:iterate id="empresa" property="empresas" indexId="nFilaEmp" type="cl.araucana.cp.distribuidor.presentation.beans.Empresa">
														<tr>
															<bean:size id="numConv" name="empresa" property="convenios"/>
															<td width="2" class="${estilo}">&nbsp;</td>
															<td width="80" class="${estilo}">&nbsp;</td>
															<td width="30" align="center" valign="middle" nowrap="nowrap" class="${estilo}">
																<c:if test="${numConv > 1}"><a style="cursor:pointer" onclick="swapAll('tr-em-${empresa.idEmpresa}-${grupo.idGrupo}', 'tr-em-img${empresa.idEmpresa}-${grupo.idGrupo}');"><img id="tr-em-img${empresa.idEmpresa}-${grupo.idGrupo}" src="<c:url value="/img/ico_mas.gif" />" width="11" height="11" border="0" /></a></c:if>														
																<c:if test="${numConv <= 1}">&nbsp;</c:if>
															</td>
												         	<td width="80" nowrap="nowrap" class="${estilo}">${empresa.rut}</td>
												         	<td width="165" class="${estilo}">${empresa.razonSocial}</td>
															<c:if test="${numConv > 1}">
								   		    					<td width="60" class="${estilo}">&nbsp;</td>
								   		    					<td width="75" class="${estilo}">&nbsp;</td>
								   		    					<td width="20" class="${estilo}">&nbsp;</td>
															...
															<c:if test="${numConv == 1}">
									   							<nested:iterate id="perm" property="convenios" indexId="nFilaPerm" type="cl.araucana.cp.distribuidor.presentation.beans.PermEncargadoLector">						         
									   		    					...
									   		    					<td width="90" class="${estilo}" ><div align="right">&nbsp;${perm.nombreNivel}</div></td>							   		    											   		    					
									   		    					<td width="10" class="${estilo}" >&nbsp;</td>
									   		    					<td width="20" class="${estilo}" >&nbsp;</td>
									   		    					<td width="20" class="${estilo}" >&nbsp;</td>
									   		    					<!-- <td width="20" class="${estilo}" >&nbsp;${perm.sucursalLector}</td> -->
