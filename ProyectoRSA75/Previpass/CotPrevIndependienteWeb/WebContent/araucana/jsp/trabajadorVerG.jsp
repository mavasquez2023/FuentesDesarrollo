...
<!--DETALLES  --> 	<div id="detallesNomina" STYLE="position:relative; width:590; display:none; z-index:1; top:0px; left:0px; ">
				        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="gratiTable">
				           ...
				           <tr> 
				                ...
				                <td height="14" align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#FFFFFF" class="textos_formularios">
				               		$ <c:out value="${CotizacionActionForm.cotizacion.gratificacion}"></c:out>
				                	<html:hidden property="cotizacion.gratificacion" styleId="montoGrati"/>
	...
	if ('${CotizacionActionForm.cotizacion}' != '') { //hay cotizante
		...
		if ( document.getElementById('idRegimenImp') && document.getElementById('idRegimenImp')!=null )
			if (document.getElementById('idRegimenImp').value != -1)
				if ( document.getElementById('codReg-' + document.getElementById('idRegimenImp').value) && document.getElementById('codReg-' + document.getElementById('idRegimenImp').value)!=null )
		...
		if (document.getElementById("segCesRemImp").value == "")
			document.getElementById("segCesRemImp").value = document.getElementById("montoGrati").value;
		...
		if (document.getElementById("rentaImpMutual").value == "")
			document.getElementById("rentaImpMutual").value = document.getElementById("montoGrati").value;
		...
		if (document.getElementById("remImpPension").value == "")
			document.getElementById("remImpPension").value = document.getElementById("montoGrati").value;
		...
		document.getElementById("remImpPens").innerHTML = "$ " + document.getElementById("remImpPension").value;
		recalculaAFP();
		recalculaINP();
	}
