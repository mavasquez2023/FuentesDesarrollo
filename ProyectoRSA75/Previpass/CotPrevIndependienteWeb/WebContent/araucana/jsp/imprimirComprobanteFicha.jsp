...
<table width="590" border="0" cellpadding="1" cellspacing="1" class="tabla-datos">			
	<tr> 
		<td width="50%"><strong>RUT Independiente:&nbsp;</strong>	${DetalleActionForm.rutEmpresaFormat}</td>
        <td width="50%"><strong>Nombre:&nbsp;</strong>${DetalleActionForm.razonSocial}</td>
    </tr>
	            		...
	            		<tr> 
	               		...
	               		<tr id="${seccion.idTipoSeccion}-${detalle.idDetalleSeccion}"> 
	                  		...
	                  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
	                        	...
	                        	<c:if test="${detalleDetalle.label != 'SIS'}">
		                            	<tr> 
