	...
	<tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
	    ...
	    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tabla-datos">
			<tr> 
	        	...
	        	<td><input type="submit" class="btn3" name="operacion" value="${buscar}" onclick="return validaFormulario();" /></td>
	      	</tr>
	      	<tr> 
	        	<td height="3" colspan="5" bgcolor="#85b4be"></td>
	      	</tr>
		</table>
	    <br />
	    <table width="100%" border="0" cellpadding="0" cellspacing="1">
					...
					<c:otherwise>
						<c:choose>
							<c:when test="${CotizantesListarActionForm.tipoProceso == 'R'}">
					        	<td align="right" bgcolor="#FFFFFF"><input type="submit" class="btn5_v2" name="operacion" value="${nuevoTrabajadorR}" /></td>
					        	<td align="right" bgcolor="#FFFFFF"><input type="submit" class="btn5"    name="operacion" value="${nuevoTrabajadorF}" /></td>
							</c:when>
							<c:otherwise>
		    					<td align="right" bgcolor="#FFFFFF"><input type="submit" class="btn2" name="operacion" value="${nuevoTrabajador}" /></td>
							</c:otherwise>
						</c:choose>
					</c:otherwise>
				</c:choose>
			        ...
			        <tr valign="top" align="center">
			        	<td height="20" style="text-align:right" nowrap="nowrap" class="${estilo}">${cotizante.rut}&nbsp;</td>
				       	...
				       	<td class="${estilo}" valign="middle">
					       	...
					       	<c:choose>
				   		    	<c:when test="${CotizantesListarActionForm.editNomina == 0}">
			   		    			<html:link action="/EditarCotizacion?rutEmpresa=${cotizante.rutEmpresa}&idConvenio=${cotizante.idConvenio}&idCotizPend=${cotizante.idCotizPendiente}&tipoProceso=${cotizante.tipoProceso}&operacion=mod&accion=inicio&subAccion=trabajadores&subSubAccion=trabajadorVer">
			   		    				<img src="<c:url value="/img/lupa.gif" />" alt="Ver" width="14" height="13" border="0" title="Ver" />
			   		    			</html:link>
				   		    	</c:when>
				   		    	<c:otherwise>
			   		    			<html:link action="/EditarCotizacion?rutEmpresa=${cotizante.rutEmpresa}&idConvenio=${cotizante.idConvenio}&idCotizPend=${cotizante.idCotizPendiente}&tipoProceso=${cotizante.tipoProceso}&operacion=mod&accion=inicio&subAccion=trabajadores&subSubAccion=trabajadorEditar">
				       	...
				       	<td class="${estilo}" valign="middle">
				   		    ...
				   		    <c:if test="${CotizantesListarActionForm.editNomina == 1}">
				   		    	<html:link href="#" onclick="javascript:eliminar(this, 'rutEmpresa=${cotizante.rutEmpresa}&idConvenio=${cotizante.idConvenio}&idCotizPend=${cotizante.idCotizPendiente}&tipoProceso=${cotizante.tipoProceso}&operacion=del&accion=inicio&subAccion=trabajadores&subSubAccion=nominaEditar','${cotizante.rut}','${cotizante.nombre} ${cotizante.apellidos}');"><img src="<c:url value="/img/icono_basurero.gif" />" alt="Eliminar" width="16" height="16" border="0" title="Eliminar" /></html:link>
				   		    </c:if>&nbsp;
				   		  	</div>
						</td>
					</tr>
		        ...
		        <tr valign="top" align="center">
		        	<td height="20" style="text-align:right" nowrap="nowrap" class="${estilo}">${cotizanteAviso.rut}&nbsp;</td>
			       	...
			       	<td class="${estilo}" valign="middle">
				       	...
				       	<c:choose>
			   		    	<c:when test="${CotizantesListarActionForm.editNomina == 0}">
		   		    			<html:link action="/EditarCotizacion?rutEmpresa=${cotizanteAviso.rutEmpresa}&idConvenio=${cotizanteAviso.idConvenio}&idCotizante=${cotizanteAviso.idCotizante}&tipoProceso=${cotizanteAviso.tipoProceso}&operacion=mod&accion=inicio&subAccion=trabajadores&subSubAccion=trabajadorVer">
		   		    				<img src="<c:url value="/img/lupa.gif" />" alt="Ver" width="14" height="13" border="0" title="Ver" />
		   		    			</html:link>
			   		    	</c:when>
			   		    	<c:otherwise>
		   		    			<html:link action="/EditarCotizacion?rutEmpresa=${cotizanteAviso.rutEmpresa}&idConvenio=${cotizanteAviso.idConvenio}&idCotizante=${cotizanteAviso.idCotizante}&tipoProceso=${cotizanteAviso.tipoProceso}&operacion=mod&accion=inicio&subAccion=trabajadores&subSubAccion=trabajadorEditar">
		   		    				<img src="<c:url value="/img/ico_hojap.gif" />" alt="Editar" width="14" height="13" border="0" title="Editar" />
		   		    			</html:link>
			   		    	</c:otherwise>
			   		  	</c:choose>
			       	...
			       	<td class="${estilo}" valign="middle">
			   		    <div align="center">
			   		    <c:if test="${CotizantesListarActionForm.editNomina == 1}">
			   		    	<html:link href="#" onclick="javascript:eliminar(this, 'rutEmpresa=${cotizanteAviso.rutEmpresa}&idConvenio=${cotizanteAviso.idConvenio}&idCotizante=${cotizanteAviso.idCotizante}&tipoProceso=${cotizanteAviso.tipoProceso}&operacion=del&accion=inicio&subAccion=trabajadores&subSubAccion=nominaEditar','${cotizanteAviso.rut}','${cotizanteAviso.nombre} ${cotizanteAviso.apellidos}');"><img src="<c:url value="/img/icono_basurero.gif" />" alt="Eliminar" width="16" height="16" border="0" title="Eliminar" /></html:link>
			   		    </c:if>&nbsp;
			   		  	</div>
				   	</td>
				</tr>
		        ...
		        <tr valign="top" align="center">
		        	<td height="20" style="text-align:right" nowrap="nowrap" class="${estilo}">${cotizante.rut}&nbsp;</td>
			       	...
			       	<td class="${estilo}" valign="middle">
				       	...
				       	<c:choose>
			   		    	<c:when test="${CotizantesListarActionForm.editNomina == 0}">
		   		    			<html:link action="/EditarCotizacion?rutEmpresa=${cotizante.rutEmpresa}&idConvenio=${cotizante.idConvenio}&idCotizante=${cotizante.idCotizante}&tipoProceso=${cotizante.tipoProceso}&operacion=mod&accion=inicio&subAccion=trabajadores&subSubAccion=trabajadorVer">
		   		    				<img src="<c:url value="/img/lupa.gif" />" alt="Ver" width="14" height="13" border="0" title="Ver" />
		   		    			</html:link>
			   		    	</c:when>
			   		    	<c:otherwise>
		   		    			<html:link action="/EditarCotizacion?rutEmpresa=${cotizante.rutEmpresa}&idConvenio=${cotizante.idConvenio}&idCotizante=${cotizante.idCotizante}&tipoProceso=${cotizante.tipoProceso}&operacion=mod&accion=inicio&subAccion=trabajadores&subSubAccion=trabajadorEditar">
		   		    				<img src="<c:url value="/img/ico_hojap.gif" />" alt="Editar" width="14" height="13" border="0" title="Editar" />
		   		    			</html:link>
			   		    	</c:otherwise>
			   		  	</c:choose>
			       	...
			       	<td class="${estilo}" valign="middle">
			   		    <div align="center">
			   		    <c:if test="${CotizantesListarActionForm.editNomina == 1}">
			   		    	<html:link href="#" onclick="javascript:eliminar(this, 'rutEmpresa=${cotizante.rutEmpresa}&idConvenio=${cotizante.idConvenio}&idCotizante=${cotizante.idCotizante}&tipoProceso=${cotizante.tipoProceso}&operacion=del&accion=inicio&subAccion=trabajadores&subSubAccion=nominaEditar','${cotizante.rut}','${cotizante.nombre} ${cotizante.apellidos}');"><img src="<c:url value="/img/icono_basurero.gif" />" alt="Eliminar" width="16" height="16" border="0" title="Eliminar" /></html:link>
			   		    </c:if>&nbsp;
			   		  	</div>
				   	</td>
				</tr>
