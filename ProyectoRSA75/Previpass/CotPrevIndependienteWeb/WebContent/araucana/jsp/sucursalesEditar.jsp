		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1"
				...
				<nested:notEqual property="tipoOper" value="crear">
					<tr>
						<td><strong>Tipo de Direcci&oacute;n</strong></td>
						<td>
				...
				<tr valign="bottom">
					<nested:notEqual property="tipoOper" value="crear">
						<td height="30" bgcolor="#FFFFFF" class="titulo">
							<strong>Edici&oacute;n de Direcci&oacute;n</strong>
							<c:set var="opcioneditcrea" value="e"/>
						</td>
					</nested:notEqual>
					<nested:equal property="tipoOper" value="crear">
						<td height="30" bgcolor="#FFFFFF" class="titulo">
							<strong>Creaci&oacute;n de Direcci&oacute;n</strong>
						</td>
					</nested:equal>
				</tr>
			</table>
			<table width="100%" border="0" cellpadding="1" cellspacing="1"
				...
				<tr>
					...
					<td height="17" class="textos_formularios">
						...
						<html:select property="codigo" styleId="codigo" styleClass="campos">
				...
				<tr>
					...
					<td height="17" class="textos_formularios">
						<html:textarea property="direccion" styleId="direccion" styleClass="campos" onblur="javascript:cuentaTxtArea(this, 80);javascript:soloDireccion(this);" onkeyup="javascript:cuentaTxtArea(this, 80);javascript:soloDireccion(this);" rows="2" cols="25"></html:textarea>
					</td>
				...
				<tr>
					...
					<td width="27%" height="17" class="textos_formularios">
						<html:text property="email" styleId="email" maxlength="30" size="45" styleClass="campos" onblur="javascript:soloEmail(this);" onkeyup="javascript:soloEmail(this);"/>
					</td>
				</tr>
			</table>
			</td>
...
<script language="javaScript">
	...
	function validaFormulario(f) 
	{
		...
		if (!validaReq(document.getElementById("direccion")))
			...
			//Datos opcionales de la casa matriz
		if (validaReq(document.getElementById("direccion")) &&
			!validaDescripcion(document.getElementById("direccion").value))
		...
		if (document.getElementById("opcComuna").value == "-1")
			sMsje += "* Debe seleccionar la comuna del sucursal\n";			
