...
<html:form action="/ListarUsuarios" styleId="formulario">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1">
					<tr valign="bottom"> 
						<td height="30" bgcolor="#FFFFFF" class="titulo">
							<strong>Lista de Encargados</strong>
						</td>
					</tr>
				</table>
			</td>
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
					<tr>
                		<td width="20%" align="center" valign="middle" nowrap="nowrap" bordercolor="#CCCCCC" class="barra_tablas">RUT</td>
		               	...
		               	<td width="40%" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Apellidos</td>
					</tr>
					<tr>
						<td colspan="3">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<nested:iterate id="fila" property="consulta" indexId="nFila">
									...
									<tr>
			                    		<td width="20%" valign="middle" nowrap="nowrap" class="${estilo}"><div align="right"><nested:write property="idUsuarioFmt"/></div></td>
			                    		<td width="40%" valign="middle" class="${estilo}"><nested:write property="nombre"/></td>
			                    		<td width="40%" valign="middle" class="${estilo}"><nested:write property="apellido"/></td>
			                  		</tr>
								</nested:iterate>
								<nested:empty property="consulta">
			             			<tr>
			             				<td class="textos_formularios" height="20">
			             					No existen encargados administrados por el encargado autenticado
			             				</td>
			             			</tr>
								</nested:empty>
							</table>
