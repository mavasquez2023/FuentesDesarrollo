            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="1" class="tabla-datos">
              <tr> 
                ...
                <td width="25%" height="17" class="textos_formularios">
                	<nested:text property="codigoConvenio" styleId="codigoConvenio" styleClass="campos" size="6" maxlength="3" onblur="javascript:soloNumero(this);" onkeyup="javascript:soloNumero(this);"/>
                </td>
