            ...
            <tr> 
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
			         <tr>
			           ...
			           <td width="91" align="center" valign="middle"  bordercolor="#FFFFFF" class="barra_tablas">Nombre</td>
			           <td width="70" align="center" valign="middle" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Convenio</td>
			           <td colspan="3" width="114" align="center" valign="middle" bordercolor="#FFFFFF" class="barra_tablas">Accesos</td>
			           <td colspan="4" width="100" align="center" valign="middle"  bordercolor="#FFFFFF" class="barra_tablas">Planillas</td>
			         </tr>
			         <tr>
			           <td colspan="3" align="center" valign="middle" nowrap="nowrap" bordercolor="#CCCCCC" class="barra_tablas">&nbsp;</td>
			           ...
			           <td colspan="2" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Gr</td>
			           <td colspan="4" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Ind</td>
			           <td align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Cn</td>
			           <td align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas" style="display:none">Sc</td>
			         </tr>
					         ...
					         <nested:iterate id="grupo" property="permisos" indexId="nFila" type="cl.araucana.cp.distribuidor.presentation.beans.GrupoConvenio">
								...
								<tr>
									...
									<td colspan="3" align="center" width="306" valign="middle" class="${estilo}">
				   		    		...
				   		    		<td width="25" class="${estilo}" style="display:none"><div align="center"><nested:checkbox property="permLector" /></div></td>
											...
											<tr>
												<td width="115" class="${estilo}">&nbsp;</td>
									         	...
									         	<td width="161" class="${estilo}">${empresa.razonSocial}<nested:hidden property="idEmpresa" /></td>
							   		    		...
							   		    		<td width="25" class="${estilo}"><div align="center"><nested:checkbox property="permLector"/></div></td>
											...
											<tr id="tr-em-${empresa.idEmpresa}-${grupo.idGrupo}" style="display:none">
												<td colspan="6" width="590">
													...
													<nested:iterate id="perm" property="convenios" indexId="nFilaPerm" type="cl.araucana.cp.distribuidor.presentation.beans.PermEncargadoLector">
														<tr>
			   		    									<!--  <td width="200" class="${estilo}">&nbsp;</td>-->
															<td width="330" colspan="2" class="${estilo}"><div align="right">${perm.idConvenio}&nbsp;</div><nested:hidden property="idConvenio" /></td>
							   		    					<td width="50" class="${estilo}"><div align="center"><nested:radio property="idNivel" value="2"/></div></td>
							   		    					<td width="60" class="${estilo}"><div align="center"><nested:radio property="idNivel" value="1"/></div></td>
							   		    					<td width="50" class="${estilo}"><div align="center"><nested:radio property="idNivel" value="0"/></div></td>
							   		    					<td width="10" class="${estilo}">&nbsp;</td>
							   		    					<td width="90" class="${estilo}" colspan="2"><div align="center">&nbsp;<nested:checkbox property="convenioLector"  style="display:none"/></div></td>
							   		    					<td class="${estilo}" style="display:none">
...
<!-- 
	...
	function deseleccionar(){
		document.getElementById("permisos[0].permLector").checked = false;	
	}
// End --> 
</script>