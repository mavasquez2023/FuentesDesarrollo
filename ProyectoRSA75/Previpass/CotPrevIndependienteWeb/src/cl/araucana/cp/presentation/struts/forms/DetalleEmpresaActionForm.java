...
public class DetalleEmpresaActionForm extends ActionForm implements Serializable
{
	...
	private String caja;
	private String nomAcEconomina;
	
	private String tipoPagoObligatorio;
	private String tipoPagoVolountarias;
	 ...
	 * 
	 */
	public String getNomAcEconomina() {
		return nomAcEconomina;
	}
	/**
	 * Nombre actividad economica
	 * @param nomAcEconomina
	 */
	public void setNomAcEconomina(String nomAcEconomina) {
		this.nomAcEconomina = nomAcEconomina;
	}
	/**
	 * Tipo Pago Obligatorio
	 * 
	 */
	public String getTipoPagoObligatorio() {
		return tipoPagoObligatorio;
	}
	/**
	 * Tipo Pago Obligatorio
	 * @param tipoPagoObligatorio
	 */
	public void setTipoPagoObligatorio(String tipoPagoObligatorio) {
		this.tipoPagoObligatorio = tipoPagoObligatorio;
	}
	/**
	 * Tipo Pago Voluntario
	 * 
	 */
	public String getTipoPagoVolountarias() {
		return tipoPagoVolountarias;
	}
	/**
	 * Tipo Pago Voluntario
	 *  @param tipoPagoVoluntario
	 */
	public void setTipoPagoVolountarias(String tipoPagoVolountarias) {
		this.tipoPagoVolountarias = tipoPagoVolountarias;
	}
}
