...
import cl.araucana.cp.webServices.aporte.orqInput.service.vo.CreditoDetalleFormVO;
...
public class DetalleActionForm extends ActionForm
{
	...
	private ArrayList aporteDetalleFormVO;
	private ArrayList creditoDetalleFormVO;
	private ArrayList leasingDetalleFormVO;
	...
	public ArrayList getCreditoDetalleFormVO() {
		return creditoDetalleFormVO;
	}

	public void setCreditoDetalleFormVO(ArrayList creditoDetalleFormVO) {
		this.creditoDetalleFormVO = creditoDetalleFormVO;
	}

	
	public ArrayList getLeasingDetalleFormVO() {
		return leasingDetalleFormVO;
	}

	public void setLeasingDetalleFormVO(ArrayList leasingDetalleFormVO) {
		this.leasingDetalleFormVO = leasingDetalleFormVO;
	}

	public ArrayList getAporteDetalleFormVO() {
		return aporteDetalleFormVO;
	}

	public void setAporteDetalleFormVO(ArrayList aporteDetalleFormVO) {
		this.aporteDetalleFormVO = aporteDetalleFormVO;
	}
