...
public class ServletConfiguration extends HttpServlet 
{
	...
	private void cargaParametros() 
	{
		...
		try
		{
			...
			//URL Para WS que informa el pago.
			Constants.URL_WS_INFORMAR_PAGO ="http://"+(param.get(""+Constants.PARAM_URL_WS_INFORMAR_PAGO)).trim() + Constants.URL_WS_INFORMAR_PAGO;
			
			Constants.URL_WS_OBTENER_PAGO ="http://"+(param.get(""+Constants.PARAM_URL_WS_OBTENER_PAGO)).trim() + Constants.URL_WS_OBTENER_PAGO;
