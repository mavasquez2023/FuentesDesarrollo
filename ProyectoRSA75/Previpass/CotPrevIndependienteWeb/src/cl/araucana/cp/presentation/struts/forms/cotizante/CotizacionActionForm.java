...
public class CotizacionActionForm extends ActionForm
{
	...
	public List getNumeroPeriodo() {
		return numeroPeriodo;
	}

	public void setNumeroPeriodo(List numeroPeriodo) {
	...
	{
		//if(cotizacion != null){
		//	cotizacion.setAccTrabajoMutual(String.valueOf(  Math.round(  Long.parseLong( cotizacion.getRentaImp().replace('.', ' ')) *this.getTasaMutual() /100 )));
		//}
