...
public class ListarEmpresasAction extends AppAction
{
	...
	private void llenaCombosEdicion(ListarEmpresasActionForm actForm, UsuarioCP usuarioCP, Session sesion) throws DaoException
	{
		...
		*/
		List grupos = new ArrayList();
		ParametrosDAO parametrosDao = new ParametrosDAO(sesion);
		ParametroVO parametroVO = parametrosDao.getParametro(Constants.GRUPO_CONV_TRAB_INDEPENDIENTE_VALOR);
		grupos.add(new LabelValueBean("INDEPENDIENTE", parametroVO.getValor().trim()));
	...
	protected ActionForward doTask(User usuario, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try 
		{
			...
			if (operacion.equals(Constants.TXT_BTNS.getProperty("crearIndependiente"))) 
			{
