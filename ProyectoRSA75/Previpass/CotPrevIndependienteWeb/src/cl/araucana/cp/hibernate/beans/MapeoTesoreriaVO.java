...
public class MapeoTesoreriaVO extends AuditableVO
{
	...
	private int idConceptoTesoreriaInd;
	...
	public MapeoTesoreriaVO(char idTipoNomina, int idTipoSeccion, int idDetalleSeccion, int idConceptoTesoreria, int idMontoDetSeccion, int idConceptoTesoreriaInd,String aplicaPara)
	{
		super();
		...
		this.idConceptoTesoreriaInd = idMontoDetSeccion;
		this.aplicaPara = aplicaPara;
	}
	
	public int getIdConceptoTesoreriaInd() {
		return idConceptoTesoreriaInd;
	}

	public void setIdConceptoTesoreriaInd(int idConceptoTesoreriaInd) {
		this.idConceptoTesoreriaInd = idConceptoTesoreriaInd;
	}
	...
	public HashMap getParametrosOrdenados()
	{
		...
		parametros.put("6", String.valueOf(this.idConceptoTesoreriaInd));
		parametros.put("7", String.valueOf(this.aplicaPara));
		return parametros;
	}
}
