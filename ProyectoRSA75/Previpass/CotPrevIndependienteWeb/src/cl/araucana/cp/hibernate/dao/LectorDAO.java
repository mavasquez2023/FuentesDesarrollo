	...
	public HashMap getEmpresasLector(int idLectorEmpresa) throws DaoException 
	{
		try
		{
			...
			for (Iterator it = lista.iterator(); it.hasNext();)
			{
				...
				EmpresaVO empresa = (EmpresaVO)this.session.createCriteria(EmpresaVO.class)
								.add(Restrictions.eq("idEmpresa", new Integer(le.getIdLectorEmpresa())))
								.add(Restrictions.eq("tipo", Constants.TIPO_EMPRESA_INDEPENDIENTE))
								.uniqueResult();
	...
	public HashMap getConveniosLector(int idLectorEmpresa) throws DaoException 
	{
		try
		{
			...
			for (Iterator it = lista.iterator(); it.hasNext();)
			{
				...
				EmpresaVO empresa = (EmpresaVO)this.session.createCriteria(EmpresaVO.class)
								.add(Restrictions.eq("idEmpresa", new Integer(lc.getIdLectorEmpresa())))
								.add(Restrictions.eq("tipo", Constants.TIPO_EMPRESA_INDEPENDIENTE))
								.uniqueResult();
	...
	public HashMap getSucsLector(int idLectorEmpresa) throws DaoException 
	{
		try
		{
			...
			for (Iterator it = lista.iterator(); it.hasNext();)
			{
				...
				EmpresaVO empresa = (EmpresaVO)this.session.createCriteria(EmpresaVO.class)
								.add(Restrictions.eq("idEmpresa", new Integer(ls.getIdLectorEmpresa())))
								.add(Restrictions.eq("tipo", Constants.TIPO_EMPRESA_INDEPENDIENTE))
								.uniqueResult();
