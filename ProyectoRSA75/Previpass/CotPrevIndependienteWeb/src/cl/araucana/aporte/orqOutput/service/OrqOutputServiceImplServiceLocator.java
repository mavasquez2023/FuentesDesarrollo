...
public class OrqOutputServiceImplServiceLocator extends org.apache.axis.client.Service implements cl.araucana.aporte.orqOutput.service.OrqOutputServiceImplService {
    ...
    public cl.araucana.aporte.orqOutput.service.OrqOutputServiceImpl getOrqOutputServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public cl.araucana.aporte.orqOutput.service.OrqOutputServiceImpl getOrqOutputServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cl.araucana.aporte.orqOutput.service.OrqOutputServiceImplSoapBindingStub _stub = new cl.araucana.aporte.orqOutput.service.OrqOutputServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cl.araucana.aporte.orqOutput.service.OrqOutputServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                cl.araucana.aporte.orqOutput.service.OrqOutputServiceImplSoapBindingStub _stub = new cl.araucana.aporte.orqOutput.service.OrqOutputServiceImplSoapBindingStub(new java.net.URL(OrqOutputServiceImpl_address), this);
                _stub.setPortName(getOrqOutputServiceImplWSDDServiceName());
                return _stub;
            }
        }
