...
public class OrqOutputResultVO  implements java.io.Serializable {
    private cl.araucana.aporte.orqOutput.service.vo.ErrorResultVO errorVO;

    public OrqOutputResultVO() {
    }

    public OrqOutputResultVO(
           cl.araucana.aporte.orqOutput.service.vo.ErrorResultVO errorVO) {
     ...
     * @return errorVO
     */
    public cl.araucana.aporte.orqOutput.service.vo.ErrorResultVO getErrorVO() {
        return errorVO;
    }
     ...
     * @param errorVO
     */
    public void setErrorVO(cl.araucana.aporte.orqOutput.service.vo.ErrorResultVO errorVO) {
        this.errorVO = errorVO;
    }
