...
public class DetalleSeccionDNPVO extends AuditableVO
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5610991398344210970L;
	private static Logger logger = Logger.getLogger(DetalleSeccionDNPVO.class);
	...
	private SeccionDNPVO seccion;
	
	private String tipoPagoDNP;
	
	public DetalleSeccionDNPVO()
	{
		super();
	}

	public DetalleSeccionDNPVO(int idTipoSeccion, int idDetalleSeccion, int numTrabajadores, int tipoPago, double []mTmp)
	{
		super();
	...
	public DetalleSeccionDNPVO(DetalleSeccionDNPVO detalle, SeccionDNPVO secc) 
	{
		super();
	...
	public SeccionDNPVO getSeccion() {
		return this.seccion;
	}

	public void setSeccion(SeccionDNPVO seccion) {
