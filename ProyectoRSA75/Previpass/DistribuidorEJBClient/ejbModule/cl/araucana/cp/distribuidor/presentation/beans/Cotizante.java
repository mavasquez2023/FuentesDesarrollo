...
public class Cotizante implements Serializable, Comparable
{
	...
	private int numeroPeriodoAfp = 0;
	...
	//csanchez 22/09/2010
	private boolean flgVoluntario = false;
	
	//Para efectos del Excel para Depósito Convenido
...
//	clillo 3-12-14 por Reliquidación
	...
	public Cotizante(String idCotizante, int idConvenio, int rutEmpresa, char tipoProceso, int periodo)
	{
		super();
...
//	clillo 3-12-14 para Independientes
	public Cotizante(String idCotizante, int idConvenio, int rutEmpresa, char tipoProceso)
	{
		super();
		this.idCotizante = idCotizante;
	...
	public boolean isFlgVoluntario()
	{
		return this.flgVoluntario;
	}

	public void setFlgVoluntario(boolean flgVoluntario)
	{
		this.flgVoluntario = flgVoluntario;
	}
