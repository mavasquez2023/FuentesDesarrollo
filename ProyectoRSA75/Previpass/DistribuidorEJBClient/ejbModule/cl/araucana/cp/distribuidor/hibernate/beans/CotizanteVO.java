...
//	clillo 3-12-14 por Reliquidación
	//public CotizanteVO(int rutEmpresa, int idConvenio, char tipoProceso, int idCotizante)
	public CotizanteVO(int rutEmpresa, int idConvenio, char tipoProceso, int idCotizante, int periodo)
	{
		super();
		this.rutEmpresa = rutEmpresa;
		this.idConvenio = idConvenio;
...
//	clillo 3-12-14 por Reliquidación
	//public CotizanteVO(int rutEmpresa, int idConvenio, int idCotizante)
	public CotizanteVO(int rutEmpresa, int idConvenio, int idCotizante, int periodo)
	{
		super();
		this.rutEmpresa = rutEmpresa;
		this.idConvenio = idConvenio;
...
//		clillo 3-12-14 por Reliquidación
	...
	public void addApv(int idAPVReal, int monto)
	{
		if (this.apvList == null)
			this.apvList = new ArrayList();
		ApvVO apv = new ApvVO(this.rutEmpresa, this.idConvenio, this.idCotizante, idAPVReal, monto, Constants.REGIMEN_APV_B);
		this.apvList.add(apv);
	}
	...
	public void addApv(ApvVO apv)
	{
		...
		if(!this.apvList.isEmpty()){
			Iterator  i = this.apvList.iterator();
			while (i.hasNext()){
				ApvVO apvVO = (ApvVO)i.next();
				if(apvVO.getIdEntidadApv() < 0){
					//apvVO = apv;
					apvVO.setId(apv.getId());
					apvVO.setRutEmpresa(apv.getRutEmpresa());
					apvVO.setIdConvenio(apv.getIdConvenio());
					apvVO.setIdCotizante(apv.getIdCotizante());
					apvVO.setIdEntidadApv(apv.getIdEntidadApv());
					apvVO.setAhorro(apv.getAhorro());
					apvVO.setMontoFormat(apv.getMontoFormat());
					break;
				}
			}				
		}else{
...
//		clillo 3-12-14 por Reliquidación
		parametros.put("22", String.valueOf(this.periodo));
	...
	/**
	 * @return el idEntAFBRReal
	 */
	public int getIdEntAFBRReal() {
		return idEntAFBRReal;
	}

	/**
	 * @param idEntAFBRReal el idEntAFBRReal a establecer
	 */
	public void setIdEntAFBRReal(int idEntAFBRReal) {
		this.idEntAFBRReal = idEntAFBRReal;
	}
}
