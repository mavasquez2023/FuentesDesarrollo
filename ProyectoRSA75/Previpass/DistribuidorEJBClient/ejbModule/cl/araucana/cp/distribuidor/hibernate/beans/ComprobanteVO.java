...
public class ComprobanteVO extends AuditableVO
{
	...
	long renta_imponible;
	//se cambia una vez leido de Parametros
	int diaFinPagoCaja=10;
	
	/**
	 * @return el diaFinPagoCaja
	 */
	public int getDiaFinPagoCaja() {
	 ...
	 */
	public void setDiaFinPagoCaja(int diaFinPagoCaja) {
		this.diaFinPagoCaja = diaFinPagoCaja;
	}
	...
	public ComprobanteVO(ComprobanteVO otro)
	{
		...
		if (otro.getSecciones() != null)
		{
			...
			{
				SeccionVO secc = new SeccionVO((SeccionVO)it.next(), this, getDiaFinPagoCaja());
				seccs.add(secc);
			}
		}
		this.secciones = seccs;
		this.renta_imponible = otro.getRenta_imponible();
	}
	...
	public long getRenta_imponible() {
		return renta_imponible;
	}

	public void setRenta_imponible(long renta_imponible) {
		this.renta_imponible = renta_imponible;
	}
