...
public class _DispDatosRemote_Stub extends Stub implements DispDatosRemote {
    
    private static final String[] _type_ids = {
        "RMI:cl.araucana.aporte.dispDatos.ejb.DispDatosRemote:0000000000000000", 
    ...
    public DispDatosResultBO obtenerInfoDatos(int arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        OutputStream out = _request("obtenerInfoDatos", true);
                        out.write_long(arg0);
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (DispDatosResultBO) in.read_value(DispDatosResultBO.class);
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                        String id = in.read_string();
                        throw new UnexpectedException(id);
                ...
                ServantObject so = _servant_preinvoke("obtenerInfoDatos",cl.araucana.aporte.dispDatos.ejb.DispDatosRemote.class);
                if (so == null) {
                    continue;
                }
                try {
                    DispDatosResultBO result = ((cl.araucana.aporte.dispDatos.ejb.DispDatosRemote)so.servant).obtenerInfoDatos(arg0);
                    return (DispDatosResultBO)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
