...
public class _EJSRemoteStatelessDispDatosBean_d7a63304_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessDispDatosBean_d7a63304 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessDispDatosBean_d7a63304) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 16: 
                    if (method.equals("obtenerInfoDatos")) {
                        return obtenerInfoDatos(in, reply);
                    }
            }
    ...
    private OutputStream obtenerInfoDatos(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        DispDatosResultBO result = target.obtenerInfoDatos(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,DispDatosResultBO.class);
        return out;
    }
}
