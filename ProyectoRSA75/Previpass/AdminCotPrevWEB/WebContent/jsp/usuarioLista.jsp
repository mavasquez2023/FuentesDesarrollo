...
<table width="590" border="0" cellspacing="0" cellpadding="0">
  	...
  	<tr> 
    	<td align="left" valign="top">
	        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #333333; background-color: #e1ebed;">
	         	<tr>
					<td colspan="4" height="11"><strong>Encargado</strong></td>
				</tr>
				<tr> 
	         	...
	         	<tr>
					<td colspan="4"><hr>
					<strong>Grupo Convenio</strong></td>
				</tr>
	         	<tr> 
	         		<td height="10"><strong>Codigo:</strong></td>
	           		<td><html:text property="codigoGrupoConvenio" styleId="codigoGrupoConvenio" maxlength="9" size="17" styleClass="campos" onblur="javascript:soloNumero(this, '');javascript:limpiaEmpresa();" onkeyup="javascript:soloNumero(this, '');javascript:limpiaEmpresa();"/></td>
	           		<td><strong>&nbsp;&nbsp;Nombre:</strong></td>
	           		<td><html:text property="nombreGrupoConvenio" styleId="nombreGrupoConvenio" maxlength="30" size="45" styleClass="campos" onblur="javascript:soloRazonSocial(this);javascript:limpiaEmpresa();" onkeyup="javascript:soloRazonSocial(this);javascript:limpiaEmpresa();"/></td>
	         	</tr>
	         	<tr><td colspan="4"><hr><strong>Empresa</strong></td></tr>
	         	<tr> 
	           		<td height="10"><strong>Rut:</strong></td>
	           		<td><html:text property="rutEmpresa" styleId="rutEmpresa" maxlength="13" size="17" styleClass="campos" onblur="javascript:soloRut(this);javascript:limpiaGrupo()" onkeyup="javascript:soloRut(this);javascript:limpiaGrupo()"/></td>
	           		<td><strong>&nbsp;&nbsp;Razon Social:</strong></td>
	           		<td><html:text property="razonSocial" styleId="razonSocial" maxlength="30" size="45" styleClass="campos" onblur="javascript:soloRazonSocial(this);javascript:limpiaGrupo()" onkeyup="javascript:soloRazonSocial(this);javascript:limpiaGrupo()"/></td>
	         	</tr>
    ...
    <logic:notEqual name="ListarUsuariosActionForm" property="mostrarLista" value="SI">
		<tr>
			<td align="right" height="30" valign="bottom">
				<html:button property="operacion" styleClass="btn2" value="Crear Encargado" onclick="javascript:creaUsuario();" />&nbsp;&nbsp;&nbsp;
	        </td>
	    </tr>
    </logic:notEqual>
	<logic:equal name="ListarUsuariosActionForm" property="mostrarLista" value="SI">
		<tr>
			<td height="40" valign="middle">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
		        	<tr valign="bottom"> 
		            	<td bgcolor="#FFFFFF" class="titulo"><strong>Lista de Encargados</strong></td>
							...
							<c:choose>
		               		...
		               		<tr>
		                   		...
		                   		<td align="center" nowrap="nowrap" class="${estilo}">
		                   			<div align="center">
			                   			<html:link action="/DetalleUsuarios" paramId="idUsuario" paramName="filaConsulta" paramProperty="rut" title="Ver detalle" styleClass="links">
			                   				<html:param name="accion" value="admin" />
			                   				<html:param name="subAccion" value="usuarios" />
			                   				<html:param name="subSubAccion" value="usuarioFicha" />
		                   					<img src="<c:url value='/img/iconos/lupa.gif' />" width="14" height="13" border="0"/>
		                   				</html:link>
		                   			</div>
		                   		</td>
		                   		<td align="center" nowrap="nowrap" class="${estilo}"><div align="center"><html:link action="/DetalleUsuarios.do?accion=admin&subAccion=usuarios&subSubAccion=usuarioEditar&idUsuario=${filaConsulta.rut}"><img src="<c:url value='/img/iconos/ico_hojap.gif' />" width="14" height="13" border="0" alt="Editar" title="Editar Encargado"/></html:link></div></td>
		                   		<td align="center" nowrap="nowrap" class="${estilo}"><div align="center"><a href="javascript:borraUsuario('${filaConsulta.rut}', '${filaConsulta.rutFormat}');"><img src="<c:url value="/img/iconos/icono_basurero.gif" />" width="14" height="13" border="0" alt="Borrar" title="Borrar Permisos" /></a></div></td>
		                   		<td align="center" nowrap="nowrap" class="${estilo}"><div align="center"><html:link action="/AsigPermisosEncargado.do?accion=admin&subAccion=usuarios&subSubAccion=usuarioEditar&operacion=Siguiente&idUsuario=${filaConsulta.rut}"><img src="<c:url value='/img/iconos/ico_llave.gif' />" width="14" height="13" border="0" alt="Editar" title="Asignar Permisos"/></html:link></div></td>
		                   		<td align="center" nowrap="nowrap" class="${estilo}"><div align="center"><html:link action="/DetalleUsuarios.do?accion=admin&subAccion=usuarios&subSubAccion=usuarioEditar&operacion=Password&idUsuario=${filaConsulta.rut}"><img src="<c:url value='/img/iconos/ico_candado.gif' />" width="14" height="13" border="0" alt="Editar" title="Cambiar Password"/></html:link></div></td>
		               		</tr>
	             		</nested:iterate>
             		</nested:notEmpty>
...
<!--
	...
	{
		if (!confirm("Está seguro que desea borrar todos los permisos de encargado de convenio del usuario: " + idUsuarioFmt))
			return;
	...
	{
		document.getElementById("formulario").action="/AdminCotPrevWEB/DetalleUsuarios.do";
	...
	function retornaEnlace(paginacion)
	{
		...
		formu.action = "ListarUsuarios.do?paginaNumero=" + paginacion;
		formu.submit();
	}
...
function abrirDocImpresion1()
{
    ...
    var rutEmpresa = document.getElementById("rutEmpresaOculto").value;
   	...
   	var URL="/AdminCotPrevWEB/ListarUsuarios.do?rut="+rut+"&nombre="+nombre+"&apellidos="+apellidos
