...
<body>
<html:form action="/AsigFamiliarListar" styleId="formulario">
	...
	<tr>
		<td colspan="2">
			<table width="100%" border="0" cellpadding="0" cellspacing="1">
				<tr valign="bottom"> 
					<td height="30" bgcolor="#FFFFFF" class="titulo"><strong>Mantenedor tipo Asig. Familiar</strong></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		...
		<td width="300" class="textos_formularios">
			<select id="estructura" name="estructura" class="campos" onchange="cambiaEstructura();">						
      	       		...
      	       		<option value="ASIG" selected>Tipo Asignaci&oacute;n Familiar</option>
			</select>			
	...
	<tr>
		<td colspan="2">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
				<tr>
					<td width="50" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">id</td>
					<td width="150" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Nombre</td>
					<td width="100" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Minimo</td>
					<td width="100" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Maximo</td>
					<td width="100" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Valor</td>
					<td width="80" align="center" valign="middle" nowrap="nowrap" bordercolor="#FFFFFF" class="barra_tablas">Acciones</td>
				</tr>
				<nested:notEmpty property="lista">
					...
					<nested:define id="id" property="id" />
						<tr>
							<td class="${estilo}" width="50">
								&nbsp;<nested:write property="id" />
								<input type="hidden" value="<nested:write property="nombre" />" id="nom_${id}"/>
							</td>
							<td class="${estilo}" width="200">
								&nbsp;<nested:write property="nombre" />
							</td>
							<td class="${estilo}" width="100">
								&nbsp;<nested:write property="rentaMinima" format="#,###"/>
							</td>
							<td class="${estilo}" width="100">
								&nbsp;<nested:write property="rentaMaxima" format="#,###" />
							</td>
							<td class="${estilo}" width="100">
								&nbsp;<nested:write property="valorCarga" format="#,###"/>
							</td>
							<td width="100" class="${estilo}" align="center">
								<div align="center">
									<a href="<c:url value='/AsigFamiliarEditar.do?id=${id}&tipoEdicion=ACTUALIZA' />">
										<img src="<c:url value="/img/iconos/ico_hojap.gif" />" width="14" alt="Editar" title="Editar" height="13" border="0" />
									</a>
									<a href="javascript:delConfirmar('<c:url value='/AsigFamiliarEditar.do?id=${id}&accionInterna=DEL_TIPO' />','${id}');">
...
function addTipo()
{
	...
	formu.action = 'AsigFamiliarEditar.do?tipoEdicion=NUEVO&id=-1';
	formu.submit();
}										
function editTipo(id)
{
	formu = document.getElementById("formulario");	
	formu.action = 'AsigFamiliarEditar.do?id='+id;
	formu.submit();
}	
function delTipo(nombre,id)
{
	formu = document.getElementById("formulario");	
	formu.action = 'AsigFamiliarEditar.do?id='+id+'&accionInterna=DEL_TIPO';	
	formu.submit();
}
