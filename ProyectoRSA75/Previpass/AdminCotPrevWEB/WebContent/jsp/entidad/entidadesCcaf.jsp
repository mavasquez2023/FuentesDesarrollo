...
<body onLoad="foco();">
<html:form action="/EdicionEntidadesCcaf" styleId="formulario" onsubmit="return onFormSubmit(this)">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<nested:equal property="nuevaEntidad" value="false">
				<tr height="26" valign="middle">
					<td valign="middle" colspan="4" height="30" bgcolor="#FFFFFF" class="titulo">
						<strong>Edici&oacute;n de Entidad CCAF</strong>
			...
			<tr height="26" valign="middle">
				...
				<td valign="middle" width="150" class="textos_formularios">
					...
					<nested:notEqual property="nuevaEntidad" value="false">
						<input type="text" name="rutEntidad" id="rutEntidad" value="<nested:write property="rutEntidad" />" class="campos" maxlength="11" size="12" onblur="javascript:soloRut(this);" onkeyup="javascript:soloRut(this);" />
				  </nested:notEqual>
				</td>
				<td valign="middle" width="130" class="barratablas">
			...
			<tr height="26" valign="middle">
				...
				<td valign="middle" colspan="3" width="150" class="textos_formularios">
					<nested:text property="nombreEntidad" styleId="nombreEntidad" styleClass="campos" maxlength="50" size="90" onblur="javascript:soloNombres(this);" onkeyup="javascript:soloNombres(this);"/>
				</td>				
			</tr>
			<tr height="26" valign="middle">
				<td valign="middle" width="130" class="barratablas">
			...
			<tr height="26" valign="middle">
				<td valign="middle" width="130" class="barratablas">
					<strong>Asignaci&oacute;n Familiar</strong>
				</td>
				<td valign="middle" width="150" class="textos_formularios">
					<nested:equal property="asigFam" value="1">
						<input type="radio" id="asigFam" name="asigFam" value="1" checked/>S&iacute;
						<input type="radio" id="asigFam" name="asigFam" value="0" />No
					</nested:equal>
					<nested:equal property="asigFam" value="0">
						<input type="radio" id="asigFam" name="asigFam" value="1" />S&iacute;
						<input type="radio" id="asigFam" name="asigFam" value="0" checked/>No
					</nested:equal>
				</td>
				<td valign="middle" width="130" class="barratablas">
				...
				<td valign="middle" width="150" class="textos_formularios">
					<nested:equal property="creditos" value="1">
						<input type="radio" id="creditos" name="creditos" value="1" checked/>S&iacute;
						<input type="radio" id="creditos" name="creditos" value="0" />No
					</nested:equal>
					<nested:equal property="creditos" value="0">
						<input type="radio" id="creditos" name="creditos" value="1" />S&iacute;
						<input type="radio" id="creditos" name="creditos" value="0" checked/>No
					</nested:equal>
				</td>
			</tr>
			<tr height="26" valign="middle">
				...
				<td valign="middle" width="150" class="textos_formularios">
					<nested:equal property="dental" value="1">
						<input type="radio" id="dental" name="dental" value="1" checked/>S&iacute;
						<input type="radio" id="dental" name="dental" value="0" />No
					</nested:equal>
					<nested:equal property="dental" value="0">
						<input type="radio" id="dental" name="dental" value="1" />S&iacute;
						<input type="radio" id="dental" name="dental" value="0" checked/>No
					</nested:equal>
				</td>
				<td valign="middle" width="130" class="barratablas">
				...
				<td valign="middle" width="150" class="textos_formularios">
					<nested:equal property="leasing" value="1">
						<input type="radio" id="leasing" name="leasing" value="1" checked/>S&iacute;
						<input type="radio" id="leasing" name="leasing" value="0" />No
					</nested:equal>
					<nested:equal property="leasing" value="0">
						<input type="radio" id="leasing" name="leasing" value="1" />S&iacute;
						<input type="radio" id="leasing" name="leasing" value="0" checked/>No
					</nested:equal>
				</td>
			</tr>	
			<tr height="26" valign="middle">
				<td valign="middle" width="130" class="barratablas">
					<strong>Porcentaje Fonasa</strong>
				</td>
				<td valign="middle" width="150" class="textos_formularios">
					<nested:equal property="porcentajeFonasa" value="1">
						<input type="radio" id="porcentajeFonasa" name="porcentajeFonasa" value="1" checked/>S&iacute;
						<input type="radio" id="porcentajeFonasa" name="porcentajeFonasa" value="0" />No
					</nested:equal>
					<nested:equal property="porcentajeFonasa" value="0">
						<input type="radio" id="porcentajeFonasa" name="porcentajeFonasa" value="1" />S&iacute;
						<input type="radio" id="porcentajeFonasa" name="porcentajeFonasa" value="0" checked/>No
					</nested:equal>				</td>
				<td valign="middle" width="130" class="barratablas">
					<strong>Seguros Vida</strong>
				</td>
				<td valign="middle" width="150" class="textos_formularios">
					<nested:equal property="segurosVida" value="1">
						<input type="radio" id="segurosVida" name="segurosVida" value="1" checked/>S&iacute;
						<input type="radio" id="segurosVida" name="segurosVida" value="0" />No
					</nested:equal>
					<nested:equal property="segurosVida" value="0">
						<input type="radio" id="segurosVida" name="segurosVida" value="1" />S&iacute;
						<input type="radio" id="segurosVida" name="segurosVida" value="0" checked/>No
					</nested:equal>
				</td>
			</tr>
				...
				<!-- <tr id="cancelarFolio" style="display:none" height="26" valign="middle">
					<td valign="middle" colspan="4" height="20" bgcolor="#FFFFFF" align="right" class="barratablas">
						<html:button property="operacion" styleClass="btn3" value="Cancelar" onclick="javascript:cancelarFolio();"/>
					</td>
				</tr>
				-->				
			...
			<tr height="26" valign="middle">
				<td valign="middle" colspan="5">
		  			        	...
		  			        	<tr height="26" valign="middle">
									...
									<td valign="middle" width="10%" class="campos" align="center">
										<nested:empty property="nombre">&nbsp;</nested:empty>
											<div align="center">
												<a href="javascript:delFolio('${idFoliacion}','${idEntPagadora}','${nFila}');">
		            ...
		            <tr id="folioNuevo2" style="display:none" height="26">
						...
						<td valign="middle" width="20%" align="center" ><html:button property="operacion" styleClass="btn3" value="Agregar Folio" onclick="javascript:saveFolio('-1','-1','-1');"/></td>
