...
<body onLoad="foco();">
<html:form action="/EdicionEntidadesApv" styleId="formulario" onsubmit="return onFormSubmit(this)">
			...
			<nested:equal property="nuevaEntidad" value="false">
				<tr height="26" valign="middle">
					<td valign="middle" colspan="4" height="30" bgcolor="#FFFFFF" class="titulo">
						<strong>Edici&oacute;n de Entidad APV</strong>
			...
			<tr height="26" valign="middle">
				...
				<td valign="middle" width="150" class="textos_formularios">
					...
					<nested:notEqual property="nuevaEntidad" value="false">
						<input type="text" name="rutEntidad" id="rutEntidad" value="<nested:write property="rutEntidad" />" class="campos" maxlength="13" size="12" onblur="javascript:soloRut(this);" onkeyup="javascript:soloRut(this);" />
					</nested:notEqual>
				</td>
				<td valign="middle" width="130" class="barratablas">
