...
<body onLoad="foco();">
<html:form action="/EdicionEntidadesSalud" styleId="formulario" onsubmit="return onFormSubmit(this)">
...
<tr>
	<td>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<nested:equal property="nuevaEntidad" value="false">
				<tr height="26" valign="middle">
					<td valign="middle" colspan="4" height="30" bgcolor="#FFFFFF" class="titulo">
						<strong>Edici&oacute;n de Entidad SALUD</strong>
			...
			<tr height="26" valign="middle">
				<td valign="middle" height="20" class="barratablas" colspan="4">
					<strong>Datos Cuenta Corriente para Cheque</strong></td>
			</tr>		
			<tr height="26" valign="middle">
				<td valign="middle" width="130" class="barratablas">
					<strong>Banco</strong>
				...
				<td valign="middle" width="150" class="textos_formularios">
					<nested:text property="idCtaCte" styleId="idCtaCte" styleClass="campos" maxlength="15" size="20" onblur="javascript:soloCtaCte(this);" onkeyup="javascript:soloCtaCte(this);"/>
				</td>
			</tr>
			<tr height="26" valign="middle">
				<td valign="middle" height="20" class="barratablas" colspan="4">
			...
			<tr height="26" valign="middle">
				<td valign="middle" width="130" class="barratablas">
					<strong>Tasa Salud *</strong>
				</td>
				<td valign="middle" width="150" colspan="3" class="textos_formularios">
					<input type="text" name="tasaSalud" id="tasaSalud" value="${EdicionEntidadesSaludActionForm.tasaSalud}" class="campos" maxlength="5" size="30" onblur="javascript:soloDecimales(this);" onkeyup="javascript:soloDecimales(this);">
				</td>
			</tr>
