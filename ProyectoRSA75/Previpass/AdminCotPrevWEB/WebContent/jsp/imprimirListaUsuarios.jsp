					...
					<tr>
						...
						<nested:iterate id="filaConsulta" property="consulta" indexId="nFila">
							<c:choose>
		               		...
		               		<tr>
		                   		<td width="20%" height="20" align="right" valign="middle" nowrap="nowrap" class="${estilo}">
	                   				<div align="right"><nested:write property="rutFormat"/></div>
		                   		</td>
		                   		<td width="40%" class="${estilo}"><nested:write property="nombre"/></td>
		                   		<td width="40%"  class="${estilo}"><nested:write
