...
<div class="msgExito" id="ok" style="display: none;"><br/><bean:message key="message.archivo"/></div>
<br>
<html:form action="/ValidateReporteMensual" styleId="form">
<a class="titulo">Reporte AFP Mensual  </a>
<br></br>
