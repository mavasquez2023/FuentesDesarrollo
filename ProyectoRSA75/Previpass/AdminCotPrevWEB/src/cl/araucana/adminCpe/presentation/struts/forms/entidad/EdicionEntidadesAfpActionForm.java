...
/*
* @(#) EdicionEntidadesAfpActionForm.java 1.8 10/05/2009
*
 ...
 * @version 1.8
 */
public class EdicionEntidadesAfpActionForm extends ActionForm implements Serializable
{
	...
	private List listaAfc;

	private int idAfc;
	private String cotizacionObligatoria;
	 ...
	 * @return
	 */
	public List getListaAfc() {
		return this.listaAfc;
	}
	 ...
	 * @param listaAfc
	 */
	public void setListaAfc(List listaAfc) {
		this.listaAfc = listaAfc;
	}
	...
	public String getCotizacionObligatoria()
	{
		return this.cotizacionObligatoria;
	}

	public void setCotizacionObligatoria(String cotizacionObligatoria)
	{
