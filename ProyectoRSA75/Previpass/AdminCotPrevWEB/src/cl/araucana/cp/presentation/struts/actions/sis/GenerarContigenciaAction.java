...
/**
* Genera Archivo Contingencia para AFP<p>
*
...
*
*/
public class GenerarContigenciaAction extends AppAction {
    ...
    public ActionForward doTask(User user, ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	...
    	ArchivoVO archivoVO = (ArchivoVO)session.getAttribute("archivoContingencia");
    	...
    	response.addHeader("Content-Disposition", "attachment; filename=" + "contingencia"+archivoVO.getCodigoAfp()+".csv");
