...
function GenerarCierreFull(){
	...
	if(confirm("¿Confirma la generación completa del cierre " + cierre + ", asociado a la forma de pago "  + forma + " ?")){
					...
					<tr>
						...
						<td class="textos-formularios1" align="right">
							...
							<tr>
								...
								<c:if test="${cierre>0}">
								<td class="text-11" align="right" ><INPUT type="button" id="accionTE" class="btn_mini" value="TE" title="Generar Cheques Tesorería" disabled='disabled' onclick="GenerarCheques();"></td>
								</c:if>
								<c:if test="${cierre==0}">
					...
					<tr>
						...
						<table border=0>
							...
							<tr>
								...
								<td height="22" align="center" valign="middle"
									class="textos_formcolor">DEPÓSITO <a href="#" onclick="VerChequesSort();"><img id="imgorder" src="icons/ascsort.gif" border="0" alt="Order by Depósito" title="Order" /></a></td>
