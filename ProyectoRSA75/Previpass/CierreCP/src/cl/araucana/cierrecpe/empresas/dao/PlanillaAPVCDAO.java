 ...
 * @version 1.0
 */
public class PlanillaAPVCDAO implements DAO_Interface {
	 ...
	 * 
	 */
	public PlanillaAPVCDAO(ConectaDB2 db2, String esquema) {
		this.db2= db2;
	...
	public int insert(Object obj) throws SQLException {
		...
		query.append("INSERT INTO " + getEsquema() + ".pwf2900 values( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ");
		...
		db2.setStatement(6, planilla.getTipoProceso()); //Tipo de Proceso
		...
		db2.setStatement(21, 0); //Cotización Voluntaria
		db2.setStatement(22, 0); //Depositos Convenidos
		db2.setStatement(23, 0); //Aporte Indemnización
		...
		db2.setStatement(40, planilla.getAporteTrabajadorFdoPensionesColectivo());
		db2.setStatement(41, planilla.getAporteEmpleadorFdoPensionesColectivo());
	...
	private int insertDetalle(Object obj) throws SQLException {
		...
		StringBuffer query= new StringBuffer();
		query.append("INSERT INTO " + getEsquema() + ".pwf2901 values( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? ) ");
		db2.prepareQuery(query.toString());
		for (Iterator iterator = pagina.getCotizantes().iterator(); iterator.hasNext();) {
			...
			db2.setStatement(20, cotizante.getAporteTrabajadorFdoPensionColectivoCotizante());
			db2.setStatement(21, cotizante.getAporteEmpleadorFdoPensionColectivoCotizante());
			db2.setStatement(22, cotizante.getCodigoContratoCotizante());
