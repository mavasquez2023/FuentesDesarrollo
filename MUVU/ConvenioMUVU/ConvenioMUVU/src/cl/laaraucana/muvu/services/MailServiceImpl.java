...
public class MailServiceImpl implements MailService {
	...
	public boolean sendEmailClie(String to, String subject, String bodyContent, String rut, String ruta) throws Exception {
		...
		try {
			...
			//Se agrega banner en cabecera correo
			htmlPart = new MimeBodyPart();
			DataSource fds = new FileDataSource(Configuraciones.getConfig("muvu.carpeta") + "banner.jpg");
			...
			//Se agrega logo al pie de correo
			htmlPart = new MimeBodyPart();
			fds = new FileDataSource(Configuraciones.getConfig("muvu.carpeta") + "logo.jpg");
			...
			if(ruta!=null){
				...
				adjunto.setFileName(rut + "_Poliza_Seguro_Vida_Sana.pdf");
	...
	public boolean sendEmailEjec(String to, String subject, String bodyContent) throws Exception {
		...
		try {
			...
			DataSource fds = new FileDataSource(Configuraciones.getConfig("muvu.carpeta") + "\\logo.jpg");
