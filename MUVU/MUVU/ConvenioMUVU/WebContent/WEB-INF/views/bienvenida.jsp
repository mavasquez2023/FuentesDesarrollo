		...
		<div class="row">
          ...
          <div class="col xs12 md8 lg10">
            <div class="respuesta text-align-center-xs">
              <p class="respuesta__titulo color--secundario">Hola ${data.nombre}, <br> ya estás inscrito en el Programa de Vida Sana</p>
              <br>
              <p class="respuesta__texto color--secundario">Desde ahora tus pasos se transforman en beneficios. </p>
