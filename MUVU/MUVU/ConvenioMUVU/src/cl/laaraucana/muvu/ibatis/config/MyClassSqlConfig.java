...
* 
*/
package cl.laaraucana.muvu.ibatis.config;
...
public class MyClassSqlConfig {
	...
	static {
		try {
			String resource = "cl/laaraucana/muvu/ibatis/config/IbatisConfig.xml";
	...
	static {
		try {
			String resource = "cl/laaraucana/muvu/ibatis/config/IbatisConfigSql.xml";
			Reader reader = Resources.getResourceAsReader(resource);
